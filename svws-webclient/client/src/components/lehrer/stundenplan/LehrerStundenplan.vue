<template>
	<Teleport defer to=".svws-ui-header--actions">
		<stundenplan-drucken-modal :reportvorlage="ReportingReportvorlage.STUNDENPLANUNG_V_LEHRER_STUNDENPLAN" :server-mode v-slot="{ openModal }" :map-stundenplaene :get-p-d-f :api-status>
