<template>
	<svws-ui-content-card title="Allgemein">
		...
		<svws-ui-input-wrapper :grid="2">
			...
			<svws-ui-select title="Lehrer" v-model="lehrer" :items="mapLehrer.values()" :item-text="(l: LehrerListeEintrag) => l.kuerzel" />
			<svws-ui-multi-select-2 title="Jahrgänge" v-model="jahrgaenge" :items="mapJahrgaenge" :item-text="(jg: JahrgangsListeEintrag) => jg?.kuerzel ?? ''" />
