<template>
	<div v-if="visible" class="page page-flex-row">
		<div class="min-w-128 h-full flex flex-col gap-4">
		...
		<div class="min-w-fit h-full flex flex-col gap-4">
			<s-benutzergruppe-add-benutzer :alle-benutzer
