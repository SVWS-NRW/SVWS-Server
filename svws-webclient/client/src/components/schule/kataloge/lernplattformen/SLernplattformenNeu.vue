		...
		<div class="flex flex-col gap-y-16 lg:gap-y-20">
			<svws-ui-content-card title="Allgemein">
				<svws-ui-input-wrapper :grid="2">
					<div>
						<svws-ui-text-input	:valid="validatorLernplattformBezeichnung" v-model="lernplattform.bezeichnung" type="text" placeholder="Bezeichnung" />
				...
				<div class="mt-7 flex flex-row gap-4 justify-end">
					<svws-ui-button type="secondary" @click="cancel" :disabled="isLoading">Abbrechen</svws-ui-button><svws-ui-button @click="addEinwilligungsart"
						:disabled="((!validatorLernplattformBezeichnung(lernplattform.bezeichnung)) || isLoading || (lernplattform.bezeichnung === ''))">
