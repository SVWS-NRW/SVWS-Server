<template>
	<div class="page--content">
		...
		<svws-ui-content-card :title="'Alle Schüler mit der Einwilligungsart `' + einwilligungsartenListeManager().auswahl().bezeichnung + '`'" class="w-full"
			v-if="einwilligungsartenListeManager().getListSchuelerEinwilligungsartenZusammenfassung().list().size() > 0">
