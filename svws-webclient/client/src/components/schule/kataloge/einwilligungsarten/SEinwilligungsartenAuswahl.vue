<template>
	<svws-ui-secondary-menu>
		...
		<template #content>
			<div class="container">
				<svws-ui-table :clicked="auswahl()" @update:clicked="gotoEintrag" :items="mapKatalogeintraege.values()" :columns clickable selectable v-model="selected" scroll-into-view enable-focus-switching>
					<template #actions>
