...
<script setup lang="ts">
	...
	import { emailIsValid, isUniqueInList, mandatoryInputIsValid, numberHasDecimals, numberIsValid, optionalInputIsValid, phoneNumberIsValid, stringIsNumeric } from "~/util/validation/Validation";
	...
	function schulnameIsValid(schulname: string | null): boolean {
