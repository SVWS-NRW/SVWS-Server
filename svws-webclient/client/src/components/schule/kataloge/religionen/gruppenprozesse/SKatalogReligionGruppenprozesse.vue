<template>
	<div class="page page-grid-cards">
		<div class="flex flex-col gap-y-16 lg:gap-y-16" v-if="ServerMode.DEV.checkServerMode(serverMode)">
			<ui-card icon="i-ri-delete-bin-line" title="Löschen" subtitle="Ausgewählte Religionen werden gelöscht." :is-open="currentAction === 'delete'"
				...
				<template #buttonFooterLeft>
					<svws-ui-button :disabled="!checkBeforeDelete().isEmpty() || loading" title="Löschen" @click="deleteReligionen" :is-loading="loading"
						class="mt-4">
