<template>
	<div class="page page-grid-cards">
		...
		<div class="flex flex-col gap-4">
			<ui-card v-if="hatKompetenzLoeschen" title="Löschen" subtitle="Ausgewählte Fachklassen werden gelöscht" icon="i-ri-delete-bin-line">
				<div v-if="isPreConditionSectionVisible">
					<span v-if="selectedAllowedToDelete">Alle ausgewählten Fachklassen sind bereit zum Löschen.</span>
				...
				<template #buttonFooterLeft>
					<svws-ui-button title="Löschen" class="mt-4"
						@click="deleteSelectedFachklassen"
...
<script setup lang="ts">
	...
	import type { FachklassenGruppenprozesseProps } from "./FachklassenGruppenprozesseProps";

	const props = defineProps<FachklassenGruppenprozesseProps>();
	...
	async function deleteSelectedFachklassen() {
