<template>
	<div class="page page-grid-cards">
		...
		<div class="flex flex-col gap-4">
			<ui-card v-if="hatKompetenzLoeschen" title="Löschen" subtitle="Ausgewählte Orte werden gelöscht" icon="i-ri-delete-bin-line">
				<div>
					<span v-if="selectedAllowedToDelete">Alle ausgewählten Orte sind bereit zum Löschen.</span>
