					...
					<thead class="svws-ui-thead" role="rowgroup" aria-label="Tabellenkopf">
						<tr class="svws-ui-tr" role="row" @click="toggleDatenaustausch">
							<td class="svws-ui-td" role="columnheader">
								<svws-ui-menu-item @click="setChild(mapChildren.get('schule.datenaustausch') ?? props.child)">
									<template #label><span>{{ mapChildren.get('schule.datenaustausch')?.text ?? '---' }}</span></template>
								</svws-ui-menu-item>
							</td>
						</tr>
					</thead>
