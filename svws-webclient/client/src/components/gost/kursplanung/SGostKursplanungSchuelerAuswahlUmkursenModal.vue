						...
						<template #header(pin)>
							...
							<div v-else @click="toggleFixierRegelAlleKursSchueler">
								<template v-if="kursSchuelerFixierungen === true">
									<span class="icon-sm i-ri-pushpin-fill -my-0.5 hover:opacity-50" />
								</template>
								<template v-else-if="kursSchuelerFixierungen === null">
									<span class="icon-sm i-ri-pushpin-line -my-0.5 hover:opacity-50" />
								</template>
								<template v-else>
									<span class="icon-sm i-ri-pushpin-line -my-0.5 opacity-0 hover:opacity-75" />
								</template>
							</div>
						</template>
