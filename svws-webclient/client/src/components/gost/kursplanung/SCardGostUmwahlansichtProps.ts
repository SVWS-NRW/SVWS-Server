import type { GostBlockungRegel, GostBlockungsdatenManager, GostBlockungsergebnisKursSchuelerZuordnung, GostBlockungsergebnisManager, SchuelerListeEintrag } from "@core";
