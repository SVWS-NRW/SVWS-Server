										...
										<template v-if="blockungstabelleHidden() === 'schienen'">
											<div role="cell" class="svws-ui-td svws-align-center !p-[2px]">
												<div @click="toggleKursAusgewaehlt(kurs)"
													class="select-none w-full h-full rounded-xs flex justify-around items-center group bg-ui-0 text-ui-100 p-px"
											...
											<template v-for="(schiene, index) in getErgebnismanager().getMengeAllerSchienen()" :key="schiene.id">
												...
												<div role="cell" class="svws-ui-td svws-align-center !p-[2px]"
													:class="{
														...
														'bg-ui-100 opacity-50 text-ui-25 font-bold': highlightKursVerschieben(kurs).value,
													...
													<div v-if="istZugeordnetKursSchiene(kurs, schiene).value"
														...
														class="select-none w-full h-full rounded-xs flex justify-around items-center group p-px bg-ui-10 text-ui-75"
														:class="{
													...
													<div v-else class="w-full h-full flex items-center justify-center relative group"
														...
														<div v-if="highlightKursVerschieben(kurs).value" class="absolute bg-ui-0/50 inset-0 border-2 border-dashed rounded-sm border-ui-25" />
