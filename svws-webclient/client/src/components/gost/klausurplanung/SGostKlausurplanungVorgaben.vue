				...
				<template #actions>
					<div class="flex w-full items-center gap-1">
						<div class="ml-auto flex items-center gap-1">
							...
							<svws-ui-button v-else type="trash" :disabled="selected.length === 0 || !hatKompetenzUpdate" @click="loescheKlausurvorgaben(ArrayList.of(...selected))" />
...
<script setup lang="ts">
	...
	const gklInHalbjahrMoeglich = computed<boolean>(() => {
		const abiturjahr = props.jahrgangsdaten?.abiturjahr ?? activeVorgabe.value.abiJahrgang;
