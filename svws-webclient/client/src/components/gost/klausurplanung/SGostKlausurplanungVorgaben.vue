		...
		<svws-ui-content-card title="Klausurvorgaben">
			<svws-ui-table id="vorgabenTable" :items="vorgaben()" :columns="cols" v-model:clicked="selectedVorgabeRow" clickable @click="startEdit">
				...
				<template #actions>
					...
					<svws-ui-button type="icon" @click="console.log(props.klausurvorgabenmanager());neueVorgabe" :disabled="selectedVorgabeRow !== undefined" title="Neue Vorgabe erstellen"><span class="icon i-ri-add-line" /></svws-ui-button>
				</template>
			</svws-ui-table>
