<template>
	<div class="svws-klausurplanung-schienen-termin flex flex-col border bg-ui-0 rounded-xl cursor-pointer max-w-120" @drop="onDrop(termin())" @dragover="checkDropZone($event)"
		:class="{
