<template>
	<div class="page page-flex-row max-w-480" style="grid-template-columns: minmax(min-content, 1.5fr) minmax(min-content, 1fr)">
		<s-card-gost-faecher class="min-w-fit" :faecher-manager :abiturjahr="jahrgangsdaten()?.abiturjahr ?? -1" :patch-fach :hat-update-kompetenz />
		<div class="min-w-180 flex flex-col gap-y-16 lg:gap-y-20 top-8 h-full overflow-y-auto overflow-x-hidden pr-4 scrollbar-thin">
