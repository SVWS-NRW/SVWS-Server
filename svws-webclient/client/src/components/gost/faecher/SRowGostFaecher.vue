<template>
	...
	<div role="cell" class="svws-ui-td svws-align-center svws-divider svws-no-padding" :class="{ 'cursor-pointer': istProjektkurs && hatUpdateKompetenz }" @click="set_pjk_stunden">
		<div v-if="istProjektkurs && hatUpdateKompetenz" class="flex items-center gap-0.5 border border-ui-25 hover:border-ui-50 border-dashed hover:border-solid hover:bg-ui-0 my-auto p-[0.1rem] rounded" @keydown.enter="set_pjk_stunden" tabindex="0">
