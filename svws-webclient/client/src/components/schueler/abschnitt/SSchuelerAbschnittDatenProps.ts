import type { SchuleStammdaten, SchuelerLernabschnittsdaten, LehrerListeEintrag, JahrgangsListeEintrag, KlassenListeEintrag, FoerderschwerpunktEintrag, SchuelerLernabschnittBemerkungen } from "@core";
