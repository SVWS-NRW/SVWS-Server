<template>
	<svws-ui-content-card title="Sprachprüfungen — Herkunftsprachlicher Unterricht">
		<div v-if="!readonly && verfuegbareSprachpruefungen.length" class="w-1/4 mb-4">
			<svws-ui-select title="Hinzufügen..." removable :model-value="undefined" @update:model-value="sprache=> hinzufuegen(sprache, true)"
				:items="verfuegbareSprachpruefungen" :item-text="getTextBySprache" ref="selectSprachpruefung" focus-class-content />
		</div>
