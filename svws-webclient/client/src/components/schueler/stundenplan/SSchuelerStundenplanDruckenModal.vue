	...
	<svws-ui-modal v-model:show="show" size="medium">
		...
		<template #modalContent>
			<svws-ui-input-wrapper>
				...
				<div class="text-left">
					<svws-ui-checkbox v-model="option2">Unterrichte"Unterrichte mit Pausenzeiten</svws-ui-checkbox>
					<svws-ui-checkbox v-model="option4">Unterrichte"Unterrichte mit Fach- statt Kursbezeichnungen in der Sek-I </svws-ui-checkbox>
					<svws-ui-checkbox v-model="option8">Unterrichte"Unterrichte mit Anzeige der individuellen Kursart</svws-ui-checkbox>
				</div>
				<svws-ui-radio-group>
