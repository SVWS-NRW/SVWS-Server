<template>
	<Teleport to=".svws-ui-header--actions" defer>
		<stundenplan-drucken-modal :reportvorlage="ReportingReportvorlage.STUNDENPLANUNG_V_SCHUELER_STUNDENPLAN" :server-mode v-slot="{ openModal }" :map-stundenplaene :get-p-d-f :api-status>
