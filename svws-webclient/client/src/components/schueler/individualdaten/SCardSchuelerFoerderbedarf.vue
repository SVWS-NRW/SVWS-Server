<template>
	<svws-ui-content-card title="Sonderpädagogische Förderung">
		<svws-ui-input-wrapper :grid="2">
			<svws-ui-select title="Haupt-Förderschwerpunkt" v-model="inputFoerderschwerpunktID" :items="mapFoerderschwerpunkte" :item-text="i=>i.text" statistics />
			<svws-ui-select title="Weiterer-Förderschwerpunkt" v-model="inputFoerderschwerpunkt2ID" :items="mapFoerderschwerpunkte" :item-text="i=>i.text" statistics />
