<template>
	<svws-ui-content-card :title="`Details zu ${betriebsStammdaten.name1}`" class="mt-16 lg:mt-20">
		...
		<svws-ui-input-wrapper :grid="4">
			...
			<svws-ui-select title="Wohnort" v-model="inputWohnortID" :items="orteById" :item-filter="orte_filter" statistics
...
<script setup lang="ts">
	...
	const inputWohnortID = computed<OrtKatalogEintrag | undefined>({
		get: () => props.betriebsStammdaten.ort_id === null ? undefined : props.orteById.get(props.betriebsStammdaten.ort_id),
