	...
	<svws-ui-modal :show="showModal">
		...
		<template #modalContent>
			<svws-ui-input-wrapper>
				<svws-ui-select :model-value="Wochentag.fromIDorException(item.id)" @update:model-value="item.wochentag=$event.id" :items="Wochentag.values()" :item-text="i=>i.beschreibung" required placeholder="Wochentag" />
