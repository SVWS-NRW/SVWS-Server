<template>
	<div class="page--content">
		...
		<s-card-stundenplan-pausenzeiten :stundenplan-manager="stundenplanManager" :patch-pausenzeit="patchPausenzeit" :add-pausenzeit="addPausenzeit" :remove-pausenzeiten="removePausenzeiten" :list-pausenzeiten="listPausenzeiten" :import-pausenzeiten="importPausenzeiten" :goto-katalog="gotoKatalog" />
		<s-card-stundenplan-raeume :stundenplan-manager="stundenplanManager" :patch-raum="patchRaum" :add-raum="addRaum" :remove-raeume="removeRaeume" :import-raeume="importRaeume" :list-raeume="listRaeume" :goto-katalog="gotoKatalog" />
