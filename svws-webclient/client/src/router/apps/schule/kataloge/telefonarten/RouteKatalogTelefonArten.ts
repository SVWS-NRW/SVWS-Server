...
import { routeKatalogTelefonArtenDaten } from "~/router/apps/schule/kataloge/telefonarten/RouteKatalogTelefonArtenDaten";
import { routeKatalogTelefonArtenGruppenprozesse } from "~/router/apps/schule/kataloge/telefonarten/RouteKatalogTelefonArtenGruppenprozesse";
import { routeKatalogTelefonArtenNeu } from "~/router/apps/schule/kataloge/telefonarten/RouteKatalogTelefonArtenNeu";
import { RouteDataKatalogTelefonArten } from "~/router/apps/schule/kataloge/telefonarten/RouteDataKatalogTelefonArten";
