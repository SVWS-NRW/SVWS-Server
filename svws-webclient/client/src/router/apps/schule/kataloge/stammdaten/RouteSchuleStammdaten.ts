...
import type { SchuleAppProps } from "~/components/schule/kataloge/stammdaten/SSchuleAppProps";

import type { RouteSchule } from "../../RouteSchule";
import { routeSchule } from "../../RouteSchule";
import { RouteSchuleMenuGroup } from "../../RouteSchuleMenuGroup";

const SSchuleStammdaten = () => import("~/components/schule/kataloge/stammdaten/SSchuleStammdaten.vue");
