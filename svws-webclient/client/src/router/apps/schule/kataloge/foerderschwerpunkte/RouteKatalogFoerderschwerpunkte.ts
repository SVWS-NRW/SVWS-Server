...
import { routeKatalogFoerderschwerpunktDaten } from "~/router/apps/schule/kataloge/foerderschwerpunkte/RouteKatalogFoerderschwerpunktDaten";
...
export class RouteKatalogFoerderschwerpunkte extends RouteNode<RouteDataKatalogFoerderschwerpunkte, RouteApp> {
	...
	public constructor() {
		super(Schulform.values(), [ BenutzerKompetenz.KEINE ], "schule.kataloge.foerderschwerpunkte", "schule/kataloge/foerderschwerpunkte/:id(\\d+)?", SFoerderschwerpunkteApp, new RouteDataKatalogFoerderschwerpunkte());
