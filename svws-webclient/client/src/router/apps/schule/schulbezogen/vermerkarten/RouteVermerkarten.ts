...
const VermerkartenAuswahl = () => import("~/components/schule/schulbezogen/vermerkarten/VermerkartenAuswahl.vue");
const VermerkartenApp = () => import("~/components/schule/schulbezogen/vermerkarten/VermerkartenApp.vue");
