...
import type { VermerkartenNeuProps } from "~/components/schule/schulbezogen/vermerkarten/VermerkartenNeuProps";
...
const VermerkartenNeu = () => import("~/components/schule/schulbezogen/vermerkarten/VermerkartenNeu.vue");
