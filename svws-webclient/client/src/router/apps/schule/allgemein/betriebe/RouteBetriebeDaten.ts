...
import type { BetriebeDatenProps } from "~/components/schule/allgemein/betriebe/daten/BetriebeDatenProps";

const BetriebeDaten = () => import("~/components/schule/allgemein/betriebe/daten/BetriebeDaten.vue");
