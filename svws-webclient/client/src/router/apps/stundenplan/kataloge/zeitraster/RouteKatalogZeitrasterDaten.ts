...
import type { RouteKatalogZeitraster } from "~/router/apps/stundenplan/kataloge/zeitraster/RouteKatalogZeitraster";
...
export class RouteKatalogZeitrasterDaten extends RouteNode<any, RouteKatalogZeitraster> {
	...
	public constructor() {
		super(Schulform.values(), [ BenutzerKompetenz.KEINE ], "stundenplan.kataloge.zeitraster.daten", "daten", SStundenplanZeitrasterPausenzeit);
