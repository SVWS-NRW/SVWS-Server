...
export class RouteDataKatalogRaeume extends RouteData<RouteStateKatalogRaeume> {
	...
	public async ladeListe() {
		...
		const raumListeManager = new RaumListeManager(schuleStateImpl.abschnitt.id, schuleStateImpl.abschnitt.id, abschnittStateImpl.alle, schuleStateImpl.schulform, listKatalogeintraege);
