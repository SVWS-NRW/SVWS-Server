...
import { routeKatalogRaumDaten } from "~/router/apps/stundenplan/kataloge/raum/RouteKatalogRaumDaten";

import type { AuswahlChildData } from "~/components/AuswahlChildData";
import type { RaeumeAppProps } from "~/components/stundenplan/kataloge/raeume/SRaeumeAppProps";
...
const SRaeumeApp = () => import("~/components/stundenplan/kataloge/raeume/SRaeumeApp.vue")

export class RouteKatalogRaeume extends RouteNode<RouteDataKatalogRaeume, RouteApp> {

	public constructor() {
		super(Schulform.values(), [ BenutzerKompetenz.KEINE ], "stundenplan.kataloge.raeume", "stundenplan/kataloge/raeume/:id(\\d+)?", SRaeumeApp, new RouteDataKatalogRaeume());
