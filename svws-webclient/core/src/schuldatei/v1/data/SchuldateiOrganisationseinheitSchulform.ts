...
export class SchuldateiOrganisationseinheitSchulform extends JavaObject {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.schuldatei.v1.data.SchuldateiOrganisationseinheitSchulform'].includes(name);
	}
