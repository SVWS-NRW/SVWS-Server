...
export class Schuldatei extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.schuldatei.v1.data.Schuldatei';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.schuldatei.v1.data.Schuldatei'].includes(name);
	}
...
export function cast_de_svws_nrw_schuldatei_v1_data_Schuldatei(obj : unknown) : Schuldatei {
