import { ValidatorLsd00LehrerStammdatenGeburtsdatum } from '../../../asd/validate/lehrer/ValidatorLsd00LehrerStammdatenGeburtsdatum';
...
export class ValidatorLsdLehrerStammdatenGeburtsdatum extends Validator {
	...
	public constructor(daten: LehrerStammdaten, kontext: ValidatorKontext) {
		super(kontext);
		this._validatoren.add(new ValidatorLsd00LehrerStammdatenGeburtsdatum(daten, kontext));
	}
	...
	public static class = new Class<ValidatorLsdLehrerStammdatenGeburtsdatum>('de.svws_nrw.asd.validate.lehrer.ValidatorLsdLehrerStammdatenGeburtsdatum');
