...
export class ValidatorLplk03LehrerPersonaldatenLehramtKombination extends Validator {
	...
	protected pruefe(): boolean {
		...
		let lehrerLehramtKatalogEintrag: LehrerLehramtKatalogEintrag | null = LehrerLehramt.ID_98.daten(this.kontext().getSchuljahr());
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.validate.lehrer.ValidatorLplk03LehrerPersonaldatenLehramtKombination';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.asd.validate.BasicValidator', 'de.svws_nrw.asd.validate.lehrer.ValidatorLplk03LehrerPersonaldatenLehramtKombination', 'de.svws_nrw.asd.validate.Validator'].includes(name);
	}

	public static readonly class = new Class<ValidatorLplk03LehrerPersonaldatenLehramtKombination>('de.svws_nrw.asd.validate.lehrer.ValidatorLplk03LehrerPersonaldatenLehramtKombination');

}

export function cast_de_svws_nrw_asd_validate_lehrer_ValidatorLplk03LehrerPersonaldatenLehramtKombination(obj: unknown): ValidatorLplk03LehrerPersonaldatenLehramtKombination {
	return obj as ValidatorLplk03LehrerPersonaldatenLehramtKombination;
}
