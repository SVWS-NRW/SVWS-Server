...
export class ValidatorLppr04LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis extends Validator {
	...
	public static class = new Class<ValidatorLppr04LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis>('de.svws_nrw.asd.validate.lehrer.ValidatorLppr04LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis');
