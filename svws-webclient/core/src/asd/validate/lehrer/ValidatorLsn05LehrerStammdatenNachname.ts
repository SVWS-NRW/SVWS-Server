...
export class ValidatorLsn05LehrerStammdatenNachname extends Validator {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.validate.lehrer.ValidatorLsn05LehrerStammdatenNachname';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.asd.validate.lehrer.ValidatorLsn05LehrerStammdatenNachname', 'de.svws_nrw.asd.validate.BasicValidator', 'de.svws_nrw.asd.validate.Validator'].includes(name);
	}

	public static readonly class = new Class<ValidatorLsn05LehrerStammdatenNachname>('de.svws_nrw.asd.validate.lehrer.ValidatorLsn05LehrerStammdatenNachname');

}

export function cast_de_svws_nrw_asd_validate_lehrer_ValidatorLsn05LehrerStammdatenNachname(obj: unknown): ValidatorLsn05LehrerStammdatenNachname {
	return obj as ValidatorLsn05LehrerStammdatenNachname;
}
