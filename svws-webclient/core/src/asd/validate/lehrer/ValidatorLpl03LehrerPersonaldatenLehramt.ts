...
export class ValidatorLpl03LehrerPersonaldatenLehramt extends Validator {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.validate.lehrer.ValidatorLpl03LehrerPersonaldatenLehramt';
	}
...
export function cast_de_svws_nrw_asd_validate_lehrer_ValidatorLpl03LehrerPersonaldatenLehramt(obj: unknown): ValidatorLpl03LehrerPersonaldatenLehramt {
	return obj as ValidatorLpl03LehrerPersonaldatenLehramt;
}
