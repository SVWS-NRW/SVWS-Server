...
export class LehrerMehrleistungsartKatalogEintrag extends CoreTypeData {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.asd.data.CoreTypeData', 'de.svws_nrw.asd.data.lehrer.LehrerMehrleistungsartKatalogEintrag'].includes(name);
	}
