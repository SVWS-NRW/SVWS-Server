...
export class OrganisationsformKatalogEintrag extends CoreTypeData {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.asd.data.schule.OrganisationsformKatalogEintrag', 'de.svws_nrw.asd.data.CoreTypeData'].includes(name);
	}
