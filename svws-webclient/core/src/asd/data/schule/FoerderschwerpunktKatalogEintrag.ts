...
export class FoerderschwerpunktKatalogEintrag extends CoreTypeData {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.asd.data.CoreTypeData', 'de.svws_nrw.asd.data.schule.FoerderschwerpunktKatalogEintrag'].includes(name);
	}
