...
export class LehrerLehramt extends JavaEnum<LehrerLehramt> implements CoreType<LehrerLehramtKatalogEintrag, LehrerLehramt> {
	 ...
	 */
	public static readonly ID_96 : LehrerLehramt = new LehrerLehramt("ID_96", 36, );

	/**
	 * Lehramt 'Lehrer, der außerhalb des Geltungsbereichs des Grundgesetzes seine Qualifikation erworben hat'
	 */
	public static readonly ID_97 : LehrerLehramt = new LehrerLehramt("ID_97", 37, );

	/**
	 * Lehramt 'Lehramtsanwärter/Studienreferendar'
	 */
	public static readonly ID_98 : LehrerLehramt = new LehrerLehramt("ID_98", 38, );

	/**
	 * Lehramt 'Sonstiger Lehrer (Gymnastik-, Werk-, Hauswirtschaftslehrer, Übungsleiter)'
	 */
	public static readonly ID_99 : LehrerLehramt = new LehrerLehramt("ID_99", 39, );

	/**
	 * Lehramt 'Schulverwaltungsassistent'
	 */
	public static readonly ID_70 : LehrerLehramt = new LehrerLehramt("ID_70", 40, );

	/**
	 * Lehramt 'Grundschule'
	 */
	public static readonly ID_04 : LehrerLehramt = new LehrerLehramt("ID_04", 41, );

	/**
	 * Lehramt 'Haupt-, Real- und  Gesamtschule'
	 */
	public static readonly ID_17 : LehrerLehramt = new LehrerLehramt("ID_17", 42, );

	/**
	 * Lehramt 'Sonderpädagogische Förderung'
	 */
	public static readonly ID_08 : LehrerLehramt = new LehrerLehramt("ID_08", 43, );

	/**
	 * Lehramt 'Haupt-, Real-, Sekundar- und Gesamtschule'
	 */
	public static readonly ID_18 : LehrerLehramt = new LehrerLehramt("ID_18", 44, );

	/**
	 * Lehramt 'Berufskolleg mit einer beruflichen Fachrichtung (§ 59 LVO)'
	 */
	public static readonly ID_49 : LehrerLehramt = new LehrerLehramt("ID_49", 45, );
