...
export class LehrerKatalogMehrleistungsartEintrag extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.lehrer.LehrerKatalogMehrleistungsartEintrag';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.data.lehrer.LehrerKatalogMehrleistungsartEintrag'].includes(name);
	}

	public static transpilerFromJSON(json : string): LehrerKatalogMehrleistungsartEintrag {
		const obj = JSON.parse(json) as Partial<LehrerKatalogMehrleistungsartEintrag>;
		const result = new LehrerKatalogMehrleistungsartEintrag();
		if (obj.id === undefined)
	...
	public static transpilerToJSON(obj : LehrerKatalogMehrleistungsartEintrag) : string {
		let result = '{';
	...
	public static transpilerToJSONPatch(obj : Partial<LehrerKatalogMehrleistungsartEintrag>) : string {
		let result = '{';
		if (obj.id !== undefined) {
			result += '"id" : ' + obj.id.toString() + ',';
		}
...
export function cast_de_svws_nrw_core_data_lehrer_LehrerKatalogMehrleistungsartEintrag(obj : unknown) : LehrerKatalogMehrleistungsartEintrag {
	return obj as LehrerKatalogMehrleistungsartEintrag;
}
