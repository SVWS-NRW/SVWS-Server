...
export class LehrerKatalogLehrbefaehigungAnerkennungEintrag extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.lehrer.LehrerKatalogLehrbefaehigungAnerkennungEintrag';
	}
	...
	public static transpilerFromJSON(json : string): LehrerKatalogLehrbefaehigungAnerkennungEintrag {
		const obj = JSON.parse(json) as Partial<LehrerKatalogLehrbefaehigungAnerkennungEintrag>;
		const result = new LehrerKatalogLehrbefaehigungAnerkennungEintrag();
		if (obj.id === undefined)
	...
	public static transpilerToJSON(obj : LehrerKatalogLehrbefaehigungAnerkennungEintrag) : string {
		let result = '{';
	...
	public static transpilerToJSONPatch(obj : Partial<LehrerKatalogLehrbefaehigungAnerkennungEintrag>) : string {
		let result = '{';
		if (obj.id !== undefined) {
			result += '"id" : ' + obj.id.toString() + ',';
		}
