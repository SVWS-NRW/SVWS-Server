...
export class LehrerKatalogEinsatzstatusEintrag extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.lehrer.LehrerKatalogEinsatzstatusEintrag';
	}
	...
	public static transpilerFromJSON(json : string): LehrerKatalogEinsatzstatusEintrag {
		const obj = JSON.parse(json) as Partial<LehrerKatalogEinsatzstatusEintrag>;
		const result = new LehrerKatalogEinsatzstatusEintrag();
		if (obj.id === undefined)
	...
	public static transpilerToJSON(obj : LehrerKatalogEinsatzstatusEintrag) : string {
		let result = '{';
	...
	public static transpilerToJSONPatch(obj : Partial<LehrerKatalogEinsatzstatusEintrag>) : string {
		let result = '{';
		if (obj.id !== undefined) {
			result += '"id" : ' + obj.id.toString() + ',';
		}
