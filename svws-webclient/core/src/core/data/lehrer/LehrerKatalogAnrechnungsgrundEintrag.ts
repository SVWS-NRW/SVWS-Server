...
export class LehrerKatalogAnrechnungsgrundEintrag extends JavaObject {
	...
	public static transpilerFromJSON(json : string): LehrerKatalogAnrechnungsgrundEintrag {
		const obj = JSON.parse(json) as Partial<LehrerKatalogAnrechnungsgrundEintrag>;
...
export function cast_de_svws_nrw_core_data_lehrer_LehrerKatalogAnrechnungsgrundEintrag(obj : unknown) : LehrerKatalogAnrechnungsgrundEintrag {
