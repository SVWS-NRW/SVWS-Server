...
export class LehrerKatalogLehrbefaehigungEintrag extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.lehrer.LehrerKatalogLehrbefaehigungEintrag';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.data.lehrer.LehrerKatalogLehrbefaehigungEintrag'].includes(name);
	}

	public static transpilerFromJSON(json : string): LehrerKatalogLehrbefaehigungEintrag {
		const obj = JSON.parse(json) as Partial<LehrerKatalogLehrbefaehigungEintrag>;
		const result = new LehrerKatalogLehrbefaehigungEintrag();
		if (obj.id === undefined)
	...
	public static transpilerToJSON(obj : LehrerKatalogLehrbefaehigungEintrag) : string {
		let result = '{';
	...
	public static transpilerToJSONPatch(obj : Partial<LehrerKatalogLehrbefaehigungEintrag>) : string {
		let result = '{';
		if (obj.id !== undefined) {
			result += '"id" : ' + obj.id.toString() + ',';
		}
...
export function cast_de_svws_nrw_core_data_lehrer_LehrerKatalogLehrbefaehigungEintrag(obj : unknown) : LehrerKatalogLehrbefaehigungEintrag {
	return obj as LehrerKatalogLehrbefaehigungEintrag;
}
