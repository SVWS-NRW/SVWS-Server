...
export class LehrerKatalogLehramtEintrag extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.lehrer.LehrerKatalogLehramtEintrag';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.data.lehrer.LehrerKatalogLehramtEintrag'].includes(name);
	}

	public static transpilerFromJSON(json : string): LehrerKatalogLehramtEintrag {
		const obj = JSON.parse(json) as Partial<LehrerKatalogLehramtEintrag>;
		const result = new LehrerKatalogLehramtEintrag();
		if (obj.id === undefined)
	...
	public static transpilerToJSON(obj : LehrerKatalogLehramtEintrag) : string {
		let result = '{';
	...
	public static transpilerToJSONPatch(obj : Partial<LehrerKatalogLehramtEintrag>) : string {
		let result = '{';
		if (obj.id !== undefined) {
			result += '"id" : ' + obj.id.toString() + ',';
		}
...
export function cast_de_svws_nrw_core_data_lehrer_LehrerKatalogLehramtEintrag(obj : unknown) : LehrerKatalogLehramtEintrag {
	return obj as LehrerKatalogLehramtEintrag;
}
