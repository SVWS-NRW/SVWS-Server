...
export class KAOAEbene4Eintrag extends JavaObject {
	...
	public static transpilerFromJSON(json : string): KAOAEbene4Eintrag {
		const obj = JSON.parse(json) as Partial<KAOAEbene4Eintrag>;
