...
import { KAOAZusatzmerkmaleOptionsarten, cast_de_svws_nrw_core_types_kaoa_KAOAZusatzmerkmaleOptionsarten } from '../../../core/types/kaoa/KAOAZusatzmerkmaleOptionsarten';
import { KAOAMerkmal, cast_de_svws_nrw_core_types_kaoa_KAOAMerkmal } from '../../../core/types/kaoa/KAOAMerkmal';
...
export class KAOAZusatzmerkmalEintrag extends JavaObject {
	...
	public constructor(__param0? : number, __param1? : string, __param2? : string, __param3? : KAOAMerkmal, __param4? : KAOAZusatzmerkmaleOptionsarten, __param5? : null | number, __param6? : null | number) {
		...
		if ((__param0 === undefined) && (__param1 === undefined) && (__param2 === undefined) && (__param3 === undefined) && (__param4 === undefined) && (__param5 === undefined) && (__param6 === undefined)) {
			// empty method body
		} else if (((__param0 !== undefined) && typeof __param0 === "number") && ((__param1 !== undefined) && (typeof __param1 === "string")) && ((__param2 !== undefined) && (typeof __param2 === "string")) && ((__param3 !== undefined) && ((__param3 instanceof JavaObject) && (__param3.isTranspiledInstanceOf('de.svws_nrw.core.types.kaoa.KAOAMerkmal')))) && ((__param4 !== undefined) && ((__param4 instanceof JavaObject) && (__param4.isTranspiledInstanceOf('de.svws_nrw.core.types.kaoa.KAOAZusatzmerkmaleOptionsarten')))) && ((__param5 !== undefined) && (typeof __param5 === "number") || (__param5 === null)) && ((__param6 !== undefined) && (typeof __param6 === "number") || (__param6 === null))) {
			const id : number = __param0 as number;
			const kuerzel : string = __param1;
			const beschreibung : string = __param2;
			const merkmal : KAOAMerkmal = cast_de_svws_nrw_core_types_kaoa_KAOAMerkmal(__param3);
			const optionsart : KAOAZusatzmerkmaleOptionsarten = cast_de_svws_nrw_core_types_kaoa_KAOAZusatzmerkmaleOptionsarten(__param4);
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.kaoa.KAOAZusatzmerkmalEintrag';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.data.kaoa.KAOAZusatzmerkmalEintrag'].includes(name);
	}
...
export function cast_de_svws_nrw_core_data_kaoa_KAOAZusatzmerkmalEintrag(obj : unknown) : KAOAZusatzmerkmalEintrag {
