...
export class SchildReportingGostLaufbahnplanungSchuelerFachwahlen extends JavaObject {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.data.schild3.reporting.SchildReportingGostLaufbahnplanungSchuelerFachwahlen'].includes(name);
	}

	public static transpilerFromJSON(json : string): SchildReportingGostLaufbahnplanungSchuelerFachwahlen {
		const obj = JSON.parse(json);
		const result = new SchildReportingGostLaufbahnplanungSchuelerFachwahlen();
	...
	public static transpilerToJSON(obj : SchildReportingGostLaufbahnplanungSchuelerFachwahlen) : string {
		let result = '{';
		result += '"SchuelerID" : ' + obj.SchuelerID + ',';
	...
	public static transpilerToJSONPatch(obj : Partial<SchildReportingGostLaufbahnplanungSchuelerFachwahlen>) : string {
		let result = '{';
		if (typeof obj.SchuelerID !== "undefined") {
			result += '"SchuelerID" : ' + obj.SchuelerID + ',';
		}
...
export function cast_de_svws_nrw_core_data_schild3_reporting_SchildReportingGostLaufbahnplanungSchuelerFachwahlen(obj : unknown) : SchildReportingGostLaufbahnplanungSchuelerFachwahlen {
	return obj as SchildReportingGostLaufbahnplanungSchuelerFachwahlen;
}
