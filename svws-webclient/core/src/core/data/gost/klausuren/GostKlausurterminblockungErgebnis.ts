...
export class GostKlausurterminblockungErgebnis extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.gost.klausuren.GostKlausurterminblockungErgebnis';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.data.gost.klausuren.GostKlausurterminblockungErgebnis'].includes(name);
	}

	public static readonly class = new Class<GostKlausurterminblockungErgebnis>('de.svws_nrw.core.data.gost.klausuren.GostKlausurterminblockungErgebnis');
...
export function cast_de_svws_nrw_core_data_gost_klausuren_GostKlausurterminblockungErgebnis(obj: unknown): GostKlausurterminblockungErgebnis {
