...
export class GostKlausurenKalenderinformation extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.gost.klausuren.GostKlausurenKalenderinformation';
	}
	...
	public static readonly class = new Class<GostKlausurenKalenderinformation>('de.svws_nrw.core.data.gost.klausuren.GostKlausurenKalenderinformation');
