...
export class GostKlausurraumblockungKonfiguration extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.data.gost.klausuren.GostKlausurraumblockungKonfiguration';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.data.gost.klausuren.GostKlausurraumblockungKonfiguration'].includes(name);
	}

	public static readonly class = new Class<GostKlausurraumblockungKonfiguration>('de.svws_nrw.core.data.gost.klausuren.GostKlausurraumblockungKonfiguration');
...
export function cast_de_svws_nrw_core_data_gost_klausuren_GostKlausurraumblockungKonfiguration(obj: unknown): GostKlausurraumblockungKonfiguration {
