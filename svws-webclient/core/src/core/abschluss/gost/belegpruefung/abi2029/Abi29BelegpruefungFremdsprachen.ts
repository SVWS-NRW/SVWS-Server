...
export class Abi29BelegpruefungFremdsprachen extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungFremdsprachen';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungFremdsprachen', 'de.svws_nrw.core.abschluss.gost.GostBelegpruefung'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungFremdsprachen>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungFremdsprachen');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungFremdsprachen(obj : unknown) : Abi29BelegpruefungFremdsprachen {
	return obj as Abi29BelegpruefungFremdsprachen;
}
