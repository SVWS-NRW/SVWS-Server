...
export class Abi29BelegpruefungLiterarischKuenstlerisch extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungLiterarischKuenstlerisch';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungLiterarischKuenstlerisch'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungLiterarischKuenstlerisch>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungLiterarischKuenstlerisch');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungLiterarischKuenstlerisch(obj : unknown) : Abi29BelegpruefungLiterarischKuenstlerisch {
	return obj as Abi29BelegpruefungLiterarischKuenstlerisch;
}
