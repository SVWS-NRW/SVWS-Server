...
export class Abi29BelegpruefungKurszahlenUndWochenstunden extends GostBelegpruefung {
	...
	protected init() : void {
		...
		const projektkurse : Abi29BelegpruefungProjektkurse = (cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungProjektkurse(this.pruefungen_vorher[0]));
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungKurszahlenUndWochenstunden';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungKurszahlenUndWochenstunden'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungKurszahlenUndWochenstunden>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungKurszahlenUndWochenstunden');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungKurszahlenUndWochenstunden(obj : unknown) : Abi29BelegpruefungKurszahlenUndWochenstunden {
	return obj as Abi29BelegpruefungKurszahlenUndWochenstunden;
}
