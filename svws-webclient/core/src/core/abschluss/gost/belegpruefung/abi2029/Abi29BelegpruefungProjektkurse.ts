...
export class Abi29BelegpruefungProjektkurse extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungProjektkurse';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungProjektkurse'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungProjektkurse>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungProjektkurse');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungProjektkurse(obj : unknown) : Abi29BelegpruefungProjektkurse {
	return obj as Abi29BelegpruefungProjektkurse;
}
