...
export class Abi29BelegpruefungFachWaehlbar extends GostBelegpruefung {
	...
	private pruefeFachbelegungAbitur(fach : GostFach, fachbelegung : AbiturFachbelegung) : void {
		if (fachbelegung.abiturFach === null)
			return;
		if ((!fach.istMoeglichAbiLK) && ((fachbelegung.abiturFach === 1) || (fachbelegung.abiturFach === 2) || (Abi29BelegpruefungFachWaehlbar.hatLKFachbelegung(fachbelegung))))
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungFachWaehlbar';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungFachWaehlbar'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungFachWaehlbar>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungFachWaehlbar');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungFachWaehlbar(obj : unknown) : Abi29BelegpruefungFachWaehlbar {
	return obj as Abi29BelegpruefungFachWaehlbar;
}
