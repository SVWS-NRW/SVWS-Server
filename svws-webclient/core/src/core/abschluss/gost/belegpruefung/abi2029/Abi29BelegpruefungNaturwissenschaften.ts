...
export class Abi29BelegpruefungNaturwissenschaften extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungNaturwissenschaften';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungNaturwissenschaften'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungNaturwissenschaften>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungNaturwissenschaften');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungNaturwissenschaften(obj : unknown) : Abi29BelegpruefungNaturwissenschaften {
	return obj as Abi29BelegpruefungNaturwissenschaften;
}
