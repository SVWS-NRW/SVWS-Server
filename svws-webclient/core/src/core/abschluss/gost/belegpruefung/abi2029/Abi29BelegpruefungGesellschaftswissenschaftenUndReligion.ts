...
export class Abi29BelegpruefungGesellschaftswissenschaftenUndReligion extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungGesellschaftswissenschaftenUndReligion';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungGesellschaftswissenschaftenUndReligion'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungGesellschaftswissenschaftenUndReligion>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungGesellschaftswissenschaftenUndReligion');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungGesellschaftswissenschaftenUndReligion(obj : unknown) : Abi29BelegpruefungGesellschaftswissenschaftenUndReligion {
	return obj as Abi29BelegpruefungGesellschaftswissenschaftenUndReligion;
}
