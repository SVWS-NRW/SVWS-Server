...
export class Abi29BelegpruefungAllgemeines extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungAllgemeines';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungAllgemeines', 'de.svws_nrw.core.abschluss.gost.GostBelegpruefung'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungAllgemeines>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungAllgemeines');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungAllgemeines(obj : unknown) : Abi29BelegpruefungAllgemeines {
	return obj as Abi29BelegpruefungAllgemeines;
}
