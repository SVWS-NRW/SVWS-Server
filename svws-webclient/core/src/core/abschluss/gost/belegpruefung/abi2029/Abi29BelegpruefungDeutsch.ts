...
export class Abi29BelegpruefungDeutsch extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungDeutsch';
	}

	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.abschluss.gost.GostBelegpruefung', 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungDeutsch'].includes(name);
	}

	public static class = new Class<Abi29BelegpruefungDeutsch>('de.svws_nrw.core.abschluss.gost.belegpruefung.abi2029.Abi29BelegpruefungDeutsch');

}

export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2029_Abi29BelegpruefungDeutsch(obj : unknown) : Abi29BelegpruefungDeutsch {
	return obj as Abi29BelegpruefungDeutsch;
}
