...
export class BKGymAbiturMarkierungsregelAufgabenfeld extends BKGymAbiturMarkierungsregel {
	...
	public markiere(variante: BKGymAbiturMarkierungsVariante): void {
		...
		const bedingung: Predicate<BKGymAbiturMarkierungsalgorithmusMarkierung> = { test: (markierung: BKGymAbiturMarkierungsalgorithmusMarkierung | null) => (markierung !== null) && feld.hatFachbezeichnung(variante.varianten.manager.getBezeichnungByFachID(markierung.fachID)) };
