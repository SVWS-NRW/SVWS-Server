...
export class LehrerAnrechnungsgrund extends JavaEnum<LehrerAnrechnungsgrund> {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.types.lehrer.LehrerAnrechnungsgrund', 'java.lang.Enum'].includes(name);
	}

}

export function cast_de_svws_nrw_core_types_lehrer_LehrerAnrechnungsgrund(obj : unknown) : LehrerAnrechnungsgrund {
