...
export class KAOAAnschlussoptionen extends JavaEnum<KAOAAnschlussoptionen> {
	...
	private static getMapStatusByID() : HashMap<number, KAOAAnschlussoptionen> {
		if (KAOAAnschlussoptionen._statusByID.size() === 0)
			for (const g of KAOAAnschlussoptionen.values())
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.types.kaoa.KAOAAnschlussoptionen';
	}
...
export function cast_de_svws_nrw_core_types_kaoa_KAOAAnschlussoptionen(obj : unknown) : KAOAAnschlussoptionen {
