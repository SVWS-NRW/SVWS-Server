...
import type { JavaIterator } from "../../../index";
import { LinkedCollection, LinkedCollectionIterator, LehrerListeEintrag, ConcurrentModificationException, NoSuchElementException, ArrayList } from "../../../index";
