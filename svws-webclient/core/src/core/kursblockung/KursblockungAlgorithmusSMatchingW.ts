...
export class KursblockungAlgorithmusSMatchingW extends KursblockungAlgorithmusS {
	 ...
	 */
	public constructor(random: Random, logger: Logger, dynDateb: KursblockungDynDaten) {
		super(random, logger, dynDateb);
		this.schuelerArr = dynDateb.gibSchuelerArray(false);
	...
	public static readonly class = new Class<KursblockungAlgorithmusSMatchingW>('de.svws_nrw.core.kursblockung.KursblockungAlgorithmusSMatchingW');
