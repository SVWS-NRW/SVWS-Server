...
export abstract class KlausurblockungSchienenAlgorithmusAbstract extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungSchienenAlgorithmusAbstract>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungSchienenAlgorithmusAbstract(obj: unknown): KlausurblockungSchienenAlgorithmusAbstract {
