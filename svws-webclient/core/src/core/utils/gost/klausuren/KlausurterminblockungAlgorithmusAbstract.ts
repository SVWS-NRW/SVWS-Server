...
export abstract class KlausurterminblockungAlgorithmusAbstract extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusAbstract';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusAbstract'].includes(name);
	}

	public static readonly class = new Class<KlausurterminblockungAlgorithmusAbstract>('de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusAbstract');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurterminblockungAlgorithmusAbstract(obj: unknown): KlausurterminblockungAlgorithmusAbstract {
