...
export class KlausurblockungSchienenAlgorithmusGreedy7 extends KlausurblockungSchienenAlgorithmusAbstract {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy7';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract', 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy7'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungSchienenAlgorithmusGreedy7>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy7');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungSchienenAlgorithmusGreedy7(obj: unknown): KlausurblockungSchienenAlgorithmusGreedy7 {
