...
import { GostKlausurterminblockungErgebnis } from '../../../../core/data/gost/klausuren/GostKlausurterminblockungErgebnis';
import { KlausurterminblockungModusKursarten } from '../../../../core/types/gost/klausuren/KlausurterminblockungModusKursarten';
...
import { KlausurterminblockungAlgorithmusGreedy1 } from '../../../../core/utils/gost/klausuren/KlausurterminblockungAlgorithmusGreedy1';
import { KlausurterminblockungAlgorithmusGreedy2 } from '../../../../core/utils/gost/klausuren/KlausurterminblockungAlgorithmusGreedy2';
import { DeveloperNotificationException } from '../../../../core/exceptions/DeveloperNotificationException';
import { KlausurterminblockungAlgorithmusGreedy3 } from '../../../../core/utils/gost/klausuren/KlausurterminblockungAlgorithmusGreedy3';
import { Logger, cast_de_svws_nrw_core_logger_Logger } from '../../../../core/logger/Logger';
import { System } from '../../../../java/lang/System';
import type { Comparator } from '../../../../java/util/Comparator';
import { Random } from '../../../../java/util/Random';
import { KlausurterminblockungDynDaten } from '../../../../core/utils/gost/klausuren/KlausurterminblockungDynDaten';
import { KlausurterminblockungAlgorithmusGreedy1b } from '../../../../core/utils/gost/klausuren/KlausurterminblockungAlgorithmusGreedy1b';
import { KlausurterminblockungModusQuartale } from '../../../../core/types/gost/klausuren/KlausurterminblockungModusQuartale';
import { KlausurterminblockungAlgorithmusAbstract } from '../../../../core/utils/gost/klausuren/KlausurterminblockungAlgorithmusAbstract';
import { KlausurterminblockungAlgorithmusGreedy2b } from '../../../../core/utils/gost/klausuren/KlausurterminblockungAlgorithmusGreedy2b';
...
export class KlausurterminblockungAlgorithmus extends JavaObject {
	...
	public apply(daten: GostKlausurterminblockungDaten): GostKlausurterminblockungErgebnis {
		...
		this.berechneRekursivQuartalsModus(daten.kursklausurenRich, daten.konfiguration, out);
		return out;
	}
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmus';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmus'].includes(name);
	}

	public static readonly class = new Class<KlausurterminblockungAlgorithmus>('de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmus');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurterminblockungAlgorithmus(obj: unknown): KlausurterminblockungAlgorithmus {
