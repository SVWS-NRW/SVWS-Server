...
export class KlausurblockungSchienenAlgorithmusGreedy4 extends KlausurblockungSchienenAlgorithmusAbstract {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy4';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy4', 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungSchienenAlgorithmusGreedy4>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy4');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungSchienenAlgorithmusGreedy4(obj: unknown): KlausurblockungSchienenAlgorithmusGreedy4 {
