...
export class KlausurblockungNachschreiberAlgorithmusBewertung extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungNachschreiberAlgorithmusBewertung';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungNachschreiberAlgorithmusBewertung'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungNachschreiberAlgorithmusBewertung>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungNachschreiberAlgorithmusBewertung');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungNachschreiberAlgorithmusBewertung(obj: unknown): KlausurblockungNachschreiberAlgorithmusBewertung {
