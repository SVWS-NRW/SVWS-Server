...
export class KlausurblockungSchienenDynDaten extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenDynDaten';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenDynDaten'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungSchienenDynDaten>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenDynDaten');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungSchienenDynDaten(obj: unknown): KlausurblockungSchienenDynDaten {
