...
import { GostKlausurterminblockungErgebnisTermin } from '../../../../core/data/gost/klausuren/GostKlausurterminblockungErgebnisTermin';
...
import { KlausurterminblockungAlgorithmen } from '../../../../core/types/gost/klausuren/KlausurterminblockungAlgorithmen';
...
export class KlausurterminblockungDynDaten extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungDynDaten';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungDynDaten'].includes(name);
	}

	public static readonly class = new Class<KlausurterminblockungDynDaten>('de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungDynDaten');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurterminblockungDynDaten(obj: unknown): KlausurterminblockungDynDaten {
