...
export class KlausurblockungSchienenAlgorithmusGreedy1b extends KlausurblockungSchienenAlgorithmusAbstract {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy1b';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy1b', 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungSchienenAlgorithmusGreedy1b>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy1b');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungSchienenAlgorithmusGreedy1b(obj: unknown): KlausurblockungSchienenAlgorithmusGreedy1b {
