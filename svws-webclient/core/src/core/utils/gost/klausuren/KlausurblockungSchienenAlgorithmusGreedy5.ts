...
export class KlausurblockungSchienenAlgorithmusGreedy5 extends KlausurblockungSchienenAlgorithmusAbstract {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy5';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy5', 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusAbstract'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungSchienenAlgorithmusGreedy5>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungSchienenAlgorithmusGreedy5');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungSchienenAlgorithmusGreedy5(obj: unknown): KlausurblockungSchienenAlgorithmusGreedy5 {
