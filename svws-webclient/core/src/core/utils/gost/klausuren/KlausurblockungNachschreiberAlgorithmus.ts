...
import { GostKlausurplanManager } from '../../../../core/utils/gost/klausuren/GostKlausurplanManager';
import { GostSchuelerklausur } from '../../../../core/data/gost/klausuren/GostSchuelerklausur';
import { KlausurblockungNachschreiberAlgorithmusBewertung } from '../../../../core/utils/gost/klausuren/KlausurblockungNachschreiberAlgorithmusBewertung';
...
export class KlausurblockungNachschreiberAlgorithmus extends JavaObject {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurblockungNachschreiberAlgorithmus';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurblockungNachschreiberAlgorithmus'].includes(name);
	}

	public static readonly class = new Class<KlausurblockungNachschreiberAlgorithmus>('de.svws_nrw.core.utils.gost.klausuren.KlausurblockungNachschreiberAlgorithmus');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurblockungNachschreiberAlgorithmus(obj: unknown): KlausurblockungNachschreiberAlgorithmus {
