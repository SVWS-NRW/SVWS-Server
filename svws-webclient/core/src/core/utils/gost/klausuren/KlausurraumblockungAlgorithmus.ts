...
import { KlausurraumblockungAlgorithmusDynDaten } from '../../../../core/utils/gost/klausuren/KlausurraumblockungAlgorithmusDynDaten';
...
export class KlausurraumblockungAlgorithmus extends JavaObject {
	 ...
	 * <br>Die Zuordnung ist im {@link GostKlausurraumRich#idsSchuelerklausurtermine}-Objekt zu finden.
	 *
	 * <br>
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurraumblockungAlgorithmus';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurraumblockungAlgorithmus'].includes(name);
	}

	public static readonly class = new Class<KlausurraumblockungAlgorithmus>('de.svws_nrw.core.utils.gost.klausuren.KlausurraumblockungAlgorithmus');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurraumblockungAlgorithmus(obj: unknown): KlausurraumblockungAlgorithmus {
