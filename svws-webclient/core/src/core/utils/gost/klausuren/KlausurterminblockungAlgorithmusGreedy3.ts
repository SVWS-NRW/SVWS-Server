...
export class KlausurterminblockungAlgorithmusGreedy3 extends KlausurterminblockungAlgorithmusAbstract {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusGreedy3';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusGreedy3', 'de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusAbstract'].includes(name);
	}

	public static readonly class = new Class<KlausurterminblockungAlgorithmusGreedy3>('de.svws_nrw.core.utils.gost.klausuren.KlausurterminblockungAlgorithmusGreedy3');

}

export function cast_de_svws_nrw_core_utils_gost_klausuren_KlausurterminblockungAlgorithmusGreedy3(obj: unknown): KlausurterminblockungAlgorithmusGreedy3 {
