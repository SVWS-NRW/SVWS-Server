...
export class KlausurblockungSchienenAlgorithmusGreedy7 extends KlausurblockungSchienenAlgorithmusAbstract {
	...
	public static readonly class = new Class<KlausurblockungSchienenAlgorithmusGreedy7>('de.svws_nrw.core.utils.gost.klausurplanung.KlausurblockungSchienenAlgorithmusGreedy7');
