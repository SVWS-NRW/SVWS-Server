<template>
	<Story title="Button mit Auswahl" id="svws-ui-button-select" icon="ri:arrow-down-s-line" auto-props-disabled>
...
<svws-ui-button-select
  type="..."
  @click="() => console.log('Klick Default')"
  :dropdown-actions="[
    { key: 1, text: 'Label 1', action: () => console.log('Klick 1') },
    { key: 2, text: 'Label 2', action: () => console.log('Klick 2') }
  ]">
  Default Button Text
</svws-ui-button-select>
        ` }}
