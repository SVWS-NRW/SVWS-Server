<template>
	<button v-if="(tab.text !== '') && !(tab.hide === true)" @click="select()" class="svws-ui-tab-button flex flex-row" :class="{ 'svws-active': isSelected }">
		<span>{{ tab.text }}</span>
...
<script lang="ts" setup>
	...
	const isSelected = computed<boolean>(() => props.tab.name.toString() === props.selected.name.toString());
