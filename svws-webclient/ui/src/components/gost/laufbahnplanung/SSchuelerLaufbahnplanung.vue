	...
	<div class="page page-flex-row max-w-480">
		...
		<div class="w-2/5 3xl:w-1/2 min-w-144 overflow-y-auto overflow-x-hidden pr-4">
			<div class="flex flex-col gap-y-16 lg:gap-y-20">
				<s-laufbahnplanung-card-beratung v-if="visible && hatUpdateKompetenz" :gost-laufbahn-beratungsdaten :patch-beratungsdaten="doPatchBeratungsdaten" :list-lehrer :id :schueler :updated :checkpoint :continue-routing-after-checkpoint />
