<template>
	<stundenplan-ansicht grow-unterricht hide-zeitachse-pausenzeiten :mode-pausenaufsichten="modePausenaufsichten" :show-zeitachse="showZeitachse" :ignore-empty="ignoreEmpty"
