<template>
	...
	<div>
		...
		<!-- Ausgabeformat -->
		<template v-if="parameter.ausgabeformat === 2">
		...
		<template v-if="(parameter.ausgabeformat === 3) && ServerMode.DEV.equals(servermode ?? null)">
			<div>
				<p class="font-bold">Die Klassenliste mit den Kontaktdaten als E-Mail an die Klassenleitungen versenden.</p>
