...
| searchable           | `boolean`                     | `true`                                                 | Definiert, ob die Optionen des Dropdowns durch Suchbegriffe gefiltert werden können. Falls  `deepSearchAttributes` definiert sind, werden diese bei der Suche berücksichtigt. |
...
| required             | `boolean`                     | `false`                                                | Definiert, ob das Select ein Pflichtfeld ist.<br/> Fügt automatisch einen Validator hinzu, wenn kein `validation` gesetzt ist.                                                |
