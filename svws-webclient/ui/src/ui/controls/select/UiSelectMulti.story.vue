	...
	<Story title="Select Multi New" id="ui-select-multi" icon="ri:expand-up-down-line" auto-props-disabled :layout="{ type: 'grid', width: '45%'}"
		...
		<Variant title="SelectManager" id="selectManager">
			<svws-ui-input-wrapper>
				<ui-select-multi label="SelectManager mit String" :class="[state.bgColor, state.textColor, state.iconColor, state.borderColor]"
				...
				<ui-select-multi label="SelectManager mit Custom-Objekten" :class="[state.bgColor, state.textColor, state.iconColor, state.borderColor]"
		...
		<Variant title="Deep Search" id="search">
			<svws-ui-input-wrapper>
				...
				<ui-select-multi label="Deep Search SelectManager" :class="[state.bgColor, state.textColor, state.iconColor, state.borderColor]"
		...
		<Variant title="Sortierung" id="sortierung">
			<svws-ui-input-wrapper>
				<ui-select-multi label="Sortiertes Select" :class="[state.bgColor, state.textColor, state.iconColor, state.borderColor]"
			...
			<template #controls>
				...
				<HstNumber title="minOptions"
					v-model="state.minOptions" />
				<HstNumber title="maxOptions"
					v-model="state.maxOptions" />
