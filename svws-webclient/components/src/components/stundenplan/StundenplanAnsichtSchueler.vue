<template>
	<stundenplan-ansicht grow-unterricht :mode-pausenaufsichten="modePausenaufsichten" :show-zeitachse="showZeitachse" :ignore-empty="ignoreEmpty" :id="id"
...
<script setup lang="ts">
	...
	import type { StundenplanAnsichtSchuelerProps } from "./StundenplanAnsichtSchuelerProps";
	...
	const props = withDefaults(defineProps<StundenplanAnsichtSchuelerProps>(), {
		mode: 'schueler',
