<template>
	<stundenplan-ansicht text-pausenzeit="Aufsicht" hide-zeitachse-pausenzeiten hide-pausenaufsicht grow-unterricht :mode-pausenaufsichten="modePausenaufsichten" :show-zeitachse="showZeitachse" :ignore-empty="ignoreEmpty"
