...
export class BaseApi {
    ...
    async #postMultipartBased(path : string, body : FormData | null) : Promise<string> {
        let requestInit : RequestInit = { ...this.#requestinit };
        requestInit.headers = { ...this.#headers };
    ...
    async #deleteTextBased(path : string, mimetype_send: string | null, mimetype_receive : string, body : string | null) : Promise<string> {
        let requestInit : RequestInit = { ...this.#requestinit };
        requestInit.headers = { ...this.#headers };
