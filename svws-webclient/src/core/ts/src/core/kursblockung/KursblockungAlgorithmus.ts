...
import { GostBlockungsergebnisManager, cast_de_nrw_schule_svws_core_utils_gost_GostBlockungsergebnisManager } from '../utils/gost/GostBlockungsergebnisManager';
import { KursblockungAlgorithmusKOptimiereBest, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusKOptimiereBest } from './KursblockungAlgorithmusKOptimiereBest';
...
import { KursblockungAlgorithmusSSchnellW, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusSSchnellW } from './KursblockungAlgorithmusSSchnellW';
import { GostBlockungsdatenManager, cast_de_nrw_schule_svws_core_utils_gost_GostBlockungsdatenManager } from '../utils/gost/GostBlockungsdatenManager';
import { KursblockungAlgorithmusKSchnellW, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusKSchnellW } from './KursblockungAlgorithmusKSchnellW';
import { KursblockungAlgorithmusKMatching, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusKMatching } from './KursblockungAlgorithmusKMatching';
import { KursblockungAlgorithmusKFachwahlmatrix, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusKFachwahlmatrix } from './KursblockungAlgorithmusKFachwahlmatrix';
import { Service, cast_de_nrw_schule_svws_core_Service } from '../Service';
import { KursblockungAlgorithmusSMatching, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusSMatching } from './KursblockungAlgorithmusSMatching';
import { KursblockungAlgorithmusKSchuelervorschlag, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusKSchuelervorschlag } from './KursblockungAlgorithmusKSchuelervorschlag';
import { LogLevel, cast_de_nrw_schule_svws_core_logger_LogLevel } from '../logger/LogLevel';
import { System, cast_java_lang_System } from '../../java/lang/System';
import { KursblockungAlgorithmusSMatchingW, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusSMatchingW } from './KursblockungAlgorithmusSMatchingW';
...
import { KursblockungAlgorithmusSZufaellig, cast_de_nrw_schule_svws_core_kursblockung_KursblockungAlgorithmusSZufaellig } from './KursblockungAlgorithmusSZufaellig';
