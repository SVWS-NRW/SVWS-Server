...
import { Naturwissenschaften, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Naturwissenschaften } from './belegpruefung/Naturwissenschaften';
import { Schwerpunkt, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Schwerpunkt } from './belegpruefung/Schwerpunkt';
import { HashMap, cast_java_util_HashMap } from '../../../java/util/HashMap';
import { KurszahlenUndWochenstunden, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_KurszahlenUndWochenstunden } from './belegpruefung/KurszahlenUndWochenstunden';
...
import { AbiturFachbelegungHalbjahr, cast_de_nrw_schule_svws_core_data_gost_AbiturFachbelegungHalbjahr } from '../../data/gost/AbiturFachbelegungHalbjahr';
...
import { GostBelegpruefungErgebnis, cast_de_nrw_schule_svws_core_abschluss_gost_GostBelegpruefungErgebnis } from './GostBelegpruefungErgebnis';
import { JavaString, cast_java_lang_String } from '../../../java/lang/JavaString';
import { GostKursart, cast_de_nrw_schule_svws_core_types_gost_GostKursart } from '../../types/gost/GostKursart';
import { Latinum, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Latinum } from './belegpruefung/Latinum';
...
import { Allgemeines, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Allgemeines } from './belegpruefung/Allgemeines';
import { GostSchuelerFachwahl, cast_de_nrw_schule_svws_core_data_gost_GostSchuelerFachwahl } from '../../data/gost/GostSchuelerFachwahl';
import { Sport, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Sport } from './belegpruefung/Sport';
...
import { ZulaessigesFach, cast_de_nrw_schule_svws_core_types_fach_ZulaessigesFach } from '../../types/fach/ZulaessigesFach';
...
import { GesellschaftswissenschaftenUndReligion, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_GesellschaftswissenschaftenUndReligion } from './belegpruefung/GesellschaftswissenschaftenUndReligion';
import { GostBelegungsfehler, cast_de_nrw_schule_svws_core_abschluss_gost_GostBelegungsfehler } from './GostBelegungsfehler';
import { AbiFaecher, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_AbiFaecher } from './belegpruefung/AbiFaecher';
...
import { LiterarischKuenstlerisch, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_LiterarischKuenstlerisch } from './belegpruefung/LiterarischKuenstlerisch';
...
import { GostFachManager, cast_de_nrw_schule_svws_core_abschluss_gost_GostFachManager } from './GostFachManager';
import { Abiturdaten, cast_de_nrw_schule_svws_core_data_gost_Abiturdaten } from '../../data/gost/Abiturdaten';
import { Projektkurse, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Projektkurse } from './belegpruefung/Projektkurse';
import { SprachendatenUtils, cast_de_nrw_schule_svws_core_utils_schueler_SprachendatenUtils } from '../../utils/schueler/SprachendatenUtils';
import { Deutsch, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Deutsch } from './belegpruefung/Deutsch';
import { Fremdsprachen, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Fremdsprachen } from './belegpruefung/Fremdsprachen';
...
import { Mathematik, cast_de_nrw_schule_svws_core_abschluss_gost_belegpruefung_Mathematik } from './belegpruefung/Mathematik';
