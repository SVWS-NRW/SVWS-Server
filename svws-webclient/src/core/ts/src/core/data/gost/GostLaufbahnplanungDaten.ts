...
import { GostJahrgangFachkombination, cast_de_nrw_schule_svws_core_data_gost_GostJahrgangFachkombination } from './GostJahrgangFachkombination';
import { GostLaufbahnplanungDatenSchueler, cast_de_nrw_schule_svws_core_data_gost_GostLaufbahnplanungDatenSchueler } from './GostLaufbahnplanungDatenSchueler';
...
export class GostLaufbahnplanungDaten extends JavaObject {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.data.gost.GostLaufbahnplanungDaten'].includes(name);
	}
...
export function cast_de_nrw_schule_svws_core_data_gost_GostLaufbahnplanungDaten(obj : unknown) : GostLaufbahnplanungDaten {
