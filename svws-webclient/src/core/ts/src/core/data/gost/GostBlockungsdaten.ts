...
import { Schueler, cast_de_nrw_schule_svws_core_data_schueler_Schueler } from '../schueler/Schueler';
import { GostBlockungsergebnisListeneintrag, cast_de_nrw_schule_svws_core_data_gost_GostBlockungsergebnisListeneintrag } from './GostBlockungsergebnisListeneintrag';
import { GostBlockungSchiene, cast_de_nrw_schule_svws_core_data_gost_GostBlockungSchiene } from './GostBlockungSchiene';
import { GostHalbjahr, cast_de_nrw_schule_svws_core_types_gost_GostHalbjahr } from '../../types/gost/GostHalbjahr';
import { GostFachwahl, cast_de_nrw_schule_svws_core_data_gost_GostFachwahl } from './GostFachwahl';
import { List, cast_java_util_List } from '../../../java/util/List';
import { JavaString, cast_java_lang_String } from '../../../java/lang/JavaString';
import { GostBlockungRegel, cast_de_nrw_schule_svws_core_data_gost_GostBlockungRegel } from './GostBlockungRegel';
import { Vector, cast_java_util_Vector } from '../../../java/util/Vector';
import { GostBlockungKurs, cast_de_nrw_schule_svws_core_data_gost_GostBlockungKurs } from './GostBlockungKurs';
