...
import { HerkunftsartKatalogEintragBezeichnung, cast_de_nrw_schule_svws_core_data_schule_HerkunftsartKatalogEintragBezeichnung } from './HerkunftsartKatalogEintragBezeichnung';
