...
export function cast_de_svws_nrw_core_utils_klausurplanung_KlausurterminblockungAlgorithmusGreedy3(obj : unknown) : KlausurterminblockungAlgorithmusGreedy3 {
