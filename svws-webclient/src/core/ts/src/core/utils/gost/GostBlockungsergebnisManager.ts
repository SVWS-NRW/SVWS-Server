...
import { GostBlockungsergebnisSchiene, cast_de_nrw_schule_svws_core_data_gost_GostBlockungsergebnisSchiene } from '../../data/gost/GostBlockungsergebnisSchiene';
import { IllegalStateException, cast_java_lang_IllegalStateException } from '../../../java/lang/IllegalStateException';
import { HashMap, cast_java_util_HashMap } from '../../../java/util/HashMap';
import { GostBlockungsergebnisKurs, cast_de_nrw_schule_svws_core_data_gost_GostBlockungsergebnisKurs } from '../../data/gost/GostBlockungsergebnisKurs';
...
import { SchuelerblockungInput, cast_de_nrw_schule_svws_core_data_kursblockung_SchuelerblockungInput } from '../../data/kursblockung/SchuelerblockungInput';
...
import { SchuelerblockungOutput, cast_de_nrw_schule_svws_core_data_kursblockung_SchuelerblockungOutput } from '../../data/kursblockung/SchuelerblockungOutput';
import { SchuelerblockungInputKurs, cast_de_nrw_schule_svws_core_data_kursblockung_SchuelerblockungInputKurs } from '../../data/kursblockung/SchuelerblockungInputKurs';
import { SchuelerblockungOutputFachwahlZuKurs, cast_de_nrw_schule_svws_core_data_kursblockung_SchuelerblockungOutputFachwahlZuKurs } from '../../data/kursblockung/SchuelerblockungOutputFachwahlZuKurs';
import { GostBlockungsdatenManager, cast_de_nrw_schule_svws_core_utils_gost_GostBlockungsdatenManager } from './GostBlockungsdatenManager';
import { SchuelerblockungAlgorithmus, cast_de_nrw_schule_svws_core_kursblockung_SchuelerblockungAlgorithmus } from '../../kursblockung/SchuelerblockungAlgorithmus';
...
export class GostBlockungsergebnisManager extends JavaObject {
	...
	public getOfKursAnzahlSchuelerSchriftlich(pKursID : number) : number {
		...
		for (let schuelerID of kursE.schueler) {
			let fachwahl : GostFachwahl = this._parent.getOfSchuelerOfFachFachwahl(schuelerID!, fachID);
	...
	public debug() : void {
		...
		for (let fachartID of this._map_fachartID_kurse.keySet()) {
			...
			for (let kurs of this.getOfFachartKursmenge(fachartID!)) {
