...
import { AbgangsartKatalog, cast_de_nrw_schule_svws_core_data_schule_AbgangsartKatalog } from '../../data/schule/AbgangsartKatalog';
import { AbgangsartKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_AbgangsartKatalogEintrag } from '../../data/schule/AbgangsartKatalogEintrag';
import { JavaLong, cast_java_lang_Long } from '../../../java/lang/JavaLong';
import { List, cast_java_util_List } from '../../../java/util/List';
import { SchulabschlussBerufsbildend, cast_de_nrw_schule_svws_core_types_schule_SchulabschlussBerufsbildend } from '../../types/schule/SchulabschlussBerufsbildend';
import { JavaString, cast_java_lang_String } from '../../../java/lang/JavaString';
import { Vector, cast_java_util_Vector } from '../../../java/util/Vector';
import { AbgangsartKatalogDaten, cast_de_nrw_schule_svws_core_data_schule_AbgangsartKatalogDaten } from '../../data/schule/AbgangsartKatalogDaten';
