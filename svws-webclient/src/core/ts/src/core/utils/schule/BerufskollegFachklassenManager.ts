...
import { BerufskollegFachklassenKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_BerufskollegFachklassenKatalogEintrag } from '../../data/schule/BerufskollegFachklassenKatalogEintrag';
import { BerufskollegFachklassenKatalog, cast_de_nrw_schule_svws_core_data_schule_BerufskollegFachklassenKatalog } from '../../data/schule/BerufskollegFachklassenKatalog';
...
import { BerufskollegFachklassenKatalogIndex, cast_de_nrw_schule_svws_core_data_schule_BerufskollegFachklassenKatalogIndex } from '../../data/schule/BerufskollegFachklassenKatalogIndex';
import { Vector, cast_java_util_Vector } from '../../../java/util/Vector';
import { BerufskollegFachklassenKatalogDaten, cast_de_nrw_schule_svws_core_data_schule_BerufskollegFachklassenKatalogDaten } from '../../data/schule/BerufskollegFachklassenKatalogDaten';
