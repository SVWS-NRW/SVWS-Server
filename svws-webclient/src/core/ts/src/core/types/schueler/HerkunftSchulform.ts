...
import { HerkunftSchulformKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_HerkunftSchulformKatalogEintrag } from '../../data/schule/HerkunftSchulformKatalogEintrag';
