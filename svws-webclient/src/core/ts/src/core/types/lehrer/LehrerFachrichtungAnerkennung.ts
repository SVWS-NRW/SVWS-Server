...
import { LehrerKatalogFachrichtungAnerkennungEintrag, cast_de_nrw_schule_svws_core_data_lehrer_LehrerKatalogFachrichtungAnerkennungEintrag } from '../../data/lehrer/LehrerKatalogFachrichtungAnerkennungEintrag';
...
export class LehrerFachrichtungAnerkennung extends JavaObject {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.lehrer.LehrerFachrichtungAnerkennung'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_lehrer_LehrerFachrichtungAnerkennung(obj : unknown) : LehrerFachrichtungAnerkennung {
