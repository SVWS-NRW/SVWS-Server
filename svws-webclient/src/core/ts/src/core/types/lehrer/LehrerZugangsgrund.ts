...
import { LehrerKatalogZugangsgrundEintrag, cast_de_nrw_schule_svws_core_data_lehrer_LehrerKatalogZugangsgrundEintrag } from '../../data/lehrer/LehrerKatalogZugangsgrundEintrag';
