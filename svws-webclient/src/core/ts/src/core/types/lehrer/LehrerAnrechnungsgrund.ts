...
import { LehrerKatalogAnrechnungsgrundEintrag, cast_de_nrw_schule_svws_core_data_lehrer_LehrerKatalogAnrechnungsgrundEintrag } from '../../data/lehrer/LehrerKatalogAnrechnungsgrundEintrag';
