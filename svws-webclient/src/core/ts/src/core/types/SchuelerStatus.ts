...
export class SchuelerStatus extends JavaObject implements JavaEnum<SchuelerStatus> {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.svws_nrw.core.types.SchuelerStatus', 'java.lang.Enum'].includes(name);
	}
