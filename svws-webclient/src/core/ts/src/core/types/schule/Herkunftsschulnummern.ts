...
import { HerkunftsschulnummerKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_HerkunftsschulnummerKatalogEintrag } from '../../data/schule/HerkunftsschulnummerKatalogEintrag';
import { Schulgliederung, cast_de_nrw_schule_svws_core_types_schule_Schulgliederung } from './Schulgliederung';
...
export class Herkunftsschulnummern extends JavaObject {
	...
	public equals(other : JavaObject) : boolean {
		if (!(other instanceof Herkunftsschulnummern))
			return false;
		return this === other;
	}
	 ...
	 */
	public compareTo(other : Herkunftsschulnummern) : number {
