...
import { BerufskollegAnlageKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_BerufskollegAnlageKatalogEintrag } from '../../data/schule/BerufskollegAnlageKatalogEintrag';
