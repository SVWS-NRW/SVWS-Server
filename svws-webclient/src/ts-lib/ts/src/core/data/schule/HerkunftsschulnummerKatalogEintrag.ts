...
export class HerkunftsschulnummerKatalogEintrag extends JavaObject {
	 ...
	 */
	public constructor(__param0? : number, __param1? : number, __param2? : String, __param3? : List<Pair<Schulform, Schulgliederung | null>> | null, __param4? : Number | null, __param5? : Number | null) {
		super();
