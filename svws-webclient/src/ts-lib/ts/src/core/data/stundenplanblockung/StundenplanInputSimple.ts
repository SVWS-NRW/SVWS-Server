...
import { StundenplanInputSimpleKurs, cast_de_nrw_schule_svws_core_data_stundenplanblockung_StundenplanInputSimpleKurs } from '../../../core/data/stundenplanblockung/StundenplanInputSimpleKurs';
