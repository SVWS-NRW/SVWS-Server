...
export class FachKatalogEintrag extends JavaObject {
	...
	public static transpilerFromJSON(json : string): FachKatalogEintrag {
		...
		result.kuerzelASD = String(obj.kuerzelASD);
		...
		result.aufgabenfeld = typeof obj.aufgabenfeld === "undefined" ? null : obj.aufgabenfeld === null ? null : Number(obj.aufgabenfeld);
		result.fachgruppe = typeof obj.fachgruppe === "undefined" ? null : obj.fachgruppe === null ? null : String(obj.fachgruppe);
		result.abJahrgang = typeof obj.abJahrgang === "undefined" ? null : obj.abJahrgang === null ? null : String(obj.abJahrgang);
