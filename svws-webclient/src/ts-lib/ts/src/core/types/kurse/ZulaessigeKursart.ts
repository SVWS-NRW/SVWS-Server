...
export class ZulaessigeKursart extends JavaObject {
	...
	public static readonly WPI_GY : ZulaessigeKursart = new ZulaessigeKursart("WPI_GY", 69, [new KursartKatalogEintrag(69000, "WPI_GY", "61", "Wahlpflichtbereich I: 2. Fremdsprache", null, null, null, false, Arrays.asList(new Pair(Schulform.GY, cast_de_nrw_schule_svws_core_types_schule_Schulgliederung(null))), null, null)]);
