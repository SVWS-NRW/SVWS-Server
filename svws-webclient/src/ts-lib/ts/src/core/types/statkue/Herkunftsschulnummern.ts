...
export class Herkunftsschulnummern extends JavaObject {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.Herkunftsschulnummern'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_Herkunftsschulnummern(obj : unknown) : Herkunftsschulnummern {
