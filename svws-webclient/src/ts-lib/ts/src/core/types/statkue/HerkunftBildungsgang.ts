...
export class HerkunftBildungsgang extends JavaObject {
	...
	private static readonly _ebenen : HashMap<String, HerkunftBildungsgang> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.HerkunftBildungsgang'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_HerkunftBildungsgang(obj : unknown) : HerkunftBildungsgang {
