...
export class Foerderschwerpunkt extends JavaObject {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.Foerderschwerpunkt'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_Foerderschwerpunkt(obj : unknown) : Foerderschwerpunkt {
