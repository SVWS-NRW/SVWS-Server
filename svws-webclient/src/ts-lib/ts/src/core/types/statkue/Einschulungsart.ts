...
export class Einschulungsart extends JavaObject {
	...
	private static readonly _ebenen : HashMap<String, Einschulungsart> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.Einschulungsart'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_Einschulungsart(obj : unknown) : Einschulungsart {
