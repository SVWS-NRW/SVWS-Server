...
export class Religion extends JavaObject {
	...
	private static readonly _mapKuerzel : HashMap<String, Religion> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.Religion'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_Religion(obj : unknown) : Religion {
