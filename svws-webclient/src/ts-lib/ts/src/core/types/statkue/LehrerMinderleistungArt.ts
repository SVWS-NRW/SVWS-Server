...
export class LehrerMinderleistungArt extends JavaObject {
	...
	private static readonly _artenByID : HashMap<Number, LehrerMinderleistungArt> = new HashMap();

	private static readonly _artenByKuerzel : HashMap<String, LehrerMinderleistungArt> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.LehrerMinderleistungArt'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_LehrerMinderleistungArt(obj : unknown) : LehrerMinderleistungArt {
