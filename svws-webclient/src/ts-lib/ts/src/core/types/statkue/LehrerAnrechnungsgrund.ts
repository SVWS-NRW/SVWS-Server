...
export class LehrerAnrechnungsgrund extends JavaObject {
	...
	private static readonly _gruendeByID : HashMap<Number, LehrerAnrechnungsgrund> = new HashMap();

	private static readonly _gruendeByKuerzel : HashMap<String, LehrerAnrechnungsgrund> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.LehrerAnrechnungsgrund'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_LehrerAnrechnungsgrund(obj : unknown) : LehrerAnrechnungsgrund {
