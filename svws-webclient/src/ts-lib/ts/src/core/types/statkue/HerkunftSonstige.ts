...
import { HerkunftSonstigeKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_HerkunftSonstigeKatalogEintrag } from '../../../core/data/schule/HerkunftSonstigeKatalogEintrag';
...
export class HerkunftSonstige extends JavaObject {
	...
	private static readonly _ebenen : HashMap<String, HerkunftSonstige> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.HerkunftSonstige'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_HerkunftSonstige(obj : unknown) : HerkunftSonstige {
