...
export class Herkunftsarten extends JavaObject {
	...
	private static readonly _mapKuerzel : HashMap<String, Herkunftsarten> = new HashMap();

	private static readonly _mapID : HashMap<Number, Herkunftsarten> = new HashMap();
	...
	public static get(schulform : Schulform | null) : List<Herkunftsarten> {
		let result : Vector<Herkunftsarten> = new Vector();
		if (schulform === null) 
			return result;
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.Herkunftsarten'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_Herkunftsarten(obj : unknown) : Herkunftsarten {
