...
import { HerkunftSchulformKatalogEintrag, cast_de_nrw_schule_svws_core_data_schule_HerkunftSchulformKatalogEintrag } from '../../../core/data/schule/HerkunftSchulformKatalogEintrag';
...
export class HerkunftSchulform extends JavaObject {
	...
	private static readonly _ebenen : HashMap<String, HerkunftSchulform> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.HerkunftSchulform'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_HerkunftSchulform(obj : unknown) : HerkunftSchulform {
