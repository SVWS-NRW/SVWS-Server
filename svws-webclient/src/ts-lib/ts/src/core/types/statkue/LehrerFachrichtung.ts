...
export class LehrerFachrichtung extends JavaObject {
	...
	private static readonly _fachrichtungenByID : HashMap<Number, LehrerFachrichtung> = new HashMap();

	private static readonly _fachrichtungenByKuerzel : HashMap<String, LehrerFachrichtung> = new HashMap();
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.LehrerFachrichtung'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_LehrerFachrichtung(obj : unknown) : LehrerFachrichtung {
