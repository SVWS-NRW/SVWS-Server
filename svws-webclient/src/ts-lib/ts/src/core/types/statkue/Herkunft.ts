...
import { HerkunftBildungsgang, cast_de_nrw_schule_svws_core_types_statkue_HerkunftBildungsgang } from '../../../core/types/statkue/HerkunftBildungsgang';
import { HerkunftSchulform, cast_de_nrw_schule_svws_core_types_statkue_HerkunftSchulform } from '../../../core/types/statkue/HerkunftSchulform';
import { HerkunftBildungsgangsTyp, cast_de_nrw_schule_svws_core_types_statkue_HerkunftBildungsgangsTyp } from '../../../core/types/statkue/HerkunftBildungsgangsTyp';
import { JavaString, cast_java_lang_String } from '../../../java/lang/JavaString';
import { HerkunftSonstige, cast_de_nrw_schule_svws_core_types_statkue_HerkunftSonstige } from '../../../core/types/statkue/HerkunftSonstige';
...
export class Herkunft extends JavaObject {
	...
	private static readonly _kuerzel : HashMap<String, Herkunft> = new HashMap();
	...
	private constructor(name : string, ordinal : number, __param0 : HerkunftBildungsgang | HerkunftBildungsgangsTyp | HerkunftSchulform | HerkunftSonstige) {
		...
		if (((typeof __param0 !== "undefined") && ((__param0 instanceof JavaObject) && (__param0.isTranspiledInstanceOf('de.nrw.schule.svws.core.types.statkue.HerkunftSonstige'))))) {
			let h : HerkunftSonstige = cast_de_nrw_schule_svws_core_types_statkue_HerkunftSonstige(__param0);
		...
		} else if (((typeof __param0 !== "undefined") && ((__param0 instanceof JavaObject) && (__param0.isTranspiledInstanceOf('de.nrw.schule.svws.core.types.statkue.HerkunftBildungsgang'))))) {
			let h : HerkunftBildungsgang = cast_de_nrw_schule_svws_core_types_statkue_HerkunftBildungsgang(__param0);
			this.historie = Array(h.historie.length).fill(null);
			for (let i : number = 0; i < h.historie.length; i++){
			...
			this.daten = this.historie[this.historie.length - 1];
		} else if (((typeof __param0 !== "undefined") && ((__param0 instanceof JavaObject) && (__param0.isTranspiledInstanceOf('de.nrw.schule.svws.core.types.statkue.HerkunftBildungsgangsTyp'))))) {
			let h : HerkunftBildungsgangsTyp = cast_de_nrw_schule_svws_core_types_statkue_HerkunftBildungsgangsTyp(__param0);
			this.historie = Array(h.historie.length).fill(null);
			for (let i : number = 0; i < h.historie.length; i++){
			...
			this.daten = this.historie[this.historie.length - 1];
		} else if (((typeof __param0 !== "undefined") && ((__param0 instanceof JavaObject) && (__param0.isTranspiledInstanceOf('de.nrw.schule.svws.core.types.statkue.HerkunftSchulform'))))) {
			let h : HerkunftSchulform = cast_de_nrw_schule_svws_core_types_statkue_HerkunftSchulform(__param0);
			this.historie = Array(h.historie.length).fill(null);
			for (let i : number = 0; i < h.historie.length; i++){
	 ...
	 */
	private static getMapByKuerzel() : HashMap<String, Herkunft> {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['de.nrw.schule.svws.core.types.statkue.Herkunft'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_types_statkue_Herkunft(obj : unknown) : Herkunft {
