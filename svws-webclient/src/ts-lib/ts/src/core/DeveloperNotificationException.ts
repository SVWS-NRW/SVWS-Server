...
export class DeveloperNotificationException extends RuntimeException {
	...
	isTranspiledInstanceOf(name : string): boolean {
		return ['java.lang.Throwable', 'de.nrw.schule.svws.core.DeveloperNotificationException', 'java.lang.RuntimeException', 'java.lang.Exception', 'java.io.Serializable'].includes(name);
	}

}

export function cast_de_nrw_schule_svws_core_DeveloperNotificationException(obj : unknown) : DeveloperNotificationException {
