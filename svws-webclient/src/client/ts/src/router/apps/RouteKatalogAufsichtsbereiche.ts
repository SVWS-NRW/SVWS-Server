...
import type { StundenplanAufsichtsbereich} from "@svws-nrw/svws-core";
...
import { routeKatalogAufsichtsbereichDaten } from "./aufsichtsbereich/RouteKatalogAufsichtsbereichDaten";
