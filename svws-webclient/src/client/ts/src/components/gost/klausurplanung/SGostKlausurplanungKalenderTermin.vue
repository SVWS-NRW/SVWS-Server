<template>
	<div class="rounded bg-dark-20 p-2">
		<div class="justify-between py-1">
			<h3 class="text-sm">{{ props.termin.bezeichnung !== null ? props.termin.bezeichnung : "Unbenannte Klausurschiene" }}</h3>
		</div>
...
<script setup lang="ts">
	import type { GostKursklausurManager, GostFaecherManager, LehrerListeEintrag, GostKlausurtermin} from "@svws-nrw/svws-core";
