<template>
	<svws-ui-content-card title="Allgemein">
		<div class="input-wrapper">
			...
			<svws-ui-text-input type="number" :model-value="data.beginn" @blur="doPatch({beginn: Number($event)})" />
			<svws-ui-text-input type="number" :model-value="data.ende" @blur="doPatch({ende: Number($event)})" />
		</div>
