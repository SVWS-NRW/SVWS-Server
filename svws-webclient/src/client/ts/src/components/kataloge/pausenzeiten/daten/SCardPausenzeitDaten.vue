<template>
	<svws-ui-content-card title="Allgemein">
		<div class="input-wrapper">
			...
			<SvwsUiTextInput type="number" :model-value="data.beginn" @blur="doPatch({beginn: Number($event)})" />
			<SvwsUiTextInput type="number" :model-value="data.ende" @blur="doPatch({ende: Number($event)})" />
		</div>
