import { BetriebStammdaten, SchuelerBetriebsdaten, BetriebAnsprechpartner, OrtKatalogEintrag, OrtsteilKatalogEintrag, List, KatalogEintrag, LehrerListeEintrag, BetriebListeEintrag } from "@svws-nrw/svws-core";
