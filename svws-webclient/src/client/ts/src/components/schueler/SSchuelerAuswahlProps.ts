import { SchuelerListeEintrag, List, KlassenListeEintrag, JahrgangsListeEintrag, KursListeEintrag, Schulgliederung, Schuljahresabschnitt, SchuelerStatus } from "@svws-nrw/svws-core";
