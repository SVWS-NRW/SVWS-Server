import { BenutzerKompetenz, KursDaten, KursListeEintrag, Schulform } from "@svws-nrw/svws-core-ts";
...
export class RouteKurseDaten extends RouteNode<RouteDataKurseDaten, RouteKurse> {
	...
	public constructor() {
		super(Schulform.values(), [ BenutzerKompetenz.KEINE ], "kurse_daten", "daten", SKursDaten, new RouteDataKurseDaten());
