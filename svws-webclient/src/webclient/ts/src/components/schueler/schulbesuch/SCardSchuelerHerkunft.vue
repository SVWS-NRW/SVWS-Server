	...
	<svws-ui-content-card title="Vor der Aufnahme besuchte Schule/Einrichtung/Herkunftsarten">
		<div class="input-wrapper">
			...
			<div class="input-wrapper-3-cols">
				...
				<svws-ui-text-input placeholder="Versetzung" v-model="vorigeArtLetzteVersetzung" type="text" />
			</div>
			<div class="input-wrapper-3-cols">
...
<script setup lang="ts">
	...
	const vorigeArtLetzteVersetzung: WritableComputedRef<string | undefined> = computed({
		get: () => props.data.daten?.vorigeArtLetzteVersetzung?.toString(),
		set: (value) => props.data.patch({ vorigeArtLetzteVersetzung:  value })
	});
