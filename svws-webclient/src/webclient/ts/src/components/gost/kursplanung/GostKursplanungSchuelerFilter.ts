import { GostBlockungKurs, GostBlockungsdatenManager, GostBlockungsergebnisManager, GostFach, GostKursart, List, SchuelerListeEintrag, Vector } from "@svws-nrw/svws-core-ts";
