...
.login-container {
	@apply bg-cover bg-center rounded-t-2xl h-full flex flex-col justify-center items-center;
	//background-image: linear-gradient(45deg, rgba(var(--color-primary), 0.5), rgba(var(--color-primary), 0)), url("/images/placeholder-background.jpg");
