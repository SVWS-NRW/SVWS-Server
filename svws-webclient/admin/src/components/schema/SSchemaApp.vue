		...
		<header class="svws-ui-header">
			<div class="svws-ui-header--title">
				<div class="svws-headline-wrapper">
					...
					<span v-if="schuleInfo !== undefined" class="svws-subline">{{ schuleInfo.schulNr }} {{ schuleInfo.schulform }} {{ schuleInfo.bezeichnung }} | {{ schuleInfo.strassenname }} {{ schuleInfo.hausnummer }} {{ schuleInfo.hausnummerZusatz ?? '' }} {{ schuleInfo.ort }}</span>
				</div>
			</div>
