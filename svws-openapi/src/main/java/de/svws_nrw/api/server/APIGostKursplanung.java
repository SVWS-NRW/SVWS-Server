   ...
   /**
	...
	public Response pdfGostKursplanungKurseSchienenZuordnung(
		...
		return DBBenutzerUtils.runWithTransaction(conn ->
				(new PdfFactory(conn, "de/svws_nrw/module/reporting/gost/kursplanung/GostKursplanungSchuelerMitSchienenKursen.html", false, idBlockungsergebnis, new ArrayList<>(), idsSchueler, 0))
					.create(),
			request, ServerMode.STABLE,
			BenutzerKompetenz.OBERSTUFE_KURSPLANUNG_ALLGEMEIN,
			BenutzerKompetenz.OBERSTUFE_KURSPLANUNG_FUNKTIONSBEZOGEN,
	...
	public Response pdfGostKursplanungSchuelerMitKursen(
            ...
            @Context final HttpServletRequest request) {
		return DBBenutzerUtils.runWithTransaction(conn ->
				(new PdfFactory(conn, "de/svws_nrw/module/reporting/gost/kursplanung/GostKursplanungSchuelerMitKursen.html", false, idBlockungsergebnis, new ArrayList<>(), idsSchueler, 0))
					.create(),
			request, ServerMode.STABLE,
			BenutzerKompetenz.OBERSTUFE_KURSPLANUNG_ALLGEMEIN,
			BenutzerKompetenz.OBERSTUFE_KURSPLANUNG_FUNKTIONSBEZOGEN,
	...
	public Response pdfGostKursplanungKurseMitKursschuelern(
            ...
            @Context final HttpServletRequest request) {
		return DBBenutzerUtils.runWithTransaction(conn ->
				(new PdfFactory(conn, "de/svws_nrw/module/reporting/gost/kursplanung/GostKursplanungKursMitKursschuelern.html", false, idBlockungsergebnis, new ArrayList<>(), idsKurse, 0))
					.create(),
			request, ServerMode.STABLE,
			BenutzerKompetenz.OBERSTUFE_KURSPLANUNG_ALLGEMEIN,
			BenutzerKompetenz.OBERSTUFE_KURSPLANUNG_FUNKTIONSBEZOGEN,
