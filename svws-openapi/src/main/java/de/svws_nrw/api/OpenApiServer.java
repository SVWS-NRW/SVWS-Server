...
import de.svws_nrw.api.common.OpenApiModelConverterNonPrimitiveNullable;
 ...
 */
@Path("")
public class OpenApiServer extends BaseOpenApiResource implements OpenApiDefinition {
	...
	public String getDescription() {
		return "Die Open-API-Schnittstellenbeschreibungen des SVWS-Servers.";
	}
