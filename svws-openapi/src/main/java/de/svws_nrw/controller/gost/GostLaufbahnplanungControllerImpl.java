...
public final class GostLaufbahnplanungControllerImpl implements GostLaufbahnplanungController {
	...
	/** Der Service für den Export mit dem Export-Format für die Laufbahnplanung. */
	private final GostLaufbahnplanungExportV1Service gostLaufbahnplanungExportV1Service;

	/** Der Service für den Import mit dem Export-Format für die Laufbahnplanung. */
	 ...
	 * @param gostJahrgangFachwahlService
	 * @param gostLaufbahnplanungExportV1Service   der Service für den Export mit dem Export-Format für die Laufbahnplanung
	 * @param gostLaufbahnplanungImportV1Service   der Service für den Import mit dem Export-Format für die Laufbahnplanung
	 */
	public GostLaufbahnplanungControllerImpl(final BenutzerKompetenzService benutzerKompetenzService,
			...
			final GostLaufbahnplanungExportV1Service gostLaufbahnplanungExportV1Service,
		...
		this.gostLaufbahnplanungExportV1Service = gostLaufbahnplanungExportV1Service;
	...
	public Response exportGZip(final long idSchueler) {
		final GostLaufbahnplanungExportV1 daten = gostLaufbahnplanungExportV1Service.get(idSchueler);
		final GostLaufbahnplanungExportV1Schueler schueler = daten.schueler.getFirst();
	...
	public Response exportGZip(final Collection<Long> idsSchueler) {
		...
		final List<GostLaufbahnplanungExportV1> listDaten = gostLaufbahnplanungExportV1Service.getList(idsSchueler);
		...
		try {
			try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
				try (ZipOutputStream zos = new ZipOutputStream(baos)) {
					for (final GostLaufbahnplanungExportV1 daten : listDaten) {
						final GostLaufbahnplanungExportV1Schueler schueler = daten.schueler.getFirst();
	...
	public Response importGostLaufbahnplanungGZip(final MultipartFormDataInput multipart) {
		try {
			...
			return importGostLaufbahnplanungInternal(logger -> gostLaufbahnplanungImportV1Service.doImport(listImporteV1, logger));
	...
	public Response importGostLaufbahnplanungGZip(final byte[] data) {
		try {
			final GostLaufbahnplanungExportV1 laufbahnplanungsdaten = JSONMapper.toObjectGZip(data, GostLaufbahnplanungExportV1.class);
	...
	@Override
	public Response importGostLaufbahnplanung(final GostLaufbahnplanungExportV1 laufbahnplanungsdaten) {
		return importGostLaufbahnplanungInternal(logger -> gostLaufbahnplanungImportV1Service.doImport(laufbahnplanungsdaten, logger));
	}
