 ...
 */
public interface UvLehrerController {
	...
	/**
	 * Retrieves all entries for general credit hours of teachers.
	 *
	 * @return the Response object containing the retrieved entries
	 */
	Response getAll();
	 ...
	 * @return die Response
	 */
	Response patch(UvLehrerPatchRequest patch);
	 ...
	 * @return die Response
	 */
	Response patchMultiple(Collection<UvLehrerPatchRequest> patches);
	 ...
	 * @return die Response
	 */
	Response create(UvLehrerCreateRequest patch);
	 ...
	 * @return die Response
	 */
	Response createMultiple(Collection<UvLehrerCreateRequest> patches);
