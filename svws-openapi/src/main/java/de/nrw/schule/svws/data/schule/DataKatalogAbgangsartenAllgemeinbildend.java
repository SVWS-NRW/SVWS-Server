...
import de.nrw.schule.svws.json.JsonReader;
...
public class DataKatalogAbgangsartenAllgemeinbildend extends DataManager<Long> {
	...
	public Response getAll() {
		AbgangsartKatalog daten = JsonReader.fromResource("daten/json/AbgangsartenAllgemeinbildend.json", AbgangsartKatalog.class);
