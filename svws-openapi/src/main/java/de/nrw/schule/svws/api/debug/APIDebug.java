...
public class APIDebug {
	 ...
	 */
	private static Response getResource(String filename, final HttpServletRequest request, final boolean isYAML) {
		String data = null;
    	try {
    ...
    public Response debugRootWrong(@PathParam("yaml") String yaml, @Context final HttpServletRequest request) {
		if ("/yaml".equals(yaml))
    ...
    public Response debugFileIndexHTML(@PathParam("yaml") String yaml, @Context final HttpServletRequest request) {
    ...
    public Response debugFileSwaggerUIJS(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUIBundleJS(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUIStandalonePresetJS(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUICSS(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUIJSMap(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUIBundleJSMap(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUIStandalonePresetJSMap(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileSwaggerUICSSMap(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileFavicon16x16PNG(@PathParam("yaml") String yaml) {
    ...
    public Response debugFileFavicon32x32PNG(@PathParam("yaml") String yaml) {
