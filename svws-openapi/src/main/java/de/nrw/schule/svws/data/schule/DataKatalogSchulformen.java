 ...
 */
public class DataKatalogSchulformen extends DataManager<Long> {
	 ...
	 */
	public DataKatalogSchulformen(DBEntityManager conn) {
		super(conn);
	}
	
	@Override
	public Response getAll() {
		Vector<SchulformKatalogEintrag> daten = new Vector<>();
