package de.nrw.schule.svws.api.client;
...
public class APISVWSClient {
	 ...
	 */
    private static Response getFile(String filename) {
    	byte[] data = ResourceFile.getData(filename);
    	if (data == null)
    ...
    @Produces(MediaType.TEXT_HTML)
    @Path("/{name}.html")
    public Response getClientHTML(@PathParam("name") String name) {
    ...
    @Path("/{name}.js")
    public Response getClientfileJS(@PathParam("name") String name) {
    ...
    @Produces("text/javascript")
    @Path("/js/{name}.js")
    public Response getClientFileJSSubdir(@PathParam("name") String name) {
    ...
    @Produces("text/javascript")
    @Path("/assets/{name}.js")
    public Response getClientFileAssetsSubdir(@PathParam("name") String name) {
    ...
    @Path("/{name}.js.map")
    public Response getClientFileJSMAP(@PathParam("name") String name) {
    ...
    @Produces(MediaType.TEXT_PLAIN)
    @Path("/js/{name}.js.map")
    public Response getClientFileJSMAPSubdir(@PathParam("name") String name) {
    ...
    public Response getClientFileAssetJSMAPSubdir(@PathParam("name") String name) {
    ...
    @Produces("text/css")
    @Path("/{name}.css")
    public Response getClientFileCSS(@PathParam("name") String name) {
    ...
    @Produces("text/css")
    @Path("/css/{name}.css")
    public Response getClientFileCSSSubdir(@PathParam("name") String name) {
    ...
    public Response getClientFileCSSAssetsSubdir(@PathParam("name") String name) {
    ...
    @Produces(MediaType.TEXT_PLAIN)
    @Path("/{name}.css.map")
    public Response getClientFileCSSMAP(@PathParam("name") String name) {
    ...
    public Response getClientFileCSSMAPSubdir(@PathParam("name") String name) {
    ...
    public Response getClientFileAssetsCSSMAPSubdir(@PathParam("name") String name) {
    ...
    @Produces("text/css")
    @Path("/fonts/{name}.css")
    public Response getClientFileFontsCSS(@PathParam("name") String name) {
    ...
    public Response getClientFileFontsWoff2(@PathParam("name") String name) {
    ...
    @Path("/{name}.ico")
    public Response getClientFileICO(@PathParam("name") String name) {
    ...
    public Response getClientFileAssetsICO(@PathParam("name") String name) {
    ...
    @Produces("image/png")
    @Path("/{name}.png")
    public Response getClientFilePNG(@PathParam("name") String name) {
    ...
    public Response getClientFileImgIconsPNG(@PathParam("name") String name) {
    ...
    public Response getClientFileAssetsPNG(@PathParam("name") String name) {
    ...
    public Response getClientFileAssetsJPG(@PathParam("name") String name) {
    ...
    @Path("/{name}.svg")
    public Response getClientFileSVG(@PathParam("name") String name) {
    ...
    public Response getClientFileAssetsSVG(@PathParam("name") String name) {
