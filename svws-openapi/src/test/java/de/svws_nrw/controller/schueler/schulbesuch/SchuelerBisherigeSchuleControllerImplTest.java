...
class SchuelerBisherigeSchuleControllerImplTest {

	@Mock
	private SchuelerBisherigeSchuleService service;

	private SchuelerBisherigeSchuleControllerImpl controller;

	private MockedStatic<BeanValidator> beanValidatorMock;

	@BeforeEach
	void setUp() {
		controller = new SchuelerBisherigeSchuleControllerImpl(service);
