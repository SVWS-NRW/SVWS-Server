...
class LehrerLehrbefaehigungControllerImplTest {
	...
	@InjectMocks
	private LehrerLehrbefaehigungControllerImpl controller;
	...
	@DisplayName("create")
	void create() {
		final var dto = new LehrerLehrbefaehigungCreateRequest();
	...
	@DisplayName("patch")
	void patch() {
		final var dto = new LehrerLehrbefaehigungPatchRequest();
