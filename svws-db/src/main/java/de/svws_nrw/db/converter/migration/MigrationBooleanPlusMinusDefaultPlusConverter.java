 ...
 */
@Converter
public class MigrationBooleanPlusMinusDefaultPlusConverter extends DBAttributeConverter<Boolean, String> {

	/** Die Instanz des Konverters */
	public final static MigrationBooleanPlusMinusDefaultPlusConverter instance = new MigrationBooleanPlusMinusDefaultPlusConverter();
