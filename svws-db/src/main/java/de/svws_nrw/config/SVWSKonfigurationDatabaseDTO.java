...
class SVWSKonfigurationDatabaseDTO {
	...
	/** DEPRECATED: Gibt an, wieviele wiederholte Verbindungsversuche zur Datenbank stattfinden sollen */
	@JsonProperty("connectionRetries")
	int connectionRetries;

	/** DEPRECATED: Gibt an, wie hoch die Zeit zwischen zwei Verbindungsversuchen in Millisekunden sein soll */
