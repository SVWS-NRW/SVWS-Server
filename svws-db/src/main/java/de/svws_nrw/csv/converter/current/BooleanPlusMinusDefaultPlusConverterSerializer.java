 ...
 */
public final class BooleanPlusMinusDefaultPlusConverterSerializer extends StdSerializer<Boolean> {
	 ...
	 */
	public BooleanPlusMinusDefaultPlusConverterSerializer(final Class<Boolean> t) {
		super(t);
	}
