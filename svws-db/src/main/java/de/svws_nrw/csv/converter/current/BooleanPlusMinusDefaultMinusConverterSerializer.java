 ...
 */
public final class BooleanPlusMinusDefaultMinusConverterSerializer extends StdSerializer<Boolean> {
	 ...
	 */
	public BooleanPlusMinusDefaultMinusConverterSerializer(final Class<Boolean> t) {
		super(t);
	}
