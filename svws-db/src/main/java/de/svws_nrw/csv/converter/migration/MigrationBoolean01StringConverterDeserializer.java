 ...
 */
public final class MigrationBoolean01StringConverterDeserializer extends StdDeserializer<Boolean> {
	 ...
	 */
	protected MigrationBoolean01StringConverterDeserializer(final Class<Boolean> t) {
		super(t);
	}
