 ...
 */
public final class BooleanPlusMinusConverterSerializer extends StdSerializer<Boolean> {
	 ...
	 */
	public BooleanPlusMinusConverterSerializer() {
		super(Boolean.class);
	}
	 ...
	 */
	public BooleanPlusMinusConverterSerializer(final Class<Boolean> t) {
		super(t);
	}
