...
public final class KursFortschreibungsartConverterSerializer extends StdSerializer<KursFortschreibungsart> {
	 ...
	 */
	public KursFortschreibungsartConverterSerializer(final Class<KursFortschreibungsart> t) {
		super(t);
	}

	@Override
	public void serialize(final KursFortschreibungsart value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
