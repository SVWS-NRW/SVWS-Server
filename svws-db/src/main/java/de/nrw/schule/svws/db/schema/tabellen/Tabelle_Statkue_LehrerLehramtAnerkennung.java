...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerLehramtAnerkennung.
 */
public class Tabelle_Statkue_LehrerLehramtAnerkennung extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID der Lehramtanerkennung");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Schlüssel der Lehramtanerkennung");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerLehramtAnerkennung.
	 */
	public Tabelle_Statkue_LehrerLehramtAnerkennung() {
		super("Statkue_LehrerLehramtAnerkennung", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerLehramtAnerkennung");
		setJavaComment("Statkue von IT.NRW  Lehramt Anerkennung");
	}
