...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerEinsatzstatus.
 */
public class Tabelle_Statkue_LehrerEinsatzstatus extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID des Lehrereinsatzstatus");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikschlüssel des Lehrereinsatzstatus");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerEinsatzstatus.
	 */
	public Tabelle_Statkue_LehrerEinsatzstatus() {
		super("Statkue_LehrerEinsatzstatus", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerEinsatzstatus");
		setJavaComment("Statkue von IT.NRW  Lehrer Einsatzstatus gültige Schlüssel");
	}
