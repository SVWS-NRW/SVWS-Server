...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle EinschulungsartKatalog.
 */
public class Tabelle_EinschulungsartKatalog extends SchemaTabelle {
	...
	public SchemaTabelleSpalte col_Bezeichnung = add("Bezeichnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
		.setNotNull()
		.setJavaComment("Eine kurze Bezeichnung für die Einschulungsart");
	...
	public SchemaTabelleSpalte col_Beschreibung = add("Beschreibung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
		.setNotNull()
		.setJavaComment("Die textuelle Beschreibung der Einschulungsart");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle EinschulungsartKatalog.
	 */
	public Tabelle_EinschulungsartKatalog() {
		super("EinschulungsartKatalog", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("schild.schule");
		setJavaClassName("DTOEinschulungsartenKatalog");
		setJavaComment("Eine Tabelle mit den Einschulungsarten");
	}
