...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerLehrbefaehigung.
 */
public class Tabelle_Statkue_LehrerLehrbefaehigung extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID der Lehrbefähigung");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikkürzel der Lehrbefähigung");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerLehrbefaehigung.
	 */
	public Tabelle_Statkue_LehrerLehrbefaehigung() {
		super("Statkue_LehrerLehrbefaehigung", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerLehrbefaehigung");
		setJavaComment("Statkue von IT.NRW  Lehrbefähigung");
	}
