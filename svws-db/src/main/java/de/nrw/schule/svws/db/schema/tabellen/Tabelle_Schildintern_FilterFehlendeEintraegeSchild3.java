...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Schildintern_FilterFehlendeEintraegeSchild3.
 */
public class Tabelle_Schildintern_FilterFehlendeEintraegeSchild3 extends SchemaTabelle {
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Schildintern_FilterFehlendeEintraegeSchild3.
	 */
	public Tabelle_Schildintern_FilterFehlendeEintraegeSchild3() {
		super("Schildintern_FilterFehlendeEintraegeSchild3", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("schild.intern");
		setJavaClassName("DTOInternFilterFehlendeEintraegeSchild3");
		setJavaComment("Schild3: Liste mit Feldern, die für den Filter auf fehlende Einträge verwendet werden können");
	}
