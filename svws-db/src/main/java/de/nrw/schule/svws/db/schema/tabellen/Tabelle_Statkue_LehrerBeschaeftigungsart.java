...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerBeschaeftigungsart.
 */
public class Tabelle_Statkue_LehrerBeschaeftigungsart extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW:  ID der Lehrerbeschäftigungsart");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: StatistikKürzel der Lehrerbeschäftigungsart");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerBeschaeftigungsart.
	 */
	public Tabelle_Statkue_LehrerBeschaeftigungsart() {
		super("Statkue_LehrerBeschaeftigungsart", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerBeschaeftigungsart");
		setJavaComment("Statkue von IT.NRW  Lehrer Beschäftigungsarten");
	}
