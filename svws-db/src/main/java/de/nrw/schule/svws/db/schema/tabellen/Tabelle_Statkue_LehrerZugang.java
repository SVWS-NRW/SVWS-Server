...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerZugang.
 */
public class Tabelle_Statkue_LehrerZugang extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID der Lehrerzugangsart");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Kurztext der Lehrerzugangsart");
	...
	public SchemaTabelleSpalte col_ASDSchluessel = add("ASDSchluessel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikschlüssel der Lehrerzugangsart");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerZugang.
	 */
	public Tabelle_Statkue_LehrerZugang() {
		super("Statkue_LehrerZugang", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerZugang");
		setJavaComment("Statkue von IT.NRW Zugangsarten");
	}
