...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerFachrichtung.
 */
public class Tabelle_Statkue_LehrerFachrichtung extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID der Fachrichtung für Lehrer");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikschlüssel der Fachrichtung für Lehrer");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerFachrichtung.
	 */
	public Tabelle_Statkue_LehrerFachrichtung() {
		super("Statkue_LehrerFachrichtung", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerFachrichtung");
		setJavaComment("Statkue von IT.NRW  Fachrichtung ");
	}
