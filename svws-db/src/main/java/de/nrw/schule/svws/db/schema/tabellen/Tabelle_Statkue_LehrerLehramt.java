...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerLehramt.
 */
public class Tabelle_Statkue_LehrerLehramt extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID des Lehrerlehramts");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikkürzel des Lehrerlehramts");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerLehramt.
	 */
	public Tabelle_Statkue_LehrerLehramt() {
		super("Statkue_LehrerLehramt", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerLehramt");
		setJavaComment("Statkue von IT.NRW  Lehramt");
	}
