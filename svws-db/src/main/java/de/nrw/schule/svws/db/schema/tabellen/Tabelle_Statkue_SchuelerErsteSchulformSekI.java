...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_SchuelerErsteSchulformSekI.
 */
public class Tabelle_Statkue_SchuelerErsteSchulformSekI extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID der ersten Schulform Sek1");
	...
	public SchemaTabelleSpalte col_SF = add("SF", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
		.setJavaComment("Statkue Tabelle IT.NRW: zulässige Schulform der ersten Schulform Sek1");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statsistikschlüssel der ersten Schulform Sek1");
	...
	public SchemaTabelleSpalte col_geaendert = add("geaendert", SchemaDatentypen.DATETIME, false)
		.setJavaComment("Statkue Tabelle IT.NRW: Datum der letzten Änderung der ersten Schulform Sek1");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_SchuelerErsteSchulformSekI.
	 */
	public Tabelle_Statkue_SchuelerErsteSchulformSekI() {
		super("Statkue_SchuelerErsteSchulformSekI", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueSchuelerErsteSchulformSekI");
		setJavaComment("Statkue von IT.NRW gültige Schulformen für die Sek1");
	}
