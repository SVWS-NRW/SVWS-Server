 ...
 */
public class MigrationBoolean01StringConverterSerializer extends StdSerializer<Boolean> {
	 ...
	 */
	public MigrationBoolean01StringConverterSerializer(Class<Boolean> t) {
		super(t);
	}
