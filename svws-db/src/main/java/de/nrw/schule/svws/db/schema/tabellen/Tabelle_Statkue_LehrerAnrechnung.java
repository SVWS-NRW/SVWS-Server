...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerAnrechnung.
 */
public class Tabelle_Statkue_LehrerAnrechnung extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID für Leheranrechnungsgründe");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikschlüssel für Leheranrechnungsgründe");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerAnrechnung.
	 */
	public Tabelle_Statkue_LehrerAnrechnung() {
		super("Statkue_LehrerAnrechnung", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerAnrechnung");
		setJavaComment("Statkue von IT.NRW  AnrechnungsstundenSchlüssel");
	}
