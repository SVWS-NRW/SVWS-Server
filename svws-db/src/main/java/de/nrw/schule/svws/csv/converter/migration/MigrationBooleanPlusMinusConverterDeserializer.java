 ...
 */
public class MigrationBooleanPlusMinusConverterDeserializer extends StdDeserializer<Boolean> {
	 ...
	 */
	protected MigrationBooleanPlusMinusConverterDeserializer(Class<Boolean> t) {
		super(t);
	}
