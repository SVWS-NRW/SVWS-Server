...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Statkue_LehrerMehrleistung.
 */
public class Tabelle_Statkue_LehrerMehrleistung extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: ID der Lehrermehrleistung");
	...
	public SchemaTabelleSpalte col_Kurztext = add("Kurztext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Statkue Tabelle IT.NRW: Statistikkürzel der Lehrermehrleistung");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Statkue_LehrerMehrleistung.
	 */
	public Tabelle_Statkue_LehrerMehrleistung() {
		super("Statkue_LehrerMehrleistung", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("statkue");
		setJavaClassName("DTOStatkueLehrerMehrleistung");
		setJavaComment("Statkue von IT.NRW Schlüssel für die LehrerMehrleistuung");
	}
