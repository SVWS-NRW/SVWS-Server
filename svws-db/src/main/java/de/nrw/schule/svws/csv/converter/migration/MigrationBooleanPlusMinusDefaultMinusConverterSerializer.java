 ...
 */
public class MigrationBooleanPlusMinusDefaultMinusConverterSerializer extends StdSerializer<Boolean> {
	 ...
	 */
	public MigrationBooleanPlusMinusDefaultMinusConverterSerializer(Class<Boolean> t) {
		super(t);
	}
