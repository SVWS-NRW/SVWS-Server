...
public class Tabelle_Gost_Blockung extends SchemaTabelle {
	...
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("Kursblockung der Gymnasialen Oberstufe: "
	...
	public SchemaTabelleSpalte col_IstAktiv = add("IstAktiv", SchemaDatentypen.INT, false)
		...
		.setJavaComment("Kursblockung der Gymnasialen Oberstufe: "
				+ "Gibt an, ob die Blockung aktiviert wurde oder nicht: 1 - true, 0 - false."
	...
	public SchemaTabelleSpalte col_Vorlage_ID = add("Vorlage_ID", SchemaDatentypen.BIGINT, false)
		.setNotNull()
		.setJavaComment("Kursblockung der Gymnasialen Oberstufe: "
				+ "Die ID des als Vorlage ausgewählten Zwischenergebnisses. Dieses gehört zur Definition"
