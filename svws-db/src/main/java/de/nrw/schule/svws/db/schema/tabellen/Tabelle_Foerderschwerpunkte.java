...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle Foerderschwerpunkte.
 */
public class Tabelle_Foerderschwerpunkte extends SchemaTabelle {

	/** Die Definition der Tabellenspalte ID */
	public SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
		.setNotNull()
		.setJavaComment("ID des Förderschwerpunkts");

	/** Die Definition der Tabellenspalte Kuerzel */
	public SchemaTabelleSpalte col_Kuerzel = add("Kuerzel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
		.setNotNull()
		.setJavaComment("Kürzel des Förderschwerpunkts");
	...
	public SchemaTabelleSpalte col_Beschreibung = add("Beschreibung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
		.setJavaComment("Beschreibung des Förderschwerpunkts");
	...
	/**
	 * Erstellt die Schema-Defintion für die Tabelle Foerderschwerpunkte.
	 */
	public Tabelle_Foerderschwerpunkte() {
		super("Foerderschwerpunkte", SchemaRevisionen.REV_0);
		setMigrate(false);
		setImportExport(false);
		setJavaSubPackage("schild.schule");
		setJavaClassName("DTOAlleFoerderschwerpunkte");
		setJavaComment("Tabelle Förderschwerpunkte");
	}
