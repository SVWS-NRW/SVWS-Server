...
public final class MigrationDTOClientKonfigurationGlobal {
	...
	public static final String QUERY_ALL = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e";

	/** Die Datenbankabfrage für DTOs anhand der Primärschlüsselattribute */
	public static final String QUERY_PK = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.AppName = ?1 AND e.Schluessel = ?2";

	/** Die Datenbankabfrage für alle DTOs im Rahmen der Migration, wobei die Einträge entfernt werden, die nicht der Primärschlüssel-Constraint entsprechen */
	public static final String QUERY_MIGRATION_ALL = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.AppName IS NOT NULL AND e.Schluessel IS NOT NULL";

	/** Die Datenbankabfrage für DTOs anhand des Attributes AppName */
	public static final String QUERY_BY_APPNAME = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.AppName = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes AppName */
	public static final String QUERY_LIST_BY_APPNAME = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.AppName IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Schluessel */
	public static final String QUERY_BY_SCHLUESSEL = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.Schluessel = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Schluessel */
	public static final String QUERY_LIST_BY_SCHLUESSEL = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.Schluessel IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Wert */
	public static final String QUERY_BY_WERT = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.Wert = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Wert */
	public static final String QUERY_LIST_BY_WERT = "SELECT e FROM MigrationDTOClientKonfigurationGlobal e WHERE e.Wert IN ?1";
