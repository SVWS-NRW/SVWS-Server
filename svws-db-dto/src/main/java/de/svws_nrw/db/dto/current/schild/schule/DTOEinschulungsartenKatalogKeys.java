...
@NamedQuery(name = "DTOEinschulungsartenKatalogKeys.primaryKeyQuery.multiple", query = "SELECT e FROM DTOEinschulungsartenKatalogKeys e WHERE e.Kuerzel IN :value")
