...
public final class MigrationDTOSchuelerZP10 {
	...
	public static final String QUERY_ALL = "SELECT e FROM MigrationDTOSchuelerZP10 e";

	/** Die Datenbankabfrage für DTOs anhand der Primärschlüsselattribute */
	public static final String QUERY_PK = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Primärschlüsselattributwerten */
	public static final String QUERY_LIST_PK = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.ID IN ?1";

	/** Die Datenbankabfrage für alle DTOs im Rahmen der Migration, wobei die Einträge entfernt werden, die nicht der Primärschlüssel-Constraint entsprechen */
	public static final String QUERY_MIGRATION_ALL = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.ID IS NOT NULL";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ID */
	public static final String QUERY_BY_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ID */
	public static final String QUERY_LIST_BY_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Schueler_ID */
	public static final String QUERY_BY_SCHUELER_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Schueler_ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Schueler_ID */
	public static final String QUERY_LIST_BY_SCHUELER_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Schueler_ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Schuljahresabschnitts_ID */
	public static final String QUERY_BY_SCHULJAHRESABSCHNITTS_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Schuljahresabschnitts_ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Schuljahresabschnitts_ID */
	public static final String QUERY_LIST_BY_SCHULJAHRESABSCHNITTS_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Schuljahresabschnitts_ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Fach_ID */
	public static final String QUERY_BY_FACH_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Fach_ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Fach_ID */
	public static final String QUERY_LIST_BY_FACH_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Fach_ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Vornote */
	public static final String QUERY_BY_VORNOTE = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Vornote = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Vornote */
	public static final String QUERY_LIST_BY_VORNOTE = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Vornote IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes NoteSchriftlich */
	public static final String QUERY_BY_NOTESCHRIFTLICH = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.NoteSchriftlich = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes NoteSchriftlich */
	public static final String QUERY_LIST_BY_NOTESCHRIFTLICH = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.NoteSchriftlich IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes MdlPruefung */
	public static final String QUERY_BY_MDLPRUEFUNG = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.MdlPruefung = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes MdlPruefung */
	public static final String QUERY_LIST_BY_MDLPRUEFUNG = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.MdlPruefung IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes MdlPruefungFW */
	public static final String QUERY_BY_MDLPRUEFUNGFW = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.MdlPruefungFW = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes MdlPruefungFW */
	public static final String QUERY_LIST_BY_MDLPRUEFUNGFW = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.MdlPruefungFW IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes NoteMuendlich */
	public static final String QUERY_BY_NOTEMUENDLICH = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.NoteMuendlich = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes NoteMuendlich */
	public static final String QUERY_LIST_BY_NOTEMUENDLICH = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.NoteMuendlich IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes NoteAbschluss */
	public static final String QUERY_BY_NOTEABSCHLUSS = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.NoteAbschluss = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes NoteAbschluss */
	public static final String QUERY_LIST_BY_NOTEABSCHLUSS = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.NoteAbschluss IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Fachlehrer_ID */
	public static final String QUERY_BY_FACHLEHRER_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Fachlehrer_ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Fachlehrer_ID */
	public static final String QUERY_LIST_BY_FACHLEHRER_ID = "SELECT e FROM MigrationDTOSchuelerZP10 e WHERE e.Fachlehrer_ID IN ?1";
