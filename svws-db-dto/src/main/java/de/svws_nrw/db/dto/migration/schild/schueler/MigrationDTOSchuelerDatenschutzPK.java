 ...
 */
public final class MigrationDTOSchuelerDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOSchuelerDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOSchuelerDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOSchuelerDatenschutzPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Datenschutz_ID   der Wert für das Attribut Datenschutz_ID
	 */
	public MigrationDTOSchuelerDatenschutzPK(final Long Schueler_ID, final Long Datenschutz_ID) {
		if (Schueler_ID == null) {
	...
	public boolean equals(final Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOSchuelerDatenschutzPK other = (MigrationDTOSchuelerDatenschutzPK) obj;
		if (Schueler_ID == null) {
