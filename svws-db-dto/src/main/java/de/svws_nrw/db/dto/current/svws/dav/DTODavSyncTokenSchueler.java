...
public final class DTODavSyncTokenSchueler {
	...
	public static final String QUERY_ALL = "SELECT e FROM DTODavSyncTokenSchueler e";

	/** Die Datenbankabfrage für DTOs anhand der Primärschlüsselattribute */
	public static final String QUERY_PK = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Primärschlüsselattributwerten */
	public static final String QUERY_LIST_PK = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.ID IN ?1";

	/** Die Datenbankabfrage für alle DTOs im Rahmen der Migration, wobei die Einträge entfernt werden, die nicht der Primärschlüssel-Constraint entsprechen */
	public static final String QUERY_MIGRATION_ALL = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.ID IS NOT NULL";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ID */
	public static final String QUERY_BY_ID = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ID */
	public static final String QUERY_LIST_BY_ID = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes SyncToken */
	public static final String QUERY_BY_SYNCTOKEN = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.SyncToken = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes SyncToken */
	public static final String QUERY_LIST_BY_SYNCTOKEN = "SELECT e FROM DTODavSyncTokenSchueler e WHERE e.SyncToken IN ?1";
