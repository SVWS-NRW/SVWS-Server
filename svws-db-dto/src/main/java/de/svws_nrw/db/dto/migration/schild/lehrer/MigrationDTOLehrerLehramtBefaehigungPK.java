 ...
 */
public class MigrationDTOLehrerLehramtBefaehigungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOLehrerLehramtBefaehigungPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOLehrerLehramtBefaehigungPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param LehrbefKrz   der Wert für das Attribut LehrbefKrz
	 */
	public MigrationDTOLehrerLehramtBefaehigungPK(final Long Lehrer_ID, final String LehrbefKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOLehrerLehramtBefaehigungPK other = (MigrationDTOLehrerLehramtBefaehigungPK) obj;
		if (Lehrer_ID == null) {
