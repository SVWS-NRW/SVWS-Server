...
@NamedQuery(name = "MigrationDTOKursFortschreibungsart.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOKursFortschreibungsart e WHERE e.ID IN :value")
