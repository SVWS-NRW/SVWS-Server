 ...
 */
public final class MigrationDTOBerufskollegFachklassenKeysPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOBerufskollegFachklassenKeysPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOBerufskollegFachklassenKeysPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOBerufskollegFachklassenKeysPK.
	 ...
	 */
	public MigrationDTOBerufskollegFachklassenKeysPK(final Integer FachklassenIndex, final String Schluessel, final String Schluessel2) {
