...
public final class DTOBetrieb {

	/** Die Datenbankabfrage für alle DTOs */
	public static final String QUERY_ALL = "SELECT e FROM DTOBetrieb e";

	/** Die Datenbankabfrage für DTOs anhand der Primärschlüsselattribute */
	public static final String QUERY_PK = "SELECT e FROM DTOBetrieb e WHERE e.ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Primärschlüsselattributwerten */
	public static final String QUERY_LIST_PK = "SELECT e FROM DTOBetrieb e WHERE e.ID IN ?1";

	/** Die Datenbankabfrage für alle DTOs im Rahmen der Migration, wobei die Einträge entfernt werden, die nicht der Primärschlüssel-Constraint entsprechen */
	public static final String QUERY_MIGRATION_ALL = "SELECT e FROM DTOBetrieb e WHERE e.ID IS NOT NULL";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ID */
	public static final String QUERY_BY_ID = "SELECT e FROM DTOBetrieb e WHERE e.ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ID */
	public static final String QUERY_LIST_BY_ID = "SELECT e FROM DTOBetrieb e WHERE e.ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes adressArt */
	public static final String QUERY_BY_ADRESSART = "SELECT e FROM DTOBetrieb e WHERE e.adressArt = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes adressArt */
	public static final String QUERY_LIST_BY_ADRESSART = "SELECT e FROM DTOBetrieb e WHERE e.adressArt IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes name1 */
	public static final String QUERY_BY_NAME1 = "SELECT e FROM DTOBetrieb e WHERE e.name1 = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes name1 */
	public static final String QUERY_LIST_BY_NAME1 = "SELECT e FROM DTOBetrieb e WHERE e.name1 IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes name2 */
	public static final String QUERY_BY_NAME2 = "SELECT e FROM DTOBetrieb e WHERE e.name2 = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes name2 */
	public static final String QUERY_LIST_BY_NAME2 = "SELECT e FROM DTOBetrieb e WHERE e.name2 IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes strassenname */
	public static final String QUERY_BY_STRASSENNAME = "SELECT e FROM DTOBetrieb e WHERE e.strassenname = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes strassenname */
	public static final String QUERY_LIST_BY_STRASSENNAME = "SELECT e FROM DTOBetrieb e WHERE e.strassenname IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes hausnr */
	public static final String QUERY_BY_HAUSNR = "SELECT e FROM DTOBetrieb e WHERE e.hausnr = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes hausnr */
	public static final String QUERY_LIST_BY_HAUSNR = "SELECT e FROM DTOBetrieb e WHERE e.hausnr IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes hausnrzusatz */
	public static final String QUERY_BY_HAUSNRZUSATZ = "SELECT e FROM DTOBetrieb e WHERE e.hausnrzusatz = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes hausnrzusatz */
	public static final String QUERY_LIST_BY_HAUSNRZUSATZ = "SELECT e FROM DTOBetrieb e WHERE e.hausnrzusatz IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ort_id */
	public static final String QUERY_BY_ORT_ID = "SELECT e FROM DTOBetrieb e WHERE e.ort_id = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ort_id */
	public static final String QUERY_LIST_BY_ORT_ID = "SELECT e FROM DTOBetrieb e WHERE e.ort_id IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ortsteil_id */
	public static final String QUERY_BY_ORTSTEIL_ID = "SELECT e FROM DTOBetrieb e WHERE e.ortsteil_id = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ortsteil_id */
	public static final String QUERY_LIST_BY_ORTSTEIL_ID = "SELECT e FROM DTOBetrieb e WHERE e.ortsteil_id IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes telefon1 */
	public static final String QUERY_BY_TELEFON1 = "SELECT e FROM DTOBetrieb e WHERE e.telefon1 = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes telefon1 */
	public static final String QUERY_LIST_BY_TELEFON1 = "SELECT e FROM DTOBetrieb e WHERE e.telefon1 IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes telefon2 */
	public static final String QUERY_BY_TELEFON2 = "SELECT e FROM DTOBetrieb e WHERE e.telefon2 = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes telefon2 */
	public static final String QUERY_LIST_BY_TELEFON2 = "SELECT e FROM DTOBetrieb e WHERE e.telefon2 IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes fax */
	public static final String QUERY_BY_FAX = "SELECT e FROM DTOBetrieb e WHERE e.fax = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes fax */
	public static final String QUERY_LIST_BY_FAX = "SELECT e FROM DTOBetrieb e WHERE e.fax IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes email */
	public static final String QUERY_BY_EMAIL = "SELECT e FROM DTOBetrieb e WHERE e.email = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes email */
	public static final String QUERY_LIST_BY_EMAIL = "SELECT e FROM DTOBetrieb e WHERE e.email IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes bemerkungen */
	public static final String QUERY_BY_BEMERKUNGEN = "SELECT e FROM DTOBetrieb e WHERE e.bemerkungen = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes bemerkungen */
	public static final String QUERY_LIST_BY_BEMERKUNGEN = "SELECT e FROM DTOBetrieb e WHERE e.bemerkungen IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes sortierung */
	public static final String QUERY_BY_SORTIERUNG = "SELECT e FROM DTOBetrieb e WHERE e.sortierung = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes sortierung */
	public static final String QUERY_LIST_BY_SORTIERUNG = "SELECT e FROM DTOBetrieb e WHERE e.sortierung IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ausbildungsbetrieb */
	public static final String QUERY_BY_AUSBILDUNGSBETRIEB = "SELECT e FROM DTOBetrieb e WHERE e.ausbildungsbetrieb = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ausbildungsbetrieb */
	public static final String QUERY_LIST_BY_AUSBILDUNGSBETRIEB = "SELECT e FROM DTOBetrieb e WHERE e.ausbildungsbetrieb IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes bietetPraktika */
	public static final String QUERY_BY_BIETETPRAKTIKA = "SELECT e FROM DTOBetrieb e WHERE e.bietetPraktika = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes bietetPraktika */
	public static final String QUERY_LIST_BY_BIETETPRAKTIKA = "SELECT e FROM DTOBetrieb e WHERE e.bietetPraktika IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes branche */
	public static final String QUERY_BY_BRANCHE = "SELECT e FROM DTOBetrieb e WHERE e.branche = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes branche */
	public static final String QUERY_LIST_BY_BRANCHE = "SELECT e FROM DTOBetrieb e WHERE e.branche IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes zusatz1 */
	public static final String QUERY_BY_ZUSATZ1 = "SELECT e FROM DTOBetrieb e WHERE e.zusatz1 = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes zusatz1 */
	public static final String QUERY_LIST_BY_ZUSATZ1 = "SELECT e FROM DTOBetrieb e WHERE e.zusatz1 IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes zusatz2 */
	public static final String QUERY_BY_ZUSATZ2 = "SELECT e FROM DTOBetrieb e WHERE e.zusatz2 = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes zusatz2 */
	public static final String QUERY_LIST_BY_ZUSATZ2 = "SELECT e FROM DTOBetrieb e WHERE e.zusatz2 IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Sichtbar */
	public static final String QUERY_BY_SICHTBAR = "SELECT e FROM DTOBetrieb e WHERE e.Sichtbar = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Sichtbar */
	public static final String QUERY_LIST_BY_SICHTBAR = "SELECT e FROM DTOBetrieb e WHERE e.Sichtbar IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Aenderbar */
	public static final String QUERY_BY_AENDERBAR = "SELECT e FROM DTOBetrieb e WHERE e.Aenderbar = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Aenderbar */
	public static final String QUERY_LIST_BY_AENDERBAR = "SELECT e FROM DTOBetrieb e WHERE e.Aenderbar IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes Massnahmentraeger */
	public static final String QUERY_BY_MASSNAHMENTRAEGER = "SELECT e FROM DTOBetrieb e WHERE e.Massnahmentraeger = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes Massnahmentraeger */
	public static final String QUERY_LIST_BY_MASSNAHMENTRAEGER = "SELECT e FROM DTOBetrieb e WHERE e.Massnahmentraeger IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes BelehrungISG */
	public static final String QUERY_BY_BELEHRUNGISG = "SELECT e FROM DTOBetrieb e WHERE e.BelehrungISG = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes BelehrungISG */
	public static final String QUERY_LIST_BY_BELEHRUNGISG = "SELECT e FROM DTOBetrieb e WHERE e.BelehrungISG IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes GU_ID */
	public static final String QUERY_BY_GU_ID = "SELECT e FROM DTOBetrieb e WHERE e.GU_ID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes GU_ID */
	public static final String QUERY_LIST_BY_GU_ID = "SELECT e FROM DTOBetrieb e WHERE e.GU_ID IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ErwFuehrungszeugnis */
	public static final String QUERY_BY_ERWFUEHRUNGSZEUGNIS = "SELECT e FROM DTOBetrieb e WHERE e.ErwFuehrungszeugnis = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ErwFuehrungszeugnis */
	public static final String QUERY_LIST_BY_ERWFUEHRUNGSZEUGNIS = "SELECT e FROM DTOBetrieb e WHERE e.ErwFuehrungszeugnis IN ?1";

	/** Die Datenbankabfrage für DTOs anhand des Attributes ExtID */
	public static final String QUERY_BY_EXTID = "SELECT e FROM DTOBetrieb e WHERE e.ExtID = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes ExtID */
	public static final String QUERY_LIST_BY_EXTID = "SELECT e FROM DTOBetrieb e WHERE e.ExtID IN ?1";
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOBetrieb ohne eine Initialisierung der Attribute.
	 */
	 ...
	 */
	public DTOBetrieb(final long ID) {
		this.ID = ID;
	}
