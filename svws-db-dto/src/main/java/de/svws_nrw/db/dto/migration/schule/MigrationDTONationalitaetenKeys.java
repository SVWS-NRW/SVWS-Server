...
public final class MigrationDTONationalitaetenKeys {
	...
	public static final String QUERY_ALL = "SELECT e FROM MigrationDTONationalitaetenKeys e";

	/** Die Datenbankabfrage für DTOs anhand der Primärschlüsselattribute */
	public static final String QUERY_PK = "SELECT e FROM MigrationDTONationalitaetenKeys e WHERE e.DEStatisCode = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Primärschlüsselattributwerten */
	public static final String QUERY_LIST_PK = "SELECT e FROM MigrationDTONationalitaetenKeys e WHERE e.DEStatisCode IN ?1";

	/** Die Datenbankabfrage für alle DTOs im Rahmen der Migration, wobei die Einträge entfernt werden, die nicht der Primärschlüssel-Constraint entsprechen */
	public static final String QUERY_MIGRATION_ALL = "SELECT e FROM MigrationDTONationalitaetenKeys e WHERE e.DEStatisCode IS NOT NULL";

	/** Die Datenbankabfrage für DTOs anhand des Attributes DEStatisCode */
	public static final String QUERY_BY_DESTATISCODE = "SELECT e FROM MigrationDTONationalitaetenKeys e WHERE e.DEStatisCode = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes DEStatisCode */
	public static final String QUERY_LIST_BY_DESTATISCODE = "SELECT e FROM MigrationDTONationalitaetenKeys e WHERE e.DEStatisCode IN ?1";
