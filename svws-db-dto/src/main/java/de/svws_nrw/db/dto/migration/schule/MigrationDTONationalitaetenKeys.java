...
@NamedQuery(name = "MigrationDTONationalitaetenKeys.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTONationalitaetenKeys e WHERE e.DEStatisCode IN :value")
