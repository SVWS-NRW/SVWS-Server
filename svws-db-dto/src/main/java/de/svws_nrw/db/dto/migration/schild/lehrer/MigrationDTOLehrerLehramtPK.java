 ...
 */
public class MigrationDTOLehrerLehramtPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOLehrerLehramtPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOLehrerLehramtPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param LehramtKrz   der Wert für das Attribut LehramtKrz
	 */
	public MigrationDTOLehrerLehramtPK(final Long Lehrer_ID, final String LehramtKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOLehrerLehramtPK other = (MigrationDTOLehrerLehramtPK) obj;
		if (Lehrer_ID == null) {
