...
@JsonPropertyOrder({"ErzieherID", "LernplattformID", "CredentialID", "EinwilligungenAbgefragt", "EinwilligungNutzung", "EinwilligungAudiokonferenz", "EinwilligungVideokonferenz", "SchulnrEigner"})
public final class MigrationDTOErzieherLernplattform {
	...
	public static final String QUERY_BY_EINWILLIGUNGENABGEFRAGT = "SELECT e FROM MigrationDTOErzieherLernplattform e WHERE e.EinwilligungenAbgefragt = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes EinwilligungenAbgefragt */
	public static final String QUERY_LIST_BY_EINWILLIGUNGENABGEFRAGT = "SELECT e FROM MigrationDTOErzieherLernplattform e WHERE e.EinwilligungenAbgefragt IN ?1";
	 ...
	 */
	public MigrationDTOErzieherLernplattform(final Long ErzieherID, final Long LernplattformID, final Boolean EinwilligungenAbgefragt, final Boolean EinwilligungNutzung, final Boolean EinwilligungAudiokonferenz, final Boolean EinwilligungVideokonferenz) {
		if (ErzieherID == null) {
