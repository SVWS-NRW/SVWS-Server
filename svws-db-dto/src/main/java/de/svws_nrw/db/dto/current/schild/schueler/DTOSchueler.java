...
public final class DTOSchueler {
	...
	/** Die Datenbankabfrage für DTOs anhand des Attributes idHochschulabschluss */
	public static final String QUERY_BY_IDHOCHSCHULABSCHLUSS = "SELECT e FROM DTOSchueler e WHERE e.idHochschulabschluss = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes idHochschulabschluss */
	public static final String QUERY_LIST_BY_IDHOCHSCHULABSCHLUSS = "SELECT e FROM DTOSchueler e WHERE e.idHochschulabschluss IN ?1";
	...
	/** Die Id des Hochschulabschlusses */
	@Column(name = "ID_Hochschulabschluss")
	@JsonProperty
