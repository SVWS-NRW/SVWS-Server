...
@NamedQuery(name = "MigrationDTOOrganisationsformenKatalogKeys.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOOrganisationsformenKatalogKeys e WHERE e.Kuerzel IN ?1")
