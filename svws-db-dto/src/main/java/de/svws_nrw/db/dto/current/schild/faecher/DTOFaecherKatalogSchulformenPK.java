 ...
 */
public class DTOFaecherKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOFaecherKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOFaecherKatalogSchulformenPK.
	 ...
	 */
	public DTOFaecherKatalogSchulformenPK(final Long Fach_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
		if (Fach_ID == null) { 
