...
/**
 * Diese Klasse dient als DTO für den Primärschlüssel der Datenbanktabelle Gost_Jahrgang_Fachwahlen.
...
public final class DTOGostJahrgangFachbelegungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOGostJahrgangFachbelegungenPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOGostJahrgangFachbelegungenPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public DTOGostJahrgangFachbelegungenPK(final int Abi_Jahrgang, final long Fach_ID) {
	...
	public boolean equals(final Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOGostJahrgangFachbelegungenPK other = (DTOGostJahrgangFachbelegungenPK) obj;
