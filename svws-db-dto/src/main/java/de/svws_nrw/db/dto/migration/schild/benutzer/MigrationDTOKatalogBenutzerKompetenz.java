...
@NamedQuery(name = "MigrationDTOKatalogBenutzerKompetenz.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOKatalogBenutzerKompetenz e WHERE e.KO_ID IN :value")
