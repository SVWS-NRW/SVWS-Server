...
@NamedQuery(name = "MigrationDTOBerufskollegBerufsebenen1.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOBerufskollegBerufsebenen1 e WHERE e.ID IN ?1")
