...
@NamedQuery(name = "DTOGostKlausurenRaeumeStundenAufsichten.primaryKeyQuery.multiple", query = "SELECT e FROM DTOGostKlausurenRaeumeStundenAufsichten e WHERE e.ID IN ?1")
