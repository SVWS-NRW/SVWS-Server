...
@NamedQuery(name = "MigrationDTOAnsprechpartnerAllgemeineAdresse.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOAnsprechpartnerAllgemeineAdresse e WHERE e.ID IN ?1")
