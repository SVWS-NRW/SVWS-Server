...
@NamedQuery(name = "MigrationDTOSchuelerIndividuelleGruppe.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOSchuelerIndividuelleGruppe e WHERE e.ID IN ?1")
