...
@NamedQuery(name = "DTOAllgemeineMerkmaleKatalogKeys.primaryKeyQuery.multiple", query = "SELECT e FROM DTOAllgemeineMerkmaleKatalogKeys e WHERE e.Kuerzel IN :value")
