...
public class MigrationDTOClientKonfigurationBenutzer {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOClientKonfigurationBenutzer ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOClientKonfigurationBenutzer() {
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOClientKonfigurationBenutzer other = (MigrationDTOClientKonfigurationBenutzer) obj;
		if (Benutzer_ID == null) {
	...
	public String toString() {
		return "MigrationDTOClientKonfigurationBenutzer(Benutzer_ID=" + this.Benutzer_ID + ", AppName=" + this.AppName + ", Schluessel=" + this.Schluessel + ", Wert=" + this.Wert + ")";
	}
