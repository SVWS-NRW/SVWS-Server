...
@NamedQuery(name = "DTOStundenplanPausenaufsichtenBereiche.primaryKeyQuery.multiple", query = "SELECT e FROM DTOStundenplanPausenaufsichtenBereiche e WHERE e.ID IN ?1")
