...
public final class MigrationDTOSchueler {
	...
	public static final String QUERY_BY_IDSTATUS = "SELECT e FROM MigrationDTOSchueler e WHERE e.idStatus = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes idStatus */
	public static final String QUERY_LIST_BY_IDSTATUS = "SELECT e FROM MigrationDTOSchueler e WHERE e.idStatus IN ?1";
	...
	/** Die Datenbankabfrage für DTOs anhand des Attributes SchulgliederungKuerzel */
	public static final String QUERY_BY_SCHULGLIEDERUNGKUERZEL = "SELECT e FROM MigrationDTOSchueler e WHERE e.SchulgliederungKuerzel = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes SchulgliederungKuerzel */
	public static final String QUERY_LIST_BY_SCHULGLIEDERUNGKUERZEL = "SELECT e FROM MigrationDTOSchueler e WHERE e.SchulgliederungKuerzel IN ?1";
	...
	@JsonProperty
	public String SchulgliederungKuerzel;
