...
@NamedQuery(name = "MigrationDTOLehrerAnrechnungsstunde.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOLehrerAnrechnungsstunde e WHERE e.ID IN ?1")
