...
@NamedQuery(name = "MigrationDTOKatalogBenutzerKompetenzGruppe.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOKatalogBenutzerKompetenzGruppe e WHERE e.KG_ID IN ?1")
