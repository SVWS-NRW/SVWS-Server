...
@NamedQuery(name = "MigrationDTOSchuelerPSFachBemerkungen.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOSchuelerPSFachBemerkungen e WHERE e.ID IN ?1")
