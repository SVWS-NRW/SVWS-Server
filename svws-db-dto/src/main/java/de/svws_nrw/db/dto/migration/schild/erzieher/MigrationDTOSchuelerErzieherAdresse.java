...
@NamedQuery(name = "MigrationDTOSchuelerErzieherAdresse.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOSchuelerErzieherAdresse e WHERE e.ID IN ?1")
