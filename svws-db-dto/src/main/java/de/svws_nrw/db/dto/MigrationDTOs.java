...
import de.svws_nrw.db.dto.migration.schild.katalog.MigrationDTOLeitungsfunktion;
...
import de.svws_nrw.db.dto.migration.schild.katalog.MigrationDTOReligion;
import de.svws_nrw.db.dto.migration.schild.katalog.MigrationDTOSchuelerSchwerpunkt;
     ...
     */
     private static HashMap<String, Class<? extends Object>> getMapDTOName2DTOClass() {
         if (mapDTOName2DTOClass == null) {
             ...
             mapDTOName2DTOClass.put(MigrationDTOLeitungsfunktion.class.getSimpleName(), MigrationDTOLeitungsfunktion.class);
             ...
             mapDTOName2DTOClass.put(MigrationDTOSchuelerSchwerpunkt.class.getSimpleName(), MigrationDTOSchuelerSchwerpunkt.class);
     ...
     */
     private static HashMap<String, Class<? extends Object>> getMapTablename2DTOClass() {
         if (mapTablename2DTOClass == null) {
             ...
             mapTablename2DTOClass.put("K_Schulfunktionen", MigrationDTOLeitungsfunktion.class);
             mapTablename2DTOClass.put("K_Ort", MigrationDTOOrt.class);
             mapTablename2DTOClass.put("K_Ortsteil", MigrationDTOOrtsteil.class);
             mapTablename2DTOClass.put("K_Religion", MigrationDTOReligion.class);
             mapTablename2DTOClass.put("K_Schwerpunkt", MigrationDTOSchuelerSchwerpunkt.class);
