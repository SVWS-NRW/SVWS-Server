...
@NamedQuery(name = "MigrationDTOLehrerLeitungsfunktionKeys.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOLehrerLeitungsfunktionKeys e WHERE e.ID IN ?1")
