...
@NamedQuery(name = "MigrationDTOCredentialsLernplattformen.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOCredentialsLernplattformen e WHERE e.ID IN ?1")
