...
@NamedQuery(name = "MigrationDTOKursartenKatalogKeys.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOKursartenKatalogKeys e WHERE e.Kuerzel IN :value")
