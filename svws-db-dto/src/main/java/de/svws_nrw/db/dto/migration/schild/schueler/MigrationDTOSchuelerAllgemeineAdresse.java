...
@NamedQuery(name = "MigrationDTOSchuelerAllgemeineAdresse.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOSchuelerAllgemeineAdresse e WHERE e.ID IN :value")
