...
@NamedQuery(name = "MigrationDTOSchemaCoreTypeVersion.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOSchemaCoreTypeVersion e WHERE e.NameTabelle IN ?1")
