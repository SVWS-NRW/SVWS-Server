...
@NamedQuery(name = "MigrationDTOKAoAAnschlussoptionKeys.primaryKeyQuery.multiple", query = "SELECT e FROM MigrationDTOKAoAAnschlussoptionKeys e WHERE e.ID IN :value")
