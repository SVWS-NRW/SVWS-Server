 ...
 */
public class Rev8DTOEigeneImporteTabellenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOEigeneImporteTabellenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOEigeneImporteTabellenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOEigeneImporteTabellenPK.
	 * @param Import_ID   der Wert für das Attribut Import_ID
	 * @param TableName   der Wert für das Attribut TableName
	 */
	public Rev8DTOEigeneImporteTabellenPK(final Integer Import_ID, final String TableName) {
		if (Import_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOEigeneImporteTabellenPK other = (Rev8DTOEigeneImporteTabellenPK) obj;
		if (Import_ID == null) {
