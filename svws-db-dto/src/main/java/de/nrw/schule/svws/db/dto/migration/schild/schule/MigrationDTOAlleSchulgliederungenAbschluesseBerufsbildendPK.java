 ...
 */
public class MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK.
	 ...
	 */
	public MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK(final Long Schulgliederung_ID, final String Abschluss_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK other = (MigrationDTOAlleSchulgliederungenAbschluesseBerufsbildendPK) obj;
		if (Schulgliederung_ID == null) {
