 ...
 */
public class DevDTOFaecherKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOFaecherKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOFaecherKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOFaecherKatalogSchulformenPK.
	 ...
	 */
	public DevDTOFaecherKatalogSchulformenPK(final Long Fach_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
		if (Fach_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOFaecherKatalogSchulformenPK other = (DevDTOFaecherKatalogSchulformenPK) obj;
		if (Fach_ID == null) {
