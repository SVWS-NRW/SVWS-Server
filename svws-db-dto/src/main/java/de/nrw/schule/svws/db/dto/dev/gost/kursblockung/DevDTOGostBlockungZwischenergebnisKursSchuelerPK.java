 ...
 */
public class DevDTOGostBlockungZwischenergebnisKursSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostBlockungZwischenergebnisKursSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostBlockungZwischenergebnisKursSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostBlockungZwischenergebnisKursSchuelerPK.
	 ...
	 */
	public DevDTOGostBlockungZwischenergebnisKursSchuelerPK(final Long Zwischenergebnis_ID, final Long Blockung_Kurs_ID, final Long Schueler_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostBlockungZwischenergebnisKursSchuelerPK other = (DevDTOGostBlockungZwischenergebnisKursSchuelerPK) obj;
		if (Zwischenergebnis_ID == null) {
