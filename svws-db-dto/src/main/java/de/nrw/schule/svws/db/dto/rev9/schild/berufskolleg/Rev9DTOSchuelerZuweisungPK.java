 ...
 */
public class Rev9DTOSchuelerZuweisungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOSchuelerZuweisungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOSchuelerZuweisungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOSchuelerZuweisungPK.
	 * @param Abschnitt_ID   der Wert für das Attribut Abschnitt_ID
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public Rev9DTOSchuelerZuweisungPK(final Long Abschnitt_ID, final Long Fach_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOSchuelerZuweisungPK other = (Rev9DTOSchuelerZuweisungPK) obj;
		if (Abschnitt_ID == null) {
