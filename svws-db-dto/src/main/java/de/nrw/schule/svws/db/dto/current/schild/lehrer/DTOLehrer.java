...
@NamedQuery(name="DTOLehrer.masernimpfnachweis", query="SELECT e FROM DTOLehrer e WHERE e.MasernImpfnachweis = :value")
@NamedQuery(name="DTOLehrer.masernimpfnachweis.multiple", query="SELECT e FROM DTOLehrer e WHERE e.MasernImpfnachweis IN :value")
