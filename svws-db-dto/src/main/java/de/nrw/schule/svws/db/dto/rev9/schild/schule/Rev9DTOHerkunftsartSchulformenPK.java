 ...
 */
public class Rev9DTOHerkunftsartSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOHerkunftsartSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOHerkunftsartSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOHerkunftsartSchulformenPK.
	 ...
	 */
	public Rev9DTOHerkunftsartSchulformenPK(final Long Herkunftsart_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOHerkunftsartSchulformenPK other = (Rev9DTOHerkunftsartSchulformenPK) obj;
		if (Herkunftsart_ID == null) {
