 ...
 */
public class Rev9DTOLehrerLehramtPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOLehrerLehramtPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOLehrerLehramtPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOLehrerLehramtPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param LehramtKrz   der Wert für das Attribut LehramtKrz
	 */
	public Rev9DTOLehrerLehramtPK(final Long Lehrer_ID, final String LehramtKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOLehrerLehramtPK other = (Rev9DTOLehrerLehramtPK) obj;
		if (Lehrer_ID == null) {
