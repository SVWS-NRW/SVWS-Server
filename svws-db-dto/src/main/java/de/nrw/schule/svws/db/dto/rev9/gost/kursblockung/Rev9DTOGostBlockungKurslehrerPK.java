 ...
 */
public class Rev9DTOGostBlockungKurslehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungKurslehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostBlockungKurslehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungKurslehrerPK.
	 * @param Blockung_Kurs_ID   der Wert für das Attribut Blockung_Kurs_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev9DTOGostBlockungKurslehrerPK(final Long Blockung_Kurs_ID, final Long Lehrer_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostBlockungKurslehrerPK other = (Rev9DTOGostBlockungKurslehrerPK) obj;
		if (Blockung_Kurs_ID == null) {
