 ...
 */
public class Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK.
	 ...
	 */
	public Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK(final Long Zwischenergebnis_ID, final Long Blockung_Kurs_ID, final Long Schueler_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK other = (Rev9DTOGostBlockungZwischenergebnisKursSchuelerPK) obj;
		if (Zwischenergebnis_ID == null) {
