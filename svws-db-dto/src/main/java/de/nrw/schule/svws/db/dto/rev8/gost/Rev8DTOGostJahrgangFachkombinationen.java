 ...
 */
@Entity
@IdClass(Rev8DTOGostJahrgangFachkombinationenPK.class)
...
@NamedQuery(name="Rev8DTOGostJahrgangFachkombinationen.phase", query="SELECT e FROM Rev8DTOGostJahrgangFachkombinationen e WHERE e.Phase = :value")
@NamedQuery(name="Rev8DTOGostJahrgangFachkombinationen.phase.multiple", query="SELECT e FROM Rev8DTOGostJahrgangFachkombinationen e WHERE e.Phase IN :value")
...
@NamedQuery(name="Rev8DTOGostJahrgangFachkombinationen.primaryKeyQuery", query="SELECT e FROM Rev8DTOGostJahrgangFachkombinationen e WHERE e.Abi_Jahrgang = ?1 AND e.ID = ?2")
@NamedQuery(name="Rev8DTOGostJahrgangFachkombinationen.all.migration", query="SELECT e FROM Rev8DTOGostJahrgangFachkombinationen e WHERE e.Abi_Jahrgang IS NOT NULL AND e.ID IS NOT NULL")
...
public class Rev8DTOGostJahrgangFachkombinationen {
	 ...
	 */
	public Rev8DTOGostJahrgangFachkombinationen(final Integer Abi_Jahrgang, final String ID, final Long Fach1_ID, final Long Fach2_ID, final String Phase, final Integer Typ) {
	...
	public String toString() {
		return "Rev8DTOGostJahrgangFachkombinationen(Abi_Jahrgang=" + this.Abi_Jahrgang + ", ID=" + this.ID + ", Fach1_ID=" + this.Fach1_ID + ", Fach2_ID=" + this.Fach2_ID + ", Kursart1=" + this.Kursart1 + ", Kursart2=" + this.Kursart2 + ", Phase=" + this.Phase + ", Typ=" + this.Typ + ")";
	}
