 ...
 */
public class Rev9DTOEigeneImporteFelderPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOEigeneImporteFelderPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOEigeneImporteFelderPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOEigeneImporteFelderPK.
	 * @param Import_ID   der Wert für das Attribut Import_ID
	 * @param Field_ID   der Wert für das Attribut Field_ID
	 */
	public Rev9DTOEigeneImporteFelderPK(final Integer Import_ID, final Integer Field_ID) {
		if (Import_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOEigeneImporteFelderPK other = (Rev9DTOEigeneImporteFelderPK) obj;
		if (Import_ID == null) {
