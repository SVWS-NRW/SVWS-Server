package de.nrw.schule.svws.db.dto.current.views.benutzer;

import java.io.Serializable;

/**
 * Diese Klasse dient als DTO für den Primärschlüssel der Datenbank-View V_Benutzerkompetenzen.
 * Sie wurde automatisch per Skript generiert und sollte nicht verändert werden, 
 * da sie aufgrund von Änderungen am DB-Schema ggf. neu generiert und überschrieben wird.
 */
public class DTOViewBenutzerKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOViewBenutzerKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOViewBenutzerKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOViewBenutzerKompetenzPK.
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public DTOViewBenutzerKompetenzPK(final Long Benutzer_ID, final Long Kompetenz_ID) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOViewBenutzerKompetenzPK other = (DTOViewBenutzerKompetenzPK) obj;
		if (Benutzer_ID == null) {
