...
@NamedQuery(name="DTOStatkueBilingual.primaryKeyQuery", query="SELECT e FROM DTOStatkueBilingual e WHERE e.Fach = ?1 AND e.SF = ?2")
@NamedQuery(name="DTOStatkueBilingual.all.migration", query="SELECT e FROM DTOStatkueBilingual e WHERE e.Fach IS NOT NULL AND e.SF IS NOT NULL")
