 ...
 */
public class Rev8DTOInternDQRNiveausPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternDQRNiveausPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOInternDQRNiveausPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternDQRNiveausPK.
	 ...
	 */
	public Rev8DTOInternDQRNiveausPK(final String Gliederung, final String FKS, final Integer DQR_Niveau) {
		if (Gliederung == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOInternDQRNiveausPK other = (Rev8DTOInternDQRNiveausPK) obj;
		if (Gliederung == null) {
