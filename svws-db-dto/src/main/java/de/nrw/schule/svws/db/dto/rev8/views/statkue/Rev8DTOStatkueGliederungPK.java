 ...
 */
public class Rev8DTOStatkueGliederungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueGliederungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOStatkueGliederungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueGliederungPK.
	 ...
	 */
	public Rev8DTOStatkueGliederungPK(final String SF, final String Flag, final String BKAnlage, final String BKTyp) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOStatkueGliederungPK other = (Rev8DTOStatkueGliederungPK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
