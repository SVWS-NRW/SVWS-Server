 ...
 */
public class MigrationDTOKlassenLeitungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOKlassenLeitungPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOKlassenLeitungPK.
	 * @param Klassen_ID   der Wert für das Attribut Klassen_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public MigrationDTOKlassenLeitungPK(final Long Klassen_ID, final Long Lehrer_ID) {
		if (Klassen_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOKlassenLeitungPK other = (MigrationDTOKlassenLeitungPK) obj;
		if (Klassen_ID == null) {
