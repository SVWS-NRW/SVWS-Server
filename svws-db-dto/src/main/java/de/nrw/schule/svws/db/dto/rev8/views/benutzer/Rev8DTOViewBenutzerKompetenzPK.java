 ...
 */
public class Rev8DTOViewBenutzerKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOViewBenutzerKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOViewBenutzerKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOViewBenutzerKompetenzPK.
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public Rev8DTOViewBenutzerKompetenzPK(final Long Benutzer_ID, final Long Kompetenz_ID) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOViewBenutzerKompetenzPK other = (Rev8DTOViewBenutzerKompetenzPK) obj;
		if (Benutzer_ID == null) {
