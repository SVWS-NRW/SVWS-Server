 ...
 */
public class Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK.
	 ...
	 */
	public Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK(final Long Schuelerklausur_ID, final Long KlausurRaumStunde_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK other = (Rev9DTOGostKlausurenSchuelerklausurenRaeumeStundenPK) obj;
		if (Schuelerklausur_ID == null) {
