 ...
 */
public class Rev9DTOStatkueAbgangsartPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOStatkueAbgangsartPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOStatkueAbgangsartPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOStatkueAbgangsartPK.
	 ...
	 */
	public Rev9DTOStatkueAbgangsartPK(final String SF, final String Art, final Integer KZ_Bereich, final Integer KZ_Bereich_JG, final String AbgangsJG) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOStatkueAbgangsartPK other = (Rev9DTOStatkueAbgangsartPK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
