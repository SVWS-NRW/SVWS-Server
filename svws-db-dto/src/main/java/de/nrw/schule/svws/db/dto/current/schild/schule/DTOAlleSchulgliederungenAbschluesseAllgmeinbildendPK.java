 ...
 */
public class DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK.
	 ...
	 */
	public DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK(final Long Schulgliederung_ID, final String Abschluss_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK other = (DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK) obj;
		if (Schulgliederung_ID == null) {
