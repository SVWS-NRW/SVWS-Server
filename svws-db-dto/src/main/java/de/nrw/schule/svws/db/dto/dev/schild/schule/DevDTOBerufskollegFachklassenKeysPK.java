 ...
 */
public class DevDTOBerufskollegFachklassenKeysPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOBerufskollegFachklassenKeysPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOBerufskollegFachklassenKeysPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOBerufskollegFachklassenKeysPK.
	 ...
	 */
	public DevDTOBerufskollegFachklassenKeysPK(final Integer FachklassenIndex, final String Schluessel, final String Schluessel2) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOBerufskollegFachklassenKeysPK other = (DevDTOBerufskollegFachklassenKeysPK) obj;
		if (FachklassenIndex == null) {
