 ...
 */
public class Rev9DTOClientKonfigurationBenutzerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOClientKonfigurationBenutzerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOClientKonfigurationBenutzerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOClientKonfigurationBenutzerPK.
	 ...
	 */
	public Rev9DTOClientKonfigurationBenutzerPK(final Long Benutzer_ID, final String AppName, final String Schluessel) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOClientKonfigurationBenutzerPK other = (Rev9DTOClientKonfigurationBenutzerPK) obj;
		if (Benutzer_ID == null) {
