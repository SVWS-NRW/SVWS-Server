 ...
 */
public class DevDTOSchuelerReportvorlagenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerReportvorlagenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOSchuelerReportvorlagenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerReportvorlagenPK.
	 * @param User_ID   der Wert für das Attribut User_ID
	 * @param Reportvorlage   der Wert für das Attribut Reportvorlage
	 */
	public DevDTOSchuelerReportvorlagenPK(final Long User_ID, final String Reportvorlage) {
		if (User_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOSchuelerReportvorlagenPK other = (DevDTOSchuelerReportvorlagenPK) obj;
		if (User_ID == null) {
