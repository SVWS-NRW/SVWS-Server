 ...
 */
public class DevDTOGostBlockungKurslehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostBlockungKurslehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostBlockungKurslehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostBlockungKurslehrerPK.
	 * @param Blockung_Kurs_ID   der Wert für das Attribut Blockung_Kurs_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public DevDTOGostBlockungKurslehrerPK(final Long Blockung_Kurs_ID, final Long Lehrer_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostBlockungKurslehrerPK other = (DevDTOGostBlockungKurslehrerPK) obj;
		if (Blockung_Kurs_ID == null) {
