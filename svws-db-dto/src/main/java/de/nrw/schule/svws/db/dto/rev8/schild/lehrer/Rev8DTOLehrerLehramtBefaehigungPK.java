 ...
 */
public class Rev8DTOLehrerLehramtBefaehigungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerLehramtBefaehigungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOLehrerLehramtBefaehigungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerLehramtBefaehigungPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param LehrbefKrz   der Wert für das Attribut LehrbefKrz
	 */
	public Rev8DTOLehrerLehramtBefaehigungPK(final Long Lehrer_ID, final String LehrbefKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOLehrerLehramtBefaehigungPK other = (Rev8DTOLehrerLehramtBefaehigungPK) obj;
		if (Lehrer_ID == null) {
