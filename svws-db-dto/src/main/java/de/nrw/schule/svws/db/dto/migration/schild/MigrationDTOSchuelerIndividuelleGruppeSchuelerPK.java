 ...
 */
public class MigrationDTOSchuelerIndividuelleGruppeSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOSchuelerIndividuelleGruppeSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOSchuelerIndividuelleGruppeSchuelerPK.
	 * @param Liste_ID   der Wert für das Attribut Liste_ID
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 */
	public MigrationDTOSchuelerIndividuelleGruppeSchuelerPK(final Long Liste_ID, final Long Schueler_ID) {
		if (Liste_ID == null) { 
