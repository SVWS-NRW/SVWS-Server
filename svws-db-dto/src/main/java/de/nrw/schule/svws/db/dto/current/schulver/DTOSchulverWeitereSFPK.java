 ...
 */
public class DTOSchulverWeitereSFPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOSchulverWeitereSFPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOSchulverWeitereSFPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOSchulverWeitereSFPK.
	 * @param SNR   der Wert für das Attribut SNR
	 * @param SGL   der Wert für das Attribut SGL
	 * @param FSP   der Wert für das Attribut FSP
	 */
	public DTOSchulverWeitereSFPK(final String SNR, final String SGL, final String FSP) {
		if (SNR == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOSchulverWeitereSFPK other = (DTOSchulverWeitereSFPK) obj;
		if (SNR == null) {
			if (other.SNR != null)
				return false;
