 ...
 */
public class Rev8DTOInternTextExportPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternTextExportPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOInternTextExportPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternTextExportPK.
	 ...
	 */
	public Rev8DTOInternTextExportPK(final String AnzeigeText, final String DatenartKrz, final String DBFormat, final String Feldname) {
		if (AnzeigeText == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOInternTextExportPK other = (Rev8DTOInternTextExportPK) obj;
		if (AnzeigeText == null) {
