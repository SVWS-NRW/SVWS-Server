 ...
 */
public class Rev8DTOFachgliederungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOFachgliederungenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOFachgliederungenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOFachgliederungenPK.
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 * @param Fachklasse_ID   der Wert für das Attribut Fachklasse_ID
	 */
	public Rev8DTOFachgliederungenPK(final Long Fach_ID, final Long Fachklasse_ID) {
		if (Fach_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOFachgliederungenPK other = (Rev8DTOFachgliederungenPK) obj;
		if (Fach_ID == null) {
