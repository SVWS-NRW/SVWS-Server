 ...
 */
public class DevDTOHerkunftSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOHerkunftSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOHerkunftSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOHerkunftSchulformenPK.
	 ...
	 */
	public DevDTOHerkunftSchulformenPK(final Long Herkunft_ID, final String Schulform_Kuerzel) {
		if (Herkunft_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOHerkunftSchulformenPK other = (DevDTOHerkunftSchulformenPK) obj;
		if (Herkunft_ID == null) {
