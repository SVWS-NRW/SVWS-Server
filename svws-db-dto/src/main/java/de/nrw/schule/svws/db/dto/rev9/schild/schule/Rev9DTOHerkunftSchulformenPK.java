 ...
 */
public class Rev9DTOHerkunftSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOHerkunftSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOHerkunftSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOHerkunftSchulformenPK.
	 ...
	 */
	public Rev9DTOHerkunftSchulformenPK(final Long Herkunft_ID, final String Schulform_Kuerzel) {
		if (Herkunft_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOHerkunftSchulformenPK other = (Rev9DTOHerkunftSchulformenPK) obj;
		if (Herkunft_ID == null) {
