...
@NamedQuery(name="DTOProtokollLogin.primaryKeyQuery", query="SELECT e FROM DTOProtokollLogin e WHERE e.LI_LoginTime = ?1 AND e.LI_UserID = ?2")
@NamedQuery(name="DTOProtokollLogin.all.migration", query="SELECT e FROM DTOProtokollLogin e WHERE e.LI_LoginTime IS NOT NULL AND e.LI_UserID IS NOT NULL")
