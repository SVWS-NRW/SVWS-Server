 ...
 */
public class Rev8DTOGostJahrgangBeratungslehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostJahrgangBeratungslehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOGostJahrgangBeratungslehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostJahrgangBeratungslehrerPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev8DTOGostJahrgangBeratungslehrerPK(final Integer Abi_Jahrgang, final Long Lehrer_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOGostJahrgangBeratungslehrerPK other = (Rev8DTOGostJahrgangBeratungslehrerPK) obj;
		if (Abi_Jahrgang == null) {
