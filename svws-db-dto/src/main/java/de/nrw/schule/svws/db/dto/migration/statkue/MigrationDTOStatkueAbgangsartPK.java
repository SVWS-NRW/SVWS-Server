 ...
 */
public class MigrationDTOStatkueAbgangsartPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOStatkueAbgangsartPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOStatkueAbgangsartPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOStatkueAbgangsartPK.
	 ...
	 */
	public MigrationDTOStatkueAbgangsartPK(final String AbgangsJG, final String Art, final Integer KZ_Bereich, final Integer KZ_Bereich_JG, final String SF) {
		if (AbgangsJG == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOStatkueAbgangsartPK other = (MigrationDTOStatkueAbgangsartPK) obj;
		if (AbgangsJG == null) {
