 ...
 */
public class DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK.
	 ...
	 */
	public DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK(final Long Schuelerklausur_ID, final Long KlausurRaumStunde_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK other = (DevDTOGostKlausurenSchuelerklausurenRaeumeStundenPK) obj;
		if (Schuelerklausur_ID == null) {
