...
/**
 * Diese Klasse dient als DTO für den Primärschlüssel der Datenbanktabelle Schulgliederungen_Abschluesse_Allgemeinbildend.
 * Sie wurde automatisch per Skript generiert und sollte nicht verändert werden, 
 * da sie aufgrund von Änderungen am DB-Schema ggf. neu generiert und überschrieben wird.
 */
public class MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK.
	 ...
	 */
	public MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK(final Long Schulgliederung_ID, final String Abschluss_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK other = (MigrationDTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK) obj;
		if (Schulgliederung_ID == null) {
