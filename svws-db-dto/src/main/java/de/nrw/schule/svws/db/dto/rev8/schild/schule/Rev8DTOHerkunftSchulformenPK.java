 ...
 */
public class Rev8DTOHerkunftSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOHerkunftSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOHerkunftSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOHerkunftSchulformenPK.
	 ...
	 */
	public Rev8DTOHerkunftSchulformenPK(final Long Herkunft_ID, final String Schulform_Kuerzel) {
		if (Herkunft_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOHerkunftSchulformenPK other = (Rev8DTOHerkunftSchulformenPK) obj;
		if (Herkunft_ID == null) {
