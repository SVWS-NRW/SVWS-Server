 ...
 */
public class DevDTOLehrerLernplattformPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLernplattformPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOLehrerLernplattformPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLernplattformPK.
	 * @param LehrerID   der Wert für das Attribut LehrerID
	 * @param LernplattformID   der Wert für das Attribut LernplattformID
	 */
	public DevDTOLehrerLernplattformPK(final Long LehrerID, final Long LernplattformID) {
		if (LehrerID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOLehrerLernplattformPK other = (DevDTOLehrerLernplattformPK) obj;
		if (LehrerID == null) {
