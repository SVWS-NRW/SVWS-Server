 ...
 */
public class DevDTOFachgliederungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOFachgliederungenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOFachgliederungenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOFachgliederungenPK.
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 * @param Fachklasse_ID   der Wert für das Attribut Fachklasse_ID
	 */
	public DevDTOFachgliederungenPK(final Long Fach_ID, final Long Fachklasse_ID) {
		if (Fach_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOFachgliederungenPK other = (DevDTOFachgliederungenPK) obj;
		if (Fach_ID == null) {
