 ...
 */
public class Rev9DTOGostBlockungRegelParameterPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungRegelParameterPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostBlockungRegelParameterPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungRegelParameterPK.
	 * @param Regel_ID   der Wert für das Attribut Regel_ID
	 * @param Nummer   der Wert für das Attribut Nummer
	 */
	public Rev9DTOGostBlockungRegelParameterPK(final Long Regel_ID, final Integer Nummer) {
		if (Regel_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostBlockungRegelParameterPK other = (Rev9DTOGostBlockungRegelParameterPK) obj;
		if (Regel_ID == null) {
