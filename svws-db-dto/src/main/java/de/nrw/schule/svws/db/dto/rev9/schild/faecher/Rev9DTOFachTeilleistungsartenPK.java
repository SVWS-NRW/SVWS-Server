 ...
 */
public class Rev9DTOFachTeilleistungsartenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOFachTeilleistungsartenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOFachTeilleistungsartenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOFachTeilleistungsartenPK.
	 ...
	 */
	public Rev9DTOFachTeilleistungsartenPK(final Long Teilleistungsart_ID, final Long Fach_ID, final String Kursart) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOFachTeilleistungsartenPK other = (Rev9DTOFachTeilleistungsartenPK) obj;
		if (Teilleistungsart_ID == null) {
