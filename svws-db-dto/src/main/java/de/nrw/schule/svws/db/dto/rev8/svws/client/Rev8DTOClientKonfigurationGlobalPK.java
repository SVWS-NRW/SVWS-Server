 ...
 */
public class Rev8DTOClientKonfigurationGlobalPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOClientKonfigurationGlobalPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOClientKonfigurationGlobalPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOClientKonfigurationGlobalPK.
	 * @param AppName   der Wert für das Attribut AppName
	 * @param Schluessel   der Wert für das Attribut Schluessel
	 */
	public Rev8DTOClientKonfigurationGlobalPK(final String AppName, final String Schluessel) {
		if (AppName == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOClientKonfigurationGlobalPK other = (Rev8DTOClientKonfigurationGlobalPK) obj;
		if (AppName == null) {
