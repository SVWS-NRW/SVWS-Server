 ...
 */
public class Rev9DTOGostKlausurenNtaZeitenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostKlausurenNtaZeitenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostKlausurenNtaZeitenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostKlausurenNtaZeitenPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Vorgabe_ID   der Wert für das Attribut Vorgabe_ID
	 */
	public Rev9DTOGostKlausurenNtaZeitenPK(final Long Schueler_ID, final Long Vorgabe_ID) {
		if (Schueler_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostKlausurenNtaZeitenPK other = (Rev9DTOGostKlausurenNtaZeitenPK) obj;
		if (Schueler_ID == null) {
