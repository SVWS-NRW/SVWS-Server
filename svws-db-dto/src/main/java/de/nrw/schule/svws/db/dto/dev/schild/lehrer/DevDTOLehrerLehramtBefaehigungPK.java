 ...
 */
public class DevDTOLehrerLehramtBefaehigungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLehramtBefaehigungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOLehrerLehramtBefaehigungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLehramtBefaehigungPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param LehrbefKrz   der Wert für das Attribut LehrbefKrz
	 */
	public DevDTOLehrerLehramtBefaehigungPK(final Long Lehrer_ID, final String LehrbefKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOLehrerLehramtBefaehigungPK other = (DevDTOLehrerLehramtBefaehigungPK) obj;
		if (Lehrer_ID == null) {
