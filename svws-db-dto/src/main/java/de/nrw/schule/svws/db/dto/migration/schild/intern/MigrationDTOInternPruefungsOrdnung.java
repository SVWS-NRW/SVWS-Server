 ...
 */
@Entity
@IdClass(MigrationDTOInternPruefungsOrdnungPK.class)
@Cacheable(DBEntityManager.use_db_caching)
@Table(name = "Schildintern_PruefungsOrdnung")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.all", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_schulform", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Schulform = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_schulform.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Schulform IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_krz", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Krz = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_krz.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Krz IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_name", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Name = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_name.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Name IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_sgl", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_SGL = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_sgl.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_SGL IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_minjahrgang", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_MinJahrgang = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_minjahrgang.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_MinJahrgang IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_maxjahrgang", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_MaxJahrgang = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_maxjahrgang.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_MaxJahrgang IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_jahrgaenge", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Jahrgaenge = :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.po_jahrgaenge.multiple", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.PO_Jahrgaenge IN :value")
@NamedQuery(name="MigrationDTOInternPruefungsOrdnung.gueltigvon", query="SELECT e FROM MigrationDTOInternPruefungsOrdnung e WHERE e.gueltigVon = :value")
...
public class MigrationDTOInternPruefungsOrdnung {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOInternPruefungsOrdnung ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOInternPruefungsOrdnung() {
	}
	 ...
	 */
	public MigrationDTOInternPruefungsOrdnung(final String PO_Schulform, final String PO_Krz, final String PO_Name, final String PO_SGL, final Integer PO_MinJahrgang, final Integer PO_MaxJahrgang, final String PO_Jahrgaenge) {
	...
	public String toString() {
		return "MigrationDTOInternPruefungsOrdnung(PO_Schulform=" + this.PO_Schulform + ", PO_Krz=" + this.PO_Krz + ", PO_Name=" + this.PO_Name + ", PO_SGL=" + this.PO_SGL + ", PO_MinJahrgang=" + this.PO_MinJahrgang + ", PO_MaxJahrgang=" + this.PO_MaxJahrgang + ", PO_Jahrgaenge=" + this.PO_Jahrgaenge + ", gueltigVon=" + this.gueltigVon + ", gueltigBis=" + this.gueltigBis + ")";
	}
