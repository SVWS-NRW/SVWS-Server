 ...
 */
public class Rev8DTOLehrerDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOLehrerDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerDatenschutzPK.
	 * @param LehrerID   der Wert für das Attribut LehrerID
	 * @param DatenschutzID   der Wert für das Attribut DatenschutzID
	 */
	public Rev8DTOLehrerDatenschutzPK(final Long LehrerID, final Long DatenschutzID) {
		if (LehrerID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOLehrerDatenschutzPK other = (Rev8DTOLehrerDatenschutzPK) obj;
		if (LehrerID == null) {
