 ...
 */
public class Rev8DTOAlleJahrgaengeBezeichnungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAlleJahrgaengeBezeichnungenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOAlleJahrgaengeBezeichnungenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAlleJahrgaengeBezeichnungenPK.
	 ...
	 */
	public Rev8DTOAlleJahrgaengeBezeichnungenPK(final Long Jahrgang_ID, final String Schulform_Kuerzel) {
		if (Jahrgang_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOAlleJahrgaengeBezeichnungenPK other = (Rev8DTOAlleJahrgaengeBezeichnungenPK) obj;
		if (Jahrgang_ID == null) {
