 ...
 */
public class DevDTOEigeneImporteFelderPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOEigeneImporteFelderPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOEigeneImporteFelderPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOEigeneImporteFelderPK.
	 * @param Import_ID   der Wert für das Attribut Import_ID
	 * @param Field_ID   der Wert für das Attribut Field_ID
	 */
	public DevDTOEigeneImporteFelderPK(final Integer Import_ID, final Integer Field_ID) {
		if (Import_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOEigeneImporteFelderPK other = (DevDTOEigeneImporteFelderPK) obj;
		if (Import_ID == null) {
