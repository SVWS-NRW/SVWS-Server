 ...
 */
public class DevDTOSchuelerIndividuelleGruppeSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerIndividuelleGruppeSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOSchuelerIndividuelleGruppeSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerIndividuelleGruppeSchuelerPK.
	 * @param Liste_ID   der Wert für das Attribut Liste_ID
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 */
	public DevDTOSchuelerIndividuelleGruppeSchuelerPK(final Long Liste_ID, final Long Schueler_ID) {
		if (Liste_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOSchuelerIndividuelleGruppeSchuelerPK other = (DevDTOSchuelerIndividuelleGruppeSchuelerPK) obj;
		if (Liste_ID == null) {
