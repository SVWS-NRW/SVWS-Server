 ...
 */
public class DevDTOEigeneImporteTabellenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOEigeneImporteTabellenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOEigeneImporteTabellenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOEigeneImporteTabellenPK.
	 * @param Import_ID   der Wert für das Attribut Import_ID
	 * @param TableName   der Wert für das Attribut TableName
	 */
	public DevDTOEigeneImporteTabellenPK(final Integer Import_ID, final String TableName) {
		if (Import_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOEigeneImporteTabellenPK other = (DevDTOEigeneImporteTabellenPK) obj;
		if (Import_ID == null) {
