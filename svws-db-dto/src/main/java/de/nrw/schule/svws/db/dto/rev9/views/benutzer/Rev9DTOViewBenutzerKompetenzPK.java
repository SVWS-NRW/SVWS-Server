 ...
 */
public class Rev9DTOViewBenutzerKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOViewBenutzerKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOViewBenutzerKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOViewBenutzerKompetenzPK.
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public Rev9DTOViewBenutzerKompetenzPK(final Long Benutzer_ID, final Long Kompetenz_ID) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOViewBenutzerKompetenzPK other = (Rev9DTOViewBenutzerKompetenzPK) obj;
		if (Benutzer_ID == null) {
