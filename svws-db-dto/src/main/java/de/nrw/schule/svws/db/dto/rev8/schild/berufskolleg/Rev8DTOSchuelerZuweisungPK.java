 ...
 */
public class Rev8DTOSchuelerZuweisungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOSchuelerZuweisungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOSchuelerZuweisungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOSchuelerZuweisungPK.
	 * @param Abschnitt_ID   der Wert für das Attribut Abschnitt_ID
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public Rev8DTOSchuelerZuweisungPK(final Long Abschnitt_ID, final Long Fach_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOSchuelerZuweisungPK other = (Rev8DTOSchuelerZuweisungPK) obj;
		if (Abschnitt_ID == null) {
