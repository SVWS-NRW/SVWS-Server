 ...
 */
public class DTOStatkueZulaessigeKursartPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueZulaessigeKursartPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueZulaessigeKursartPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueZulaessigeKursartPK.
	 ...
	 */
	public DTOStatkueZulaessigeKursartPK(final String SF, final String FSP, final String BG, final String Kursart, final String Kursart2, final String Bezeichnung, final Integer SGLBereich, final String Flag) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOStatkueZulaessigeKursartPK other = (DTOStatkueZulaessigeKursartPK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
