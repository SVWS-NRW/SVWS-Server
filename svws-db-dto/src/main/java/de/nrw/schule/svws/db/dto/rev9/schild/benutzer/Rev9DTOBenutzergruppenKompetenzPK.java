 ...
 */
public class Rev9DTOBenutzergruppenKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOBenutzergruppenKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOBenutzergruppenKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOBenutzergruppenKompetenzPK.
	 * @param Gruppe_ID   der Wert für das Attribut Gruppe_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public Rev9DTOBenutzergruppenKompetenzPK(final Long Gruppe_ID, final Long Kompetenz_ID) {
		if (Gruppe_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOBenutzergruppenKompetenzPK other = (Rev9DTOBenutzergruppenKompetenzPK) obj;
		if (Gruppe_ID == null) {
