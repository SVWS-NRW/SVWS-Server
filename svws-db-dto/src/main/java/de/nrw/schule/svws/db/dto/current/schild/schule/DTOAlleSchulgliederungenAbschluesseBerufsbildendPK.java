 ...
 */
public class DTOAlleSchulgliederungenAbschluesseBerufsbildendPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleSchulgliederungenAbschluesseBerufsbildendPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOAlleSchulgliederungenAbschluesseBerufsbildendPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleSchulgliederungenAbschluesseBerufsbildendPK.
	 ...
	 */
	public DTOAlleSchulgliederungenAbschluesseBerufsbildendPK(final Long Schulgliederung_ID, final String Abschluss_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOAlleSchulgliederungenAbschluesseBerufsbildendPK other = (DTOAlleSchulgliederungenAbschluesseBerufsbildendPK) obj;
		if (Schulgliederung_ID == null) {
