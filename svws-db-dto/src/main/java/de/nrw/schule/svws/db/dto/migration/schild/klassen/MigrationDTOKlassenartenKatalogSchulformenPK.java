 ...
 */
public class MigrationDTOKlassenartenKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOKlassenartenKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOKlassenartenKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOKlassenartenKatalogSchulformenPK.
	 ...
	 */
	public MigrationDTOKlassenartenKatalogSchulformenPK(final Long Klassenart_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOKlassenartenKatalogSchulformenPK other = (MigrationDTOKlassenartenKatalogSchulformenPK) obj;
		if (Klassenart_ID == null) {
