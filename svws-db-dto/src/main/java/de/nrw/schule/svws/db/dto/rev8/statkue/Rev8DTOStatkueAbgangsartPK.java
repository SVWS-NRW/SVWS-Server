 ...
 */
public class Rev8DTOStatkueAbgangsartPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueAbgangsartPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOStatkueAbgangsartPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueAbgangsartPK.
	 ...
	 */
	public Rev8DTOStatkueAbgangsartPK(final String AbgangsJG, final String Art, final Integer KZ_Bereich, final Integer KZ_Bereich_JG, final String SF) {
		if (AbgangsJG == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOStatkueAbgangsartPK other = (Rev8DTOStatkueAbgangsartPK) obj;
		if (AbgangsJG == null) {
