 ...
 */
public class Rev8DTOSchuelerIndividuelleGruppeSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOSchuelerIndividuelleGruppeSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOSchuelerIndividuelleGruppeSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOSchuelerIndividuelleGruppeSchuelerPK.
	 * @param Liste_ID   der Wert für das Attribut Liste_ID
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 */
	public Rev8DTOSchuelerIndividuelleGruppeSchuelerPK(final Long Liste_ID, final Long Schueler_ID) {
		if (Liste_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOSchuelerIndividuelleGruppeSchuelerPK other = (Rev8DTOSchuelerIndividuelleGruppeSchuelerPK) obj;
		if (Liste_ID == null) {
