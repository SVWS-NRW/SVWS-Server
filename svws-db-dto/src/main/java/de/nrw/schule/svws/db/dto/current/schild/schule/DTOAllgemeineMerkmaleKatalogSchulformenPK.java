 ...
 */
public class DTOAllgemeineMerkmaleKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOAllgemeineMerkmaleKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOAllgemeineMerkmaleKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOAllgemeineMerkmaleKatalogSchulformenPK.
	 * @param Merkmal_ID   der Wert für das Attribut Merkmal_ID
	 * @param Schulform_Kuerzel   der Wert für das Attribut Schulform_Kuerzel
	 */
	public DTOAllgemeineMerkmaleKatalogSchulformenPK(final Long Merkmal_ID, final String Schulform_Kuerzel) {
		if (Merkmal_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOAllgemeineMerkmaleKatalogSchulformenPK other = (DTOAllgemeineMerkmaleKatalogSchulformenPK) obj;
		if (Merkmal_ID == null) {
