 ...
 */
public class MigrationDTOFachTeilleistungsartenPK implements Serializable {
	 ...
	 */
	public MigrationDTOFachTeilleistungsartenPK(final Long Fach_ID, final String Kursart, final Long Teilleistungsart_ID) {
		if (Fach_ID == null) { 
