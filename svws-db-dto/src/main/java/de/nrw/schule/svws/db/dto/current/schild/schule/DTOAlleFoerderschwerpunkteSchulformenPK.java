 ...
 */
public class DTOAlleFoerderschwerpunkteSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleFoerderschwerpunkteSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOAlleFoerderschwerpunkteSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleFoerderschwerpunkteSchulformenPK.
	 ...
	 */
	public DTOAlleFoerderschwerpunkteSchulformenPK(final Long Foerderschwerpunkt_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOAlleFoerderschwerpunkteSchulformenPK other = (DTOAlleFoerderschwerpunkteSchulformenPK) obj;
		if (Foerderschwerpunkt_ID == null) {
