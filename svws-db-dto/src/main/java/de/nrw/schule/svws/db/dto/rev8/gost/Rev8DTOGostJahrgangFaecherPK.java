 ...
 */
public class Rev8DTOGostJahrgangFaecherPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostJahrgangFaecherPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOGostJahrgangFaecherPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostJahrgangFaecherPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public Rev8DTOGostJahrgangFaecherPK(final Integer Abi_Jahrgang, final Long Fach_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOGostJahrgangFaecherPK other = (Rev8DTOGostJahrgangFaecherPK) obj;
		if (Abi_Jahrgang == null) {
