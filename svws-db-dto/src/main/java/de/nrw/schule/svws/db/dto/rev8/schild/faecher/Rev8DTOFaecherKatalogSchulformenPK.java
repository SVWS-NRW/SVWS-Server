 ...
 */
public class Rev8DTOFaecherKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOFaecherKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOFaecherKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOFaecherKatalogSchulformenPK.
	 ...
	 */
	public Rev8DTOFaecherKatalogSchulformenPK(final Long Fach_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
		if (Fach_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOFaecherKatalogSchulformenPK other = (Rev8DTOFaecherKatalogSchulformenPK) obj;
		if (Fach_ID == null) {
