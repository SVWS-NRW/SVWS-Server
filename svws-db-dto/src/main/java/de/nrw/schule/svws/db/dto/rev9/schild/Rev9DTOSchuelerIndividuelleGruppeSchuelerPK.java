 ...
 */
public class Rev9DTOSchuelerIndividuelleGruppeSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOSchuelerIndividuelleGruppeSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOSchuelerIndividuelleGruppeSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOSchuelerIndividuelleGruppeSchuelerPK.
	 * @param Liste_ID   der Wert für das Attribut Liste_ID
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 */
	public Rev9DTOSchuelerIndividuelleGruppeSchuelerPK(final Long Liste_ID, final Long Schueler_ID) {
		if (Liste_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOSchuelerIndividuelleGruppeSchuelerPK other = (Rev9DTOSchuelerIndividuelleGruppeSchuelerPK) obj;
		if (Liste_ID == null) {
