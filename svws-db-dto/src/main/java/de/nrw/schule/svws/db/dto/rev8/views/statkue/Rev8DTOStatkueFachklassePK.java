 ...
 */
public class Rev8DTOStatkueFachklassePK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueFachklassePK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOStatkueFachklassePK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueFachklassePK.
	 ...
	 */
	public Rev8DTOStatkueFachklassePK(final Integer BKIndex, final String FKS, final String AP) {
		if (BKIndex == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOStatkueFachklassePK other = (Rev8DTOStatkueFachklassePK) obj;
		if (BKIndex == null) {
