 ...
 */
public class MigrationDTOAlleJahrgaengeBezeichnungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOAlleJahrgaengeBezeichnungenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOAlleJahrgaengeBezeichnungenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOAlleJahrgaengeBezeichnungenPK.
	 ...
	 */
	public MigrationDTOAlleJahrgaengeBezeichnungenPK(final Long Jahrgang_ID, final String Schulform_Kuerzel) {
		if (Jahrgang_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOAlleJahrgaengeBezeichnungenPK other = (MigrationDTOAlleJahrgaengeBezeichnungenPK) obj;
		if (Jahrgang_ID == null) {
