 ...
 */
public class DevDTOSchuelerZuweisungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerZuweisungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOSchuelerZuweisungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerZuweisungPK.
	 * @param Abschnitt_ID   der Wert für das Attribut Abschnitt_ID
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public DevDTOSchuelerZuweisungPK(final Long Abschnitt_ID, final Long Fach_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOSchuelerZuweisungPK other = (DevDTOSchuelerZuweisungPK) obj;
		if (Abschnitt_ID == null) {
