 ...
 */
public class DTOStatkueZulaessigeKlassenartPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueZulaessigeKlassenartPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueZulaessigeKlassenartPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueZulaessigeKlassenartPK.
	 ...
	 */
	public DTOStatkueZulaessigeKlassenartPK(final String KlArt, final String Schulform, final String FSP, final String Bezeichnung) {
		if (KlArt == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOStatkueZulaessigeKlassenartPK other = (DTOStatkueZulaessigeKlassenartPK) obj;
		if (KlArt == null) {
			if (other.KlArt != null)
				return false;
