 ...
 */
public class Rev9DTOEigeneImporteTabellenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOEigeneImporteTabellenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOEigeneImporteTabellenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOEigeneImporteTabellenPK.
	 * @param Import_ID   der Wert für das Attribut Import_ID
	 * @param TableName   der Wert für das Attribut TableName
	 */
	public Rev9DTOEigeneImporteTabellenPK(final Integer Import_ID, final String TableName) {
		if (Import_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOEigeneImporteTabellenPK other = (Rev9DTOEigeneImporteTabellenPK) obj;
		if (Import_ID == null) {
