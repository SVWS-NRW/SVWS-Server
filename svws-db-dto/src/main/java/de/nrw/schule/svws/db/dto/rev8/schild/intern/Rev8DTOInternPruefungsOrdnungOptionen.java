 ...
 */
@Entity
@IdClass(Rev8DTOInternPruefungsOrdnungOptionenPK.class)
@Cacheable(DBEntityManager.use_db_caching)
@Table(name = "Schildintern_PruefOrd_Optionen")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.all", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_schulformen", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Schulformen = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_schulformen.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Schulformen IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_pokrz", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_POKrz = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_pokrz.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_POKrz IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_krz", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Krz = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_krz.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Krz IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_abgangsart_b", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Abgangsart_B = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_abgangsart_b.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Abgangsart_B IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_abgangsart_nb", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Abgangsart_NB = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_abgangsart_nb.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Abgangsart_NB IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_art", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Art = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_art.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Art IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_typ", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Typ = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_typ.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Typ IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_bildungsgang", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Bildungsgang = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_bildungsgang.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Bildungsgang IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_name", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Name = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_name.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Name IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_kommentar", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Kommentar = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_kommentar.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Kommentar IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_jahrgaenge", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Jahrgaenge = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_jahrgaenge.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Jahrgaenge IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_bkindex", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_BKIndex = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_bkindex.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_BKIndex IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_bkanl_typ", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_BKAnl_Typ = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_bkanl_typ.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_BKAnl_Typ IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_reihenfolge", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Reihenfolge = :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.op_reihenfolge.multiple", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Reihenfolge IN :value")
@NamedQuery(name="Rev8DTOInternPruefungsOrdnungOptionen.gueltigvon", query="SELECT e FROM Rev8DTOInternPruefungsOrdnungOptionen e WHERE e.gueltigVon = :value")
...
public class Rev8DTOInternPruefungsOrdnungOptionen {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternPruefungsOrdnungOptionen ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOInternPruefungsOrdnungOptionen() {
	}
	 ...
	 */
	public Rev8DTOInternPruefungsOrdnungOptionen(final String OP_Schulformen, final String OP_POKrz, final String OP_Krz, final String OP_Art, final String OP_Bildungsgang, final String OP_Name, final String OP_Jahrgaenge, final Integer OP_Reihenfolge) {
