 ...
 */
public class Rev8DTOKursSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOKursSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOKursSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOKursSchuelerPK.
	 * @param Kurs_ID   der Wert für das Attribut Kurs_ID
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 */
	public Rev8DTOKursSchuelerPK(final Long Kurs_ID, final Long Schueler_ID) {
		if (Kurs_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOKursSchuelerPK other = (Rev8DTOKursSchuelerPK) obj;
		if (Kurs_ID == null) {
