 ...
 */
public class DTOGostKlausurenEntfallPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOGostKlausurenEntfallPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOGostKlausurenEntfallPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOGostKlausurenEntfallPK.
	 ...
	 */
	public DTOGostKlausurenEntfallPK(final Long Termin_ID, final Long Kurs_ID, final Long Zeitraster_ID) {
		if (Termin_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOGostKlausurenEntfallPK other = (DTOGostKlausurenEntfallPK) obj;
		if (Termin_ID == null) {
