 ...
 */
public class Rev8DTOInternPrfSemesterAbschlussPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternPrfSemesterAbschlussPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOInternPrfSemesterAbschlussPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternPrfSemesterAbschlussPK.
	 * @param Nr   der Wert für das Attribut Nr
	 * @param Schulform   der Wert für das Attribut Schulform
	 */
	public Rev8DTOInternPrfSemesterAbschlussPK(final String Nr, final String Schulform) {
		if (Nr == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOInternPrfSemesterAbschlussPK other = (Rev8DTOInternPrfSemesterAbschlussPK) obj;
		if (Nr == null) {
			if (other.Nr != null)
				return false;
