 ...
 */
public class DevDTOHerkunftsartSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOHerkunftsartSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOHerkunftsartSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOHerkunftsartSchulformenPK.
	 ...
	 */
	public DevDTOHerkunftsartSchulformenPK(final Long Herkunftsart_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOHerkunftsartSchulformenPK other = (DevDTOHerkunftsartSchulformenPK) obj;
		if (Herkunftsart_ID == null) {
