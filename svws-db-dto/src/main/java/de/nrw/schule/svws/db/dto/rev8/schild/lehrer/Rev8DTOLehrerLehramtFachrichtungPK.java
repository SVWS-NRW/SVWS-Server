 ...
 */
public class Rev8DTOLehrerLehramtFachrichtungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerLehramtFachrichtungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOLehrerLehramtFachrichtungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerLehramtFachrichtungPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param FachrKrz   der Wert für das Attribut FachrKrz
	 */
	public Rev8DTOLehrerLehramtFachrichtungPK(final Long Lehrer_ID, final String FachrKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOLehrerLehramtFachrichtungPK other = (Rev8DTOLehrerLehramtFachrichtungPK) obj;
		if (Lehrer_ID == null) {
