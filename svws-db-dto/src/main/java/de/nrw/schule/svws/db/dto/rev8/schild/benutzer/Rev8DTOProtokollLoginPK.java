 ...
 */
public class Rev8DTOProtokollLoginPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOProtokollLoginPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOProtokollLoginPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOProtokollLoginPK.
	 * @param LI_UserID   der Wert für das Attribut LI_UserID
	 * @param LI_LoginTime   der Wert für das Attribut LI_LoginTime
	 */
	public Rev8DTOProtokollLoginPK(final Long LI_UserID, final String LI_LoginTime) {
		if (LI_UserID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOProtokollLoginPK other = (Rev8DTOProtokollLoginPK) obj;
		if (LI_UserID == null) {
