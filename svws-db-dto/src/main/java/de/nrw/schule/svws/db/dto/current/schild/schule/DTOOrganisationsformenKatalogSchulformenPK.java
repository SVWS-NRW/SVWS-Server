 ...
 */
public class DTOOrganisationsformenKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOOrganisationsformenKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOOrganisationsformenKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOOrganisationsformenKatalogSchulformenPK.
	 ...
	 */
	public DTOOrganisationsformenKatalogSchulformenPK(final Long Organisationsform_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOOrganisationsformenKatalogSchulformenPK other = (DTOOrganisationsformenKatalogSchulformenPK) obj;
		if (Organisationsform_ID == null) {
