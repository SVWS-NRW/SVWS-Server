 ...
 */
public class Rev8DTOGostJahrgangFachkombinationenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostJahrgangFachkombinationenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOGostJahrgangFachkombinationenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostJahrgangFachkombinationenPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param ID   der Wert für das Attribut ID
	 */
	public Rev8DTOGostJahrgangFachkombinationenPK(final Integer Abi_Jahrgang, final String ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOGostJahrgangFachkombinationenPK other = (Rev8DTOGostJahrgangFachkombinationenPK) obj;
		if (Abi_Jahrgang == null) {
