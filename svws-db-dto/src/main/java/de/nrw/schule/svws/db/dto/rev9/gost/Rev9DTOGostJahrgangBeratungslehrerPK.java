 ...
 */
public class Rev9DTOGostJahrgangBeratungslehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostJahrgangBeratungslehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostJahrgangBeratungslehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostJahrgangBeratungslehrerPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev9DTOGostJahrgangBeratungslehrerPK(final Integer Abi_Jahrgang, final Long Lehrer_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostJahrgangBeratungslehrerPK other = (Rev9DTOGostJahrgangBeratungslehrerPK) obj;
		if (Abi_Jahrgang == null) {
