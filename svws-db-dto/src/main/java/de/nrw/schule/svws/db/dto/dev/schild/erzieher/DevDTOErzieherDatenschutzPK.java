 ...
 */
public class DevDTOErzieherDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOErzieherDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOErzieherDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOErzieherDatenschutzPK.
	 * @param ErzieherID   der Wert für das Attribut ErzieherID
	 * @param DatenschutzID   der Wert für das Attribut DatenschutzID
	 */
	public DevDTOErzieherDatenschutzPK(final Long ErzieherID, final Long DatenschutzID) {
		if (ErzieherID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOErzieherDatenschutzPK other = (DevDTOErzieherDatenschutzPK) obj;
		if (ErzieherID == null) {
