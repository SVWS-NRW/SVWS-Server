 ...
 */
public class Rev9DTOErzieherLernplattformPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOErzieherLernplattformPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOErzieherLernplattformPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOErzieherLernplattformPK.
	 * @param ErzieherID   der Wert für das Attribut ErzieherID
	 * @param LernplattformID   der Wert für das Attribut LernplattformID
	 */
	public Rev9DTOErzieherLernplattformPK(final Long ErzieherID, final Long LernplattformID) {
		if (ErzieherID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOErzieherLernplattformPK other = (Rev9DTOErzieherLernplattformPK) obj;
		if (ErzieherID == null) {
