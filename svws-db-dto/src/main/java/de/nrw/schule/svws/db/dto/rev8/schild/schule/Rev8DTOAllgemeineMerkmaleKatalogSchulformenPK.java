 ...
 */
public class Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK.
	 * @param Merkmal_ID   der Wert für das Attribut Merkmal_ID
	 * @param Schulform_Kuerzel   der Wert für das Attribut Schulform_Kuerzel
	 */
	public Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK(final Long Merkmal_ID, final String Schulform_Kuerzel) {
		if (Merkmal_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK other = (Rev8DTOAllgemeineMerkmaleKatalogSchulformenPK) obj;
		if (Merkmal_ID == null) {
