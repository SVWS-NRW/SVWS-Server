 ...
 */
public class DTOStatkueReformpaedagogikPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueReformpaedagogikPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueReformpaedagogikPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueReformpaedagogikPK.
	 * @param RPG   der Wert für das Attribut RPG
	 * @param SF   der Wert für das Attribut SF
	 */
	public DTOStatkueReformpaedagogikPK(final String RPG, final String SF) {
		if (RPG == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOStatkueReformpaedagogikPK other = (DTOStatkueReformpaedagogikPK) obj;
		if (RPG == null) {
			if (other.RPG != null)
				return false;
