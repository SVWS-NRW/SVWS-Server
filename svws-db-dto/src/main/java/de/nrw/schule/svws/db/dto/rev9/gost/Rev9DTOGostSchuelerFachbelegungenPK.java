 ...
 */
public class Rev9DTOGostSchuelerFachbelegungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostSchuelerFachbelegungenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostSchuelerFachbelegungenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostSchuelerFachbelegungenPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public Rev9DTOGostSchuelerFachbelegungenPK(final Long Schueler_ID, final Long Fach_ID) {
		if (Schueler_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostSchuelerFachbelegungenPK other = (Rev9DTOGostSchuelerFachbelegungenPK) obj;
		if (Schueler_ID == null) {
