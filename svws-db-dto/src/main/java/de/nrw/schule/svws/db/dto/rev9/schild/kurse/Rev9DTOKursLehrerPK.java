 ...
 */
public class Rev9DTOKursLehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOKursLehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOKursLehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOKursLehrerPK.
	 * @param Kurs_ID   der Wert für das Attribut Kurs_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev9DTOKursLehrerPK(final Long Kurs_ID, final Long Lehrer_ID) {
		if (Kurs_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOKursLehrerPK other = (Rev9DTOKursLehrerPK) obj;
		if (Kurs_ID == null) {
