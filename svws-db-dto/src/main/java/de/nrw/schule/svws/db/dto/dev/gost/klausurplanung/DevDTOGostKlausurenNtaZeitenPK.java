 ...
 */
public class DevDTOGostKlausurenNtaZeitenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostKlausurenNtaZeitenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostKlausurenNtaZeitenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostKlausurenNtaZeitenPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Vorgabe_ID   der Wert für das Attribut Vorgabe_ID
	 */
	public DevDTOGostKlausurenNtaZeitenPK(final Long Schueler_ID, final Long Vorgabe_ID) {
		if (Schueler_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostKlausurenNtaZeitenPK other = (DevDTOGostKlausurenNtaZeitenPK) obj;
		if (Schueler_ID == null) {
