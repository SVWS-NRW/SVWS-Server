 ...
 */
public class DTOKlassenartenKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOKlassenartenKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOKlassenartenKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOKlassenartenKatalogSchulformenPK.
	 ...
	 */
	public DTOKlassenartenKatalogSchulformenPK(final Long Klassenart_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOKlassenartenKatalogSchulformenPK other = (DTOKlassenartenKatalogSchulformenPK) obj;
		if (Klassenart_ID == null) {
