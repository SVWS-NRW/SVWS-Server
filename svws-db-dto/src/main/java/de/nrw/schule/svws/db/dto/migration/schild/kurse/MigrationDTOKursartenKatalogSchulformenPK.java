 ...
 */
public class MigrationDTOKursartenKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOKursartenKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOKursartenKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOKursartenKatalogSchulformenPK.
	 ...
	 */
	public MigrationDTOKursartenKatalogSchulformenPK(final Long Kursart_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
		if (Kursart_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOKursartenKatalogSchulformenPK other = (MigrationDTOKursartenKatalogSchulformenPK) obj;
		if (Kursart_ID == null) {
