 ...
 */
public class DTOKursartenKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOKursartenKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOKursartenKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOKursartenKatalogSchulformenPK.
	 ...
	 */
	public DTOKursartenKatalogSchulformenPK(final Long Kursart_ID, final String Schulform_Kuerzel, final String Schulgliederung_Kuerzel) {
		if (Kursart_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOKursartenKatalogSchulformenPK other = (DTOKursartenKatalogSchulformenPK) obj;
		if (Kursart_ID == null) {
