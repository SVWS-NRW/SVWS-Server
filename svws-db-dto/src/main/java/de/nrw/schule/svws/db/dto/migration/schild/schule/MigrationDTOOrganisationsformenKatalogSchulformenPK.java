 ...
 */
public class MigrationDTOOrganisationsformenKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOOrganisationsformenKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOOrganisationsformenKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOOrganisationsformenKatalogSchulformenPK.
	 ...
	 */
	public MigrationDTOOrganisationsformenKatalogSchulformenPK(final Long Organisationsform_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOOrganisationsformenKatalogSchulformenPK other = (MigrationDTOOrganisationsformenKatalogSchulformenPK) obj;
		if (Organisationsform_ID == null) {
