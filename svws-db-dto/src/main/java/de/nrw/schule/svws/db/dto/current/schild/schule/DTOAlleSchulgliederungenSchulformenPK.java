 ...
 */
public class DTOAlleSchulgliederungenSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleSchulgliederungenSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOAlleSchulgliederungenSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOAlleSchulgliederungenSchulformenPK.
	 ...
	 */
	public DTOAlleSchulgliederungenSchulformenPK(final Long Schulgliederung_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOAlleSchulgliederungenSchulformenPK other = (DTOAlleSchulgliederungenSchulformenPK) obj;
		if (Schulgliederung_ID == null) {
