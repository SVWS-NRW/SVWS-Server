 ...
 */
public class DevDTOSchuelerDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOSchuelerDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOSchuelerDatenschutzPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Datenschutz_ID   der Wert für das Attribut Datenschutz_ID
	 */
	public DevDTOSchuelerDatenschutzPK(final Long Schueler_ID, final Long Datenschutz_ID) {
		if (Schueler_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOSchuelerDatenschutzPK other = (DevDTOSchuelerDatenschutzPK) obj;
		if (Schueler_ID == null) {
