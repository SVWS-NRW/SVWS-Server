 ...
 */
public class Rev8DTOGostBlockungRegelParameterPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostBlockungRegelParameterPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOGostBlockungRegelParameterPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostBlockungRegelParameterPK.
	 * @param Regel_ID   der Wert für das Attribut Regel_ID
	 * @param Nummer   der Wert für das Attribut Nummer
	 */
	public Rev8DTOGostBlockungRegelParameterPK(final Long Regel_ID, final Integer Nummer) {
		if (Regel_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOGostBlockungRegelParameterPK other = (Rev8DTOGostBlockungRegelParameterPK) obj;
		if (Regel_ID == null) {
