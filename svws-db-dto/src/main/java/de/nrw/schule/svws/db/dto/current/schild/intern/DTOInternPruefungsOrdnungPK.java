 ...
 */
public class DTOInternPruefungsOrdnungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOInternPruefungsOrdnungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOInternPruefungsOrdnungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOInternPruefungsOrdnungPK.
	 ...
	 */
	public DTOInternPruefungsOrdnungPK(final String PO_Krz, final String PO_Schulform, final String PO_SGL) {
		if (PO_Krz == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOInternPruefungsOrdnungPK other = (DTOInternPruefungsOrdnungPK) obj;
		if (PO_Krz == null) {
