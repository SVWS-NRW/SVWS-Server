 ...
 */
public class Rev8DTOKursLehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOKursLehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOKursLehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOKursLehrerPK.
	 * @param Kurs_ID   der Wert für das Attribut Kurs_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev8DTOKursLehrerPK(final Long Kurs_ID, final Long Lehrer_ID) {
		if (Kurs_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOKursLehrerPK other = (Rev8DTOKursLehrerPK) obj;
		if (Kurs_ID == null) {
