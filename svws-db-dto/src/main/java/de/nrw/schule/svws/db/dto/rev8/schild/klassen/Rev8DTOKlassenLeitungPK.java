 ...
 */
public class Rev8DTOKlassenLeitungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOKlassenLeitungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOKlassenLeitungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOKlassenLeitungPK.
	 * @param Klassen_ID   der Wert für das Attribut Klassen_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev8DTOKlassenLeitungPK(final Long Klassen_ID, final Long Lehrer_ID) {
		if (Klassen_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOKlassenLeitungPK other = (Rev8DTOKlassenLeitungPK) obj;
		if (Klassen_ID == null) {
