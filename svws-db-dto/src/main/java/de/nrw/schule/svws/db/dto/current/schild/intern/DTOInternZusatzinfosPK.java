 ...
 */
public class DTOInternZusatzinfosPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOInternZusatzinfosPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOInternZusatzinfosPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOInternZusatzinfosPK.
	 * @param SGL_BKAbschl   der Wert für das Attribut SGL_BKAbschl
	 * @param JG_BKAbschl   der Wert für das Attribut JG_BKAbschl
	 */
	public DTOInternZusatzinfosPK(final String SGL_BKAbschl, final String JG_BKAbschl) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOInternZusatzinfosPK other = (DTOInternZusatzinfosPK) obj;
		if (SGL_BKAbschl == null) {
