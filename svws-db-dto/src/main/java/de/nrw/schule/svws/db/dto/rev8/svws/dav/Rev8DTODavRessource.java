...
@NamedQuery(name="Rev8DTODavRessource.all", query="SELECT e FROM Rev8DTODavRessource e")
@NamedQuery(name="Rev8DTODavRessource.id", query="SELECT e FROM Rev8DTODavRessource e WHERE e.ID = :value")
@NamedQuery(name="Rev8DTODavRessource.id.multiple", query="SELECT e FROM Rev8DTODavRessource e WHERE e.ID IN :value")
@NamedQuery(name="Rev8DTODavRessource.davressourcecollection_id", query="SELECT e FROM Rev8DTODavRessource e WHERE e.DavRessourceCollection_ID = :value")
@NamedQuery(name="Rev8DTODavRessource.davressourcecollection_id.multiple", query="SELECT e FROM Rev8DTODavRessource e WHERE e.DavRessourceCollection_ID IN :value")
@NamedQuery(name="Rev8DTODavRessource.uid", query="SELECT e FROM Rev8DTODavRessource e WHERE e.UID = :value")
@NamedQuery(name="Rev8DTODavRessource.uid.multiple", query="SELECT e FROM Rev8DTODavRessource e WHERE e.UID IN :value")
@NamedQuery(name="Rev8DTODavRessource.lastmodified", query="SELECT e FROM Rev8DTODavRessource e WHERE e.lastModified = :value")
@NamedQuery(name="Rev8DTODavRessource.lastmodified.multiple", query="SELECT e FROM Rev8DTODavRessource e WHERE e.lastModified IN :value")
@NamedQuery(name="Rev8DTODavRessource.kalendertyp", query="SELECT e FROM Rev8DTODavRessource e WHERE e.KalenderTyp = :value")
@NamedQuery(name="Rev8DTODavRessource.kalendertyp.multiple", query="SELECT e FROM Rev8DTODavRessource e WHERE e.KalenderTyp IN :value")
@NamedQuery(name="Rev8DTODavRessource.kalenderstart", query="SELECT e FROM Rev8DTODavRessource e WHERE e.KalenderStart = :value")
@NamedQuery(name="Rev8DTODavRessource.kalenderstart.multiple", query="SELECT e FROM Rev8DTODavRessource e WHERE e.KalenderStart IN :value")
@NamedQuery(name="Rev8DTODavRessource.kalenderende", query="SELECT e FROM Rev8DTODavRessource e WHERE e.KalenderEnde = :value")
...
public class Rev8DTODavRessource {
	 ...
	 */
	public Rev8DTODavRessource(final Long ID, final Long DavRessourceCollection_ID, final String UID, final String lastModified, final String KalenderTyp, final String KalenderStart, final String KalenderEnde, final byte[] ressource) {
		if (ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTODavRessource other = (Rev8DTODavRessource) obj;
		if (ID == null) {
			if (other.ID != null)
				return false;
