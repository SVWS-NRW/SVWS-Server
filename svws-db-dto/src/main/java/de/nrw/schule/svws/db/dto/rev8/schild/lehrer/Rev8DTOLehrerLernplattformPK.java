 ...
 */
public class Rev8DTOLehrerLernplattformPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerLernplattformPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOLehrerLernplattformPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOLehrerLernplattformPK.
	 * @param LehrerID   der Wert für das Attribut LehrerID
	 * @param LernplattformID   der Wert für das Attribut LernplattformID
	 */
	public Rev8DTOLehrerLernplattformPK(final Long LehrerID, final Long LernplattformID) {
		if (LehrerID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOLehrerLernplattformPK other = (Rev8DTOLehrerLernplattformPK) obj;
		if (LehrerID == null) {
