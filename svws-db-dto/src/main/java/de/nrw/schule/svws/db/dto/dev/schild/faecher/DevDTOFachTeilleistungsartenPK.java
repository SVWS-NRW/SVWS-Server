 ...
 */
public class DevDTOFachTeilleistungsartenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOFachTeilleistungsartenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOFachTeilleistungsartenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOFachTeilleistungsartenPK.
	 ...
	 */
	public DevDTOFachTeilleistungsartenPK(final Long Teilleistungsart_ID, final Long Fach_ID, final String Kursart) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOFachTeilleistungsartenPK other = (DevDTOFachTeilleistungsartenPK) obj;
		if (Teilleistungsart_ID == null) {
