 ...
 */
public class MigrationDTOInternPruefungsOrdnungOptionenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOInternPruefungsOrdnungOptionenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOInternPruefungsOrdnungOptionenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOInternPruefungsOrdnungOptionenPK.
	 ...
	 */
	public MigrationDTOInternPruefungsOrdnungOptionenPK(final String OP_Schulformen, final String OP_POKrz, final String OP_Krz, final String OP_Art, final String OP_Bildungsgang, final String OP_Name, final String OP_Jahrgaenge, final Integer OP_Reihenfolge) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOInternPruefungsOrdnungOptionenPK other = (MigrationDTOInternPruefungsOrdnungOptionenPK) obj;
		if (OP_Schulformen == null) {
