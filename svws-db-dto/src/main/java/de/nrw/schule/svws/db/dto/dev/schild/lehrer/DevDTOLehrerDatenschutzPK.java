 ...
 */
public class DevDTOLehrerDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOLehrerDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerDatenschutzPK.
	 * @param LehrerID   der Wert für das Attribut LehrerID
	 * @param DatenschutzID   der Wert für das Attribut DatenschutzID
	 */
	public DevDTOLehrerDatenschutzPK(final Long LehrerID, final Long DatenschutzID) {
		if (LehrerID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOLehrerDatenschutzPK other = (DevDTOLehrerDatenschutzPK) obj;
		if (LehrerID == null) {
