 ...
 */
public class Rev9DTOKlassenLeitungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOKlassenLeitungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOKlassenLeitungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOKlassenLeitungPK.
	 * @param Klassen_ID   der Wert für das Attribut Klassen_ID
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public Rev9DTOKlassenLeitungPK(final Long Klassen_ID, final Long Lehrer_ID) {
		if (Klassen_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOKlassenLeitungPK other = (Rev9DTOKlassenLeitungPK) obj;
		if (Klassen_ID == null) {
