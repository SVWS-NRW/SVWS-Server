 ...
 */
public class Rev8DTOClientKonfigurationBenutzerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOClientKonfigurationBenutzerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOClientKonfigurationBenutzerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOClientKonfigurationBenutzerPK.
	 ...
	 */
	public Rev8DTOClientKonfigurationBenutzerPK(final Long Benutzer_ID, final String AppName, final String Schluessel) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOClientKonfigurationBenutzerPK other = (Rev8DTOClientKonfigurationBenutzerPK) obj;
		if (Benutzer_ID == null) {
