 ...
 */
public class Rev8DTOBenutzergruppenMitgliedPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOBenutzergruppenMitgliedPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOBenutzergruppenMitgliedPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOBenutzergruppenMitgliedPK.
	 * @param Gruppe_ID   der Wert für das Attribut Gruppe_ID
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 */
	public Rev8DTOBenutzergruppenMitgliedPK(final Long Gruppe_ID, final Long Benutzer_ID) {
		if (Gruppe_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOBenutzergruppenMitgliedPK other = (Rev8DTOBenutzergruppenMitgliedPK) obj;
		if (Gruppe_ID == null) {
