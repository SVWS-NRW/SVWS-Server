 ...
 */
public class Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK.
	 ...
	 */
	public Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK(final Long Zwischenergebnis_ID, final Long Blockung_Kurs_ID, final Long Schueler_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK other = (Rev8DTOGostBlockungZwischenergebnisKursSchuelerPK) obj;
		if (Zwischenergebnis_ID == null) {
