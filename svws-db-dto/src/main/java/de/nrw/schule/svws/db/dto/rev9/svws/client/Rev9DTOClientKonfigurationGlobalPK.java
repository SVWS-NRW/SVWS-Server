 ...
 */
public class Rev9DTOClientKonfigurationGlobalPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOClientKonfigurationGlobalPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOClientKonfigurationGlobalPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOClientKonfigurationGlobalPK.
	 * @param AppName   der Wert für das Attribut AppName
	 * @param Schluessel   der Wert für das Attribut Schluessel
	 */
	public Rev9DTOClientKonfigurationGlobalPK(final String AppName, final String Schluessel) {
		if (AppName == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOClientKonfigurationGlobalPK other = (Rev9DTOClientKonfigurationGlobalPK) obj;
		if (AppName == null) {
