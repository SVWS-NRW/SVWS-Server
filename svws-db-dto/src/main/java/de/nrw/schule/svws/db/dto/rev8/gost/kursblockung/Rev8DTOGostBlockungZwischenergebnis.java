...
public class Rev8DTOGostBlockungZwischenergebnis {
	 ...
	 */
	public Rev8DTOGostBlockungZwischenergebnis(final Long ID, final Long Blockung_ID, final Boolean IstMarkiert, final Boolean IstVorlage) {
		if (ID == null) { 
	...
	public String toString() {
		return "Rev8DTOGostBlockungZwischenergebnis(ID=" + this.ID + ", Blockung_ID=" + this.Blockung_ID + ", IstMarkiert=" + this.IstMarkiert + ", IstVorlage=" + this.IstVorlage + ")";
	}
