 ...
 */
public class Rev9DTOSchuelerDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOSchuelerDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOSchuelerDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOSchuelerDatenschutzPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Datenschutz_ID   der Wert für das Attribut Datenschutz_ID
	 */
	public Rev9DTOSchuelerDatenschutzPK(final Long Schueler_ID, final Long Datenschutz_ID) {
		if (Schueler_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOSchuelerDatenschutzPK other = (Rev9DTOSchuelerDatenschutzPK) obj;
		if (Schueler_ID == null) {
