 ...
 */
public class DevDTOGostJahrgangFaecherPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostJahrgangFaecherPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostJahrgangFaecherPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostJahrgangFaecherPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public DevDTOGostJahrgangFaecherPK(final Integer Abi_Jahrgang, final Long Fach_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostJahrgangFaecherPK other = (DevDTOGostJahrgangFaecherPK) obj;
		if (Abi_Jahrgang == null) {
