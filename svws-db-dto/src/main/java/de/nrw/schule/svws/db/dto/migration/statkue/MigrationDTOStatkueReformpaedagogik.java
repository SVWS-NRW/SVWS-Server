...
@NamedQuery(name="MigrationDTOStatkueReformpaedagogik.primaryKeyQuery", query="SELECT e FROM MigrationDTOStatkueReformpaedagogik e WHERE e.SF = ?1 AND e.RPG = ?2")
@NamedQuery(name="MigrationDTOStatkueReformpaedagogik.all.migration", query="SELECT e FROM MigrationDTOStatkueReformpaedagogik e WHERE e.SF IS NOT NULL AND e.RPG IS NOT NULL")
