...
@NamedQuery(name="Rev9DTOGostKlausurenVorgaben.istaudionotwendig", query="SELECT e FROM Rev9DTOGostKlausurenVorgaben e WHERE e.IstAudioNotwendig = :value")
@NamedQuery(name="Rev9DTOGostKlausurenVorgaben.istaudionotwendig.multiple", query="SELECT e FROM Rev9DTOGostKlausurenVorgaben e WHERE e.IstAudioNotwendig IN :value")
@NamedQuery(name="Rev9DTOGostKlausurenVorgaben.istvideonotwendig", query="SELECT e FROM Rev9DTOGostKlausurenVorgaben e WHERE e.IstVideoNotwendig = :value")
@NamedQuery(name="Rev9DTOGostKlausurenVorgaben.istvideonotwendig.multiple", query="SELECT e FROM Rev9DTOGostKlausurenVorgaben e WHERE e.IstVideoNotwendig IN :value")
...
public class Rev9DTOGostKlausurenVorgaben {
	...
	public String toString() {
		return "Rev9DTOGostKlausurenVorgaben(ID=" + this.ID + ", Abi_Jahrgang=" + this.Abi_Jahrgang + ", Halbjahr=" + this.Halbjahr + ", Fach_ID=" + this.Fach_ID + ", KursartAllg=" + this.KursartAllg + ", Quartal=" + this.Quartal + ", Dauer=" + this.Dauer + ", Auswahlzeit=" + this.Auswahlzeit + ", IstMdlPruefung=" + this.IstMdlPruefung + ", IstAudioNotwendig=" + this.IstAudioNotwendig + ", IstVideoNotwendig=" + this.IstVideoNotwendig + ", Bemerkungen=" + this.Bemerkungen + ")";
	}
