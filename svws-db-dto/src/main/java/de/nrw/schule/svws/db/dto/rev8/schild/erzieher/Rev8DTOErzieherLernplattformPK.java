 ...
 */
public class Rev8DTOErzieherLernplattformPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOErzieherLernplattformPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOErzieherLernplattformPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOErzieherLernplattformPK.
	 * @param ErzieherID   der Wert für das Attribut ErzieherID
	 * @param LernplattformID   der Wert für das Attribut LernplattformID
	 */
	public Rev8DTOErzieherLernplattformPK(final Long ErzieherID, final Long LernplattformID) {
		if (ErzieherID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOErzieherLernplattformPK other = (Rev8DTOErzieherLernplattformPK) obj;
		if (ErzieherID == null) {
