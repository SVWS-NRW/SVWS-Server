 ...
 */
public class DevDTOGostJahrgangBeratungslehrerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostJahrgangBeratungslehrerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostJahrgangBeratungslehrerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostJahrgangBeratungslehrerPK.
	 * @param Abi_Jahrgang   der Wert für das Attribut Abi_Jahrgang
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 */
	public DevDTOGostJahrgangBeratungslehrerPK(final Integer Abi_Jahrgang, final Long Lehrer_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostJahrgangBeratungslehrerPK other = (DevDTOGostJahrgangBeratungslehrerPK) obj;
		if (Abi_Jahrgang == null) {
