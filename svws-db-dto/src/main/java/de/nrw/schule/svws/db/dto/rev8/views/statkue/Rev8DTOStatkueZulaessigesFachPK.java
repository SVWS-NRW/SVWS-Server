 ...
 */
public class Rev8DTOStatkueZulaessigesFachPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueZulaessigesFachPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOStatkueZulaessigesFachPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueZulaessigesFachPK.
	 ...
	 */
	public Rev8DTOStatkueZulaessigesFachPK(final String Schulform, final String BG, final String Fach, final String Bezeichnung, final String Flag) {
		if (Schulform == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOStatkueZulaessigesFachPK other = (Rev8DTOStatkueZulaessigesFachPK) obj;
		if (Schulform == null) {
