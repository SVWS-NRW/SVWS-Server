 ...
 */
public class DevDTOGostSchuelerFachbelegungenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostSchuelerFachbelegungenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostSchuelerFachbelegungenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostSchuelerFachbelegungenPK.
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 * @param Fach_ID   der Wert für das Attribut Fach_ID
	 */
	public DevDTOGostSchuelerFachbelegungenPK(final Long Schueler_ID, final Long Fach_ID) {
		if (Schueler_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostSchuelerFachbelegungenPK other = (DevDTOGostSchuelerFachbelegungenPK) obj;
		if (Schueler_ID == null) {
