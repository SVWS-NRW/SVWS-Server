 ...
 */
public class MigrationDTOHerkunftSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOHerkunftSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOHerkunftSchulformenPK.
	 ...
	 */
	public MigrationDTOHerkunftSchulformenPK(final Long Herkunft_ID, final String Schulform_Kuerzel) {
		if (Herkunft_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOHerkunftSchulformenPK other = (MigrationDTOHerkunftSchulformenPK) obj;
		if (Herkunft_ID == null) {
