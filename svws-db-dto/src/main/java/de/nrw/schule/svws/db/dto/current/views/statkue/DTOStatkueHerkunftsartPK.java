 ...
 */
public class DTOStatkueHerkunftsartPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueHerkunftsartPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueHerkunftsartPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueHerkunftsartPK.
	 * @param SF   der Wert für das Attribut SF
	 * @param Art   der Wert für das Attribut Art
	 */
	public DTOStatkueHerkunftsartPK(final String SF, final String Art) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOStatkueHerkunftsartPK other = (DTOStatkueHerkunftsartPK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
