...
public class MigrationDTOKatalogBenutzerKompetenzGruppe {
	 ...
	 */
	public MigrationDTOKatalogBenutzerKompetenzGruppe(final Long KG_Spalte, final Long KG_Zeile, final Long KG_ID, final String KG_Bezeichnung) {
		if (KG_Spalte == null) { 
	...
	public String toString() {
		return "MigrationDTOKatalogBenutzerKompetenzGruppe(KG_Spalte=" + this.KG_Spalte + ", KG_Zeile=" + this.KG_Zeile + ", KG_ID=" + this.KG_ID + ", KG_Bezeichnung=" + this.KG_Bezeichnung + ")";
	}
