 ...
 */
public class MigrationDTOInternDQRNiveausPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOInternDQRNiveausPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOInternDQRNiveausPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOInternDQRNiveausPK.
	 ...
	 */
	public MigrationDTOInternDQRNiveausPK(final String Gliederung, final String FKS, final Integer DQR_Niveau) {
		if (Gliederung == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOInternDQRNiveausPK other = (MigrationDTOInternDQRNiveausPK) obj;
		if (Gliederung == null) {
