 ...
 */
@Entity
@IdClass(Rev8DTOSchuelerDatenschutzPK.class)
@Cacheable(DBEntityManager.use_db_caching)
@Table(name = "SchuelerDatenschutz")
@NamedQuery(name="Rev8DTOSchuelerDatenschutz.all", query="SELECT e FROM Rev8DTOSchuelerDatenschutz e")
@NamedQuery(name="Rev8DTOSchuelerDatenschutz.schueler_id", query="SELECT e FROM Rev8DTOSchuelerDatenschutz e WHERE e.Schueler_ID = :value")
@NamedQuery(name="Rev8DTOSchuelerDatenschutz.schueler_id.multiple", query="SELECT e FROM Rev8DTOSchuelerDatenschutz e WHERE e.Schueler_ID IN :value")
@NamedQuery(name="Rev8DTOSchuelerDatenschutz.datenschutz_id", query="SELECT e FROM Rev8DTOSchuelerDatenschutz e WHERE e.Datenschutz_ID = :value")
@NamedQuery(name="Rev8DTOSchuelerDatenschutz.datenschutz_id.multiple", query="SELECT e FROM Rev8DTOSchuelerDatenschutz e WHERE e.Datenschutz_ID IN :value")
@NamedQuery(name="Rev8DTOSchuelerDatenschutz.status", query="SELECT e FROM Rev8DTOSchuelerDatenschutz e WHERE e.Status = :value")
...
public class Rev8DTOSchuelerDatenschutz {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOSchuelerDatenschutz ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOSchuelerDatenschutz() {
	}
	 ...
	 */
	public Rev8DTOSchuelerDatenschutz(final Long Schueler_ID, final Long Datenschutz_ID, final Boolean Status, final Boolean Abgefragt) {
		if (Schueler_ID == null) { 
	...
	public String toString() {
		return "Rev8DTOSchuelerDatenschutz(Schueler_ID=" + this.Schueler_ID + ", Datenschutz_ID=" + this.Datenschutz_ID + ", Status=" + this.Status + ", Abgefragt=" + this.Abgefragt + ")";
	}
