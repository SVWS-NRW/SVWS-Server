 ...
 */
public class DevDTOLehrerLehramtPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLehramtPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOLehrerLehramtPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLehramtPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param LehramtKrz   der Wert für das Attribut LehramtKrz
	 */
	public DevDTOLehrerLehramtPK(final Long Lehrer_ID, final String LehramtKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOLehrerLehramtPK other = (DevDTOLehrerLehramtPK) obj;
		if (Lehrer_ID == null) {
