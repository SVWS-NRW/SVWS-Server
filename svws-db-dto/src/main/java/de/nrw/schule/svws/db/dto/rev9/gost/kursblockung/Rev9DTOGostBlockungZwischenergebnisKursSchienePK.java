 ...
 */
public class Rev9DTOGostBlockungZwischenergebnisKursSchienePK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungZwischenergebnisKursSchienePK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOGostBlockungZwischenergebnisKursSchienePK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOGostBlockungZwischenergebnisKursSchienePK.
	 ...
	 */
	public Rev9DTOGostBlockungZwischenergebnisKursSchienePK(final Long Zwischenergebnis_ID, final Long Blockung_Kurs_ID, final Long Schienen_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOGostBlockungZwischenergebnisKursSchienePK other = (Rev9DTOGostBlockungZwischenergebnisKursSchienePK) obj;
		if (Zwischenergebnis_ID == null) {
