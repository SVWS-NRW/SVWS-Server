 ...
 */
public class Rev9DTOErzieherDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOErzieherDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOErzieherDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOErzieherDatenschutzPK.
	 * @param ErzieherID   der Wert für das Attribut ErzieherID
	 * @param DatenschutzID   der Wert für das Attribut DatenschutzID
	 */
	public Rev9DTOErzieherDatenschutzPK(final Long ErzieherID, final Long DatenschutzID) {
		if (ErzieherID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOErzieherDatenschutzPK other = (Rev9DTOErzieherDatenschutzPK) obj;
		if (ErzieherID == null) {
