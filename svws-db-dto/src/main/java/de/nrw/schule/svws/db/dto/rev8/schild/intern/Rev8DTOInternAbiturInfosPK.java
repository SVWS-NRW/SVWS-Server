 ...
 */
public class Rev8DTOInternAbiturInfosPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternAbiturInfosPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOInternAbiturInfosPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOInternAbiturInfosPK.
	 ...
	 */
	public Rev8DTOInternAbiturInfosPK(final String AbiFach, final String AbiInfoKrz, final String Bedingung, final String PrfOrdnung) {
		if (AbiFach == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOInternAbiturInfosPK other = (Rev8DTOInternAbiturInfosPK) obj;
		if (AbiFach == null) {
