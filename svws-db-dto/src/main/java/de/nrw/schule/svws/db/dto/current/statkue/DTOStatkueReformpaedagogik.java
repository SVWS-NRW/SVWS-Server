 ...
 */
@Entity
@IdClass(DTOStatkueReformpaedagogikPK.class)
@Cacheable(DBEntityManager.use_db_caching)
@Table(name = "Statkue_Reformpaedagogik")
@NamedQuery(name="DTOStatkueReformpaedagogik.all", query="SELECT e FROM DTOStatkueReformpaedagogik e")
@NamedQuery(name="DTOStatkueReformpaedagogik.sf", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.SF = :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.sf.multiple", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.SF IN :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.rpg", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.RPG = :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.rpg.multiple", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.RPG IN :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.beschreibung", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.Beschreibung = :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.beschreibung.multiple", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.Beschreibung IN :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.geaendert", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.geaendert = :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.geaendert.multiple", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.geaendert IN :value")
@NamedQuery(name="DTOStatkueReformpaedagogik.gueltigvon", query="SELECT e FROM DTOStatkueReformpaedagogik e WHERE e.gueltigVon = :value")
...
public class DTOStatkueReformpaedagogik {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueReformpaedagogik ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueReformpaedagogik() {
	}
	 ...
	 */
	public DTOStatkueReformpaedagogik(final String SF, final String RPG, final String Beschreibung) {
		if (SF == null) { 
	...
	public String toString() {
		return "DTOStatkueReformpaedagogik(SF=" + this.SF + ", RPG=" + this.RPG + ", Beschreibung=" + this.Beschreibung + ", geaendert=" + this.geaendert + ", gueltigVon=" + this.gueltigVon + ", gueltigBis=" + this.gueltigBis + ")";
	}
