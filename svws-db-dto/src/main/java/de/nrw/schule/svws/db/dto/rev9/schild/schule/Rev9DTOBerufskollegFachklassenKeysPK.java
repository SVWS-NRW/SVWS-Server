 ...
 */
public class Rev9DTOBerufskollegFachklassenKeysPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOBerufskollegFachklassenKeysPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOBerufskollegFachklassenKeysPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOBerufskollegFachklassenKeysPK.
	 ...
	 */
	public Rev9DTOBerufskollegFachklassenKeysPK(final Integer FachklassenIndex, final String Schluessel, final String Schluessel2) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOBerufskollegFachklassenKeysPK other = (Rev9DTOBerufskollegFachklassenKeysPK) obj;
		if (FachklassenIndex == null) {
