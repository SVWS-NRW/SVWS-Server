 ...
 */
public class DevDTOClientKonfigurationBenutzerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOClientKonfigurationBenutzerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOClientKonfigurationBenutzerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOClientKonfigurationBenutzerPK.
	 ...
	 */
	public DevDTOClientKonfigurationBenutzerPK(final Long Benutzer_ID, final String AppName, final String Schluessel) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOClientKonfigurationBenutzerPK other = (DevDTOClientKonfigurationBenutzerPK) obj;
		if (Benutzer_ID == null) {
