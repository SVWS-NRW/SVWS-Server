...
public class MigrationDTOFaecherKatalogSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOFaecherKatalogSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private MigrationDTOFaecherKatalogSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOFaecherKatalogSchulformenPK.
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOFaecherKatalogSchulformenPK other = (MigrationDTOFaecherKatalogSchulformenPK) obj;
		if (Fach_ID == null) {
