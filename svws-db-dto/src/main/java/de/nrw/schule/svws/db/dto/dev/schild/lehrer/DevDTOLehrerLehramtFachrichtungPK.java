 ...
 */
public class DevDTOLehrerLehramtFachrichtungPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLehramtFachrichtungPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOLehrerLehramtFachrichtungPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOLehrerLehramtFachrichtungPK.
	 * @param Lehrer_ID   der Wert für das Attribut Lehrer_ID
	 * @param FachrKrz   der Wert für das Attribut FachrKrz
	 */
	public DevDTOLehrerLehramtFachrichtungPK(final Long Lehrer_ID, final String FachrKrz) {
		if (Lehrer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOLehrerLehramtFachrichtungPK other = (DevDTOLehrerLehramtFachrichtungPK) obj;
		if (Lehrer_ID == null) {
