 ...
 */
public class DevDTOBenutzergruppenMitgliedPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOBenutzergruppenMitgliedPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOBenutzergruppenMitgliedPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOBenutzergruppenMitgliedPK.
	 * @param Gruppe_ID   der Wert für das Attribut Gruppe_ID
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 */
	public DevDTOBenutzergruppenMitgliedPK(final Long Gruppe_ID, final Long Benutzer_ID) {
		if (Gruppe_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOBenutzergruppenMitgliedPK other = (DevDTOBenutzergruppenMitgliedPK) obj;
		if (Gruppe_ID == null) {
