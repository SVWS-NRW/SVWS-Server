 ...
 */
public class DTOBerufskollegFachklassenKeysPK implements Serializable {
	 ...
	 */
	public DTOBerufskollegFachklassenKeysPK(final Integer FachklassenIndex, final String Schluessel, final String Schluessel2) {
