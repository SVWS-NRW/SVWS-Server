...
public class DTOInternPruefungsOrdnungOptionenPK implements Serializable {
	 ...
	 */
	public DTOInternPruefungsOrdnungOptionenPK(final String OP_Art, final String OP_Bildungsgang, final String OP_Jahrgaenge, final String OP_Krz, final String OP_Name, final String OP_POKrz, final Integer OP_Reihenfolge, final String OP_Schulformen) {
		if (OP_Art == null) { 
