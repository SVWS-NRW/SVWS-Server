 ...
 */
public class DTOInternPrfSemesterAbschlussPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOInternPrfSemesterAbschlussPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOInternPrfSemesterAbschlussPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOInternPrfSemesterAbschlussPK.
	 * @param Nr   der Wert für das Attribut Nr
	 * @param Schulform   der Wert für das Attribut Schulform
	 */
	public DTOInternPrfSemesterAbschlussPK(final String Nr, final String Schulform) {
		if (Nr == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOInternPrfSemesterAbschlussPK other = (DTOInternPrfSemesterAbschlussPK) obj;
		if (Nr == null) {
			if (other.Nr != null)
				return false;
