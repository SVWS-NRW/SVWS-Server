 ...
 */
public class Rev9DTOBenutzerKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOBenutzerKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOBenutzerKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOBenutzerKompetenzPK.
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public Rev9DTOBenutzerKompetenzPK(final Long Benutzer_ID, final Long Kompetenz_ID) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOBenutzerKompetenzPK other = (Rev9DTOBenutzerKompetenzPK) obj;
		if (Benutzer_ID == null) {
