 ...
 */
public class Rev8DTOStatkueHerkunftsschulformPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueHerkunftsschulformPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOStatkueHerkunftsschulformPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOStatkueHerkunftsschulformPK.
	 * @param SF   der Wert für das Attribut SF
	 * @param HSF   der Wert für das Attribut HSF
	 */
	public Rev8DTOStatkueHerkunftsschulformPK(final String SF, final String HSF) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOStatkueHerkunftsschulformPK other = (Rev8DTOStatkueHerkunftsschulformPK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
