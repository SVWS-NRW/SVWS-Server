...
@NamedQuery(name="DTOStatkueAbgangsart.primaryKeyQuery", query="SELECT e FROM DTOStatkueAbgangsart e WHERE e.SF = ?1 AND e.Art = ?2 AND e.KZ_Bereich = ?3 AND e.KZ_Bereich_JG = ?4 AND e.AbgangsJG = ?5")
@NamedQuery(name="DTOStatkueAbgangsart.all.migration", query="SELECT e FROM DTOStatkueAbgangsart e WHERE e.SF IS NOT NULL AND e.Art IS NOT NULL AND e.KZ_Bereich IS NOT NULL AND e.KZ_Bereich_JG IS NOT NULL AND e.AbgangsJG IS NOT NULL")
