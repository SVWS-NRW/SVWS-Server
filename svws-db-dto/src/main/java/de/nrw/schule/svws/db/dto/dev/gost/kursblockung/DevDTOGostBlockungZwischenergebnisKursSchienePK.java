 ...
 */
public class DevDTOGostBlockungZwischenergebnisKursSchienePK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostBlockungZwischenergebnisKursSchienePK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOGostBlockungZwischenergebnisKursSchienePK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOGostBlockungZwischenergebnisKursSchienePK.
	 ...
	 */
	public DevDTOGostBlockungZwischenergebnisKursSchienePK(final Long Zwischenergebnis_ID, final Long Blockung_Kurs_ID, final Long Schienen_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOGostBlockungZwischenergebnisKursSchienePK other = (DevDTOGostBlockungZwischenergebnisKursSchienePK) obj;
		if (Zwischenergebnis_ID == null) {
