 ...
 */
public class Rev8DTOBenutzerKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOBenutzerKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOBenutzerKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOBenutzerKompetenzPK.
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public Rev8DTOBenutzerKompetenzPK(final Long Benutzer_ID, final Long Kompetenz_ID) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOBenutzerKompetenzPK other = (Rev8DTOBenutzerKompetenzPK) obj;
		if (Benutzer_ID == null) {
