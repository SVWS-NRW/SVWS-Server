...
@NamedQuery(name="DTOInternPruefungsOrdnungOptionen.primaryKeyQuery", query="SELECT e FROM DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Art = ?1 AND e.OP_Bildungsgang = ?2 AND e.OP_Jahrgaenge = ?3 AND e.OP_Krz = ?4 AND e.OP_Name = ?5 AND e.OP_POKrz = ?6 AND e.OP_Reihenfolge = ?7 AND e.OP_Schulformen = ?8")
@NamedQuery(name="DTOInternPruefungsOrdnungOptionen.all.migration", query="SELECT e FROM DTOInternPruefungsOrdnungOptionen e WHERE e.OP_Art IS NOT NULL AND e.OP_Bildungsgang IS NOT NULL AND e.OP_Jahrgaenge IS NOT NULL AND e.OP_Krz IS NOT NULL AND e.OP_Name IS NOT NULL AND e.OP_POKrz IS NOT NULL AND e.OP_Reihenfolge IS NOT NULL AND e.OP_Schulformen IS NOT NULL")
