 ...
 */
public class DevDTOViewBenutzerKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOViewBenutzerKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOViewBenutzerKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOViewBenutzerKompetenzPK.
	 * @param Benutzer_ID   der Wert für das Attribut Benutzer_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public DevDTOViewBenutzerKompetenzPK(final Long Benutzer_ID, final Long Kompetenz_ID) {
		if (Benutzer_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOViewBenutzerKompetenzPK other = (DevDTOViewBenutzerKompetenzPK) obj;
		if (Benutzer_ID == null) {
