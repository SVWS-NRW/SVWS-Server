 ...
 */
public class DTOSchildInternBerufsebenenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOSchildInternBerufsebenenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOSchildInternBerufsebenenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOSchildInternBerufsebenenPK.
	 * @param Berufsebene   der Wert für das Attribut Berufsebene
	 * @param Kuerzel   der Wert für das Attribut Kuerzel
	 */
	public DTOSchildInternBerufsebenenPK(final Integer Berufsebene, final String Kuerzel) {
		if (Berufsebene == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOSchildInternBerufsebenenPK other = (DTOSchildInternBerufsebenenPK) obj;
		if (Berufsebene == null) {
