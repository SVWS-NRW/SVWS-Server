 ...
 */
public class DTOStatkueHerkunftsschulformPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueHerkunftsschulformPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueHerkunftsschulformPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueHerkunftsschulformPK.
	 * @param SF   der Wert für das Attribut SF
	 * @param HSF   der Wert für das Attribut HSF
	 */
	public DTOStatkueHerkunftsschulformPK(final String SF, final String HSF) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOStatkueHerkunftsschulformPK other = (DTOStatkueHerkunftsschulformPK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
