 ...
 */
public class Rev8DTOBenutzergruppenKompetenzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOBenutzergruppenKompetenzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOBenutzergruppenKompetenzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOBenutzergruppenKompetenzPK.
	 * @param Gruppe_ID   der Wert für das Attribut Gruppe_ID
	 * @param Kompetenz_ID   der Wert für das Attribut Kompetenz_ID
	 */
	public Rev8DTOBenutzergruppenKompetenzPK(final Long Gruppe_ID, final Long Kompetenz_ID) {
		if (Gruppe_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOBenutzergruppenKompetenzPK other = (Rev8DTOBenutzergruppenKompetenzPK) obj;
		if (Gruppe_ID == null) {
