...
import de.nrw.schule.svws.db.dto.current.gost.klausurplanung.DTOGostKlausurenAufsichten;
import de.nrw.schule.svws.db.dto.current.gost.klausurplanung.DTOGostKlausurenEntfall;
import de.nrw.schule.svws.db.dto.current.gost.klausurplanung.DTOGostKlausurenKlausuren;
     ...
     */
     private static final HashMap<String, Class<? extends Object>> getMapDTOName2DTOClass() {
         if (mapDTOName2DTOClass == null) {
             ...
             mapDTOName2DTOClass.put(DTOGostKlausurenAufsichten.class.getSimpleName(),DTOGostKlausurenAufsichten.class);
             mapDTOName2DTOClass.put(DTOGostKlausurenEntfall.class.getSimpleName(),DTOGostKlausurenEntfall.class);
             mapDTOName2DTOClass.put(DTOGostKlausurenKlausuren.class.getSimpleName(),DTOGostKlausurenKlausuren.class);
     ...
     */
     private static final HashMap<String, Class<? extends Object>> getMapTablename2DTOClass() {
         if (mapTablename2DTOClass == null) {
             ...
             mapTablename2DTOClass.put("Gost_Klausuren_Aufsichten",DTOGostKlausurenAufsichten.class);
             mapTablename2DTOClass.put("Gost_Klausuren_Entfall",DTOGostKlausurenEntfall.class);
             mapTablename2DTOClass.put("Gost_Klausuren_Klausuren",DTOGostKlausurenKlausuren.class);
