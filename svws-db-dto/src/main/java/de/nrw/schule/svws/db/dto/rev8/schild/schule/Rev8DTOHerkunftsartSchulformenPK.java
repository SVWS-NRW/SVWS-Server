 ...
 */
public class Rev8DTOHerkunftsartSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOHerkunftsartSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOHerkunftsartSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOHerkunftsartSchulformenPK.
	 ...
	 */
	public Rev8DTOHerkunftsartSchulformenPK(final Long Herkunftsart_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOHerkunftsartSchulformenPK other = (Rev8DTOHerkunftsartSchulformenPK) obj;
		if (Herkunftsart_ID == null) {
