 ...
 */
public class DTOStatkueFoerderschwerpunktePK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueFoerderschwerpunktePK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DTOStatkueFoerderschwerpunktePK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DTOStatkueFoerderschwerpunktePK.
	 * @param SF   der Wert für das Attribut SF
	 * @param FSP   der Wert für das Attribut FSP
	 * @param Flag   der Wert für das Attribut Flag
	 */
	public DTOStatkueFoerderschwerpunktePK(final String SF, final String FSP, final String Flag) {
		if (SF == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOStatkueFoerderschwerpunktePK other = (DTOStatkueFoerderschwerpunktePK) obj;
		if (SF == null) {
			if (other.SF != null)
				return false;
