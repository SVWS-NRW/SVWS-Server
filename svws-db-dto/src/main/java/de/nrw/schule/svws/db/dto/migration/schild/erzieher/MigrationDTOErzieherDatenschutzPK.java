 ...
 */
public class MigrationDTOErzieherDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOErzieherDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	...
	/**
	 * Erstellt ein neues Objekt der Klasse MigrationDTOErzieherDatenschutzPK.
	 * @param ErzieherID   der Wert für das Attribut ErzieherID
	 * @param DatenschutzID   der Wert für das Attribut DatenschutzID
	 */
	public MigrationDTOErzieherDatenschutzPK(final Long ErzieherID, final Long DatenschutzID) {
		if (ErzieherID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationDTOErzieherDatenschutzPK other = (MigrationDTOErzieherDatenschutzPK) obj;
		if (ErzieherID == null) {
