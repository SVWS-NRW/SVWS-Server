 ...
 */
public class Rev9DTOLehrerDatenschutzPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOLehrerDatenschutzPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOLehrerDatenschutzPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOLehrerDatenschutzPK.
	 * @param LehrerID   der Wert für das Attribut LehrerID
	 * @param DatenschutzID   der Wert für das Attribut DatenschutzID
	 */
	public Rev9DTOLehrerDatenschutzPK(final Long LehrerID, final Long DatenschutzID) {
		if (LehrerID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOLehrerDatenschutzPK other = (Rev9DTOLehrerDatenschutzPK) obj;
		if (LehrerID == null) {
