 ...
 */
public class Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK.
	 ...
	 */
	public Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK(final Long Schulgliederung_ID, final String Abschluss_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK other = (Rev8DTOAlleSchulgliederungenAbschluesseAllgmeinbildendPK) obj;
		if (Schulgliederung_ID == null) {
