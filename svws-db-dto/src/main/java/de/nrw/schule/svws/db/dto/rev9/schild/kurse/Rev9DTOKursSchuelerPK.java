 ...
 */
public class Rev9DTOKursSchuelerPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOKursSchuelerPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev9DTOKursSchuelerPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev9DTOKursSchuelerPK.
	 * @param Kurs_ID   der Wert für das Attribut Kurs_ID
	 * @param Schueler_ID   der Wert für das Attribut Schueler_ID
	 */
	public Rev9DTOKursSchuelerPK(final Long Kurs_ID, final Long Schueler_ID) {
		if (Kurs_ID == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev9DTOKursSchuelerPK other = (Rev9DTOKursSchuelerPK) obj;
		if (Kurs_ID == null) {
