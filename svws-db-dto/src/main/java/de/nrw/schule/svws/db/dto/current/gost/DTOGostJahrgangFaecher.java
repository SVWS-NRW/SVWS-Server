...
@NamedQuery(name="DTOGostJahrgangFaecher.wochenstundenef1", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.WochenstundenEF1 = :value")
@NamedQuery(name="DTOGostJahrgangFaecher.wochenstundenef1.multiple", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.WochenstundenEF1 IN :value")
@NamedQuery(name="DTOGostJahrgangFaecher.wochenstundenef2", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.WochenstundenEF2 = :value")
@NamedQuery(name="DTOGostJahrgangFaecher.wochenstundenef2.multiple", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.WochenstundenEF2 IN :value")
...
@NamedQuery(name="DTOGostJahrgangFaecher.schiftlichkeitef1", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.SchiftlichkeitEF1 = :value")
@NamedQuery(name="DTOGostJahrgangFaecher.schiftlichkeitef1.multiple", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.SchiftlichkeitEF1 IN :value")
@NamedQuery(name="DTOGostJahrgangFaecher.schiftlichkeitef2", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.SchiftlichkeitEF2 = :value")
@NamedQuery(name="DTOGostJahrgangFaecher.schiftlichkeitef2.multiple", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.SchiftlichkeitEF2 IN :value")
@NamedQuery(name="DTOGostJahrgangFaecher.nurmuendlich", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.NurMuendlich = :value")
@NamedQuery(name="DTOGostJahrgangFaecher.nurmuendlich.multiple", query="SELECT e FROM DTOGostJahrgangFaecher e WHERE e.NurMuendlich IN :value")
...
public class DTOGostJahrgangFaecher {
	 ...
	 */
	public DTOGostJahrgangFaecher(final Integer Abi_Jahrgang, final Long Fach_ID, final Boolean WaehlbarEF1, final Boolean WaehlbarEF2, final Boolean WaehlbarQ11, final Boolean WaehlbarQ12, final Boolean WaehlbarQ21, final Boolean WaehlbarQ22, final Boolean WaehlbarAbiGK, final Boolean WaehlbarAbiLK, final Boolean NurMuendlich) {
