 ...
 */
public class Rev8DTOAlleFoerderschwerpunkteSchulformenPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAlleFoerderschwerpunkteSchulformenPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private Rev8DTOAlleFoerderschwerpunkteSchulformenPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse Rev8DTOAlleFoerderschwerpunkteSchulformenPK.
	 ...
	 */
	public Rev8DTOAlleFoerderschwerpunkteSchulformenPK(final Long Foerderschwerpunkt_ID, final String Schulform_Kuerzel) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rev8DTOAlleFoerderschwerpunkteSchulformenPK other = (Rev8DTOAlleFoerderschwerpunkteSchulformenPK) obj;
		if (Foerderschwerpunkt_ID == null) {
