 ...
 */
public class DevDTOClientKonfigurationGlobalPK implements Serializable {
	...
	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOClientKonfigurationGlobalPK ohne eine Initialisierung der Attribute.
	 */
	@SuppressWarnings("unused")
	private DevDTOClientKonfigurationGlobalPK() {
	}

	/**
	 * Erstellt ein neues Objekt der Klasse DevDTOClientKonfigurationGlobalPK.
	 * @param AppName   der Wert für das Attribut AppName
	 * @param Schluessel   der Wert für das Attribut Schluessel
	 */
	public DevDTOClientKonfigurationGlobalPK(final String AppName, final String Schluessel) {
		if (AppName == null) { 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DevDTOClientKonfigurationGlobalPK other = (DevDTOClientKonfigurationGlobalPK) obj;
		if (AppName == null) {
