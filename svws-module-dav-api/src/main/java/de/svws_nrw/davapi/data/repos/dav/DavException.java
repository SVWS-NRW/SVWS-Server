...
public class DavException extends Exception {
	...
	public enum ErrorCode {
		 ...
		 */
		ErrorCode(final int statusCode, final String status) {
		 ...
		 */
		public Response getDavResponse(final String href) {
	 ...
	 */
	public DavException(final ErrorCode errorCode) {
		super();
	 ...
	 */
	public DavException(final ErrorCode errorCode, final String message) {
		super(message);
		this.errorCode = errorCode;
	}
	 ...
	 */
	public DavException(final ErrorCode errorCode, final Throwable cause) {
		super(cause);
		this.errorCode = errorCode;
	}
	 ...
	 * @param cause      die Ursache dieser Exception
	 */
	public DavException(final ErrorCode errorCode, final String message, final Throwable cause) {
		super(message, cause);
		this.errorCode = errorCode;
	}
