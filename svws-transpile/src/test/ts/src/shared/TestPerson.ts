...
export class TestPerson extends JavaObject {
	...
	public static transpilerFromJSON(json: string): TestPerson {
		...
		if (obj.id === undefined) {
			throw new TypeError('invalid json format, missing attribute id');
		}
		result.id = obj.id;
		if (obj.kuerzel === undefined) {
			throw new TypeError('invalid json format, missing attribute kuerzel');
		}
		result.kuerzel = obj.kuerzel;
		result.titel = obj.titel ?? null;
		if (obj.nachname === undefined) {
			throw new TypeError('invalid json format, missing attribute nachname');
		}
		result.nachname = obj.nachname;
		if (obj.vorname === undefined) {
			throw new TypeError('invalid json format, missing attribute vorname');
		}
