...
/**
 * Diese Klasse dient als DTO für die CSV-Tabelle Statkue_LehrerAbgang.
 */
@JsonPropertyOrder({"ID","Kurztext","Langtext","Beginn","Ende","Sort","ASDSchluessel","gueltigVon","gueltigBis"})
public class DataStatkueLehrerAbgangsgrund {
	...
	private static List<DataStatkueLehrerAbgangsgrund> cache = null;
	 ...
	 */
	public static List<DataStatkueLehrerAbgangsgrund> get() {
		if (cache == null)
			cache = CsvReader.fromResource("schema/csv/statkue/Statkue_LehrerAbgang.csv", DataStatkueLehrerAbgangsgrund.class); 
		return cache;
	}
