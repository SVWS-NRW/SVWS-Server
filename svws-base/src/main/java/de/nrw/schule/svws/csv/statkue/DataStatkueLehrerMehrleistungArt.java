...
/**
 * Diese Klasse dient als DTO für die CSV-Tabelle Statkue_LehrerMehrleistung.
 */
@JsonPropertyOrder({"ID","Kurztext","Langtext","Beginn","Ende","Sort","gueltigVon","gueltigBis"})
public class DataStatkueLehrerMehrleistungArt {
	...
	/** Statkue Tabelle IT.NRW: Bezeichnung der Art der Mehrleistung */
	@JsonProperty
	...
	private static List<DataStatkueLehrerMehrleistungArt> cache = null;
	 ...
	 */
	public static List<DataStatkueLehrerMehrleistungArt> get() {
		if (cache == null)
			cache = CsvReader.fromResource("schema/csv/statkue/Statkue_LehrerMehrleistung.csv", DataStatkueLehrerMehrleistungArt.class); 
		return cache;
	}
