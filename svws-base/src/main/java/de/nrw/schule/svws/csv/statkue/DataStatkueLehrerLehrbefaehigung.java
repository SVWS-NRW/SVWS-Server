...
/**
 * Diese Klasse dient als DTO für die CSV-Tabelle Statkue_LehrerLehrbefaehigung.
 */
@JsonPropertyOrder({"ID","Kurztext","Langtext","Beginn","Ende","Sort","gueltigVon","gueltigBis"})
public class DataStatkueLehrerLehrbefaehigung {
	...
	/** Statkue Tabelle IT.NRW: Bezeichnung der Lehrbefähigung */
	@JsonProperty
	...
	/** Statkue Tabelle IT.NRW: Sortierung der Lehrbefähigungen */
	@JsonProperty
	public Integer Sort;
	...
	private static List<DataStatkueLehrerLehrbefaehigung> cache = null;
	 ...
	 */
	public static List<DataStatkueLehrerLehrbefaehigung> get() {
		if (cache == null)
			cache = CsvReader.fromResource("schema/csv/statkue/Statkue_LehrerLehrbefaehigung.csv", DataStatkueLehrerLehrbefaehigung.class); 
		return cache;
	}
