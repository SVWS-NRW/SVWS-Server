...
/**
 * Diese Klasse dient als DTO für die CSV-Tabelle Statkue_LehrerFachrichtung.
 */
@JsonPropertyOrder({"ID","Kurztext","Langtext","Beginn","Ende","Sort","gueltigVon","gueltigBis"})
public class DataStatkueLehrerFachrichtung {
	...
	/** Statkue Tabelle IT.NRW: Bezeichnung der Fachrichtung */
	@JsonProperty
	...
	/** Statkue Tabelle IT.NRW: Sortierung der Fachrichtungen */
	@JsonProperty
	public Integer Sort;
	...
	private static List<DataStatkueLehrerFachrichtung> cache = null;
	 ...
	 */
	public static List<DataStatkueLehrerFachrichtung> get() {
		if (cache == null)
			cache = CsvReader.fromResource("schema/csv/statkue/Statkue_LehrerFachrichtung.csv", DataStatkueLehrerFachrichtung.class); 
		return cache;
	}
