 ...
 * <ul>
 *   <li> {@link ValidatorLsv01LehrerStammdatenVorname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsv01LehrerStammdatenVorname")
class TestValidatorLsv01LehrerStammdatenVorname {
	...
	/**
	 * Test von ValidatorLsv01LehrerStammdatenVorname
	 *
	 * @param vorname    der Vorname, welcher bei den eingelesenen Testdaten ersetzt wird
	 * @param result     gibt an, welches Ergebnis bei den Testdaten erwartet wird
	 */
	@DisplayName("Tests für ValidatorLsv01LehrerStammdaten")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_VORNAME)
	void testValidatorLsv01LehrerStammdaten(final String vorname, final boolean result) {
		// Testdaten setzen
		lehrerTestdaten_001.vorname = vorname;

		// Erzeuge den Kontext für die Validierung
		final ValidatorKontext kontext = new ValidatorKontext(schuleTestdaten_001, true);
		final ValidatorLsv01LehrerStammdatenVorname validator = new ValidatorLsv01LehrerStammdatenVorname(lehrerTestdaten_001, kontext);
