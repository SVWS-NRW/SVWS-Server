...
class TestValidatorLpla10LehrerPersonaldatenLehramtLehrbefaehigung {
	...
	// Bei dem ersten Fall gibt es nur die Lehrbefähigung 'OA' => true
	// Bei dem zweiten Fall ist die Lehrbefähigung, insgesamt sind es jetzt zwei, ungleich 'OA'
	...
	void testValidatorLpla10LehrerPersonaldatenLehramtLehrbefaehigung(final long idTest, final long idLehramtTest, final long idLehrbefaehigungTest, final Long idAnerkennungsgrundTest, final boolean result) {
		...
		final ValidatorLpla10LehrerPersonaldatenLehramtLehrbefaehigung validator = new ValidatorLpla10LehrerPersonaldatenLehramtLehrbefaehigung(() -> lehraemterAusJson, kontext);
