 ...
 * <ul>
 *   <li> {@link ValidatorLsn02LehrerStammdatenNachname}
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsn02LehrerStammdatenNachname")
class TestValidatorLsn02LehrerStammdatenNachname {
	...
	/**
	 * Test von ValidatorLsn02LehrerStammdatenNachname
	 *
	 * CoreType: LehrerStammdaten
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLsn02LehrerStammdatenNachname")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_NACHNAME)
	void testValidatorLsn02LehrerStammdatenNachname(final String nachname, final boolean result) {
		// Testdaten setzen
		lehrerTestdaten_001.nachname = nachname;

		// Erzeuge den Kontext für die Validierung
		final ValidatorKontext kontext = new ValidatorKontext(schuleTestdaten_001, true);
		final ValidatorLsn02LehrerStammdatenNachname validator = new ValidatorLsn02LehrerStammdatenNachname(() -> lehrerTestdaten_001.nachname, kontext);
