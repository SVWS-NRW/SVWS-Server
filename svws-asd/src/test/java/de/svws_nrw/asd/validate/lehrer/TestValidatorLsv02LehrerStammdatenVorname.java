 ...
 * <ul>
 *   <li> {@link ValidatorLsv02LehrerStammdatenVorname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsv0_LehrerStammdatenVorname")
class TestValidatorLsv02LehrerStammdatenVorname {
	...
	/**
	 * Test von ValidatorLsv02LehrerStammdatenVorname
	 *
	 * @param vorname    der Vorname, welcher bei den eingelesenen Testdaten ersetzt wird
	 * @param result     gibt an, welches Ergebnis bei den Testdaten erwartet wird
	 */
	@DisplayName("Tests für ValidatorLsv02LehrerStammdatenVorname")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_VORNAME)
	void testValidatorLsv02LehrerStammdatenVorname(final String vorname, final boolean result) {
		// Testdaten setzen
		lehrerTestdaten_001.vorname = vorname;

		// Erzeuge den Kontext für die Validierung
		final ValidatorKontext kontext = new ValidatorKontext(schuleTestdaten_001, true);
		final ValidatorLsv02LehrerStammdatenVorname validator = new ValidatorLsv02LehrerStammdatenVorname(lehrerTestdaten_001, kontext);
