 ...
 * <ul>
 *   <li> {@link ValidatorLsv06LehrerStammdatenVorname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsv06LehrerStammdatenVorname")
class TestValidatorLsv06LehrerStammdatenVorname {
	...
	/**
	 * Test von ValidatorLsv06LehrerStammdatenVorname
	 *
	 * @param vorname    der Vorname, welcher bei den eingelesenen Testdaten ersetzt wird
	 * @param result     gibt an, welches Ergebnis bei den Testdaten erwartet wird
	 */
	@DisplayName("Tests für ValidatorLsv06LehrerStammdatenVorname")
	@ParameterizedTest
	...
	void testValidatorLehrerStammdaten(final String vorname, final boolean result) {
		...
		final ValidatorLsv06LehrerStammdatenVorname validator = new ValidatorLsv06LehrerStammdatenVorname(lehrerTestdaten_001, kontext);
