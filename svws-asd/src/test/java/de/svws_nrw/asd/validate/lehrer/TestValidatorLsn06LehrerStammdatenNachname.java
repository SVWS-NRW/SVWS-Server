 ...
 * <ul>
 *   <li> {@link ValidatorLsn06LehrerStammdatenNachname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Tests ValidatorLsn06LehrerStammdatenNachname")
class TestValidatorLsn06LehrerStammdatenNachname {
	...
	/**
	 * Test von ValidatorLsn06LehrerStammdatenNachname
	 *
	 * CoreType: LehrerStammdaten
	 *
	...
	void testValidatorLehrerStammdatenNachname(final String nachname, final boolean result) {
		...
		final ValidatorLsn06LehrerStammdatenNachname validator = new ValidatorLsn06LehrerStammdatenNachname(() -> lehrerTestdaten_001.nachname, kontext);
