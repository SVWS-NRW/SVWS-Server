...
class TestValidatorLppr04LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis {
	...
	void testValidatorLehrerPersonalabschnittsdatenRechtsverhaeltnisGeburtsdatum_GeburtsdatumZuJung() {
		...
		try {
			...
			LehrerPersonalabschnittsdaten_Plausibel.rechtsverhaeltnis = "X";
			final ValidatorLppr04LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis validator = new ValidatorLppr04LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis(LehrerPersonalabschnittsdaten_Plausibel, geburtsdatum, kontext);
