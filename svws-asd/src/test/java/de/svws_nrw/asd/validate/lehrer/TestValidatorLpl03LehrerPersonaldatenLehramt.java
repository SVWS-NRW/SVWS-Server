...
class TestValidatorLpl03LehrerPersonaldatenLehramt {
	...
	/**
	 * Test von ValidatorLpl03LehrerPersonaldatenLehramt
	 *
	...
	void testValidatorLpl03LehrerPersonaldatenLehramt(final long id, final String geburtsdatum, final String schulform, final boolean result) {
		...
		final ValidatorLpl03LehrerPersonaldatenLehramt validator =
				new ValidatorLpl03LehrerPersonaldatenLehramt(
