...
class TestValidatorLpl02LehrerPersonaldatenLehramt {
	...
	void testValidatorLplLehrerPersonaldatenLehramt(final long id, final long idLehrer, final long idKatalogLehramt, final String schulform, final boolean result) {
		...
		final ValidatorLpl02LehrerPersonaldatenLehramt validator = new ValidatorLpl02LehrerPersonaldatenLehramt(() -> listLehrerLehramtEintrag, kontext);
