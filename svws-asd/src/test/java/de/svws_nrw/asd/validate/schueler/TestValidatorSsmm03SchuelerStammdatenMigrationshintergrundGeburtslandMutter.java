 ...
 * {@link ValidatorSsmm03SchuelerStammdatenMigrationshintergrundGeburtslandMutter}.
 */
@DisplayName("Tests ValidatorSsmm03SchuelerStammdatenMigrationshintergrundGeburtslandMutter")
class TestValidatorSsmm03SchuelerStammdatenMigrationshintergrundGeburtslandMutter {
	...
	/**
	 * Test von ValidatorSsmm03SchuelerStammdatenMigrationshintergrundGeburtslandMutter
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorSsmm03SchuelerStammdatenMigrationshintergrundGeburtslandMutter")
	@ParameterizedTest
	@CsvSource(useHeadersInDisplayName = true, textBlock = TESTDATEN, nullValues = { "null" })
	void testValidatorSsmm03(final Long idGeburtslandMutter, final boolean hatMigrationshintergrund, final boolean result) {
