 ...
 * <ul>
 *   <li> {@link ValidatorLsv05LehrerStammdatenVorname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsv05LehrerStammdatenVorname")
class TestValidatorLsv05LehrerStammdatenVorname {
	...
	/**
	 * Test von ValidatorLsv05LehrerStammdatenVorname
	 *
	...
	void testValidatorLehrerStammdaten(final String vorname, final boolean result) {
		...
		final ValidatorLsv05LehrerStammdatenVorname validator = new ValidatorLsv05LehrerStammdatenVorname(lehrerTestdaten_001, kontext);
