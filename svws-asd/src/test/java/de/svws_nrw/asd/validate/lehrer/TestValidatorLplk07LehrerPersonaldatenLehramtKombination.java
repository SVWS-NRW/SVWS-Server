...
@DisplayName("TestValidatorLplk07: Prüfung der Lehramtskombinationen")
class TestValidatorLplk07LehrerPersonaldatenLehramtKombination {
	...
	private static void teste(final boolean result, final LehrerLehramt[] typen) {
		...
		final ValidatorLplk07LehrerPersonaldatenLehramtKombination validator =
				new ValidatorLplk07LehrerPersonaldatenLehramtKombination(() -> liste, kontext);
