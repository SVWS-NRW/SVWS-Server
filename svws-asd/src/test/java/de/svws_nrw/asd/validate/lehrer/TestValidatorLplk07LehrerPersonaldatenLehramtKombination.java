 ...
 * <ul>
 *   <li> {@link TestValidatorLplk07LehrerPersonaldatenLehramtKombination},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 *
 */
@DisplayName("Tests für TestValidatorLplk07LehrerPersonaldatenLehramtKombination")
class TestValidatorLplk07LehrerPersonaldatenLehramtKombination {
	...
	// idKatalogLehramt = 129 entspricht ID_64
	private static final String TESTDATEN_LEHRAMT_KOMBINATIONEN = """
			111,   1,    119,	112,   1,    120,	113,   1,    129,	false
			111,   1,    119,	112,   1,    120,	113,   1,    124,	true
			111,   1,    129,	112,   1,    129,	113,   1,    129,	true
		""";
	...
	/**
	 * Test von ValidatorLplk07LehrerPersonaldatenLehramt
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLplk07LehrerPersonaldatenLehramtKombination")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LEHRAMT_KOMBINATIONEN)
	void testValidatorLplk07LehrerPersonaldatenLehramtKombination(final long id1, final long idLehrer1, final long idKatalogLehramt1, final long id2, final long idLehrer2, final long idKatalogLehramt2, final long id3, final long idLehrer3, final long idKatalogLehramt3, final boolean result) {
		...
		final ValidatorLplk07LehrerPersonaldatenLehramtKombination validator = new ValidatorLplk07LehrerPersonaldatenLehramtKombination(lehrerPersonaldaten, kontext);
