 ...
 * <ul>
 *   <li> {@link ValidatorLsv03LehrerStammdatenVorname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsv03LehrerStammdatenVorname")
class TestValidatorLsv03LehrerStammdatenVorname {
	...
	/**
	 * Test von ValidatorLsv03LehrerStammdatenVorname
	 *
	 * @param vorname    der Vorname, welcher bei den eingelesenen Testdaten ersetzt wird
	 * @param result     gibt an, welches Ergebnis bei den Testdaten erwartet wird
	 */
	@DisplayName("Tests für ValidatorLsv03LehrerStammdatenVorname")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_VORNAME)
	void testValidatorLsv03LehrerStammdatenVorname(final String vorname, final boolean result) {
		// Testdaten setzen
		lehrerTestdaten_001.vorname = vorname;

		// Erzeuge den Kontext für die Validierung
		final ValidatorKontext kontext = new ValidatorKontext(schuleTestdaten_001, true);
		final ValidatorLsv03LehrerStammdatenVorname validator = new ValidatorLsv03LehrerStammdatenVorname(lehrerTestdaten_001, kontext);
