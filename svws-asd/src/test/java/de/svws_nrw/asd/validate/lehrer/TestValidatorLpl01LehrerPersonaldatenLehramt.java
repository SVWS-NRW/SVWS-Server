...
class TestValidatorLpl01LehrerPersonaldatenLehramt {
	...
	void testValidatorLplLehrerPersonaldatenLehramt(final long id, final long idLehrer, final long idKatalogLehramt, final String schulform, final boolean result) {
		...
		final ValidatorLpl01LehrerPersonaldatenLehramt validator = new ValidatorLpl01LehrerPersonaldatenLehramt(() -> listLehrerLehramtEintrag, () -> idLehrer, kontext);
