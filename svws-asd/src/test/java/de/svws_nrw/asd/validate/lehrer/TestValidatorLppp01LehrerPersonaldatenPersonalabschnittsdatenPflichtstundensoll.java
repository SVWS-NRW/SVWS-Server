...
class TestValidatorLppp01LehrerPersonaldatenPersonalabschnittsdatenPflichtstundensoll {
	 ...
	 * Testdaten
	 */
	private static final String LPPP01_TESTDATEN = """
		25.5, true
		80.5, false
	""";
	...
	@ParameterizedTest
	@CsvSource(textBlock = LPPP01_TESTDATEN)
	void testValidatorLppp01LehrerPersonaldatenPersonalabschnittsdatenPflichstundensoll(final double pflichtstundensoll, final boolean result) {
		...
		final ValidatorLppp01LehrerPersonaldatenPersonalabschnittsdatenPflichtstundensoll validator = new ValidatorLppp01LehrerPersonaldatenPersonalabschnittsdatenPflichtstundensoll(
				() -> pflichtstundensoll,
				kontext);
