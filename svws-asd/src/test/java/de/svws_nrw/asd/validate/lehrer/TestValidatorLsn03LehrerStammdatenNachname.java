 ...
 * <ul>
 *   <li> {@link ValidatorLsn03LehrerStammdatenNachname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Tests ValidatorLsn03LehrerStammdatenNachname")
class TestValidatorLsn03LehrerStammdatenNachname {
	...
	void testValidatorLsn03LehrerStammdatenNachname(final String nachname, final boolean result) {
		// Testdaten setzen
		lehrerTestdaten_001.nachname = nachname;

		// Erzeuge den Kontext für die Validierung
		final ValidatorKontext kontext = new ValidatorKontext(schuleTestdaten_001, true);
		final ValidatorLsn03LehrerStammdatenNachname validator = new ValidatorLsn03LehrerStammdatenNachname(() -> lehrerTestdaten_001.nachname, kontext);
