 ...
 * <ul>
 *   <li> {@link TestValidatorLplk08LehrerPersonaldatenLehramtKombination},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 *
 */
@DisplayName("Tests für TestValidatorLplk08LehrerPersonaldatenLehramtKombination")
class TestValidatorLplk08LehrerPersonaldatenLehramtKombination {
	...
	// idKatalogLehramt = 128 entspricht ID_63
	private static final String TESTDATEN_LEHRAMT_KOMBINATIONEN = """
			111,   1,    119,	112,   1,    120,	113,   1,    128,	false
			111,   1,    119,	112,   1,    120,	113,   1,    124,	true
			111,   1,    128,	112,   1,    128,	113,   1,    128,	true
		""";
	...
	/**
	 * Test von ValidatorLplk08LehrerPersonaldatenLehramt
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLplk08LehrerPersonaldatenLehramtKombination")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LEHRAMT_KOMBINATIONEN)
	void testValidatorLplk08LehrerPersonaldatenLehramtKombination(final long id1, final long idLehrer1, final long idKatalogLehramt1, final long id2, final long idLehrer2, final long idKatalogLehramt2, final long id3, final long idLehrer3, final long idKatalogLehramt3, final boolean result) {
		...
		final ValidatorLplk08LehrerPersonaldatenLehramtKombination validator = new ValidatorLplk08LehrerPersonaldatenLehramtKombination(lehrerPersonaldaten, kontext);
