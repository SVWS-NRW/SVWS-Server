...
@DisplayName("TestValidatorLplk08: Prüfung der Lehramtskombinationen")
class TestValidatorLplk08LehrerPersonaldatenLehramtKombination {
	...
	private static void teste(final boolean result, final LehrerLehramt[] typen) {
		...
		final ValidatorLplk08LehrerPersonaldatenLehramtKombination validator =
				new ValidatorLplk08LehrerPersonaldatenLehramtKombination(() -> liste, kontext);
