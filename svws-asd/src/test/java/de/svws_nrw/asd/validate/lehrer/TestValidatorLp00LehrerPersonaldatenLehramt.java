...
class TestValidatorLp00LehrerPersonaldatenLehramt {
	...
	void testValidatorLplLehrerPersonaldatenLehramt(final long id, final long idLehrer, final long idKatalogLehramt, final String schulform, final boolean result) {
		...
		final ValidatorLp00LehrerPersonaldatenLehramt validator = new ValidatorLp00LehrerPersonaldatenLehramt(() -> listLehrerLehramtEintrag, () -> idLehrer, kontext);
