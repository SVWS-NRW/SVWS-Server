 ...
 */
@DisplayName("Test ValidatorLsn00LehrerStammdatenNachname")
class TestValidatorLsn01LehrerStammdatenNachname {
	...
	/**
	 * Test von ValidatorLsn00LehrerStammdatenNachname
	 *
	 * CoreType: LehrerStammdaten
	 *
	 ...
	 */
	@DisplayName("Tests ValidatorLsn00LehrerStammdatenNachname")
	@ParameterizedTest
	...
	void testValidatorLsn00LehrerStammdatenNachname(final String nachname, final boolean result) {
		...
		final ValidatorLsn00LehrerStammdatenNachname validator = new ValidatorLsn00LehrerStammdatenNachname(() -> lehrerTestdaten_001.nachname, kontext);
