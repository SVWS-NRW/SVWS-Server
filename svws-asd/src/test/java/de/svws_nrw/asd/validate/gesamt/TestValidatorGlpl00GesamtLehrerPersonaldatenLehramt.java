...
class TestValidatorGlpl00GesamtLehrerPersonaldatenLehramt {
	...
	void testValidator(final String schulform, final int anzahlMitLehramt, final boolean result) {
		...
		final var validator = new ValidatorGlpl00GesamtLehrerPersonaldatenLehramt(() -> listLehrerStatistikGesamt, kontext);
