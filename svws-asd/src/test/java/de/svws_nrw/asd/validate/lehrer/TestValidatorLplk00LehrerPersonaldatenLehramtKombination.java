 ...
 * <ul>
 *   <li> {@link TestValidatorLplk00LehrerPersonaldatenLehramtKombination},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 *
 */
@DisplayName("Tests für TestValidatorLplk00LehrerPersonaldatenLehramtKombination")
class TestValidatorLplk00LehrerPersonaldatenLehramtKombination {
	...
	/**
	 * Test von ValidatorLplk00LehrerPersonaldatenLehramt
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLplk00LehrerPersonaldatenLehramtKombination")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LEHRAMT_KOMBINATIONEN)
	void testValidatorLplk00LehrerPersonaldatenLehramtKombination(final long id1, final long idLehrer1, final long idKatalogLehramt1, final long id2, final long idLehrer2, final long idKatalogLehramt2, final long id3, final long idLehrer3, final long idKatalogLehramt3, final boolean result) {
		...
		final ValidatorLplk00LehrerPersonaldatenLehramtKombination validator = new ValidatorLplk00LehrerPersonaldatenLehramtKombination(lehrerPersonaldaten, kontext);
