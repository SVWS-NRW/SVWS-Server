...
class TestValidatorKk02KlassenKlassenart {
	...
	// null    -> true  (Ignoriert)
	// 9999999 -> true  (Unbekannte ID -> wird von KK01 abgefangen, hier ignoriert)
	// 7000    -> true  (Regelklasse ist auch heute noch gültig)
	...
	void testValidatorKk02KlassenKlassenart(final Long idKlassenart, final boolean result) {
