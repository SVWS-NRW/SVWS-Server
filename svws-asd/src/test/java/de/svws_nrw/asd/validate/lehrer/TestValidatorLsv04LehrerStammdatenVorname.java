 ...
 * <ul>
 *   <li> {@link ValidatorLsv04LehrerStammdatenVorname},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Test ValidatorLsv04LehrerStammdatenVorname")
class TestValidatorLsv04LehrerStammdatenVorname {
	...
	/**
	 * Test von ValidatorLsv04LehrerStammdatenVorname
	 *
	 * @param vorname    der Vorname, welcher bei den eingelesenen Testdaten ersetzt wird
	 * @param result     gibt an, welches Ergebnis bei den Testdaten erwartet wird
	 */
	@DisplayName("Tests für ValidatorLsv04LehrerStammdatenVorname")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_VORNAME)
	void testValidatorLsv04LehrerStammdatenVorname(final String vorname, final boolean result) {
		// Testdaten setzen
		lehrerTestdaten_001.vorname = vorname;

		// Erzeuge den Kontext für die Validierung
		final ValidatorKontext kontext = new ValidatorKontext(schuleTestdaten_001, true);
		final ValidatorLsv04LehrerStammdatenVorname validator = new ValidatorLsv04LehrerStammdatenVorname(lehrerTestdaten_001, kontext);
