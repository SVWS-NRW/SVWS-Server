 ...
 * <ul>
 *   <li> {@link TestValidatorLplk09LehrerPersonaldatenLehramtKombination},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 *
 */
@DisplayName("Tests für TestValidatorLplk09LehrerPersonaldatenLehramtKombination")
class TestValidatorLplk09LehrerPersonaldatenLehramtKombination {
	...
	// idKatalogLehramt = 130 entspricht ID_65
	private static final String TESTDATEN_LEHRAMT_KOMBINATIONEN = """
			111,   1,    119,	112,   1,    120,	113,   1,    130,	false
			111,   1,    119,	112,   1,    120,	113,   1,    124,	true
			111,   1,    130,	112,   1,    130,	113,   1,    130,	true
		""";
	...
	/**
	 * Test von ValidatorLplk09LehrerPersonaldatenLehramt
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLplk09LehrerPersonaldatenLehramtKombination")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LEHRAMT_KOMBINATIONEN)
	void testValidatorLplk09LehrerPersonaldatenLehramtKombination(final long id1, final long idLehrer1, final long idKatalogLehramt1, final long id2, final long idLehrer2, final long idKatalogLehramt2, final long id3, final long idLehrer3, final long idKatalogLehramt3, final boolean result) {
		...
		final ValidatorLplk09LehrerPersonaldatenLehramtKombination validator = new ValidatorLplk09LehrerPersonaldatenLehramtKombination(lehrerPersonaldaten, kontext);
