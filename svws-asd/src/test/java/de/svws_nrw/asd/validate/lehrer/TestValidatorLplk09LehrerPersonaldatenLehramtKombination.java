...
@DisplayName("TestValidatorLplk09: Prüfung der Lehramtskombinationen")
class TestValidatorLplk09LehrerPersonaldatenLehramtKombination {
	...
	private static void teste(final boolean result, final LehrerLehramt[] typen) {
		...
		final ValidatorLplk09LehrerPersonaldatenLehramtKombination validator =
				new ValidatorLplk09LehrerPersonaldatenLehramtKombination(() -> liste, kontext);
