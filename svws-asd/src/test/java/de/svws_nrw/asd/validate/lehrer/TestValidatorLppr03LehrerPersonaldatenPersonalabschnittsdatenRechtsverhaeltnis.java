...
class TestValidatorLppr03LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis {
	...
	void testValidatorLehrerPersonalabschnittsdatenRechtsverhaeltnisGeburtsdatum_GeburtsdatumZuJung() {
		...
		try {
			...
			LehrerPersonalabschnittsdaten_Plausibel.rechtsverhaeltnis = "W";
			final ValidatorLppr03LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis validator = new ValidatorLppr03LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis(LehrerPersonalabschnittsdaten_Plausibel, geburtsdatum, kontext);
