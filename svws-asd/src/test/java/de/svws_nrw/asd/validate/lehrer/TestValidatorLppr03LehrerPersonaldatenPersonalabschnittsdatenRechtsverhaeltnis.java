...
class TestValidatorLppr03LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis {
	...
	void testValidatorLehrerPersonalabschnittsdatenRechtsverhaeltnisGeburtsdatum_GeburtsdatumZuJung() {
		...
		try {
			...
			final Long idRechtsverhaeltnis = LehrerRechtsverhaeltnis.W.historie().getLast().id;
			final Long idSchuljahresabschnitt = kontext.getSchuljahresabschnitt().id;

			final ValidatorLppr03LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis validator = new ValidatorLppr03LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnis(
