 ...
 * <ul>
 *   <li> {@link TestValidatorLplk01LehrerPersonaldatenLehramtKombination},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 *
 */
@DisplayName("Tests für TestValidatorLplk01LehrerPersonaldatenLehramtKombination")
class TestValidatorLplk01LehrerPersonaldatenLehramtKombination {
	...
	// idKatalogLehramt = 107 entspricht ID_52
	private static final String TESTDATEN_LEHRAMT_KOMBINATIONEN = """
			111,   1,    119,	112,   1,    120,	113,   1,    107,	false
			111,   1,    119,	112,   1,    120,	113,   1,    124,	true
			111,   1,    107,	112,   1,    107,	113,   1,    107,	true
		""";
	...
	/**
	 * Test von ValidatorLplk01LehrerPersonaldatenLehramt
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLplk01LehrerPersonaldatenLehramtKombination")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LEHRAMT_KOMBINATIONEN)
	void testValidatorLplk01LehrerPersonaldatenLehramtKombination(final long id1, final long idLehrer1, final long idKatalogLehramt1, final long id2, final long idLehrer2, final long idKatalogLehramt2, final long id3, final long idLehrer3, final long idKatalogLehramt3, final boolean result) {
		...
		final ValidatorLplk01LehrerPersonaldatenLehramtKombination validator = new ValidatorLplk01LehrerPersonaldatenLehramtKombination(lehrerPersonaldaten, kontext);
