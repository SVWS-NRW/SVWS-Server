 ...
 * <ul>
 *   <li> {@link ValidatorLpl00LehrerPersonaldatenLehramt},
 * </ul>
 * </p>
 */
...
class TestValidatorLpl00LehrerPersonaldatenLehramt {
	...
	/**
	 * Test von ValidatorLpl00LehrerPersonaldatenLehramt
	 *
	...
	void testValidatorLpl00LehrerPersonaldatenLehramt(final long id, final long idLehrer, final long idKatalogLehramt, final String schulform, final boolean result) {
		...
		final ValidatorLpl00LehrerPersonaldatenLehramt validator = new ValidatorLpl00LehrerPersonaldatenLehramt(() -> listLehrerLehramtEintrag, () -> idLehrer, null, kontext);
