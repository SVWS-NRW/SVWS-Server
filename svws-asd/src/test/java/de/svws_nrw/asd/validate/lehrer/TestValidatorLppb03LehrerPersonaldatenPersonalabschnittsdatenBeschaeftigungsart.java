 ...
 * <ul>
 *   <li> {@link ValidatorLppb03LehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 */
@DisplayName("Tests zur Validierung der Lppb03LehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart")
class TestValidatorLppb03LehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart {

	private static final String TESTDATEN_LPPB03 = """
'G',  'A'  , 0, false
'G',  'tr' , 0, true
'G',  'A'  , 1, true
'tr', 'A'  , 0, true
...
""";
	 ...
	 */
	@DisplayName("Tests für ValidatorLppb03LehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LPPB03)
	void testValidatorLppbLehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart(final String beschaeftigungsart, final String einsatzstatus, final double pflichtstundensoll, final boolean result) {
		// Testdaten setzen
		...
		final ValidatorLppb03LehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart validator =
				new ValidatorLppb03LehrerPersonaldatenPersonalabschnittsdatenBeschaeftigungsart(
						() -> beschaeftigungsart,
						() -> einsatzstatus,
						() -> pflichtstundensoll,
						kontext);
