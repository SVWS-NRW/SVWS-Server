...
@DisplayName("TestValidatorLplk18: Prüfung der Lehramtskombinationen")
class TestValidatorLplk18LehrerPersonaldatenLehramtKombination {
	...
	private static void teste(final boolean result, final LehrerLehramt[] typen) {
		...
		final ValidatorLplk18LehrerPersonaldatenLehramtKombination validator =
				new ValidatorLplk18LehrerPersonaldatenLehramtKombination(() -> liste, kontext);

		assertEquals(result, validator.run());
	}

	@Test
	@DisplayName("'Heilpädagogen/-innen' (ID_63) + normales Lehramt ist VERBOTEN")
	void testHeilpaedagogenUndAnderes() {
		// ID_63 (Heilpädagogen/-innen) + ID_25 (Gymnasium) - Explizites Array statt Varargs
		teste(false, new LehrerLehramt[] { LehrerLehramt.ID_63, LehrerLehramt.ID_25 });
	}

	@Test
	@DisplayName("Nur Lehramt 'Heilpädagogen/-innen' ist ERLAUBT")
	void testNurHeilpaedagogen() {
		// ID_63 (Heilpädagogen/-innen) - Explizites Array statt Varargs
		teste(true, new LehrerLehramt[] { LehrerLehramt.ID_63 });
	}
