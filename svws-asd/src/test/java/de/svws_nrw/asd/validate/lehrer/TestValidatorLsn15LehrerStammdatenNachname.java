 ...
 * <ul>
 *   <li> {@link ValidatorLsn15LehrerStammdatenNachname},
 * </ul>
 * </p>
...
class TestValidatorLsn15LehrerStammdatenNachname {
	...
	void testValidatorLehrerStammdatenNachname(final String nachname, final boolean result) {
		...
		final ValidatorLsn15LehrerStammdatenNachname validator = new ValidatorLsn15LehrerStammdatenNachname(() -> nachname, kontext);
