 ...
 * <ul>
 *   <li> {@link TestValidatorLplk03LehrerPersonaldatenLehramtKombination},
 * </ul>
 * </p>
 *
 * <p> Testdaten:
 ...
 *
 */
@DisplayName("Tests für TestValidatorLplk03LehrerPersonaldatenLehramtKombination")
class TestValidatorLplk03LehrerPersonaldatenLehramtKombination {
	...
	// idKatalogLehramt = 120 entspricht ID_98
	private static final String TESTDATEN_LEHRAMT_KOMBINATIONEN = """
			111,   1,    119,	112,   1,    120,	113,   1,    120,	false
			111,   1,    119,	112,   1,    122,	113,   1,    124,	true
			111,   1,    120,	112,   1,    120,	113,   1,    120,	true
		""";
	...
	/**
	 * Test von ValidatorLplk03LehrerPersonaldatenLehramt
	 *
	 ...
	 */
	@DisplayName("Tests für ValidatorLplk03LehrerPersonaldatenLehramtKombination")
	@ParameterizedTest
	@CsvSource(textBlock = TESTDATEN_LEHRAMT_KOMBINATIONEN)
	void testValidatorLplk03LehrerPersonaldatenLehramtKombination(final long id1, final long idLehrer1, final long idKatalogLehramt1, final long id2, final long idLehrer2, final long idKatalogLehramt2, final long id3, final long idLehrer3, final long idKatalogLehramt3, final boolean result) {
		...
		final ValidatorLplk03LehrerPersonaldatenLehramtKombination validator = new ValidatorLplk03LehrerPersonaldatenLehramtKombination(lehrerPersonaldaten, kontext);
