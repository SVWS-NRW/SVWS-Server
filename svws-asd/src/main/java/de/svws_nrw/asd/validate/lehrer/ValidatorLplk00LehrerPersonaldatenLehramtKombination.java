 ...
 */
public final class ValidatorLplk00LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk00LehrerPersonaldatenLehramtKombination(final @NotNull LehrerPersonaldaten lehrerPersonaldaten, final @NotNull ValidatorKontext kontext) {
		super(kontext);
	...
	protected boolean pruefe() {
		...
		// Fehlerkürzel: LPLK00 Neben dem Lehramtseintrag 'Schulverwaltungsassistenten/-innen' sollten keine weiteren Lehramtseinträge vorliegen.
		boolean lehramtId70Vorhanden = false;
		boolean anderesLehramtVorhanden = false;
		LehrerLehramtKatalogEintrag lehrerLehramtKatalogEintrag = LehrerLehramt.ID_70.daten(this.kontext().getSchuljahr());
