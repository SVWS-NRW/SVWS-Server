 ...
 */
public final class ValidatorLplk19LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk19LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter,
	...
	protected boolean pruefe() {
		...
		// Fehlerkürzel: LPLK19 Neben dem Lehramtseintrag 'Alltagshelfern/-innen' sollten keine weiteren Lehramtseinträge vorliegen. Bitte korrigieren Sie Ihre Angaben.
		boolean lehramtId65Vorhanden = false;
		boolean anderesLehramtVorhanden = false;
		final LehrerLehramtKatalogEintrag lehrerLehramtKatalogEintrag = LehrerLehramt.ID_65.daten(this.kontext().getSchuljahr());
		...
		if (lehramtId65Vorhanden && anderesLehramtVorhanden) {
			this.addFehler(9,
					"Neben dem Lehramtseintrag 'Alltagshelfern/-innen' sollten keine weiteren Lehramtseinträge vorliegen. Bitte korrigieren Sie Ihre Angaben.");
			return false;
		}
