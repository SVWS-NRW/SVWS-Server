 ...
 */
public final class ValidatorLplk06LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk06LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter, final @NotNull ValidatorKontext kontext) {
		super(kontext);
