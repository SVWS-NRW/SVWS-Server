 ...
 */
public final class ValidatorLplk08LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk08LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter, final @NotNull ValidatorKontext kontext) {
		super(kontext);
	...
	protected boolean pruefe() {
		...
		// Fehlerkürzel: LPLK08 Neben dem Lehramtseintrag 'Heilpädagogen/-innen' sollten keine weiteren Lehramtseinträge vorliegen. Bitte korrigieren Sie Ihre Angaben.
		boolean lehramtId63Vorhanden = false;
		boolean	anderesLehramtVorhanden = false;
		LehrerLehramtKatalogEintrag lehrerLehramtKatalogEintrag = LehrerLehramt.ID_63.daten(this.kontext().getSchuljahr());
