 ...
 * einer Klasse aus.
 */
public final class ValidatorKobKlassenOrganisationsformBerufsbildend extends Validator {
		 ...
		 */
		public ValidatorKobKlassenOrganisationsformBerufsbildend(
			...
			_validatoren.add(
					new ValidatorKob00KlassenOrganisationsformBerufsbildend(getNotNullSupplierLong(idOrgaform), kontext));
		}
