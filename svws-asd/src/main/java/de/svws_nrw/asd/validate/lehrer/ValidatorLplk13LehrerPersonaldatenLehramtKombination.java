 ...
 */
public final class ValidatorLplk13LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk13LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter,
	...
	protected boolean pruefe() {
		...
		// Fehlerkürzel: LPLK13 Neben dem Lehramtseintrag 'Lehramtsanwärter/-in / Studienreferendar/-in' dürfen keine weiteren Lehramtseinträge vorliegen. Bitte überprüfen Sie Ihre Angaben.
		boolean lehramtId98Vorhanden = false;
		boolean anderesLehramtVorhanden = false;
		final LehrerLehramtKatalogEintrag lehrerLehramtKatalogEintrag = LehrerLehramt.ID_98.daten(this.kontext().getSchuljahr());
		...
		if (lehramtId98Vorhanden && anderesLehramtVorhanden) {
			this.addFehler(3,
					"Neben dem Lehramtseintrag 'Lehramtsanwärter/-in / Studienreferendar/-in' dürfen keine weiteren Lehramtseinträge vorliegen. Bitte überprüfen Sie Ihre Angaben.");
			return false;
		}
