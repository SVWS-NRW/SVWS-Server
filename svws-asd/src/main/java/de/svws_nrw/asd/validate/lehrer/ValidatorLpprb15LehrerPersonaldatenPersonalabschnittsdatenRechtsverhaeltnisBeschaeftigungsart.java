 ...
 */
public final class ValidatorLpprb15LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnisBeschaeftigungsart extends Validator {
	...
	private static final @NotNull Set<LehrerBeschaeftigungsart> setBeschaeftigungsart = Set.of(LehrerBeschaeftigungsart.G);
	 ...
	 */
	public ValidatorLpprb15LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnisBeschaeftigungsart(
	...
	protected boolean pruefe() {
		...
		if (_rechtsverhaeltnis.get().equals(LehrerRechtsverhaeltnis.S) && !setBeschaeftigungsart.contains(_beschaeftigungsart.get())) {

			addFehler(0, "Für das Rechtsverhältnis 'Gestellungsvertrag' ist die Beschätigungsart 'Gestellungsvertrag' zulässig.");
			return false;
		}
		return true;
	}
