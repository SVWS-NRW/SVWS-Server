...
public final class ValidatorLplk07LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk07LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter, final @NotNull ValidatorKontext kontext) {
		super(kontext);
