 ...
 */
public final class ValidatorLsn05LehrerStammdatenNachname extends Validator {
	 ...
	 */
	public ValidatorLsn05LehrerStammdatenNachname(final @NotNull LehrerStammdaten daten, final @NotNull ValidatorKontext kontext) {
		super(kontext);
		this.daten = daten;
	}
