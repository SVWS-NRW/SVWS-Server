...
public final class ValidatorLplk02LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk02LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter, final @NotNull ValidatorKontext kontext) {
		super(kontext);
