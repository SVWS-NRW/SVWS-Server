...
public final class ValidatorLplk09LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk09LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter, final @NotNull ValidatorKontext kontext) {
		super(kontext);
