 ...
 */
public final class ValidatorSsmlSchuelerStammdatenMigrationshintergrundGeburtsland extends Validator {
	 ...
	 */
	public ValidatorSsmlSchuelerStammdatenMigrationshintergrundGeburtsland(
		...
		_validatoren.add(
				new ValidatorSsml00SchuelerStammdatenMigrationshintergrundGeburtsland(idGeburtsland, hatMigrationshintergrund, kontext));
