 ...
 */
public final class ValidatorLplk17LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk17LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter,
	...
	protected boolean pruefe() {
		...
		// Fehlerkürzel: LPLK17 Neben dem Lehramtseintrag 'Handwerksmeistern/-innen' sollten keine weiteren Lehramtseinträge vorliegen. Bitte korrigieren Sie Ihre Angaben.
		...
		if (lehramtId64Vorhanden && anderesLehramtVorhanden) {
			this.addFehler(7,
					"Neben dem Lehramtseintrag 'Handwerksmeistern/-innen' sollten keine weiteren Lehramtseinträge vorliegen. Bitte korrigieren Sie Ihre Angaben.");
			return false;
		}
