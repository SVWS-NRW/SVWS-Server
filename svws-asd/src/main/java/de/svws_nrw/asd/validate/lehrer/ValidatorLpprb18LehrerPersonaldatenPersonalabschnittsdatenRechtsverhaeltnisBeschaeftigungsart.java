 ...
 */
public final class ValidatorLpprb18LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnisBeschaeftigungsart extends Validator {
	...
	private static final @NotNull Set<LehrerBeschaeftigungsart> setBeschaeftigungsart = Set.of(LehrerBeschaeftigungsart.X);
	 ...
	 */
	public ValidatorLpprb18LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnisBeschaeftigungsart(
	...
	protected boolean pruefe() {
		...
		if (_rechtsverhaeltnis.get().equals(LehrerRechtsverhaeltnis.X) && !setBeschaeftigungsart.contains(_beschaeftigungsart.get())) {

			addFehler(0, "Für das Rechtsverhältnis 'Unentgeltlich Beschäftigte' ist die Beschätigungsart 'Unentgeltlich Beschäftigte' zulässig.");
			return false;
		}
		return true;
	}
