 ...
 */
public final class ValidatorLpprb14LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnisBeschaeftigungsart extends Validator {
	...
	private static final @NotNull Set<LehrerBeschaeftigungsart> setBeschaeftigungsart = Set.of(LehrerBeschaeftigungsart.NA);
	 ...
	 */
	public ValidatorLpprb14LehrerPersonaldatenPersonalabschnittsdatenRechtsverhaeltnisBeschaeftigungsart(
	...
	protected boolean pruefe() {
		...
		if (_rechtsverhaeltnis.get().equals(LehrerRechtsverhaeltnis.N) && !setBeschaeftigungsart.contains(_beschaeftigungsart.get())) {

			addFehler(0, "Für das Rechtsverhältnis 'Beamte, nebenamtlich (nicht hauptamtlich im Schuldienst)' ist die Beschätigungsart 'Beamte, nebenamtlich (nicht hauptamtlich im Schuldienst)' zulässig.");
			return false;
		}
		return true;
	}
