 ...
 */
public final class ValidatorLplk01LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk01LehrerPersonaldatenLehramtKombination(final @NotNull LehrerPersonaldaten lehrerPersonaldaten, final @NotNull ValidatorKontext kontext) {
		super(kontext);
	...
	protected boolean pruefe() {
		...
		// Fehlerkürzel: LPLK01 Neben dem Lehramtseintrag 'Werkstattlehrern/-innen' sollten keine weiteren Lehramtseinträge vorliegen.
		boolean lehramtId52Vorhanden = false;
		boolean	anderesLehramtVorhanden = false;
		LehrerLehramtKatalogEintrag lehrerLehramtKatalogEintrag = LehrerLehramt.ID_52.daten(this.kontext().getSchuljahr());
