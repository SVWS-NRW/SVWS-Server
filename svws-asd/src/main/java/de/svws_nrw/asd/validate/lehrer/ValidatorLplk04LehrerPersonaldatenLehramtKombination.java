 ...
 */
public final class ValidatorLplk04LehrerPersonaldatenLehramtKombination extends Validator {
	 ...
	 */
	public ValidatorLplk04LehrerPersonaldatenLehramtKombination(final @NotNull Supplier<List<LehrerLehramtEintrag>> lehraemter, final @NotNull ValidatorKontext kontext) {
		super(kontext);
