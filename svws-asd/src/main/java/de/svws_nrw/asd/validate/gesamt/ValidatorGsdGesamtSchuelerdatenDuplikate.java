 ...
 * zu Schülern einer Schule aus und überprüft dort, ob Duplikate in Bezug
 * auf die ID vorkommen.
 */
public final class ValidatorGsdGesamtSchuelerdatenDuplikate extends Validator {
	 ...
	 */
	public ValidatorGsdGesamtSchuelerdatenDuplikate(
			final @NotNull Supplier<List<SchuelerStatistikGesamt>> listSchueler,
			final @NotNull ValidatorKontext kontext) {
		super(kontext);
		_validatoren.add(new ValidatorGsd10GesamtSchuelerdatenDuplikate(listSchueler, kontext));
	}
