...
@TranspilerDTO
public class SchuleStatistikGesamt {
	...
	public boolean hatKonfessionelleKooperation;
	...
	@ArraySchema(schema = @Schema(implementation = SchuleAdressenStatistikGesamt.class))
	public final @NotNull List<SchuleAdressenStatistikGesamt> adressen = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public SchuleStatistikGesamt() {
		// leer
	}
