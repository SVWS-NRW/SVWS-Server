...
public class CoreTypeDataManager<T extends CoreTypeData, U extends CoreType<T, U>> {
	 ...
	 */
	public U getWertByBezeichnerOrNull(final @NotNull String bezeichner) {
		return _mapBezeichnerToEnum.get(bezeichner);
	}
	 ...
	 * @return  gültig oder nicht
	 */
	public boolean isGueltigMitAuslaufdauer(final Long id, final int schuljahr) {
		final T eintrag = _mapIDToEintrag.get(id);
