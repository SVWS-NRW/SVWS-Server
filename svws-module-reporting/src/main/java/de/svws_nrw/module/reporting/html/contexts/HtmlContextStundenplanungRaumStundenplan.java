...
public final class HtmlContextStundenplanungRaumStundenplan extends HtmlContext<ReportingStundenplanungRaumStundenplan>
		implements HtmlContextAufteilbar<HtmlContextStundenplanungRaumStundenplan> {
	 ...
	 */
	public HtmlContextStundenplanungRaumStundenplan(final ReportingContext reportingContext, final ReportingStundenplanungStundenplan stundenplan,
	...
	public List<HtmlContextStundenplanungRaumStundenplan> getEinzelContexts() {
		...
		for (final ReportingStundenplanungRaumStundenplan stundenplan : getContextData()) {
			...
			resultContexts.add(new HtmlContextStundenplanungRaumStundenplan(this.reportingContext, stundenplan.stundenplan(), eineId));
		}
