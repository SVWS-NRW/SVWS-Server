...
public final class SortierungRegistryReportingStundenplanungRaumStundenplan {
	...
	public static List<String> standardsortierung() {
		...
		standard.add(ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::raum) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungRaum::kuerzel));
		standard.add(ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::raum) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungRaum::id));
		return standard;
	}
	...
	private static SortierungRegistry<ReportingStundenplanungRaumStundenplan> sortierungRegistryReportingStundenplanungRaumStundenplan() {
		...
		reg.registiereComparable(
				ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::stundenplan) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungStundenplan::id),
		...
		reg.registiereString(
				ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::raum) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungRaum::kuerzel),
				FunktionBuilder.start(ReportingStundenplanungRaumStundenplan::raum)
						.then(ReportingStundenplanungRaum::kuerzel)
						.toFunction());
		reg.registiereString(
				ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::raum) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungRaum::beschreibung),
				FunktionBuilder.start(ReportingStundenplanungRaumStundenplan::raum)
						.then(ReportingStundenplanungRaum::beschreibung)
						.toFunction());
		reg.registiereComparable(ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::raum) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungRaum::id),
				FunktionBuilder.start(ReportingStundenplanungRaumStundenplan::raum)
						.then(ReportingStundenplanungRaum::id)
						.toFunction());
		reg.registiereComparable(
				ReportingTypesUtils.methodeToString(ReportingStundenplanungRaumStundenplan::raum) + "." + ReportingTypesUtils.methodeToString(ReportingStundenplanungRaum::kapazitaet),
				FunktionBuilder.start(ReportingStundenplanungRaumStundenplan::raum)
