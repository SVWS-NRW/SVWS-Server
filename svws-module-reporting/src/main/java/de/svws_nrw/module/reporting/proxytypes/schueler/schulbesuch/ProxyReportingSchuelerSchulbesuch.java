...
public class ProxyReportingSchuelerSchulbesuch extends ReportingSchuelerSchulbesuch {
	...
	public ProxyReportingSchuelerSchulbesuch(final ReportingRepository reportingRepository, final SchuelerSchulbesuchsdaten schulbesuchsdaten) {
		super(
				...
				schulbesuchsdaten.vorigeAllgHerkunft,
				schulbesuchsdaten.vorigeEntlassdatum,
				schulbesuchsdaten.vorigeEntlassjahrgang,
				schulbesuchsdaten.vorigeArtLetzteVersetzung,
				schulbesuchsdaten.vorigeBemerkung,
				createEndlassgrund(reportingRepository, schulbesuchsdaten.vorigeEntlassgrundID),
				schulbesuchsdaten.vorigeAbschlussartID,
				schulbesuchsdaten.entlassungDatum,
				schulbesuchsdaten.entlassungJahrgang,
				...
				schulbesuchsdaten.aufnehmendWechseldatum,
				...
				schulbesuchsdaten.kuerzelGrundschuleUebergangsempfehlung,
				schulbesuchsdaten.sekIWechsel,
				schulbesuchsdaten.sekIErsteSchulform,
