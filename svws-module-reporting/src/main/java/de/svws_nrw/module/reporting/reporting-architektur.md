...
| `ReportingRepositoryKataloge`            | Fächerkatalog, Jahrgänge, Erzieherarten, weitere stammdaten-nahe Listen | `faecher()`, `jahrgaenge()`, `erzieherarten()` |
| `ReportingRepositoryLehrer`              | Lehrkräfte, Kollegium, Leitungsfunktionen, Lehrer-spezifische Unterrichts-Aufstellungen | `lehrer(id)`, `kollegium()`, `leitungsfunktionen()` |
