...
public final class HtmlContextStundenplanungKlassenStundenplan extends HtmlContext<ReportingStundenplanungKlasseStundenplan>
		implements HtmlContextAufteilbar<HtmlContextStundenplanungKlassenStundenplan> {
	 ...
	 */
	public HtmlContextStundenplanungKlassenStundenplan(final ReportingContext reportingContext, final ReportingStundenplanungStundenplan stundenplan,
	...
	private void erzeugeContext(final ReportingStundenplanungStundenplan stundenplan, final List<Long> idsAusgabe) {
		...
		this.reportingContext.repositoryLerngruppen().klassen(idsAusgabe)
				.forEach(klasse -> stundenplaene.add(new ReportingStundenplanungKlasseStundenplan(klasse, stundenplan)));

		setContextDataSortiert(stundenplaene, ReportingStundenplanungKlasseStundenplan.SORTIERUNG, ReportingStundenplanungKlasseStundenplan.class);
	...
	public List<HtmlContextStundenplanungKlassenStundenplan> getEinzelContexts() {
		...
		for (final ReportingStundenplanungKlasseStundenplan stundenplan : getContextData()) {
			...
			resultContexts.add(new HtmlContextStundenplanungKlassenStundenplan(this.reportingContext, stundenplan.stundenplan(), eineId));
		}
