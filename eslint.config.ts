			...
			"simple-import-sort/imports": [
				"error",
				{
					"groups": [
						...
						[String.raw`^\u0000`],
						// 2. Packages. Things that start with a letter (or digit or underscore), or `@` followed by a letter.
						[String.raw`^@?\w`],
						// 3. Specific Alias imports.
						["^(@ui|@core|@images|@icons|@githash|@version)(/.*|$)"],
