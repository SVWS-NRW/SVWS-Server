...
public class HerkunftBildungsgangKatalogEintrag {
	...
	@Schema(required = true, description = "das Kürzel des Bildungsganges, welches im Rahmen der amtlichen Schulstatistik verwendet wird", example="UN")
	public @NotNull String kuerzel = "";

	/** Die Kürzel der Schulformen, bei welchen der Bildungsgang als Herkunft vorkommen kann (BK und SB). */
	@Schema(required = true, description = "die Kürzel der Schulformen, bei welchen der Bildungsgang als Herkunft vorkommen kann (BK und SB)")
	public @NotNull List<@NotNull String> schulformen = new Vector<>();
	
	/** Die textuelle Beschreibung der sonstigen Herkunft. */
	@Schema(required = true, description = "die textuelle Beschreibung des Bildungsganges", example="Berufsabschl./Hauptschulab.Kl. 10 oder mittl. Schulab. (BAB/HSA10-FOR, 3j. TZ)")
	 ...
	 */
	public HerkunftBildungsgangKatalogEintrag(long id, @NotNull Schulgliederung gliederung,
