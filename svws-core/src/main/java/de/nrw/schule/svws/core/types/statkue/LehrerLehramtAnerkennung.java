...
public enum LehrerLehramtAnerkennung {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerLehramtAnerkennung> _anerkennungenByID = new HashMap<>();

	/** Eine Hashmap mit allen Lehramtsanerkennungen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerLehramtAnerkennung> _anerkennungenByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerLehramtAnerkennung> getMapAnerkennungenByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerLehramtAnerkennung> getMapAnerkennungenByKuerzel() {
