...
public enum LehrerLehrbefaehigungAnerkennung {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerLehrbefaehigungAnerkennung> _anerkennungenByID = new HashMap<>();

	/** Eine Hashmap mit allen Anerkennungsgründen für Lehrbefähigungen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerLehrbefaehigungAnerkennung> _anerkennungenByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerLehrbefaehigungAnerkennung> getMapAnerkennungenByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerLehrbefaehigungAnerkennung> getMapAnerkennungenByKuerzel() {
