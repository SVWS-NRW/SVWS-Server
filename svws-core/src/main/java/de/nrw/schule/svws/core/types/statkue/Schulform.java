...
public enum Schulform {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull Schulform> _schulformen = new HashMap<>();
	
	/** Ein Vector mit allen definierten Schulformen, die eine Statistiknummer zugewiesen haben. */
	private static final @NotNull HashMap<@NotNull String, @NotNull Schulform> _schulformenNummer = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull Schulform> getMapSchulformenByKuerzel() {
	 ...
	 * @return die Map von den Kürzels der Schulformen auf die zugehörigen Schulformen
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull Schulform> getMapSchulformenByNummer() {
