...
public enum AllgemeineMerkmale {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull AllgemeineMerkmale> _mapByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull AllgemeineMerkmale> getMapByKuerzel() {
