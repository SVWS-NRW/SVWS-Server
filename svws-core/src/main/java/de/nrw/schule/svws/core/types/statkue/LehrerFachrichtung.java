...
public enum LehrerFachrichtung {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerFachrichtung> _fachrichtungenByID = new HashMap<>();

	/** Eine Hashmap mit allen Fachrichtungen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerFachrichtung> _fachrichtungenByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerFachrichtung> getMapFachrichtungByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerFachrichtung> getMapFachrichtungByKuerzel() {
