...
public enum Herkunft {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull Herkunft> _kuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull Herkunft> getMapByKuerzel() {
		if (_kuerzel.size() == 0) {
