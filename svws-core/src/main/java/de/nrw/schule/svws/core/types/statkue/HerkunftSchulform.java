...
import de.nrw.schule.svws.core.data.schule.HerkunftSchulformKatalogEintrag;
...
public enum HerkunftSchulform {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull HerkunftSchulform> _ebenen = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull HerkunftSchulform> getMapByKuerzel() {
		if (_ebenen.size() == 0) {
