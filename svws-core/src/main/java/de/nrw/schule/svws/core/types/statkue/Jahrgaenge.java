...
public enum Jahrgaenge {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull Jahrgaenge> _mapKuerzel = new HashMap<>();

	/** Eine Map mit der Zuordnung des Jahrgangs zu der ID des Jahrgangs */
	private static final @NotNull HashMap<@NotNull Long, @NotNull Jahrgaenge> _mapID = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull Jahrgaenge> getMapJahrgangByKuerzel() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull Jahrgaenge> getMapJahrgangByID() {
		if (_mapID.size() == 0)
			for (Jahrgaenge j : Jahrgaenge.values()) {
	 ...
	 */
	public static @NotNull List<@NotNull Jahrgaenge> get(Schulform schulform) {
		@NotNull Vector<@NotNull Jahrgaenge> result = new Vector<>();
		if (schulform == null)
			return result;
