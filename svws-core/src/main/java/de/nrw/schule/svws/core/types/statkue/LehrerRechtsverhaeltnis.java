...
public enum LehrerRechtsverhaeltnis {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerRechtsverhaeltnis> _rechtsverhaeltnisByID = new HashMap<>();

	/** Eine Hashmap mit allen Arten von Rechtsverhältnissen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerRechtsverhaeltnis> _rechtsverhaeltnisByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerRechtsverhaeltnis> getMapRechtsverhaeltnisByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerRechtsverhaeltnis> getMapRechtsverhaeltnisByKuerzel() {
