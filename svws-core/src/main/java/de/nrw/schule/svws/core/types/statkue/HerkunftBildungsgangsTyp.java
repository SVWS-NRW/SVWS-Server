...
import de.nrw.schule.svws.core.data.schule.HerkunftBildungsgangTypKatalogEintrag;
...
public enum HerkunftBildungsgangsTyp {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull HerkunftBildungsgangsTyp> _ebenen = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull HerkunftBildungsgangsTyp> getMapByKuerzel() {
		if (_ebenen.size() == 0) {
