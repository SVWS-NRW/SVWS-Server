...
public enum LehrerEinsatzstatus {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerEinsatzstatus> _statusByID = new HashMap<>();

	/** Eine Hashmap mit allen Einsatzstatus, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerEinsatzstatus> _statusByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerEinsatzstatus> getMapStatusByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerEinsatzstatus> getMapStatusByKuerzel() {
