...
public enum LehrerMehrleistungArt {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerMehrleistungArt> _artenByID = new HashMap<>();

	/** Eine Hashmap mit allen Arten von Mehrleistungen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerMehrleistungArt> _artenByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerMehrleistungArt> getMapArtenByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerMehrleistungArt> getMapArtenByKuerzel() {
