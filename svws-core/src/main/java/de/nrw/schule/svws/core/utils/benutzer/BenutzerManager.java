...
/**
 * Ein Manager zur Handhabung von Daten des Typs {@link BenutzerDaten}. Hierbei werden 
...
public class BenutzerManager {
    ...
    /** Eine Map, welche zu einer Kompetenz eine Liste zuordnet, welche alle Benutzer-Gruppen beinhaltet, von denen
    ...
    /** Die Menge an Kompetenzen, die diesem Benutzer entweder direkt oder über mindestens eine Gruppe zugeordnet ist. */
    ...
    public void removeKompetenz(@NotNull BenutzerKompetenz kompetenz) throws IllegalArgumentException {
        ...
        @NotNull List<@NotNull BenutzergruppeDaten> gruppen = getGruppen(kompetenz);
        if (gruppen.size() == 0)
