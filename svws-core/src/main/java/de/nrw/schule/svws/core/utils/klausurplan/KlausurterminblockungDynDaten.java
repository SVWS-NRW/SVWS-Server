...
public class KlausurterminblockungDynDaten {
	 ...
	 */
	KlausurterminblockungDynDaten(@NotNull Random pRandom, @NotNull List<@NotNull GostKursklausur> pInput) {
		_random = pRandom;
	...
	private int gibSchienenBevorzugt(@NotNull int @NotNull [] pKlausurZuSchiene) {
