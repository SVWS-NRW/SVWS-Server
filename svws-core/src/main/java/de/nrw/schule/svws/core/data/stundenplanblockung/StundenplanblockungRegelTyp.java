...
public enum StundenplanblockungRegelTyp {
	...
	private static @NotNull HashMap<@NotNull Integer, StundenplanblockungRegelTyp> getMap() {
		if (_map_id_regel.isEmpty())
			for (@NotNull StundenplanblockungRegelTyp typ : StundenplanblockungRegelTyp.values())
	 ...
	 */
	private StundenplanblockungRegelTyp(int id, @NotNull String bezeichnung,
			@NotNull List<@NotNull StundenplanblockungRegelParameterTyp> paramTypes) throws IllegalArgumentException {
		this.id = id;
	 ...
	 */
	public static @NotNull StundenplanblockungRegelTyp fromTyp(Integer id) {
		if (id == null)
			return StundenplanblockungRegelTyp.UNDEFINIERT;
		StundenplanblockungRegelTyp gostTyp = getMap().get(id);
		if (gostTyp == null)
			return StundenplanblockungRegelTyp.UNDEFINIERT;
		return gostTyp;
	}
	 ...
	 * @return der Regel-Typ 
	 */
	public static @NotNull StundenplanblockungRegelTyp fromRegel(@NotNull StundenplanblockungRegel pRegel) {
	 ...
	 */
	public @NotNull StundenplanblockungRegelParameterTyp getParamType(int i) throws IllegalArgumentException {
	...
	public boolean hasParamType(StundenplanblockungRegelParameterTyp paramType) {
		for (StundenplanblockungRegelParameterTyp cur : paramTypes)
			if (paramType == cur)
				return true;
		return false;
	}
