...
public enum LehrerLehramt {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerLehramt> _aemterByID = new HashMap<>();

	/** Eine Hashmap mit allen Lehrämtern, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerLehramt> _aemterByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerLehramt> getMapLehraemterByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerLehramt> getMapLehraemterByKuerzel() {
