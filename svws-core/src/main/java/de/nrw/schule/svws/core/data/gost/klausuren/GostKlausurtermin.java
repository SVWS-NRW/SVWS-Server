...
public class GostKlausurtermin {
	...
	@Schema(required = true, description = "das Quartal, in welchem die Klausur gechrieben wird", example="1")
	public int quartal = -1;

	/** Das Datum des Klausurtermins, falls schon gesetzt. */
	@Schema(required = false, description = "das Datum des Klausurtermins, falls schon gesetzt", example="29.02.2025")
	public String datum = null;
	
	/** Die Startzeit des Klausurtermins, falls schon gesetzt. */
	@Schema(required = false, description = "die ID der Unterrichtseinheit, falls schon gesetzt", example="09:00:00")
	public String startzeit = null;
	
	/** Die Bezeichnung des Klausurtermins, falls schon gesetzt. */
	@Schema(required = false, description = "die Bezeichnung des Klausurtermins", example="Zentrale Vergleichsarbeit")
	public String bezeichnung = null;
	
	/** Die textuelle Bemerkung zum Termin, sofern vorhanden. */
	@Schema(required = false, description = "die textuelle Bemerkung zum Termin, sofern vorhanden", example="Im Anschluss kein regulärer Unterricht.")
