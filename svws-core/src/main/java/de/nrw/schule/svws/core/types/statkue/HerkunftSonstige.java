...
public enum HerkunftSonstige {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull HerkunftSonstige> _ebenen = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull HerkunftSonstige> getMapByKuerzel() {
		if (_ebenen.size() == 0) {
