...
public class SchuelerLernabschnittsdaten {
	...
	@Schema(required = false, description = "das Datum, wann der Lernabschnitt beginnt", example="NULL")	
	public String datumAnfang = null;
	
	/** Das Datum, wann der Lernabschnitt endet */
	@Schema(required = false, description = "das Datum, wann der Lernabschnitt endet", example="NULL")	
	public String datumEnde = null;

	/** Das Datum der Konferenz */
	@Schema(required = false, description = "das Datum der Konferenz", example="NULL")	
	public String datumKonferenz = null;

	/** Das Datum des Zeugnisses bzw. der Laufbahnbescheinigung */
	@Schema(required = false, description = "das Datum der Zeugnisses bzw. der Laufbahnbescheinigung", example="NULL")	
	...
	@Schema(required = false, description = "die Anzahl der Schulbesuchsjahre", example="NULL")	
	...
	@Schema(required = true, description = "das Kürzel der Schulgliederung bzw. des Bildungsgangs des Schülers", example="B09")	
	...
	@Schema(required = false, description = "die ID der Fachklasse des Schülers an einem Berufskolleg", example="null")
	public Long fachklasseID = null;

	/** Der Schwerpunkt eines Schülers laut dem Schwerpunkt-Katalog */
	@Schema(required = false, description = "der Schwerpunkt eines Schülers laut dem Schwerpunkt-Katalog", example="null")
	...
	@Schema(required = false, description = "das Kürzel der Organisationsform der Schule in Bezug auf den Schüler (z.B. Ganztag)", example="null")
	public String organisationsform = null;

	/** Das Kürzel der Klassenart in Bezug auf den Schüler (z.B. Regelklasse - siehe Core-Type) */
	@Schema(required = true, description = "das Kürzel der Klassenart in Bezug auf den Schüler (z.B. Regelklasse)", example="null")	
	public String Klassenart = "RK";

	/** Die Summe der Gesamtfehlstunden für den gesamten Lernabschnitt */
	@Schema(required = true, description = "die Summe der Gesamtfehlstunden für den gesamten Lernabschnitt", example="0")
	public int fehlstundenGesamt = 0;
	
	/** Die Summe der unentschuldigten Fehlstunden für den gesamten Lernabschnitt */
	@Schema(required = true, description = "die Summe der unentschuldigten Fehlstunden für den gesamten Lernabschnitt", example="0")
	...
	@Schema(required = false, description = "der Grenzwert für die Fehlstunden, ab dem am Berufskolleg Warnbriefe zur Entlassung verschickt werden", example="null")	
	public Integer fehlstundenGrenzwert = null;
	
	/** Gibt an, ob eine Schwerbehinderung nachgewiesen ist oder nicht */
	@Schema(required = true, description = "gibt an, ob eine Schwerbehinderung nachgwiesen ist oder nicht", example="false")
	...
	@Schema(required = true, description = "gibt an, ob eine Förderung nach der Ausbildungsordnung Sonderpädagogischer Förderung (AOSF) vorliegt", example="false")
	public boolean hatAOSF = false;

	/** Gibt an, ob eine Diagnose zu Autismus vorliegt oder nicht */
	@Schema(required = true, description = "gibt an, ob eine Diagnose zu Autismus vorliegt oder nicht", example="false")
	public boolean hatAutismus = false;

	/** Gibt an, ob zieldifferent unterrichet wird oder nicht */
	@Schema(required = true, description = "gibt an, ob zieldifferent unterrichet wird oder nicht", example="false")
	public boolean hatZieldifferentenUnterricht = false;

	/** Die ID des Haupförderschwerpunktes des Schülers */
	@Schema(required = false, description = "die ID des Haupförderschwerpunktes des Schülers", example="null")
	public Long foerderschwerpunkt1ID = null;

	/** Die ID des weiteren Förderschwerpunktes des Schülers */
	@Schema(required = false, description = "die ID des weiteren Förderschwerpunktes des Schülers", example="null")
	public Long foerderschwerpunkt2ID = null;

	/** Die ID eines Sonderpädagogen, der den Schüler betreut und auch im Notenmodul hat */
	@Schema(required = false, description = "die ID eines Sonderpädagogen, der den Schüler betreut und auch im Notenmodul hat", example="null")
	...
	@Schema(required = false, description = "die Sprache des bilngualen Zweigs, falls der Schüler im bilingualen Zweig unterrichtet wird", example="null")
	...
	@Schema(required = true, description = "gibt für das Berufskolleg an, ob der fachpraktische Anteil in den Anlagen B08, B09 und B10 ausreichend sind für Versetzung", example="true")
	public boolean istFachpraktischerAnteilAusreichend = true;
	
	/** Das Kürzel des Versetzungsvermerks */
	@Schema(required = false, description = "das Kürzel des Versetzungsvermerks", example="null")
	...
	@Schema(required = false, description = "die Durchschnittsnote in diesem Lernabschnitt - wird ggf. von einem Prüfungsalgorithmus gesetzt und kann dann ausgelesen werden", example="null")
	...
	@Schema(required = false, description = "die Lernbereichnote Gesellschaftswissenschaft oder Arbeitlehre für den Hauptschulabschluss nach Klassen 10", example="null")
	...
	@Schema(required = false, description = "die Lernbereichnote Naturwissenschaft für den Hauptschulabschluss nach Klassen 10", example="null")
	public Integer noteLernbereichNW = null;

	/** Die Art des Abschlusses (siehe Katalog) */
	@Schema(required = false, description = "die Art des Abschlusses", example="null")
	public Integer abschlussart = null;

	/** Gibt an, ob der berechnete Abschluss eine Prognose ist oder nicht (siehe Katalog) */
	@Schema(required = true, description = "gibt an, ob der berechnete Abschluss eine Prognose ist oder nicht", example="false")
	public boolean istAbschlussPrognose = false;

	/** Der erreichte allgemeinbildende Abschluss */
	@Schema(required = false, description = "der erreichte allgemeinbildende Abschluss", example="null")
	public String abschluss = null;

	/** Der erreichte berufsbezogene Abschluss am Berufskolleg */
	@Schema(required = false, description = "der erreichte berufsbezogene Abschluss am Berufskolleg", example="null")
	...
	@Schema(required = false, description = "die textuelle Ausgabe des Prüfungsalgorithmus für die Versetzungs-/Abschlussberechnung", example="null")
	public String textErgebnisPruefungsalgorithmus = null;

	/** Die Art des Zeugnisses */
	@Schema(required = false, description = "die Art des Zeugnisses", example="null")
	...
	@Schema(required = false, description = "die Informationen den Nachprüfungen in diesem Lernabschnitt oder null, falls keine vorhanden sind.", example="null")
	public SchuelerLernabschnittNachpruefungsdaten nachpruefungen = null;

	/** Die Bemerkungen in diesem Lernabschnitt. */
	@Schema(required = true, description = "die Bemerkungen in diesem Lernabschnitt")
	...
	@ArraySchema(schema = @Schema(required = true, implementation = SchuelerLeistungsdaten.class, description = "Ein Array mit den Leistungsdaten des Schülers in diesem Lernabschnitt."))
