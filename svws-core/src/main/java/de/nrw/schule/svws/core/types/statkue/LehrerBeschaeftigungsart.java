...
public enum LehrerBeschaeftigungsart {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerBeschaeftigungsart> _artenByID = new HashMap<>();

	/** Eine Hashmap mit allen Beschäftigungsarten, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerBeschaeftigungsart> _artenByKuerzel = new HashMap<>();	
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerBeschaeftigungsart> getMapArtenByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerBeschaeftigungsart> getMapArtenByKuerzel() {
