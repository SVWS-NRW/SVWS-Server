...
public enum ZulaessigeKursart {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull ZulaessigeKursart> _mapID = new HashMap<>();

	/** Eine HashMap mit zulässigen Kursarten. Der Zugriff erfolgt dabei über das Kürzel */ 
	private static final @NotNull HashMap<@NotNull String, @NotNull ZulaessigeKursart> _mapKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull ZulaessigeKursart> getMapByID() {
		if (_mapID.size() == 0)
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull ZulaessigeKursart> getMapByKuerzel() {
	 ...
	 */
	public static @NotNull List<@NotNull ZulaessigeKursart> get(Schulform schulform) {
		@NotNull Vector<@NotNull ZulaessigeKursart> kursarten = new Vector<>();
		if (schulform == null)
			return kursarten;
