...
public enum HerkunftBildungsgang {
	...
	private static final @NotNull HashMap<@NotNull String, @NotNull HerkunftBildungsgang> _ebenen = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull HerkunftBildungsgang> getMapByKuerzel() {
		if (_ebenen.size() == 0) {
