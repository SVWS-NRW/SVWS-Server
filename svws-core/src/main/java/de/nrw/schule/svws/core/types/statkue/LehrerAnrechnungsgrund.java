...
public enum LehrerAnrechnungsgrund {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerAnrechnungsgrund> _gruendeByID = new HashMap<>();

	/** Eine Hashmap mit allen Anrechnungsgründen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerAnrechnungsgrund> _gruendeByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerAnrechnungsgrund> getMapGruendeByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerAnrechnungsgrund> getMapGruendeByKuerzel() {
