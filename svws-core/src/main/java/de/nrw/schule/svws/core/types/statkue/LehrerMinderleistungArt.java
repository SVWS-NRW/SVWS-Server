...
public enum LehrerMinderleistungArt {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerMinderleistungArt> _artenByID = new HashMap<>();

	/** Eine Hashmap mit allen Arten von Minderleistungen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerMinderleistungArt> _artenByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerMinderleistungArt> getMapArtenByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerMinderleistungArt> getMapArtenByKuerzel() {
