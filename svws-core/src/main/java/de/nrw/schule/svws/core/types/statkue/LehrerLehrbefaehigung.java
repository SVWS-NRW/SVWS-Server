...
public enum LehrerLehrbefaehigung {
	...
	private static final @NotNull HashMap<@NotNull Long, @NotNull LehrerLehrbefaehigung> _lehrbefaehigungenByID = new HashMap<>();

	/** Eine Hashmap mit allen Lehrbefähigungen, welche dem Kürzel bzw. ASD-Schlüssel zugeordnet sind. */
	private static final @NotNull HashMap<@NotNull String, @NotNull LehrerLehrbefaehigung> _lehrbefaehigungenByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<@NotNull Long, @NotNull LehrerLehrbefaehigung> getMapLehrbefaehigungByID() {
	 ...
	 */
	private static @NotNull HashMap<@NotNull String, @NotNull LehrerLehrbefaehigung> getMapLehrbefaehigungByKuerzel() {
