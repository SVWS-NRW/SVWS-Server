...
public class SchuelerSchulbesuchsdaten {
	...
	@Schema(required = true, description = "die Schulnummer der vorher besuchten Schule", example="178947")
	...
	@Schema(required = true, description = "die allgemeine Herkunftsart des Schüler in Bezug auf die schulform der zuvor besuchten Schule", example="Grundschule (auch Primarstufe der Volkschule)")
	public String vorigeAllgHerkunft;
	
	/** Das Entlassdatum an der zuvor besuchten Schule. */
	@Schema(required = true, description = "das Entlassdatum an der zuvor besuchten Schule", example="1901-03-11")
	public String vorigeEntlassdatum;

	/** Der Entlassjahrgang an der zuvor besuchten Schule. */
	@Schema(required = true, description = "der Entlassjahrgang an der zuvor besuchten Schule", example="03")
	public String vorigeEntlassjahrgang;

	/** Die ID der Art der letzten Versetzung an der zuvor besuchten Schule. */
	@Schema(required = true, description = "die Art der letzten Versetzung an der zuvor besuchten Schule", example="11")
	public String vorigeArtLetzteVersetzung;

	/** Bemerkungen zu der zuvor besuchten Schule. */
	@Schema(required = true, description = "die Art der letzten Versetzung an der zuvor besuchten Schule", example="diverse")
	public String vorigeBemerkung;

	/** Die ID des Grundes für die Entlassung von der zuvor besuchten Schule. */
	@Schema(required = true, description = "die ID des Grundes für die Entlassung von der zuvor besuchten Schule", example="2")
	public Long vorigeEntlassgrundID;
	
	/** Die ID des Abschlusses, welcher an der zuvor besuchten Schule erworben wurde. */
	@Schema(required = true, description = "die ID des Abschlusses, welcher an der zuvor besuchten Schule erworben wurde", example="OA")
	...
	@Schema(required = true, description = "das Entlassdatum von dieser Schule", example="1902-03-11")
	public String entlassungDatum;
	
	/** Der Jahrgang bei der Entlassung von dieser Schule. */
	@Schema(required = true, description = "er Jahrgang bei der Entlassung von dieser Schule", example="03")
	public String entlassungJahrgang;

	/** Die ID des Grundes für die Entlassung von dieser Schule. */
	@Schema(required = true, description = "die ID des Grundes für die Entlassung von dieser Schule", example="1")
	public Long entlassungGrundID;
	
	/** Die ID des Abschlusses, welcher an dieser Schule erworben wurde. */
	@Schema(required = true, description = "die ID des Abschlusses, welcher an dieser Schule erworben wurde", example="OA")
	...
	@Schema(required = true, description = "die Schulnummer der aufnehmenden Schule nach einer Entlassung", example="187486")
	public String aufnehmdendSchulnummer;
	
	/** Das Datum beim Wechsel zu einer aufnehmenden Schule. */
	@Schema(required = true, description = "das Datum beim Wechsel zu einer aufnehmenden Schule", example="2020-01-01")
	public String aufnehmdendWechseldatum;

	/** Gibt an, ob die aufnehmende Schule den Wechsel bestätigt hat. */
	@Schema(required = true, description = "gibt an, ob die aufnehmende Schule den Wechsel bestätigt hat", example="true")
	...
	@Schema(required = true, description = "das Jahr der Einschulung in die Grundschule", example="2005")
	public Integer grundschuleEinschulungsjahr;

	/** Die ID der Einschulungsart in die Grundschule. */
	@Schema(required = true, description = "die ID der Einschulungsart in die Grundschule", example="51")
	public Long grundschuleEinschulungsartID;
	
	/** Die Anzahl der Jahre in der Schuleingangsphase der Grundschule. */
	@Schema(required = true, description = "die Anzahl der Jahre in der Schuleingangsphase der Grundschule", example="2")
	public Integer grundschuleJahreEingangsphase;
	
	/** Die ID für die Übergangsempfehlung der Grundschule in die Sekundarstufe I */
	@Schema(required = true, description = "die ID für die Übergangsempfehlung der Grundschule in die Sekundarstufe I", example="3")
	...
	@Schema(required = true, description = "das Jahr des Wechsels in die Sekundarstufe I", example="2009")
	public Integer sekIWechsel;

	/** Das Kürzel der ersten Schulform in der Sekundarstufe I */
	@Schema(required = true, description = "das Kürzel der ersten Schulform in der Sekundarstufe I", example="GY")
	public String sekIErsteSchulform;
	
	/** Das Jahr des Wechsels in die Sekundarstufe II. */
	@Schema(required = true, description = "das Jahr des Wechsels in die Sekundarstufe II", example="2017")
	...
	@ArraySchema(schema = @Schema(required = true, implementation = SchuelerSchulbesuchMerkmal.class, description = "Ein Array mit den Informationen zu den besonderen Merkmalen für die Statistik."))
	...
	@ArraySchema(schema = @Schema(required = true, implementation = SchuelerSchulbesuchSchule.class, description = "Ein Array mit den Informationen zu allen bisher besuchten Schulen."))
