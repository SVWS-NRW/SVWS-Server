...
public class UntisGPU003 {
	...
	private static final ObjectReader reader = new CsvMapper().readerFor(UntisGPU003.class).with(schema);
	 ...
	 */
	public static @NotNull List<UntisGPU003> readCSV(final String csvData) throws IOException {
		try (MappingIterator<UntisGPU003> it = reader.readValues(csvData)) {
			return it.readAll();
		}
	}
