...
public class GZip {
	 ...
	 */
	public static byte[] decodeData(final InputStream input) throws CompressionException {
	 ...
	 * @throws CompressionException   falls ein Fehler beim Dekomprimieren auftritt
	 */
	public static byte[] decode(final byte[] data) throws CompressionException {
	 ...
	 * @throws CompressionException   falls ein Fehler beim Dekomprimieren auftritt
	 */
	public static byte[] decodeBase64(final String data) throws CompressionException {
