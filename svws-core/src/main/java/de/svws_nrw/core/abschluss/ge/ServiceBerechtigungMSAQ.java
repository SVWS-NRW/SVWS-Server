...
public class ServiceBerechtigungMSAQ extends Service<@NotNull GEAbschlussFaecher, @NotNull AbschlussErgebnis> {
    ...
    private @NotNull AbschlussErgebnis pruefeDefizite(final @NotNull AbschlussFaecherGruppen faecher, final @NotNull String log_indent) {
        ...
        if ((fg1_defizite.size() > 2) || ((fg1_defizite.size() == 2) && (wp_defizit == null))) {
            ...
            final @NotNull AbschlussErgebnis abschlussergebnis = pruefeFG2(faecher, log_indent, npFaecher, nachpruefung_genutzt);
            if (abschlussergebnis.erworben) {
        ...
        if ((fg1_defizite.size() == 1) && (wp_defizit != null)) {
        	...
        	final @NotNull AbschlussErgebnis abschlussergebnis = pruefeFG2(faecher, log_indent, npFaecher, true);
