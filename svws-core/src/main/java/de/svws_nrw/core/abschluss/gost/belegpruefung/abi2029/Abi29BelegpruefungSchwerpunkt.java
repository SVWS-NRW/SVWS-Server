...
public final class Abi29BelegpruefungSchwerpunkt extends GostBelegpruefung {
	 ...
	 */
	public Abi29BelegpruefungSchwerpunkt(final @NotNull AbiturdatenManager manager, final @NotNull GostBelegpruefungsArt pruefungsArt,
			final @NotNull Abi29BelegpruefungFremdsprachen pruefungSprachen, final @NotNull Abi29BelegpruefungNaturwissenschaften pruefungNawi) {
	...
	protected void pruefeEF1() {
		final @NotNull Abi29BelegpruefungFremdsprachen pruefung_sprachen = ((@NotNull Abi29BelegpruefungFremdsprachen) pruefungen_vorher[0]);
		final @NotNull Abi29BelegpruefungNaturwissenschaften pruefung_nawi = ((@NotNull Abi29BelegpruefungNaturwissenschaften) pruefungen_vorher[1]);
