...
/**
 * Diese Klasse enthält die Informationen zu der Fachbelegung eines Schülers für das Abitur des beruflichen Gymnasiums
 */
@XmlRootElement
@Schema(description = "enthält die Informationen zu der Fachbelegung eines Schülers für das Abitur des beruflichen Gymnasiums.")
@TranspilerDTO
public class BKGymAbiturFachbelegung {
	...
	public final @NotNull BKGymAbiturFachbelegungHalbjahr[] belegungen = new BKGymAbiturFachbelegungHalbjahr[GostHalbjahr.maxHalbjahre];

	/**
	 * Leerer Standardkonstruktor.
	 */
	public BKGymAbiturFachbelegung() {
		// leer
	}
}
