...
/**
 * Diese Klasse enthält Informationen zu der Halbjahres-Fachbelegung eines Schülers für das Abitur des beruflichen Gymnasiums.
 */
@XmlRootElement
@Schema(description = "enthält die Informationen zu der Halbjahres-Fachbelegung eines Schülers für das Abitur des beruflichen Gymnasiums.")
@TranspilerDTO
public class BKGymAbiturFachbelegungHalbjahr {
	 ...
	 */
	public BKGymAbiturFachbelegungHalbjahr() {
		// leer
	}
}
