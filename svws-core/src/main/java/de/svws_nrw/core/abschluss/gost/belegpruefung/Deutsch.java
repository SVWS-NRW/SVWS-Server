 ...
 */
public class Deutsch extends GostBelegpruefung {
	 ...
	 */
	public Deutsch(final @NotNull AbiturdatenManager manager, final @NotNull GostBelegpruefungsArt pruefungs_art) {
