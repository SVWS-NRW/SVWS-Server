...
*/
public final class SatPreprocessor2 implements Function<@NotNull SatInput, @NotNull SatOutput> {
	 ...
	 */
	public SatPreprocessor2(@NotNull final Function<@NotNull SatInput, @NotNull SatOutput> next) {
		super();
		this.next = next;
	}
