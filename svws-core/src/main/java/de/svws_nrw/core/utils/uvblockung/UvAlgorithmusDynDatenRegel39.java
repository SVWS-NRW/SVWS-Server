...
/**
 * Implementiert die Regel {@link UvBlockungRegelTyp#LEHRKRAFT_A_UNGERNE_ALS_STELLV_KLASSENLEHRER_IN_KLASSE_B}.
 *
 * @author Benjamin A. Bartsch
 */
public final class UvAlgorithmusDynDatenRegel39 implements UvAlgorithmusDynDatenRegel {
	 ...
	 */
	public UvAlgorithmusDynDatenRegel39(
	...
	public void changeMalus(final int faktor) {
		final boolean istLeitung2 = lehrkraft.istLeitung2InKlasse[klasse.interneID];

		if ((prioritaet >= 0) && (istLeitung2)) {
