...
public final class Map4DUtils {
     ...
     * @param map3D   Die Map, welche (K1, K2, K3, K4) auf "HashSet of V" abbildet.
     * @param key1  Der 1. Schlüssel.
     * @param key2  Der 2. Schlüssel.
     * @param key3  Der 3. Schlüssel.
     * @param key4  Der 4. Schlüssel.
     ...
     */
	public static <@NotNull K1, @NotNull K2, @NotNull K3, @NotNull K4, @NotNull V>  @NotNull HashSet<@NotNull V> getOrCreateHashSet(final @NotNull HashMap4D<@NotNull K1, @NotNull K2, @NotNull K3, @NotNull K4, @NotNull HashSet<@NotNull V>> map3D, final @NotNull K1 key1, final @NotNull K2 key2, final @NotNull K3 key3, final @NotNull K4 key4) {
		final HashSet<@NotNull V> set = map3D.getOrNull(key1, key2, key3, key4);
		if (set != null)
			return set;
