...
//					return a.quartal - b.quartal;
    ...
    private final @NotNull HashMap4D<Integer, Integer, Long, Integer, List<GostKursklausur>> _kursklausurmenge_by_abijahr_and_halbjahr_and_idTermin_and_quartal = new HashMap4D<>();
    private final @NotNull HashMap4D<Long, Integer, Integer, Integer, GostKursklausur> _kursklausur_by_idKurs_and_abijahr_and_halbjahr_and_quartal = new HashMap4D<>();
    ...
    private final @NotNull HashMap2D<Long, Long, List<GostSchuelerklausurTermin>> _schuelerklausurterminaktuellmenge_by_idTermin_and_idKursklausur = new HashMap2D<>();
    private final @NotNull HashMap4D<Integer, Integer, Integer, Long, List<GostSchuelerklausurTermin>> _schuelerklausurterminntaktuellmenge_by_abijahr_and_halbjahr_and_quartal_and_idTermin = new HashMap4D<>(); // ggf.
    // neuer
    // Manager
    ...
    public GostKursklausurManager(final @NotNull GostKlausurvorgabenManager vorgabenManager,
	    final @NotNull List<GostKursklausur> listKlausuren, final List<GostKlausurtermin> listTermine,
...
//		update_schuelerIds_by_idTermin(); // benötigt _kursklausurmenge_by_idTermin
     ...
     * @return die Liste von GostKlausurtermin-Objekten
     */
    public @NotNull List<GostKlausurtermin> terminGetMengeByDatumAndAbijahr(final @NotNull String datum,
     ...
     * @return die Liste von GostKlausurtermin-Objekten
     */
    public @NotNull List<GostKlausurtermin> terminGetFremdmengeByDatumAndAbijahr(final @NotNull String datum,
	    final int abiJahrgang) {
	final @NotNull List<GostKlausurtermin> termine = new ArrayList<>();
	final Map<Integer, List<GostKlausurtermin>> jgDatumMap = _terminmenge_by_datum_and_abijahr
     ...
     * @return die Liste von GostKlausurtermin-Objekten
     */
    public @NotNull List<GostKlausurtermin> terminGetMengeByDatumAndAbijahrAndZeitraster(final @NotNull String datum,
	    final int abiJahrgang, final @NotNull StundenplanZeitraster zr, final @NotNull StundenplanManager manager) {
	...
	for (final @NotNull GostKlausurtermin termin : termine) {
	    ...
	    final @NotNull List<StundenplanZeitraster> zrsTermin = manager.getZeitrasterByWochentagStartVerstrichen(
		    Wochentag.fromIDorException(zr.wochentag),
     ...
     * @return die Liste von GostKursklausur-Objekten
     */
    public List<GostKursklausur> kursklausurGetMengeByHalbjahrAndQuartal(final int abiJahrgang,
     ...
     * @return die Liste von GostKursklausur-Objekten
     */
    public @NotNull List<GostKursklausur> kursklausurOhneTerminGetMengeByHalbjahrAndQuartal(final int abiJahrgang,
	    final @NotNull GostHalbjahr halbjahr, final int quartal) {
	if (quartal > 0) {
...
//	}
     ...
     */
    public static @NotNull List<PairNN<Integer, GostHalbjahr>> getParallelHalbjahre(final int abiJahrgang,
	    final int halbjahr, final boolean includeSelf) {
     ...
     * @return die Liste von GostKlausurtermin-Objekten
     */
    public @NotNull List<GostKlausurtermin> terminGetMengeByHalbjahrAndQuartalMultijahrgang(final int abiJahrgang,
     ...
     */
    public @NotNull List<GostKlausurtermin> terminGetNTMengeByHalbjahrAndQuartalMultijahrgang(final int abiJahrgang,
	    final @NotNull GostHalbjahr halbjahr, final int quartal, final boolean multijahrgang) {
	final List<GostKlausurtermin> termine = new ArrayList<>();
     ...
     */
    public @NotNull List<GostKlausurtermin> terminGetHTMengeByHalbjahrAndQuartal(final int abiJahrgang,
	    final @NotNull GostHalbjahr halbjahr, final int quartal) {
	final List<GostKlausurtermin> termine = new ArrayList<>();
	...
	final @NotNull List<GostSchuelerklausurTermin> schuelertermine = schuelerklausurterminNtByTerminid(idTermin);
...
//			schuelerklausurGetByIdOrException(termin1.idSchuelerklausur).idSchueler, termin1);
	...
	for (final @NotNull Entry<Long, List<GostKursklausur>> entry : kursklausurmenge_by_schuelerId.entrySet()) {
	    ...
	    final @NotNull List<GostKursklausur> klausuren = (temp != null) ? new ArrayList<>(temp) : new ArrayList<>();
     ...
     * @return die Liste von Schülerklausur-Terminen
     */
    public @NotNull List<GostSchuelerklausurTermin> schuelerklausurterminaktuellGetMengeByTerminidAndKursklausurid(
	    final long idTermin, final long idKursklausur) {
     ...
     */
    public @NotNull List<GostSchuelerklausurTermin> schuelerklausurterminFolgeterminGetMengeByTerminid(
	    final long idTermin) {
	...
	final @NotNull List<GostSchuelerklausurTermin> ergebnis = new ArrayList<>();
	if (quartal > 0) {
	    final Map<Long, List<GostSchuelerklausurTermin>> skts = _schuelerklausurterminntaktuellmenge_by_abijahr_and_halbjahr_and_quartal_and_idTermin
	    ...
	    final Map<Integer, Map<Long, List<GostSchuelerklausurTermin>>> skts = _schuelerklausurterminntaktuellmenge_by_abijahr_and_halbjahr_and_quartal_and_idTermin
	...
	if (quartal > 0) {
	    ...
	    final Map<Integer, Map<Long, List<GostSchuelerklausurTermin>>> map3 = _schuelerklausurterminntaktuellmenge_by_abijahr_and_halbjahr_and_quartal_and_idTermin
		    .getMap3OrNull(abiJahrgang, halbjahr.id);
	    if (map3 == null)
		return ergebnis;
	...
	final Map<Integer, Map<Long, List<GostSchuelerklausurTermin>>> mapHalbjahr = _schuelerklausurterminntaktuellmenge_by_abijahr_and_halbjahr_and_quartal_and_idTermin
		.getMap3OrNull(abiJahrgang, halbjahr.id);
	if (mapHalbjahr != null)
     ...
     * @return die Liste von GostSchuelerklausurTermin-Objekten
     */
    public @NotNull List<GostSchuelerklausurTermin> schuelerklausurterminNtByTermin(
	...
	final @NotNull List<GostSchuelerklausurTermin> ergebnis = new ArrayList<>();
	final @NotNull List<GostSchuelerklausurTermin> listSkts = schuelerklausurterminGetMengeByTerminid(idTermin);
	if (listSkts != null)
    ...
    /**
     * Prüft, ob ein Schüler an einem Klausurtermin gesetzt ist.
     *
     * @param idSchueler die ID des zu prüfenden Schülers
     * @param idTermin   die ID des zu prüfenden Termins
     *
     * @return true, wenn der Schüler an dem Termin eine Klausurschreibt, sonst
     *         false
     */
    public boolean schuelerSchreibtKlausurtermin(final long idSchueler, final long idTermin) {
	final List<GostSchuelerklausurTermin> skts = _schuelerklausurterminmenge_by_idTermin.get(idTermin);
	if (skts == null)
	    return false;
	for (final @NotNull GostSchuelerklausurTermin skt : skts)
	    if (schuelerklausurBySchuelerklausurtermin(skt).idSchueler == idSchueler
		    && istAktuellerSchuelerklausurtermin(skt))
		return true;
	return false;
    }

    /**
     * Liefert zu einer Kursklausur die Schülerklausurtermine der Schüler, die den
    ...
    /**
     * Liefert zu einem Schülerklausurtermin den Schülerlisten-Eintrag
     *
     * @param skt der Schülerklausurtermin
     *
