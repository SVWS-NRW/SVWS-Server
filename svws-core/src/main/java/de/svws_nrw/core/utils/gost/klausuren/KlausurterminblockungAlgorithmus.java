...
import de.svws_nrw.core.types.gost.klausuren.KlausurterminblockungModusKursarten;
import de.svws_nrw.core.types.gost.klausuren.KlausurterminblockungModusQuartale;
...
public class KlausurterminblockungAlgorithmus {
	...
	public @NotNull GostKlausurterminblockungErgebnis apply(final @NotNull GostKlausurterminblockungDaten daten) {
		...
		berechneRekursivQuartalsModus(daten.kursklausurenRich, daten.konfiguration, out);
		return out;
	}
