 ...
 *
 * - DTO für die an der Schule unzulässigen oder erforderlichen Fachkombination. Diese können ggf. auch Kursart-spezifisch sein.
 */
@XmlRootElement
...
@TranspilerDTO
public class GostLaufbahnplanungExportV1Fachkombination {
	 ...
	 */
	public GostLaufbahnplanungExportV1Fachkombination() {
		// leer
	}
