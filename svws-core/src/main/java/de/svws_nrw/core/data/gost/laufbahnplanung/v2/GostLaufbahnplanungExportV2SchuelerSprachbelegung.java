 ...
 *
 * - Eine Sprachbelegung eines Schülers.
 */
@TranspilerDTO
@JsonIgnoreProperties(ignoreUnknown = true)
public class GostLaufbahnplanungExportV2SchuelerSprachbelegung {
	 ...
	 */
	public GostLaufbahnplanungExportV2SchuelerSprachbelegung() {
		// leer
	}
