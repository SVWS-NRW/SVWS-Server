...
public class LehrerKatalogFachrichtungAnerkennungEintrag {
	...
	@Schema(required = true, description = "das Kürzel für den Anerkennungsgrund einer Fachrichtungen eines Lehrers", example="2")
	public @NotNull String kuerzel = "";
	
	/** Der Klartext des Anerkennungsgrundes einer Fachrichtungen eines Lehrers. */
	@Schema(required = true, description = "der Anerkennungsgrund einer Fachrichtungen eines Lehrers", example="Unterrichtserlaubnis (z. B. Zertifikatskurs)")
	...
	@Schema(required = false, description = "gibt an, in welchem Schuljahr der Anerkennungsgrund einer Fachrichtungen eines Lehrers einführt wurde. Ist kein Schuljahr bekannt, so ist null gesetzt", example="null")
	...
	@Schema(required = false, description = "gibt an, bis zu welchem Schuljahr der Anerkennungsgrund einer Fachrichtungen eines Lehrers gültig ist. Ist kein Schuljahr bekannt, so ist null gesetzt", example="2025")
