...
public class ENMv1Schueler {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv1Sprachenfolge.class, description = "Ein Array mit den Informationen zu der Sprachenfolge des Schülers."))
	public @NotNull List<ENMv1Sprachenfolge> sprachenfolge = new ArrayList<>();
	...
	public @NotNull ENMv1Lernabschnitt lernabschnitt = new ENMv1Lernabschnitt();

	/** Die Leistungsdaten des Schülers in dem Lernabschnitt der Notendatei */
	@ArraySchema(schema = @Schema(implementation = ENMv1Leistung.class, description = "Ein Array mit den Informationen "
			+ "der Leistungsdaten des Schülers in dem Lernabschnitt der Notendatei."))
	public @NotNull List<ENMv1Leistung> leistungsdaten = new ArrayList<>();

	/** Die Ankreuzkompetenzen des Schülers in dem Lernabschnitt der Notendatei */
	@ArraySchema(schema = @Schema(implementation = ENMv1SchuelerAnkreuzkompetenz.class, description = "Ein Array mit den Informationen "
			+ "der Ankreuzkompetenzen des Schülers in dem Lernabschnitt der Notendatei."))
	public @NotNull List<ENMv1SchuelerAnkreuzkompetenz> ankreuzkompetenzen = new ArrayList<>();
	...
	public @NotNull ENMv1LeistungBemerkungen bemerkungen = new ENMv1LeistungBemerkungen();
	...
	public ENMv1BKAbschluss bkabschluss;

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv1Schueler() {
		// leer
	}
