...
@TranspilerDTO
public class ENMv1Floskelgruppe {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv1Floskel.class, description = "Ein Array mit den Informationen "
			+ "der Floskeln, die dieser Floskelgruppe zugeordnet sind."))
	public final @NotNull List<ENMv1Floskel> floskeln = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv1Floskelgruppe() {
		// leer
	}
