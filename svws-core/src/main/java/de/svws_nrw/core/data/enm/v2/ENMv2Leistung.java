...
public class ENMv2Leistung {
	...
	@Schema(description = "gibt an, ob es sich an einer Gesamtschule, falls es sich um einen Differenzierungskurs handelt, um einen Erweiterungskurs handelt (E-Kurs) oder nicht (G-Kurs).",
			example = "true")
	public boolean istDifferenzierungkursErweitert;
	...
	@Schema(description = "der Zeitstempel der letzten Änderung an der Kurszuweisung, die auf dem Zeugnis erscheinen soll.",
			example = "2013-11-14 13:12:48.774")
	public String tsNeueZuweisungKursart;
	...
	@ArraySchema(schema = @Schema(implementation = ENMv2Teilleistung.class, description = "Ein Array mit den Informationen zu den Teilleistungen, "
			+ "sofern welche vordefiniert sind."))
	public @NotNull List<ENMv2Teilleistung> teilleistungen = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv2Leistung() {
		// leer
	}
