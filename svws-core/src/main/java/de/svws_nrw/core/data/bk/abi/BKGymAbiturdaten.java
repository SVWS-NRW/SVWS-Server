 ...
 */
@XmlRootElement
@Schema(description = "enthält die Informationen des beruflichen Gymnasiums eines Schülers in Bezug auf das Abitur.")
@TranspilerDTO
public class BKGymAbiturdaten {
	...
	@Schema(description = "Die ID des Katalog-Eintrags des Core-Types Schulgliederung des Bildungsganges.", example = "42")
	public long idSchulgliederung;

	/** Der fünfstellige Fachklassenschlüssel des Bildungsganges. */
	@Schema(description = "Der fünfstellige Fachklassenschlüssel des Bildungsganges.", example = "10600")
	...
	@ArraySchema(schema = @Schema(implementation = BKGymAbiturFachbelegung.class, description = "Ein Array mit den Fachbelegungen in der Oberstufe."))
	public final @NotNull List<BKGymAbiturFachbelegung> fachbelegungen = new ArrayList<>();
	...
	@Schema(description = "Gibt ggf. die Note einer externen besonderen Lernleistung an.", example = "11")
	public Integer besondereLernleistungNotenpunkte = null; // nur bei externer BLL
	...
	@Schema(description = "Gibt ggf. das Fach der Facharbeit an.", example = "Mathematik")
	public String facharbeitFachbezeichnung = null;

	/** Gibt ggf. die Notenpunkte der Facharbeit an. */
	@Schema(description = "Gibt ggf. die Note der Facharbeit an.", example = "2+")
	public Integer facharbeitNotenpunkte = null;

	/** Gibt das Thema der Facharbeit an. */
	@Schema(description = "Gibt das Thema der Facharbeit an.", example = "Die Arbeit ist vom Fach.")
	public String facharbeitThema = null;
