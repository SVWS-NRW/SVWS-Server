...
public class LehrerKatalogMinderleistungsartEintrag {
	...
	@Schema(description = "gibt an, in welchem Schuljahr die Mindeleistungsart einführt wurde. Ist kein Schuljahr bekannt, so ist null gesetzt",
			example = "null")
	public Integer gueltigVon = null;

	/** Gibt an, bis zu welchem Schuljahr die Mindeleistungsart gültig ist. Ist kein Schuljahr bekannt, so ist null gesetzt. */
	@Schema(description = "gibt an, bis zu welchem Schuljahr die Mindeleistungsart gültig ist. Ist kein Schuljahr bekannt, so ist null gesetzt",
			example = "2025")
	 ...
	 */
	public LehrerKatalogMinderleistungsartEintrag(final long id, final @NotNull String kuerzel, final @NotNull String text, final Integer gueltigVon,
