 ...
 */
@XmlRootElement
@Schema(description="ein Eintrag in dem Katalog der Arten von allgemeinbildenden Schulabschlüsse.")
@TranspilerDTO
public class SchulabschlussAllgemeinbildendKatalogEintrag {
	...
	@Schema(required = true, description = "das Kürzel der Abschlussart für die amtliche Schulstatistik", example="6")
	 ...
	 */
	public SchulabschlussAllgemeinbildendKatalogEintrag() {
	}
	 ...
	 */
	public SchulabschlussAllgemeinbildendKatalogEintrag(final long id, final @NotNull String kuerzel, final @NotNull String bezeichnung, 
