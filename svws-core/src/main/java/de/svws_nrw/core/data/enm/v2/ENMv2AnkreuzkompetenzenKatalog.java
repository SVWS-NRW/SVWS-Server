...
@TranspilerDTO
public class ENMv2AnkreuzkompetenzenKatalog {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv2Ankreuzkompetenz.class,
			description = "Ein Array mit den Katalog-Einträge für die Ankreuzkompetenzen, die in der Notendatei enthalten sind."))
	public @NotNull List<ENMv2Ankreuzkompetenz> kompetenzen = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv2AnkreuzkompetenzenKatalog() {
		// leer
	}
