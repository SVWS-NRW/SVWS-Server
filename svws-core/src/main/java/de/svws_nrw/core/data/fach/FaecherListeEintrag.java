 ...
 * Sie beschreibt eine Auswahl von Daten eines Fächereintrags aus einer Liste.
 */
@XmlRootElement
...
public class FaecherListeEintrag {
	...
	@Schema(description = "die Sprache, in der das Fach unterrichtet wird, sofern es sich um ein bilinguales Sachfach handelt", example = "null")
