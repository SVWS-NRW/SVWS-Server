...
@TranspilerDTO
public class ENMv2Ankreuzkompetenz {
	...
	@Schema(description = "die Jahrgänge, falls die Ankreuzkompetenz auf bestimme Jahrgänge eingeschränkt ist, ansonsten eine leere Liste bei keiner Einschränkung")
