...
@TranspilerDTO
public class ENMv1Sprachenfolge {
	...
	@Schema(description = "Die Information, ab welchem Abschnitt in dem Jahrgang die "
	...
	@Schema(description = "Die Information, bis zu welchem Jahrgang die Sprache belegt wurde (Beispiel 12), "
	...
	@Schema(description = "Die Information, bis zu welchem Abschnitt in dem Jahrgang die "
	...
	@Schema(description = "Die Mindest-Dauer der Belegung in der Sekundarstufe I gemäß den Stufen im Core-Type "
