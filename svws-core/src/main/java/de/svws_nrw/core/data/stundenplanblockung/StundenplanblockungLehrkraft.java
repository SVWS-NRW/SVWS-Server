...
@Schema(name = "StundenplanblockungLehrkraft",
		description = "Diese Klasse spezifiziert die grundlegende Struktur von JSON-Daten für eine Lehrkraft bei {@link StundenplanblockungInput}.")
@TranspilerDTO
