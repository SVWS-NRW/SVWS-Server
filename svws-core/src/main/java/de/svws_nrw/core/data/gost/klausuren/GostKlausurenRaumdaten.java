...
@TranspilerDTO
public class GostKlausurenRaumdaten {
	...
	public @NotNull List<GostSchuelerklausurterminraumstunde> schuelerklausurterminRaumstunden = new ArrayList<>();
	 ...
	 */
	public void addAll(final @NotNull GostKlausurenRaumdaten data) {
		raeume.addAll(data.raeume);
		raumstunden.addAll(data.raumstunden);
		schuelerklausurterminRaumstunden.addAll(data.schuelerklausurterminRaumstunden);
