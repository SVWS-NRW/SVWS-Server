...
public class LehrerKatalogLehrbefaehigungAnerkennungEintrag {
	...
	@Schema(description = "gibt an, in welchem Schuljahr der Anerkennungsgrund einer Lehrbefähigung einführt wurde. Ist kein Schuljahr bekannt, so ist null gesetzt",
			example = "null")
	...
	@Schema(description = "gibt an, bis zu welchem Schuljahr der Anerkennungsgrund einer Lehrbefähigung gültig ist. Ist kein Schuljahr bekannt, so ist null gesetzt",
			example = "2025")
	 ...
	 */
	public LehrerKatalogLehrbefaehigungAnerkennungEintrag(final long id, final @NotNull String kuerzel, final @NotNull String text, final Integer gueltigVon,
