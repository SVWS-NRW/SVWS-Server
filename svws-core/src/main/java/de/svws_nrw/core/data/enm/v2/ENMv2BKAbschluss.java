...
public class ENMv2BKAbschluss {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv2BKFach.class,
			description = "Ein Array mit den Informationen zu den einzelnen Fächern, die dem Abschluss zugeordnet sind."))
	public @NotNull List<ENMv2BKFach> faecher = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv2BKAbschluss() {
		// leer
	}
