...
public class ENMv1Leistung {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv1Teilleistung.class, description = "Ein Array mit den Informationen zu den Teilleistungen, "
			+ "sofern welche vordefiniert sind."))
	public @NotNull List<ENMv1Teilleistung> teilleistungen = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv1Leistung() {
		// leer
	}
