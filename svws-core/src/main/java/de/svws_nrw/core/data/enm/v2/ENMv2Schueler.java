...
public class ENMv2Schueler {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv2Sprachenfolge.class, description = "Ein Array mit den Informationen zu der Sprachenfolge des Schülers."))
	public @NotNull List<ENMv2Sprachenfolge> sprachenfolge = new ArrayList<>();
	...
	public @NotNull ENMv2Lernabschnitt lernabschnitt = new ENMv2Lernabschnitt();

	/** Die Leistungsdaten des Schülers in dem Lernabschnitt der Notendatei */
	@ArraySchema(schema = @Schema(implementation = ENMv2Leistung.class, description = "Ein Array mit den Informationen "
			+ "der Leistungsdaten des Schülers in dem Lernabschnitt der Notendatei."))
	public @NotNull List<ENMv2Leistung> leistungsdaten = new ArrayList<>();

	/** Die Ankreuzkompetenzen des Schülers in dem Lernabschnitt der Notendatei */
	@ArraySchema(schema = @Schema(implementation = ENMv2SchuelerAnkreuzkompetenz.class, description = "Ein Array mit den Informationen "
			+ "der Ankreuzkompetenzen des Schülers in dem Lernabschnitt der Notendatei."))
	public @NotNull List<ENMv2SchuelerAnkreuzkompetenz> ankreuzkompetenzen = new ArrayList<>();
	...
	public @NotNull ENMv2LeistungBemerkungen bemerkungen = new ENMv2LeistungBemerkungen();

	/** Die Informationen zu den Zentralen Prüfungen Klasse 10, sofern vorhanden - ansonsten null */
	@ArraySchema(schema = @Schema(implementation = ENMv2ZP10.class, description = "Die Informationen zu den Zentralen Prüfungen Klasse 10."))
	public @NotNull List<ENMv2ZP10> zp10 = new ArrayList<>();
	...
	public ENMv2BKAbschluss bkabschluss;

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv2Schueler() {
		// leer
	}
