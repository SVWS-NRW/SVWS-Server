 ...
 *
 * - Die an der Schule unzulässigen oder erforderlichen Fachkombination. Diese können ggf. auch Kursart-spezifisch sein.
 */
@XmlRootElement
...
@TranspilerDTO
public class GostLaufbahnplanungExportV2Fachkombination {
	 ...
	 */
	public GostLaufbahnplanungExportV2Fachkombination() {
		// leer
	}
