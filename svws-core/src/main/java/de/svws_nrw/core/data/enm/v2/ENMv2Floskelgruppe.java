...
@TranspilerDTO
public class ENMv2Floskelgruppe {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv2Floskel.class, description = "Ein Array mit den Informationen "
			+ "der Floskeln, die dieser Floskelgruppe zugeordnet sind."))
	public final @NotNull List<ENMv2Floskel> floskeln = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv2Floskelgruppe() {
		// leer
	}
