 ...
 * Sie liefert die Informationen zu einem Unterricht im Stundenplan einer Klasse
 * (bestehend auf mehreren Unterrichtsstunden).
 */
@XmlRootElement
@Schema(description = "der Unterricht im Stundenplan einer Klasse.")
@TranspilerDTO
public class KlasseStundenplanUnterricht {
	...
	public @NotNull List<@NotNull StundenplanSchiene> schiene = new ArrayList<>();
	...
	/** Die ID des Lehrers. */
	@Schema(description = "die Lehrer, sofern Lehrer zugeordnet sind", example = "")
