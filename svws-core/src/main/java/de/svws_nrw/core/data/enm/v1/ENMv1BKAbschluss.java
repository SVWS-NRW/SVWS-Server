...
public class ENMv1BKAbschluss {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv1BKFach.class,
			description = "Ein Array mit den Informationen zu den einzelnen Fächern, die dem Abschluss zugeordnet sind."))
	public @NotNull List<ENMv1BKFach> faecher = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv1BKAbschluss() {
		// leer
	}
