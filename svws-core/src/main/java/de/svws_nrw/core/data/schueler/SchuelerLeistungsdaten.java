...
public class SchuelerLeistungsdaten {
	...
	@Schema(required = true, description = "die ID der Leistungsdaten in der Datenbank", example="126784")
	public long id = -1;
	
	/** Die ID des Lernabschnitts des Schülers, zu dem diese Leistungsdaten gehören. */
	@Schema(required = true, description = "die ID des Lernabschnitts des Schülers, zu dem diese Leistungsdaten gehören", example="4785")
	...
	@Schema(required = true, description = "die ID des Faches, auf welches sich die Leistungsdaten beziehen", example="46")
	public long fachID = -1;

	/** Die ID des Kurses, auf welches sich die Leistungsdaten beziehen - bei Klassen unterricht NULL. */
	@Schema(required = true, description = "die ID des Kurses, auf welches sich die Leistungsdaten beziehen - bei Klassen unterricht NULL", example="7732")
	public Long kursID = null;

	/** Die spezielle Kursart des Schülers, sofern Kursunterricht vorliegt. */
	@Schema(required = true, description = "die spezielle Kursart des Schülers, sofern Kursunterricht vorliegt", example="LK1")
	...
	@Schema(required = true, description = "gibt an, ob es sich bei der Fachbelegung um ein Abiturfach des Schülers handelt (NULL, 1, 2, 3, 4)", example="1")
	...
	@Schema(required = true, description = "gibt an, ob es sich um ein Fach der Zentralen Prüfungen 10 handelt oder um ein Fach der Zentralen Klausuren 10 (G8)", example="false")
	...
	@Schema(required = true, description = "die Schulnummer, sofern es sich um Unterricht an einer kooperierenden Schule handelt, ansonsten NULL", example="null")
	...
	@Schema(required = false, description = "die ID des Lernabschnitts des Schülers, zu dem diese Leistungsdaten gehören", example="23")
	public Long lehrerID = null;

	/** Die Anzahl der Wochenstunden, welche das Fach unterrichtet wird. */
	@Schema(required = false, description = "die Anzahl der Wochenstunden, welche das Fach unterrichtet wird", example="3")
	...
	@Schema(required = false, description = "die ID der Zusatzkraft", example="23")
	public Long zusatzkraftID = null;

	/** Die Anzahl der Wochenstunden der Zusatzkraft. */
	@Schema(required = false, description = "die Anzahl der Wochenstunden der Zusatzkraft", example="3")
	...
	@Schema(required = false, description = "gibt an, on das Fach auf dem Zeugnis erscheint oder nicht", example="3")
	public boolean aufZeugnis = true;

	/** Das Kürzel der erteilten Note - es können auch Pseudonoten eingetragen werden (z.B. AT). */
	@Schema(required = false, description = "das Kürzel der erteilten Note - es können auch Pseudonoten eingetragen werden (z.B. AT)", example="3-")
	public String note = null;

	/** Gibt an, ob die Leistung gemahnt wurde oder nicht. */
	@Schema(required = false, description = "gibt an, ob die Leistung gemahnt wurde oder nicht", example="false")
	public boolean istGemahnt = false;
	
	/** Das Datum, wann die Leistung gemahnt wurde oder null. */
	@Schema(required = false, description = "das Datum, wann die Leistung gemahnt wurde oder null", example="null")
	public String Mahndatum = null;

	/** Gibt an, ob es sich um ein epochal unterrichtetes Fach handelt oder nicht. */
	@Schema(required = false, description = "gibt an, ob es sich um ein epochal unterrichtetes Fach handelt oder nicht", example="false")
	...
	@Schema(required = false, description = "gibt an, ob es sich um eine Leistung handelt, welche über das \"Holen von abgeschlossenen Fächern\" in diesem Leistungsabschnitt bereitstehen. Wenn ja, dann ist hier der Jahrgang angegeben aus welchem die Daten geholt wurden", example="06")	
	public String geholtJahrgangAbgeschlossen = null;
	
	/** Die Gewichtung für den allgemeinbildenden Teil (am Berufskolleg) */
	@Schema(required = false, description = "die Gewichtung für den allgemeinbildenden Teil (am Berufskolleg)", example="1")	
	public int gewichtungAllgemeinbildend = 1;

	// TODO Deprecated ???
	/** Die Berufsabschlussnote am Berufskolleg */
	@Schema(required = false, description = "die Berufsabschlussnote am Berufskolleg ", example="2")	
	public String noteBerufsabschluss = null; 


	/** Der Text für die fachbezogene Lernentwicklung des Schülers */
	@Schema(required = false, description = "der Text für die fachbezogene Lernentwicklung des Schülers", example="")		
	...
	@Schema(required = false, description = "die Facheigenschaft für die Lernstandberichte an Grundschulen (V = voller Umfang, R = reduzierter Umfang)", example="V")		
	public @NotNull String umfangLernstandsbericht = "";


	/** Die Gesamt-Anzahl der Fehlstunden für dieses Fach */
	@Schema(required = false, description = "die Gesamt-Anzahl der Fehlstunden für dieses Fach", example="2")		
	public int fehlstundenGesamt = 0;

	/** Die Anzahl der unentschuldigten Fehlstunden für dieses Fach */
	@Schema(required = false, description = "die Anzahl der unentschuldigten Fehlstunden für dieses Fach", example="2")		
