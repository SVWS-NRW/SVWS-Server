...
@TranspilerDTO
public class ENMv1AnkreuzkompetenzenKatalog {
	...
	@ArraySchema(schema = @Schema(implementation = ENMv1Ankreuzkompetenz.class,
			description = "Ein Array mit den Katalog-Einträge für die Ankreuzkompetenzen, die in der Notendatei enthalten sind."))
	public @NotNull List<ENMv1Ankreuzkompetenz> kompetenzen = new ArrayList<>();

	/**
	 * Leerer Standardkonstruktor.
	 */
	public ENMv1AnkreuzkompetenzenKatalog() {
		// leer
	}
