...
public class LehrerKatalogLehramtAnerkennungEintrag {
	...
	@Schema(description = "das Kürzel für den Anerkennungsgrund eines Lehramts", example = "AP")
	public @NotNull String kuerzel = "";

	/** Der Klartext des Anerkennungsgrundes eines Lehramts. */
	@Schema(description = "der Anerkennungsgrund eines Lehramts", example = "Anerkennung geeignete Prüfung")
	...
	@Schema(description = "gibt an, in welchem Schuljahr der Anerkennungsgrund eines Lehramts einführt wurde. Ist kein Schuljahr bekannt, so ist null gesetzt",
			example = "null")
	...
	@Schema(description = "gibt an, bis zu welchem Schuljahr der Anerkennungsgrund eines Lehramts gültig ist. Ist kein Schuljahr bekannt, so ist null gesetzt",
			example = "2025")
	 ...
	 */
	public LehrerKatalogLehramtAnerkennungEintrag(final long id, final @NotNull String kuerzel, final @NotNull String text, final Integer gueltigVon,
