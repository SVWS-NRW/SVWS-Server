...
public enum Nationalitaeten {
	...
	XXC(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(88088067, "XXC", "XC", "999", "999", "(ohne Angabe)", "(ohne Angabe)", "(ohne Angabe)", "(ohne Angabe)", null,
					null)
	}),

	/** Afghanistan (AFG) */
	AFG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(65070071, "AFG", "AF", "004", "423", "Afghanistan", "Afghanistan", "die Islamische Republik Afghanistan",
					"afghanisch", null, null)
	}),

	/** Ägypten (EGY) */
	EGY(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(69071089, "EGY", "EG", "818", "287", "Ägypten", "Ägypten", "die Arabische Republik Ägypten", "ägyptisch", null,
					null)
	}),
	...
	DZA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(68090065, "DZA", "DZ", "012", "221", "Algerien", "Algerien", "die Demokratische Volksrepublik Algerien",
					"algerisch", 1961, null)
	}),
	...
	ATG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(65084071, "ATG", "AG", "028", "320", "Antigua und Barbuda", "Antigua und Barbuda", "Antigua und Barbuda",
					"antiguanisch", 1981, null)
	}),

	/** Äquatorialguinea (GNQ) */
	GNQ(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(71078081, "GNQ", "GQ", "226", "274", "Äquatorialguinea", "Äquatorialguinea", "die Republik Äquatorialguinea",
					"äquatorialguineisch", 1968, null)
	}),

	/** Argentinien (ARG) */
	ARG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(65082071, "ARG", "AR", "032", "323", "Argentinien", "Argentinien", "die Argentinische Republik", "argentinisch",
					null, null)
	}),
	...
	AZE(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(65090069, "AZE", "AZ", "031", "425", "Aserbaidschan", "Aserbaidschan", "die Republik Aserbaidschan",
					"aserbaidschanisch", 1991, null)
	}),

	/** Äthiopien (ETH) */
	ETH(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(69084072, "ETH", "ET", "231", "225", "Äthiopien", "Äthiopien", "die Demokratische Bundesrepublik Äthiopien",
					"äthiopisch", null, null)
	}),
	...
	BHS(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(66072083, "BHS", "BS", "044", "324", "Bahamas", "Bahamas", "das Commonwealth der Bahamas", "bahamaisch", 1972,
					null)
	}),
	...
	BGD(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(66071068, "BGD", "BD", "050", "460", "Bangladesch", "Bangladesch", "die Volksrepublik Bangladesch",
					"bangladeschisch", 1970, null)
	}),
	...
	BOL(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(66079076, "BOL", "BO", "068", "326", "Bolivien", "Plurinationaler Staat Bolivien",
					"der Plurinationale Staat Bolivien", "bolivianisch", null, null)
	}),

	/** Bosnien und Herzegowina (BIH) */
	BIH(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(66073072, "BIH", "BA", "070", "122", "Bosnien und Herzegowina", "Bosnien und Herzegowina",
					"Bosnien und Herzegowina", "bosnisch-herzegowinisch", 1991, null)
	}),
	...
	BRA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(66082065, "BRA", "BR", "076", "327", "Brasilien", "Brasilien", "die Föderative Republik Brasilien",
					"brasilianisch", null, null)
	}),

	/** Brunei Darussalam (BRN) */
	BRN(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(66082078, "BRN", "BN", "096", "429", "Brunei Darussalam", "Brunei Darussalam", "Brunei Darussalam", "bruneiisch",
					1983, null)
	}),
	...
	CPV(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67080086, "CPV", "CV", "132", "242", "Cabo Verde", "Cabo Verde", "die Republik Cabo Verde", "cabo-verdisch", 1974,
					null)
	}),
	...
	CRI(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67082073, "CRI", "CR", "188", "334", "Costa Rica", "Costa Rica", "die Republik Costa Rica", "costa-ricanisch",
					null, null)
	}),

	/** Côte d’Ivoire (CIV) */
	CIV(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67073086, "CIV", "CI", "384", "231", "Côte d’Ivoire", "Côte d’Ivoire", "die Republik Côte d’Ivoire", "ivorisch",
					1960, null)
	}),
	...
	DEU(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(68069085, "DEU", "DE", "276", "000", "Deutschland", "Deutschland", "die Bundesrepublik Deutschland", "deutsch",
					1948, null)
	}),

	/** Dominica (DMA) */
	DMA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(68077065, "DMA", "DM", "212", "333", "Dominica", "Dominica", "das Commonwealth Dominica", "dominicanisch", 1978,
					null)
	}),

	/** Dominikanische Republik (DOM) */
	DOM(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(68079077, "DOM", "DO", "214", "335", "Dominikanische Republik", "Dominikanische Republik",
					"die Dominikanische Republik", "dominikanisch", null, null)
	}),

	/** Dschibuti (DJI) */
	DJI(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(68074073, "DJI", "DJ", "262", "230", "Dschibuti", "Dschibuti", "die Republik Dschibuti", "dschibutisch", 1976,
					null)
	}),
	...
	SLV(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83076086, "SLV", "SV", "222", "337", "El Salvador", "El Salvador", "die Republik El Salvador", "salvadorianisch",
					null, null)
	}),
	...
	FRA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(70082065, "FRA", "FR", "250", "129", "Frankreich", "Frankreich", "die Französische Republik", "französisch", null,
					null)
	}),
	...
	GRC(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(71082067, "GRC", "GR", "300", "134", "Griechenland", "Griechenland", "die Hellenische Republik", "griechisch",
					null, null)
	}),

	/** Guatemala (GTM) */
	GTM(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(71084077, "GTM", "GT", "320", "345", "Guatemala", "Guatemala", "die Republik Guatemala", "guatemaltekisch", null,
					null)
	}),
	...
	GNB(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(71078066, "GNB", "GW", "624", "259", "Guinea-Bissau", "Guinea-Bissau", "die Republik Guinea-Bissau",
					"guinea-bissauisch", 1973, null)
	}),

	/** Guyana (GUY) */
	GUY(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(71085089, "GUY", "GY", "328", "328", "Guyana", "Guyana", "die Kooperative Republik Guyana", "guyanisch", 1965,
					null)
	}),
	...
	HKG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(72075071, "HKG", "HK", "344", "411", "Hongkong", "Hongkong", "die Sonderverwaltungsregion Hongkong",
					"chinesisch (Hongkong)", null, null)
	}),
	...
	IDN(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(73068078, "IDN", "ID", "360", "437", "Indonesien", "Indonesien", "die Republik Indonesien", "indonesisch", 1945,
					null)
	}),
	...
	IRN(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(73082078, "IRN", "IR", "364", "439", "Iran", "Islamische Republik Iran", "die Islamische Republik Iran",
					"iranisch", null, null)
	}),
	...
	JOR(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(74079082, "JOR", "JO", "400", "445", "Jordanien", "Jordanien", "das Haschemitische Königreich Jordanien",
					"jordanisch", 1945, null)
	}),

	/** Jugoslawien (YUG) */
	YUG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(89085071, "YUG", "YU", "891", "120", "Jugoslawien", "Jugoslawien",
					"die Sozialistische Föderative Republik Jugoslawien", "jugoslawisch", 1945, 1991),
			new NationalitaetenKatalogEintrag(1089085071, "YUG", "YU", "891", "138", "Jugoslawien", "Jugoslawien", "die Bundesrepublik Jugoslawien",
					"jugoslawisch", 1992, 2002)
	}),

	/** Kambodscha (KHM) */
	KHM(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(75072077, "KHM", "KH", "116", "446", "Kambodscha", "Kambodscha", "das Königreich Kambodscha", "kambodschanisch",
					1953, null)
	}),
	...
	KAZ(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(75065090, "KAZ", "KZ", "398", "444", "Kasachstan", "Kasachstan", "die Republik Kasachstan", "kasachisch", 1991,
					null)
	}),
	...
	KGZ(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(75071090, "KGZ", "KG", "417", "450", "Kirgisistan", "Kirgisistan", "die Kirgisische Republik", "kirgisisch", 1991,
					null)
	}),
	...
	COL(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67079076, "COL", "CO", "170", "349", "Kolumbien", "Kolumbien", "die Republik Kolumbien", "kolumbianisch", null,
					null)
	}),
	...
	COD(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67079068, "COD", "CD", "180", "246", "Kongo, Demokratische Republik", "Demokratische Republik Kongo",
					"die Demokratische Republik Kongo", "der Demokratischen Republik Kongo", 1959, null)
	}),

	/** Demokratische Volksrepublik Korea (PRK) */
	PRK(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(80082075, "PRK", "KP", "408", "434", "Korea, Demokratische Volksrepublik", "Demokratische Volksrepublik Korea",
					"die Demokratische Volksrepublik Korea", "der Demokratischen Volksrepublik Korea", 1948, null)
	}),

	/** Republik Korea (KOR) */
	KOR(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(75079082, "KOR", "KR", "410", "467", "Korea, Republik", "Republik Korea", "die Republik Korea",
					"der Republik Korea", 1948, null)
	}),
	...
	LAO(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(76065079, "LAO", "LA", "418", "449", "Laos", "Demokratische Volksrepublik Laos",
					"die Demokratische Volksrepublik Laos", "laotisch", 1953, null)
	}),
	...
	LIE(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(76073069, "LIE", "LI", "438", "141", "Liechtenstein", "Liechtenstein", "das Fürstentum Liechtenstein",
					"liechtensteinisch", null, null)
	}),
	...
	LUX(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(76085088, "LUX", "LU", "442", "143", "Luxemburg", "Luxemburg", "das Großherzogtum Luxemburg", "luxemburgisch",
					null, null)
	}),

	/** Macau (MAC) */
	MAC(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77065067, "MAC", "MO", "446", "412", "Macau", "Macau", "die Sonderverwaltungsregion Macau", "chinesisch (Macau)",
					null, null)
	}),

	/** Madagaskar (MDG) */
	MDG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77068071, "MDG", "MG", "450", "249", "Madagaskar", "Madagaskar", "die Republik Madagaskar", "madagassisch", 1959,
					null)
	}),
	...
	MDV(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77068086, "MDV", "MV", "462", "454", "Malediven", "Malediven", "die Republik Malediven", "maledivisch", 1964,
					null)
	}),
	...
	MHL(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77072076, "MHL", "MH", "584", "544", "Marshallinseln", "Marshallinseln", "die Republik Marshallinseln",
					"marshallisch", 1990, null)
	}),

	/** Mauretanien (MRT) */
	MRT(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77082084, "MRT", "MR", "478", "239", "Mauretanien", "Mauretanien", "die Islamische Republik Mauretanien",
					"mauretanisch", 1960, null)
	}),
	...
	MEX(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77069088, "MEX", "MX", "484", "353", "Mexiko", "Mexiko", "die Vereinigten Mexikanischen Staaten", "mexikanisch",
					null, null)
	}),

	/** Föderierte Staaten von Mikronesien (FSM) */
	FSM(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(70083077, "FSM", "FM", "583", "545", "Mikronesien", "Föderierte Staaten von Mikronesien",
					"die Föderierten Staaten von Mikronesien", "mikronesisch", 1990, null)
	}),
	...
	MOZ(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77079090, "MOZ", "MZ", "508", "254", "Mosambik", "Mosambik", "die Republik Mosambik", "mosambikanisch", 1974,
					null)
	}),

	/** Myanmar (MMR) */
	MMR(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77077082, "MMR", "MM", "104", "427", "Myanmar", "Myanmar", "die Republik der Union Myanmar", "myanmarisch", 1947,
					null)
	}),
	...
	NIC(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(78073067, "NIC", "NI", "558", "354", "Nicaragua", "Nicaragua", "die Republik Nicaragua", "nicaraguanisch", null,
					null)
	}),

	/** Niederlande (NLD) */
	NLD(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(78076068, "NLD", "NL", "528", "148", "Niederlande", "Niederlande", "das Königreich der Niederlande",
					"niederländisch", null, null)
	}),
	...
	NGA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(78071065, "NGA", "NG", "566", "232", "Nigeria", "Nigeria", "die Bundesrepublik Nigeria", "nigerianisch", 1960,
					null)
	}),
	...
	MKD(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(77075068, "MKD", "MK", "807", "144", "Nordmazedonien", "Nordmazedonien", "die Republik Nordmazedonien",
					"mazedonisch/Bürger der Republik Nordmazedonien", 1991, null)
	}),
	...
	AUT(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(65085084, "AUT", "AT", "040", "151", "Österreich", "Österreich", "die Republik Österreich", "österreichisch",
					null, null)
	}),

	/** Pakistan (PAK) */
	PAK(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(80065075, "PAK", "PK", "586", "461", "Pakistan", "Pakistan", "die Islamische Republik Pakistan", "pakistanisch",
					1947, null)
	}),
	...
	PNG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(80078071, "PNG", "PG", "598", "538", "Papua-Neuguinea", "Papua-Neuguinea",
					"der Unabhängige Staat Papua-Neuguinea", "papua-neuguineisch", 1975, null)
	}),
	...
	PHL(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(80072076, "PHL", "PH", "608", "462", "Philippinen", "Philippinen", "die Republik der Philippinen",
					"philippinisch", null, null)
	}),
	...
	PRT(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(80082084, "PRT", "PT", "620", "153", "Portugal", "Portugal", "die Portugiesische Republik", "portugiesisch", null,
					null)
	}),
	...
	RUS(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(82085083, "RUS", "RU", "643", "160", "Russische Föderation", "Russische Föderation", "die Russische Föderation",
					"russisch", 1991, null)
	}),
	...
	SMR(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83077082, "SMR", "SM", "674", "156", "San Marino", "San Marino", "die Republik San Marino", "san-marinesisch",
					null, null)
	}),

	/** São Tomé und Príncipe (STP) */
	STP(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83084080, "STP", "ST", "678", "268", "São Tomé und Príncipe", "São Tomé und Príncipe",
					"die Demokratische Republik São Tomé und Príncipe", "são-toméisch", 1974, null)
	}),

	/** Saudi-Arabien (SAU) */
	SAU(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83065085, "SAU", "SA", "682", "472", "Saudi-Arabien", "Saudi-Arabien", "das Königreich Saudi-Arabien",
					"saudi-arabisch", null, null)
	}),
	...
	CHE(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67072069, "CHE", "CH", "756", "158", "Schweiz", "Schweiz", "die Schweizerische Eidgenossenschaft",
					"schweizerisch", null, null)
	}),
	...
	SRB(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83082066, "SRB", "RS", "688", "133", "Serbien", "Serbien (einschließlich Kosovo)", "die Republik Serbien",
					"serbisch", 2005, 2006),
	...
	SCG(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83067071, "SCG", "CS", "891", "132", "Serbien und Montenegro", "Serbien und Montenegro", "Serbien und Montenegro",
					"von Serbien und Montenegro", 2002, 2005),
	}),

	/** Seychellen (SYC) */
	SYC(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83089067, "SYC", "SC", "690", "271", "Seychellen", "Seychellen", "die Republik Seychellen", "seychellisch", 1975,
					null)
	}),

	/** Sierra Leone (SLE) */
	SLE(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83076069, "SLE", "SL", "694", "272", "Sierra Leone", "Sierra Leone", "die Republik Sierra Leone",
					"sierra-leonisch", 1960, null)
	}),
	...
	SUN(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83085078, "SUN", "SU", "810", "159", "Sowjetunion", "Sowjetunion",
					"die Union der Sozialistischen Sowjetrepubliken", "sowjetisch", null, 1991)
	}),
	...
	LKA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(76075065, "LKA", "LK", "144", "431", "Sri Lanka", "Sri Lanka",
					"die Demokratische Sozialistische Republik Sri Lanka", "sri-lankisch", 1947, null)
	}),

	/** St. Kitts und Nevis (KNA) */
	KNA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(75078065, "KNA", "KN", "659", "370", "St. Kitts und Nevis", "St. Kitts und Nevis",
					"die Föderation St. Kitts und Nevis", "von St. Kitts und Nevis", 1983, null)
	}),
	...
	VCT(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(86067084, "VCT", "VC", "670", "369", "St. Vincent und die Grenadinen", "St. Vincent und die Grenadinen",
					"St. Vincent und die Grenadinen", "vincentisch", 1979, null)
	}),

	/** Südafrika (ZAF) */
	ZAF(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(90065070, "ZAF", "ZA", "710", "263", "Südafrika", "Südafrika", "die Republik Südafrika", "südafrikanisch", null,
					null)
	}),

	/** Sudan (SDN) */
	SDN(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83068078, "SDN", "SD", "729", "276", "Sudan", "Sudan (einschließlich Südsudan)", "die Republik Sudan",
					"sudanesisch", 1955, 2010),
	...
	SSD(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83083068, "SSD", "SS", "728", "278", "Südsudan", "Südsudan", "die Republik Südsudan", "südsudanesisch", 2010,
					null)
	}),
	...
	SYR(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(83089082, "SYR", "SY", "760", "475", "Syrien", "Arabische Republik Syrien", "die Arabische Republik Syrien",
					"syrisch", 1945, null)
	}),

	/** Tadschikistan (TJK) */
	TJK(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(84074075, "TJK", "TJ", "762", "470", "Tadschikistan", "Tadschikistan", "die Republik Tadschikistan",
					"tadschikisch", 1991, null)
	}),
	...
	TZA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(84090065, "TZA", "TZ", "834", "282", "Tansania", "Vereinigte Republik Tansania",
					"die Vereinigte Republik Tansania", "tansanisch", null, null)
	}),

	/** Thailand (THA) */
	THA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(84072065, "THA", "TH", "764", "476", "Thailand", "Thailand", "das Königreich Thailand", "thailändisch", null,
					null)
	}),

	/** Timor-Leste (TLS) */
	TLS(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(84076083, "TLS", "TL", "626", "483", "Timor-Leste", "Timor-Leste", "die Demokratische Republik Timor-Leste",
					"von Timor-Leste", 2001, null)
	}),
	...
	TTO(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(84084079, "TTO", "TT", "780", "371", "Trinidad und Tobago", "Trinidad und Tobago",
					"die Republik Trinidad und Tobago", "von Trinidad und Tobago", 1962, null)
	}),
	...
	CZE(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67090069, "CZE", "CZ", "203", "164", "Tschechien", "Tschechien", "die Tschechische Republik", "tschechisch", 1992,
					null)
	}),

	/** Tschechoslowakei (CSK) */
	CSK(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67083075, "CSK", "CS", "200", "162", "Tschechoslowakei", "Tschechoslowakei",
					"die Tschechoslowakische Sozialistische Republik", "tschechoslowakisch", null, 1992)
	}),
	...
	URY(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(85082089, "URY", "UY", "858", "365", "Uruguay", "Uruguay", "die Republik Östlich des Uruguay", "uruguayisch",
					null, null)
	}),

	/** Usbekistan (UZB) */
	UZB(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(85090066, "UZB", "UZ", "860", "477", "Usbekistan", "Usbekistan", "die Republik Usbekistan", "usbekisch", 1991,
					null)
	}),
	...
	VAT(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(86065084, "VAT", "VA", "336", "167", "Vatikanstadt", "Vatikanstadt", "der Staat Vatikanstadt", "vatikanisch",
					null, null)
	}),

	/** Venezuela (VEN) */
	VEN(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(86069078, "VEN", "VE", "862", "367", "Venezuela", "Bolivarische Republik Venezuela",
					"die Bolivarische Republik Venezuela", "venezolanisch", null, null)
	}),

	/** Vereinigte Arabische Emirate (ARE) */
	ARE(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(65082069, "ARE", "AE", "784", "469", "Vereinigte Arabische Emirate", "Vereinigte Arabische Emirate",
					"die Vereinigten Arabischen Emirate (Abu Dhabi, Adschman, Dubai, Fudschaira, Ras al Chaima, Schardscha, Umm al Kaiwain)",
					"der Vereinigten Arabischen Emirate", 1971, null)
	}),

	/** Vereinigte Staaten (USA) */
	USA(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(85083065, "USA", "US", "840", "368", "Vereinigte Staaten", "Vereinigte Staaten",
					"die Vereinigten Staaten von Amerika", "amerikanisch", null, null)
	}),

	/** Vereinigtes Königreich (GBR) */
	GBR(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(71066082, "GBR", "GB", "826", "168", "Vereinigtes Königreich", "Vereinigtes Königreich",
					"das Vereinigte Königreich Großbritannien und Nordirland", "britisch", null, null)
	}),

	/** Vietnam (VNM) */
	VNM(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(86078077, "VNM", "VN", "704", "432", "Vietnam", "Vietnam", "die Sozialistische Republik Vietnam", "vietnamesisch",
					1975, null)
	}),

	/** Zentralafrikanische Republik (CAF) */
	CAF(new NationalitaetenKatalogEintrag[] {
			new NationalitaetenKatalogEintrag(67065070, "CAF", "CF", "140", "289", "Zentralafrikanische Republik", "Zentralafrikanische Republik",
					"die Zentralafrikanische Republik", "zentralafrikanisch", 1960, null)
	}),
