...
public enum LehrerAnrechnungsgrund {
	...
	ID_310(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(310000, "310",
					"Seiteneinsteiger/-in: Entlastung für berufsbegleitende Ausbildung für Universitätsabsolventen OBAS", 2010, null)
	}),
	...
	ID_315(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(315000, "315", "Seiteneinsteiger/-in: Entlastung für berufsbegleitende Ausbildung für FH - Absolventen",
					2010, null)
	}),
	...
	ID_320(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(320000, "320", "Seiteneinsteiger/-in: Entlastung für Pädagogische Einführung in den Schuldienst", 2010,
					null)
	}),
	...
	ID_330(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(330000, "330", "Tätigkeit als schulische/-r Ausbilder/-in OBAS (§ 11 Abs. 5 i. V. mit § 9 Abs. 2)", 2012,
					null)
	}),
	...
	ID_340(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(340000, "340", "Erfahrene Lehrkraft: Entlastung für Pädagogische Einführung in den Schuldienst", 2012,
					null)
	}),
	...
	ID_500(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(500000, "500",
					"Wahrnehmung besonderer schulischer Aufgaben / Ausgleich besonderer unterrichtlicher Belastungen", null, null)
	}),
	...
	ID_605(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(605000, "605",
					"Tätigkeit als Fachleiter/-in am Zentrum für schulpraktische Lehrerausbildung (Vorbereitungsdienst, OBAS, VOBASOF, Pädagogische Einführung in den Schuldienst)",
					null, null)
	}),
	...
	ID_620(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(620000, "620", "Tätigkeit als schulische/-r Ausbilder/-in VOBASOF (qualifizierte Fachkraft, § 11 VOBASOF)",
					2013, null)
	}),
	...
	ID_625(new LehrerKatalogAnrechnungsgrundEintrag[] {
			...
			new LehrerKatalogAnrechnungsgrundEintrag(625001, "625",
					"Tätigkeit als Fachleiter/-in am Zentrum für schulpraktische Lehrerausbildung (Eignungs- und Orientierungspraktikum)", 2013, null)
	}),
	...
	ID_630(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(630000, "630",
					"Lehrkraft in Ausbildung: Schulpraktische Ausbildung am Zentrum für schulpraktische Ausbildung (§ 7 VOBASOF)", 2013, null)
	}),
	...
	ID_645(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(645000, "645", "Sport sowie für Beratung und Koordination im Verbundsystem Schule und Leistungssport",
					null, null)
	}),
	...
	ID_665(new LehrerKatalogAnrechnungsgrundEintrag[] {
			...
			new LehrerKatalogAnrechnungsgrundEintrag(665001, "665",
					"Tätigkeit als Fachleiter/-in am Zentrum für schulpraktische Lehrerausbildung (Praxissemester)", 2013, null)
	}),
	...
	ID_750(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(750000, "750",
					"Sonstiger Ausgleichsbedarf, der aus wechselnden Ausgleichs- und Mehrbedarfen finanziert ist.", null, null)
	}),
	...
	ID_770(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(770000, "770",
					"Individuelle Beratung der Schülerinnen und Schüler im Rahmen des Schulversuchs Talentschule", 2020, null)
	}),
	...
	ID_771(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(771000, "771", "Innerschulischer Transfer der Maßnahmen im Rahmen des Schulversuchs Talentschule", 2020,
					null)
	}),
	...
	ID_773(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(773000, "773",
					"Berufsfeld- oder fachbereichsübergreifende Berufsorientierung im Rahmen des Schulversuchs Talentschule", 2020, null)
	}),
	...
	ID_774(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(774000, "774",
					"Erweiterte Blockpraktika/Praxismodul „Berufliche Orientierung“ im Rahmen des Schulversuchs Talentschule", 2020, null)
	}),
	...
	ID_778(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(778000, "778",
					"Verwaltungstätigkeiten zur Unterstützung der Schulleitung bei den Landesaufgaben im Schulversuch Talentschule", 2020, null)
	}),
	...
	ID_855(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(855000, "855",
					"sonderpädagogischer Förderbedarf, z. B. Lese- und Rechtschreibschwächen, Lernbehinderungen", null, null)
	}),
	...
	ID_970(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(970000, "970",
					"sonstige nichtunterrichtliche Tätigkeiten (Nur mit Genehmigung durch die Schulaufsicht.; auch Beratungstätigkeiten für sonderpäd. Förderung)",
					null, null)
	}),
	...
	ID_985(new LehrerKatalogAnrechnungsgrundEintrag[] {
			new LehrerKatalogAnrechnungsgrundEintrag(985000, "985", "Übergangsbegleitung im Rahmen des Langzeitpraktikums im Ausbildungskonsens KAoA", 2015,
					null)
	});
	 ...
	 */
	LehrerAnrechnungsgrund(final @NotNull LehrerKatalogAnrechnungsgrundEintrag @NotNull [] historie) {
