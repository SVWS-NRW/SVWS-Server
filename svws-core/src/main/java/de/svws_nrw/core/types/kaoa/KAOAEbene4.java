...
public enum KAOAEbene4 {
	...
	SBO_9_2_1_1(new KAOAEbene4Eintrag[] {
			new KAOAEbene4Eintrag(17, "SBO 9.2.1.1", "Veranstaltungen zur allgemeinen Studienorientierung an einer Hochschule", KAOAZusatzmerkmal.SBO_9_2_1,
					null, null)
	}),
	...
	SBO_9_2_1_2(new KAOAEbene4Eintrag[] {
			new KAOAEbene4Eintrag(18, "SBO 9.2.1.2", "Veranstaltungen zur allgemeinen Studienorientierung in der Schule", KAOAZusatzmerkmal.SBO_9_2_1, null,
					null)
	}),
	...
	SBO_9_2_1_5(new KAOAEbene4Eintrag[] {
			new KAOAEbene4Eintrag(21, "SBO 9.2.1.5", "Individuelle Einzelberatung durch die Zentralen Studienberatungen der Hochschulen",
					KAOAZusatzmerkmal.SBO_9_2_1, null, null)
	}),
	...
	SBO_9_2_1_6(new KAOAEbene4Eintrag[] {
			new KAOAEbene4Eintrag(22, "SBO 9.2.1.6", "Workshops für Schülerinnen und Schüler in der Zentralen Studienberatung", KAOAZusatzmerkmal.SBO_9_2_1,
					null, null)
	}),
	...
	SBO_9_2_1_7(new KAOAEbene4Eintrag[] {
			new KAOAEbene4Eintrag(23, "SBO 9.2.1.7",
					"Besondere Formate für Schlerinnen und Schüler an der Hochschule (Hochschultag, Hochschulpraktikum i.S. eines „Schnupperstudiums“, allgemeine Boys‘ und Girls‘ Day Angebote)",
					KAOAZusatzmerkmal.SBO_9_2_1, null, null)
	}),
	...
	SBO_9_2_1_8(new KAOAEbene4Eintrag[] {
			new KAOAEbene4Eintrag(24, "SBO 9.2.1.8",
					"Fachspezifische Angebote (z. B. Schülerstudium, Praktika bei Hochschullehrer*innen, Schülerlabore, zdi-Zentren, fachspezifische Boys‘ und Girls‘ Day Angebote)",
					KAOAZusatzmerkmal.SBO_9_2_1, null, null)
	});
