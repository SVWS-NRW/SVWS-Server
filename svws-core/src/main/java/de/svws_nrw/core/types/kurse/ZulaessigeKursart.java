...
public enum ZulaessigeKursart {
	...
	AGGT(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(3000, "AGGT", "36", "Arbeitsgemeinschaft im Ganztagsbereich", "gemäß § 9 Abs. 2, 3  SchulG", null, null, false,
					Arrays.asList(
	...
	BUS(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(8000, "BUS", "94", "Unterricht im Rahmen von KAOA einschl. Schule trifft Arbeitswelt", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.GE, (Schulgliederung) null),
							new Pair<>(Schulform.GM, (Schulgliederung) null),
							new Pair<>(Schulform.GY, (Schulgliederung) null),
	...
	EGSN(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(15000, "EGSN", "97", "Ergänzungsstunden mit Benotung", "gemäß § 3 Abs. 1, 3 und § 19 Abs. 3 Nr.2 und 4 APO-SI", null,
	...
	EWBF(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(17000, "EWBF", "12", "Erweiterungsunterricht Wahlbereich - berufsbezogen, fachübergreifend", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.BK, (Schulgliederung) null),
							new Pair<>(Schulform.SB, (Schulgliederung) null)
					), null, null)
	...
	EWF(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(18000, "EWF", "11", "Erweiterungsunterricht Wahlbereich - fach-, jedoch nicht abschlussbezogen", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.BK, (Schulgliederung) null),
							new Pair<>(Schulform.SB, (Schulgliederung) null)
					), null, null)
	...
	EWFA(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(19000, "EWFA", "10", "Erweiterungsunterricht Wahlbereich - fach- und abschlussbezogen", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.BK, (Schulgliederung) null),
							new Pair<>(Schulform.SB, (Schulgliederung) null)
					), null, null)
	...
	F3(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(20000, "F3", "64",
					"Wahlplflichtunterricht: Einzelfach im math.-naturw., techn., gesellschaftsw., künstlerischen Schwerpunkt", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.GE, Schulgliederung.GY),
							new Pair<>(Schulform.GM, Schulgliederung.GY),
							new Pair<>(Schulform.GY, (Schulgliederung) null),
	...
	DFG(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(24000, "DFG", "89",
					"Förderung neu zugewanderter Schüler in Deutschfördergruppen (teilweise äußere und innere Differenzierung)", "gemäß Erlass 13-63 Nr. 3",
	...
	FS3(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(25000, "FS3", "65", "Wahlpflichtbereich II (Kl. 09 und 10, bei G8: 08 und 09): 3. Fremdsprache", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.GE, Schulgliederung.GY),
							new Pair<>(Schulform.GM, Schulgliederung.GY),
							new Pair<>(Schulform.GY, (Schulgliederung) null),
	...
	DFK(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(26000, "DFK", "90", "Förderung neu zugewanderter Schüler in Deutschförderklassen (vollständige äußere Differenzierung)",
					"gemäß Erlass 13-63 Nr. 3", null, null, false, Arrays.asList(
							new Pair<>(Schulform.G, (Schulgliederung) null),
							new Pair<>(Schulform.GE, (Schulgliederung) null),
							new Pair<>(Schulform.GM, (Schulgliederung) null),
							new Pair<>(Schulform.GY, (Schulgliederung) null),
	...
	FUAUS(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(28000, "FUAUS", "03", "Stützunterricht Wahlbereich - Förderunterricht für ausländische u. ausgesiedelte Schüler", null,
					null, null, false, Arrays.asList(
							new Pair<>(Schulform.BK, (Schulgliederung) null),
							new Pair<>(Schulform.SB, (Schulgliederung) null)
					), null, null)
	...
	KMFOE(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(38000, "KMFOE", "95", "Zusätzlicher Förderunterricht im Rahmen der Initiative Komm mit", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.GE, (Schulgliederung) null),
							new Pair<>(Schulform.GM, (Schulgliederung) null),
							new Pair<>(Schulform.GY, (Schulgliederung) null),
	...
	LRS(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(41000, "LRS", "82",
					"Schülerinnen und Schüler mit besonderen Schwierigkeiten im Erlernen des Lesens und Rechtschreibens (LRS)", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.G, (Schulgliederung) null),
							new Pair<>(Schulform.GE, (Schulgliederung) null),
							new Pair<>(Schulform.GM, (Schulgliederung) null),
	...
	MEU(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(42000, "MEU", "84", "Unterricht in der Herkunftssprache (Muttersprachlicher Unterricht)", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.G, (Schulgliederung) null),
							new Pair<>(Schulform.GE, (Schulgliederung) null),
							new Pair<>(Schulform.GM, (Schulgliederung) null),
	...
	FDS(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(43000, "FDS", "85", "Förderung in der deutschen Sprache außerhalb von Sprachfördermaßnahmen", "gemäß Erlass 13-63 Nr. 3",
					null, null, false, Arrays.asList(
							new Pair<>(Schulform.G, (Schulgliederung) null),
							new Pair<>(Schulform.GE, (Schulgliederung) null),
							new Pair<>(Schulform.GM, (Schulgliederung) null),
	...
	UMPF(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(57000, "UMPF", "56", "Unterricht in der Herkunftssprache anstelle einer Pflichtfremdsprache oder eines Wahlpflichtfaches",
	...
	VUW(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(60000, "VUW", "21", "Vertiefungsunterricht Wahlbereich - berufsfeld- / berufsbezogener fachpraxisorientierter Kurs", null,
					null, null, false, Arrays.asList(
							new Pair<>(Schulform.BK, (Schulgliederung) null),
							new Pair<>(Schulform.SB, (Schulgliederung) null)
					), null, null)
	...
	WPII(new KursartKatalogEintrag[] {
			new KursartKatalogEintrag(70000, "WPII", "62",
					"Wahlpflichtbereich II - Fächerkombination im math.-naturwiss, gesellschaftswiss. oder künstlerischen Schwerpunkt", null, null, null, false,
					Arrays.asList(
							new Pair<>(Schulform.GM, Schulgliederung.GY),
							new Pair<>(Schulform.GY, (Schulgliederung) null),
							new Pair<>(Schulform.H, (Schulgliederung) null),
	...
	ZulaessigeKursart(final @NotNull KursartKatalogEintrag @NotNull [] historie) {
