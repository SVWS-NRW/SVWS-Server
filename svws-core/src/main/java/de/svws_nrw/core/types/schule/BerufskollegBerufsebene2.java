...
public enum BerufskollegBerufsebene2 {
	...
	BS(new BerufskollegBerufsebeneKatalogEintrag[] {
			new BerufskollegBerufsebeneKatalogEintrag(200005000, 2, "BS", "Aufbaubildungsgang Bildung und Schulvorbereitung in Tageseinrichtungen f. Kinder",
					null, null)
	}),
	...
	BE(new BerufskollegBerufsebeneKatalogEintrag[] {
			new BerufskollegBerufsebeneKatalogEintrag(200006000, 2, "BE", "Aufbaubildungsgang Bildung, Erziehung u. Betreuung von Kindern unter drei Jahren",
					null, null)
	}),
	...
	HF(new BerufskollegBerufsebeneKatalogEintrag[] {
			new BerufskollegBerufsebeneKatalogEintrag(200011000, 2, "HF", "Aufbaubildungsgang Fachkraft für heilpädagogische Förderung mit dem Pferd", null,
					null)
	}),
	...
	MF(new BerufskollegBerufsebeneKatalogEintrag[] {
			new BerufskollegBerufsebeneKatalogEintrag(200014000, 2, "MF", "Aufbaubildungsgang Musikalische Förderung im sozialpädagogischen Arbeitsfeld", null,
					null)
	}),
	...
	private static final @NotNull HashMap<String, BerufskollegBerufsebene2> _ebenen = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<String, BerufskollegBerufsebene2> getMapBerufsebenenByKuerzel() {
		if (_ebenen.size() == 0) {
