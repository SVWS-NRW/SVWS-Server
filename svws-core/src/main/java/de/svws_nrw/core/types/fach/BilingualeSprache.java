...
public enum BilingualeSprache {
	...
	ENGLISCH(new BilingualeSpracheKatalogEintrag[] {
			new BilingualeSpracheKatalogEintrag(1000L, ZulaessigesFach.E, Arrays.asList(
					Schulform.BK, Schulform.SB, Schulform.G, Schulform.GE, Schulform.GY, Schulform.GM, Schulform.R, Schulform.SG, Schulform.SK, Schulform.SR),
					null, 2022),
	...
	private static final @NotNull HashMap<Long, BilingualeSpracheKatalogEintrag> _mapEintragByID = new HashMap<>();

	/** Eine Map, welche der ID der bilingualen Sprache die Instanz dieser Aufzählung zuordnet. */
	private static final @NotNull HashMap<Long, BilingualeSprache> _mapByID = new HashMap<>();

	/** Eine Map, welche dem Kürzel der bilingualen Sprache die Instanz dieser Aufzählung zuordnet. */
	private static final @NotNull HashMap<String, BilingualeSprache> _mapByKuerzel = new HashMap<>();
	 ...
	 */
	private static @NotNull HashMap<Long, BilingualeSpracheKatalogEintrag> getMapEintragByID() {
	 ...
	 */
	private static @NotNull HashMap<Long, BilingualeSprache> getMapByID() {
		if (_mapByID.size() == 0)
			for (final BilingualeSprache s : BilingualeSprache.values())
	 ...
	 */
	private static @NotNull HashMap<String, BilingualeSprache> getMapByKuerzel() {
	 ...
	 */
	public static @NotNull List<BilingualeSprache> get(final Schulform schulform) {
		final @NotNull ArrayList<BilingualeSprache> faecher = new ArrayList<>();
		if (schulform == null)
			return faecher;
