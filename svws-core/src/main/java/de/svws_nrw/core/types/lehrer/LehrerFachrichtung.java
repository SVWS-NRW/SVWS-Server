...
public enum LehrerFachrichtung {
	...
	ID_55(new LehrerKatalogFachrichtungEintrag[] {
			new LehrerKatalogFachrichtungEintrag(92, "55",
					"Farb- u. Raumgestaltung, Gestaltungstechnik, Malerei, Graphik, Design, Fotografie, Glas- und Keramiktechnik", null, null)
	}),
	...
	ID_OL(new LehrerKatalogFachrichtungEintrag[] {
			new LehrerKatalogFachrichtungEintrag(125, "OL", "Organisation und Bürokommunikation / Datenverarbeitung / Organisationslehre / Betriebsinformatik",
					null, null)
	}),
