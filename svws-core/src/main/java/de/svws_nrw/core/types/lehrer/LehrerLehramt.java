...
public enum LehrerLehramt {
	...
	ID_16(new LehrerKatalogLehramtEintrag[] {
			new LehrerKatalogLehramtEintrag(92, "16", "Grund-, Haupt- u. Realschule u. entspr. Jahrg.stufen d. Gesamtsch. -Schwerp.- H/R/Gesamtsch.", null,
					null)
	}),
	...
	ID_30(new LehrerKatalogLehramtEintrag[] {
			new LehrerKatalogLehramtEintrag(100, "30", "an berufsbildenden Schulen (alle Lehrer mit 2. Staatsprüfung oder erworbener Anstellungsfähigkeit)",
					null, null)
	}),
	...
	ID_55(new LehrerKatalogLehramtEintrag[] {
			new LehrerKatalogLehramtEintrag(110, "55", "Fachlehrer mit der Befähigung für die Laufbahn des technischen Lehrers an beruflichen Schulen", null,
					null)
	}),
	...
	ID_96(new LehrerKatalogLehramtEintrag[] {
			new LehrerKatalogLehramtEintrag(118, "96",
					"Lehrer, der eine Qualifikation erworben hat, die der 1. Staatsprüfung entspricht (z.B. Diplom, sofern nicht Schlüssel 98)", null, null)
	}),
	...
	ID_97(new LehrerKatalogLehramtEintrag[] {
			new LehrerKatalogLehramtEintrag(119, "97", "Lehrer, der außerhalb des Geltungsbereichs des Grundgesetzes seine Qualifikation erworben hat", null,
					null)
	}),
