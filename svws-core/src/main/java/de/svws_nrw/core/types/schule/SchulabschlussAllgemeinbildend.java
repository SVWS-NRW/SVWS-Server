...
public enum SchulabschlussAllgemeinbildend {
	...
	HA9A(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(1000, "HA9A",
					"Hauptschulabschluss nach Klasse 9 (ohne Berechtigung zum Besuch der Klasse 10 Typ B)", "B", null, 2021),
			new SchulabschlussAllgemeinbildendKatalogEintrag(1001, "ESAA", "Erster Schulabschluss (ohne Berechtigung zum Besuch der Klasse 10 Typ B)", "B",
					2022, null)
	}),
	...
	HA9(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(2000, "HA9", "Hauptschulabschluss nach Klasse 9 (mit Berechtigung zum Besuch der Klasse 10 Typ B)",
					"C", null, 2021),
			new SchulabschlussAllgemeinbildendKatalogEintrag(2001, "ESA", "Erster Schulabschluss (mit Berechtigung zum Besuch der Klasse 10 Typ B)", "C", 2022,
					null)
	}),
	...
	HA9_FOE(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(3000, "HA9_FOE",
					"Hauptschulabschluss nach Klasse 9 (ggf. mit Berechtigung zum Besuch eines weiterführenden Bildungsgangs am Berufskolleg bei internationalen Förderklassen)",
					"S", null, 2021),
			new SchulabschlussAllgemeinbildendKatalogEintrag(3001, "ESA_FOE",
					"Erster Schulabschluss (ggf. mit Berechtigung zum Besuch eines weiterführenden Bildungsgangs am Berufskolleg bei internationalen Förderklassen)",
					"S", 2022, null)
	}),
	...
	HA9_Q(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(4000, "HA9_Q",
					"Hauptschulabschluss nach Klasse 9 (mit der Berechtigung zum Besuch der Gymnasialen Oberstufe)", "O", null, 2021),
			new SchulabschlussAllgemeinbildendKatalogEintrag(4001, "ESA_Q", "Erster Schulabschluss (mit der Berechtigung zum Besuch der Gymnasialen Oberstufe)",
					"O", 2022, null)
	}),
	...
	HA10_Q(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(6000, "HA10_Q",
					"Hauptschulabschluss nach Klasse 10 (mit der Berechtigung zum Besuch der Gymnasialen Oberstufe)", "U", null, 2021),
			new SchulabschlussAllgemeinbildendKatalogEintrag(6001, "EESA_Q",
					"Erweiterter Erster Schulabschluss (mit der Berechtigung zum Besuch der Gymnasialen Oberstufe)", "U", 2022, null)
	}),
	...
	MSA_Q(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(11000, "MSA_Q", "Mittlerer Schulabschluss (mit der Berechtigung zum Besuch Gymnasialen Oberstufe)",
					"G", null, null)
	}),
	...
	MSA_Q1(new SchulabschlussAllgemeinbildendKatalogEintrag[] {
			new SchulabschlussAllgemeinbildendKatalogEintrag(12000, "MSA_Q1",
					"Mittlerer Schulabschluss mit der Berechtigung zum Besuch der Qualifikationsphase Gymnasialen Oberstufe", "I", null, null)
	}),
