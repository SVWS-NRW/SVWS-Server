...
public enum BerufskollegBerufsebene3 {
	...
	FL(new BerufskollegBerufsebeneKatalogEintrag[] {
			new BerufskollegBerufsebeneKatalogEintrag(300011000, 3, "FL",
					"Allgemeine Hochschulreife / Freizeitsportleiter (Sport/Gesundheitsförderung/Biologie)", null, null)
	}),
	...
	private static final @NotNull HashMap<String, BerufskollegBerufsebene3> _ebenen = new HashMap<>();
	 ...
	 */
	BerufskollegBerufsebene3(final @NotNull BerufskollegBerufsebeneKatalogEintrag @NotNull [] historie) {
	 ...
	 */
	private static @NotNull HashMap<String, BerufskollegBerufsebene3> getMapBerufsebenenByKuerzel() {
		if (_ebenen.size() == 0) {
			for (final BerufskollegBerufsebene3 s : BerufskollegBerufsebene3.values()) {
				if (s.daten != null)
	 ...
	 */
	public static BerufskollegBerufsebene3 getByKuerzel(final String kuerzel) {
