...
public enum KAOAAnschlussoption {
	...
	SCHUAUS(new KAOAAnschlussoptionEintrag[] {
			new KAOAAnschlussoptionEintrag(31, "SCHUAUS",
					"Berufskolleg - schulische Ausbildung zwei- oder dreijährig in der Berufsfachschule Anlage B oder C oder am Beruflichen Gymnasium",
					Arrays.asList(
							Schulstufe.SEKUNDARSTUFE_I, Schulstufe.SEKUNDARSTUFE_II
					), Arrays.asList(
	...
	FACHAUS(new KAOAAnschlussoptionEintrag[] {
			new KAOAAnschlussoptionEintrag(34, "FACHAUS",
					"Betriebliche Ausbildung in gesondert geregelten Berufen (Fachpraktikerausbildung/Werkerausbildung) für Jugendliche mit Behinderung",
					Arrays.asList(
							Schulstufe.SEKUNDARSTUFE_I, Schulstufe.SEKUNDARSTUFE_II
					), Arrays.asList(
	...
	MASS(new KAOAAnschlussoptionEintrag[] {
			new KAOAAnschlussoptionEintrag(39, "MASS", "weitere Maßnahmen gemäß SGB II/III/VIII (z. B. Aktivierungshilfen, Projekte der Jugendberufshilfe) ",
					Arrays.asList(
							Schulstufe.SEKUNDARSTUFE_I, Schulstufe.SEKUNDARSTUFE_II
					), Arrays.asList(
							KAOAZusatzmerkmal.SBO_10_7_1, KAOAZusatzmerkmal.SBO_10_7_2, KAOAZusatzmerkmal.SBO_10_7_3,
	...
	FREI(new KAOAAnschlussoptionEintrag[] {
			new KAOAAnschlussoptionEintrag(42, "FREI", "Freiwilligendienste, Freiwilliger Wehrdienst/Laufbahn Bundeswehr und ähnliche Anschlussoptionen",
					Arrays.asList(
							Schulstufe.SEKUNDARSTUFE_I, Schulstufe.SEKUNDARSTUFE_II
					), Arrays.asList(
							KAOAZusatzmerkmal.SBO_10_7_1, KAOAZusatzmerkmal.SBO_10_7_2, KAOAZusatzmerkmal.SBO_10_7_3,
	...
	WFBM(new KAOAAnschlussoptionEintrag[] {
			new KAOAAnschlussoptionEintrag(48, "WFBM",
					"Maßnahmen im Eingangsverfahren und im Berufsbildungsbereich in Werkstätten für behinderte Menschen (WfbM)", Arrays.asList(
							Schulstufe.SEKUNDARSTUFE_I, Schulstufe.SEKUNDARSTUFE_II
					), Arrays.asList(
							KAOAZusatzmerkmal.SBO_10_7_1, KAOAZusatzmerkmal.SBO_10_7_3, KAOAZusatzmerkmal.SBO_10_7_4
					), null, null)
