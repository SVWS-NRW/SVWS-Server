 ...
 */
@DisplayName("Teste de.nrw.schule.svws.core.utils.TestAdressenUtils")
public class TestAdressenUtils {
    ...
    static void setup() {
        ...
        testdatenSplitStrasse = CsvReader.fromResourceWithEmptyValues("de/nrw/schule/svws/core/utils/TestdatenSplitStrasse.csv", TestdatenSplitStrasse.class);
