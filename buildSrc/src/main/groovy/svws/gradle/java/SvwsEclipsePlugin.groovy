	...
	void configureEclipse(){
		project.eclipse.project.file.whenMerged { gp ->
			if (gp.name != null) {
				...
				project.ext.setEclipsePreference(project.file('.settings/org.eclipse.jdt.core.prefs'), 'org.eclipse.jdt.core.compiler.annotation.nonnull', 'de.nrw.schule.svws.base.annotations.NonNull')
				...
				project.ext.setEclipsePreference(project.file('.settings/org.eclipse.jdt.core.prefs'), 'org.eclipse.jdt.core.compiler.annotation.nonnullbydefault', 'de.nrw.schule.svws.base.annotations.NonNullByDefault')
				...
				project.ext.setEclipsePreference(project.file('.settings/org.eclipse.jdt.core.prefs'), 'org.eclipse.jdt.core.compiler.annotation.nullable', 'de.nrw.schule.svws.base.annotations.Nullable')
