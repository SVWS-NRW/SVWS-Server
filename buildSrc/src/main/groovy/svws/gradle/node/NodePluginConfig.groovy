...
abstract class NodePluginConfig {
    ...
    NodePluginConfig(Project p) {
    	...
    	tsVersion.convention('5.0.2'); // https://github.com/microsoft/TypeScript/releases
    	tsNodeTypesVersion.convention('18.15.10'); // https://www.npmjs.com/package/@types/node
    }
