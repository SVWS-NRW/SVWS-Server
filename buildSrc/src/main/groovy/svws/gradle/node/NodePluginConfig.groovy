...
abstract class NodePluginConfig {
    ...
    NodePluginConfig(Project p) {
    	...
    	tsVersion.convention('5.4.2'); // https://github.com/microsoft/TypeScript/releases
    	tsNodeTypesVersion.convention('20.11.25'); // https://www.npmjs.com/package/@types/node
    }
