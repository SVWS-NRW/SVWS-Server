...
abstract class NodePluginConfig {
    ...
    NodePluginConfig(Project p) {
    	...
    	version.convention('20.5.1'); // https://nodejs.org/en/download/
    	npmVersion.convention('9.8.0');
    	tsVersion.convention('5.1.6'); // https://github.com/microsoft/TypeScript/releases
    	tsNodeTypesVersion.convention('20.5.1'); // https://www.npmjs.com/package/@types/node
    }
