...
class NotenmodulRepositoryFactoryTest {
	...
	void testAllRepositoryGetters() {
		...
		final NotenmodulRepositoryFactory factory = NotenmodulRepositoryFactory.getNewInstance();
		assertNotNull(factory);

		assertNotNull(factory.getNotenmodulCredentialsRepository());
		assertNotNull(factory.getNotenmodulCredentialsTimestampsRepository());
		assertNotNull(factory.getNotenmodulKonfigurationClientRepository());
		assertNotNull(factory.getNotenmodulKonfigurationServerRepository());
		assertNotNull(factory.getNotenmodulVerbindungenRepository());
	}
