...
class KatalogeRepositoryFactoryTest {
	...
	void testAllRepositoryGetters() {
		...
		final KatalogeRepositoryFactory factory = KatalogeRepositoryFactory.getNewInstance();
		assertNotNull(factory);

		assertNotNull(factory.getFachRepository());
		assertNotNull(factory.getJahrgaengeRepository());
