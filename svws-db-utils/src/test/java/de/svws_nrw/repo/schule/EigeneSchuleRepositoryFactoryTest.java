...
class EigeneSchuleRepositoryFactoryTest {
	...
	void testAllRepositoryGetters() {
		...
		final EigeneSchuleRepositoryFactory factory = EigeneSchuleRepositoryFactory.getNewInstance();
		assertNotNull(factory);

		assertNotNull(factory.getSchuleRepository());
		assertNotNull(factory.getSchuljahresabschnitteRepository());
	}
