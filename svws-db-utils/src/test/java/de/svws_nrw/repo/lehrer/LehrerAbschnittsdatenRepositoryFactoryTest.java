...
class LehrerAbschnittsdatenRepositoryFactoryTest {
	...
	void getNewInstance_success() {
		final var factory = LehrerAbschnittsdatenRepositoryFactory.getNewInstance();

		assertThat(factory)
				.isNotNull()
				.isInstanceOf(LehrerAbschnittsdatenRepositoryFactory.class);
	}

	@Test
	@DisplayName("getNewInstance | Jeder Aufruf erstellt neue Instanz")
	void getNewInstance_createsNewInstance() {
		final var factory1 = LehrerAbschnittsdatenRepositoryFactory.getNewInstance();
		final var factory2 = LehrerAbschnittsdatenRepositoryFactory.getNewInstance();
	...
	void getRepository_success() {
		...
		assertThat(repository)
				.isNotNull()
				.isInstanceOf(LehrerAbschnittsdatenRepository.class)
				.isInstanceOf(LehrerAbschnittsdatenRepositoryImpl.class);
	}
