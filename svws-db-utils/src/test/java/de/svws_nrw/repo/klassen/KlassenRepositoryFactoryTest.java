...
class KlassenRepositoryFactoryTest {
	...
	void testAllRepositoryGetters() {
		...
		final KlassenRepositoryFactory factory = KlassenRepositoryFactory.getNewInstance();
		assertNotNull(factory);

		assertNotNull(factory.getKlassenRepository());
		assertNotNull(factory.getKlassenleitungenRepository());
	}
