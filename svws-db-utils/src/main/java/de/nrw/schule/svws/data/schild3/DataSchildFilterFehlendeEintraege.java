 ...
 */
public class DataSchildFilterFehlendeEintraege extends DataManager<Long> {
	...
	public Response getAll() {
		List<Schild3KatalogEintragFilterFehlendeEintraege> katalog = CsvReader.fromResource("daten/csv/schild3/FilterFehlendeEintraege.csv", Schild3KatalogEintragFilterFehlendeEintraege.class);
    	if (katalog == null)
