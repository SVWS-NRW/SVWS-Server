 ...
 */
public final class DataStrassen extends DataManager<Long> {
	...
	public Response getAll() {
		final List<KatalogEintragStrassen> katalog = CsvReader.fromResource("daten/csv/Strassen.csv", KatalogEintragStrassen.class);
    	if (katalog == null)
