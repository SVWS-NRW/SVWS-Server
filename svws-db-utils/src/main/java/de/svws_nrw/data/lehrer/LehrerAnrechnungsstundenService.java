 ...
 */
public final class LehrerAnrechnungsstundenService {

	private final LehrerAnrechnungsstundenServiceKontext kontext;
	 ...
	 */
	public LehrerAnrechnungsstundenService(final LehrerAnrechnungsstundenServiceKontext kontext) {
	...
	private void applyPatch(final DTOLehrerAnrechnungsstunde daten, final LehrerAnrechnungsstundenPatchRequest patch) {
	...
	private void applyCreateRequest(final DTOLehrerAnrechnungsstunde daten, final LehrerAnrechnungsstundenCreateRequest createRequest) {
	 ...
	 */
	public LehrerPersonalabschnittsdatenAnrechnungsstunden create(final LehrerAnrechnungsstundenCreateRequest patch) {
	 ...
	 */
	public List<LehrerPersonalabschnittsdatenAnrechnungsstunden> createMultiple(final Collection<LehrerAnrechnungsstundenCreateRequest> createRequests) {
		...
		return transactional(() -> {
			...
			int i = 0;
			for (final LehrerAnrechnungsstundenCreateRequest createRequest : createRequests) {
