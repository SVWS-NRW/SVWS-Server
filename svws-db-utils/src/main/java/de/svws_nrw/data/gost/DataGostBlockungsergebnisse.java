...
public final class DataGostBlockungsergebnisse extends DataManager<Long> {
	...
	public static GostBlockungsergebnisManager getErgebnismanager(final @NotNull DBEntityManager conn, final @NotNull DTOGostBlockungZwischenergebnis ergebnis,
		...
		final List<DTOGostBlockungZwischenergebnisKursSchiene> listSchienenKurse = conn
				.queryList(DTOGostBlockungZwischenergebnisKursSchiene.QUERY_BY_ZWISCHENERGEBNIS_ID, DTOGostBlockungZwischenergebnisKursSchiene.class,
						ergebnis.ID);
		...
		final List<DTOGostBlockungZwischenergebnisKursSchueler> listKursSchueler = conn
				.queryList(DTOGostBlockungZwischenergebnisKursSchueler.QUERY_BY_ZWISCHENERGEBNIS_ID, DTOGostBlockungZwischenergebnisKursSchueler.class,
						ergebnis.ID);
