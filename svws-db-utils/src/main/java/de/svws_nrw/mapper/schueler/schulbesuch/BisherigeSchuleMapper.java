...
public interface BisherigeSchuleMapper {

	/** Instanz des Mappers */
	BisherigeSchuleMapper INSTANCE = Mappers.getMapper(BisherigeSchuleMapper.class);
	...
	/**
	 * Erstellt eine neue {@link DTOSchuelerAbgaenge}-Entity aus einem {@link BisherigeSchuleCreateRequest}.
	 * <p>
	...
	DTOSchuelerAbgaenge toDomain(BisherigeSchuleCreateRequest dto, String bezeichnungEntlassgrund, String schulnummer);

	/**
	 * Wendet die Änderungen eines {@link BisherigeSchulePatchRequest} auf eine bestehende
	...
	void patch(BisherigeSchulePatchRequest input, @MappingTarget DTOSchuelerAbgaenge toPatch);
