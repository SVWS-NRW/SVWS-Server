...
public final class SchuelerBisherigeSchuleService {

	private final SchuelerBisherigeSchuleRepository repository;
	private final SchuelerBisherigeSchuleMapper mapper;
	 ...
	 */
	public SchuelerBisherigeSchuleService(
			final SchuelerBisherigeSchuleRepository repository,
			final SchuelerBisherigeSchuleMapper mapper,
	 ...
	 */
	public SchuelerSchulbesuchSchule create(final SchuelerBisherigeSchuleCreateRequest dto) {
	 ...
	 */
	public SchuelerSchulbesuchSchule patch(final long id, final SchuelerBisherigeSchulePatchRequest dto) {
		return TransactionSupport.transactional(() -> {
	...
	private void validateAndResolvePatch(final DTOSchuelerAbgaenge entity, final SchuelerBisherigeSchulePatchRequest dto) {
	...
	private DTOSchuelerAbgaenge validateCreate(final SchuelerBisherigeSchuleCreateRequest dto) {
