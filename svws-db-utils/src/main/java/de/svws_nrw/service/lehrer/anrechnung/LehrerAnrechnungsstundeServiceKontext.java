 ...
 */
public final class LehrerAnrechnungsstundeServiceKontext {
	...
	private LehrerAnrechnungsstundeServiceKontext(
	 ...
	 */
	public static LehrerAnrechnungsstundeServiceKontext of(final SchuljahresabschnitteRepository schuljahresabschnitteRepository,
			final LehrerPersonalabschnittsdatenRepository lehrerAbschnittsdatenRepository,
			final LehrerAnrechnungRepository lehrerAnrechnungRepository) {
		return new LehrerAnrechnungsstundeServiceKontext(schuljahresabschnitteRepository, lehrerAbschnittsdatenRepository, lehrerAnrechnungRepository);
	}
	 ...
	 */
	public List<DTOLehrerAnrechnungsstunde> create(final Collection<LehrerAnrechnungsstundeCreateRequest> patches) {
		long nextId = lehrerAnrechnungRepository.getNextID();
		final List<DTOLehrerAnrechnungsstunde> result = new ArrayList<>();
		for (final LehrerAnrechnungsstundeCreateRequest patch : patches) {
