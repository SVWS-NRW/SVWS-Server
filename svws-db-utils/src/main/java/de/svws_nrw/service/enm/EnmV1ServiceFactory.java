 ...
 */
public final class EnmV1ServiceFactory {
	 ...
	 */
	private EnmV1ServiceFactory(final KatalogeRepositoryFactory katalogeRepositoryFactory,
	 ...
	 */
	public static EnmV1ServiceFactory getNewInstance(final KatalogeRepositoryFactory katalogeRepositoryFactory,
			final KlassenRepositoryFactory klassenRepositoryFactory,
			final KurseRepositoryFactory kurseRepositoryFactory,
			final LehrerRepositoryFactory lehrerRepositoryFactory,
			final NotenmodulRepositoryFactory notenmodulRepositoryFactory,
			final SchuelerRepositoryFactory schuelerRepositoryFactory,
			final SchuleRepositoryFactory schuleRepositoryFactory) {
		return new EnmV1ServiceFactory(katalogeRepositoryFactory, klassenRepositoryFactory, kurseRepositoryFactory, lehrerRepositoryFactory,
