 ...
 */
public final class SchuelerAnkreuzkompetenzenRepositoryImpl extends RepositoryImpl<DTOSchuelerAnkreuzfloskeln>
		implements SchuelerAnkreuzkompetenzenRepository {
	 ...
	 */
	public SchuelerAnkreuzkompetenzenRepositoryImpl(final DBEntityManager conn) {
