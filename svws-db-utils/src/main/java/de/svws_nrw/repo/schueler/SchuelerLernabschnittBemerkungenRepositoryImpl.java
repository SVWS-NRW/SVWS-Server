 ...
 */
public final class SchuelerLernabschnittBemerkungenRepositoryImpl extends RepositoryImpl<DTOSchuelerPSFachBemerkungen>
		implements SchuelerLernabschnittBemerkungenRepository {
	 ...
	 */
	public SchuelerLernabschnittBemerkungenRepositoryImpl(final DBEntityManager conn) {
