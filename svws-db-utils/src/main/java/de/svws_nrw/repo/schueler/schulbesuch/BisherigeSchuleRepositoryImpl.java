...
public final class BisherigeSchuleRepositoryImpl extends RepositoryImpl<DTOSchuelerAbgaenge> implements BisherigeSchuleRepository {
	 ...
	 */
	public BisherigeSchuleRepositoryImpl(final DBEntityManager conn) {
