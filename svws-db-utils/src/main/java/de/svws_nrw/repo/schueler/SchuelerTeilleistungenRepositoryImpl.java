 ...
 */
public final class SchuelerTeilleistungenRepositoryImpl extends RepositoryImpl<DTOSchuelerTeilleistung>
		implements SchuelerTeilleistungenRepository {
	 ...
	 */
	public SchuelerTeilleistungenRepositoryImpl(final DBEntityManager conn) {
