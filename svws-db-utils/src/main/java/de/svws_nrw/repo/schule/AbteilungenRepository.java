...
public interface AbteilungenRepository extends Repository<DTOAbteilungen> {
	...
	/**
	 * Gibt eine Map aller Abteilungen für den angegebenen Schuljahresabschnitt zurück.
	 *
	 * @param idSchuljahresabschnitt   die ID des Schuljahresabschnittes
	 *
	 * @return die Map der Abteilungen
	 */
	Map<Long, DTOAbteilungen> getMapBySchuljahresabschnitt(long idSchuljahresabschnitt);
