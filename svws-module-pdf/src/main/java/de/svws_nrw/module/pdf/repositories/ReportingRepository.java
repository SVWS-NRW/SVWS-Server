package de.svws_nrw.module.pdf.repositories;
...
public class ReportingRepository {
	...
	/**
	 * Stellt die eine Map der Schuljahresabschnitte der Schule aus der Datenbankverbindung zu deren IDs zur Verfügung
